...
if (require_once '../../application.php') {
    if ($_SESSION['LEVEL'] >= 2) {
        ?>
        <body onload="search_data('data_display', 'select', '', '', '/RKAPP/ITM/pages/select_work_data.php')">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="input-group w3-margin-bottom"><span class="input-group-addon">ประเภทงาน</span>
                                <select class='form-control' id="type_code" name="type_code" onchange="search_data('data_display', 'select', this.value, '0', '/RKAPP/ITM/pages/select_work_data.php')">
