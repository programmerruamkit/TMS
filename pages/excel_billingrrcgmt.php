...
if ($result_seBillings['JOBSTART'] == 'GMT' && $result_seBillings['JOBEND'] == 'GMT') {
   ?>
      ...
      <tbody>
         ...
         <tr>
              <td colspan="5" style="font-size:22px">ลูกค้า บจก.กรีน เมทัลส์(ประเทศไทย)</td>
              <td colspan="5" style="text-align:right;font-size:22px">วันที่ <?= $datemon  ?> <?=$year?></td>
         </tr>
         <tr>
              <td colspan="10" style="font-size:22px">ที่อยู่ 254 หมู่ 7 นิคมอุตสาหกรรมเกตเวย์ชิตี้</td>
         </tr>
         <tr>
              <td colspan="10" style="font-size:22px">ต.หัวสำโรง อ.แปลงยาว จ.ฉะเชิงเทรา 24190</td>
         </tr>
         <tr>
  ...
  <?php
   ...
   ?>
      ...
      <tbody>
         ...
         <tr>
              <td colspan="10" style="font-size:22px">ที่อยู่ 219/18 หมู่ 6 นิคมอุตสาหกรรมปิ่นทอง 3</td>
         </tr>
         <tr>
              <td colspan="10" style="font-size:22px">ตำบลบ่อวิน อำเภอศรีราชา จังหวัดชลบุรี 20230</td>
         </tr>
      </tbody>
  </table>
  <?php
