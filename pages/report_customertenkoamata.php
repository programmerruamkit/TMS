...
<html lang="en">
    ...
    <body>
            ...
            <div id="page-wrapper" >
                ...
                <ul class="nav nav-pills">
                    ...
                    <!-- <li ><a href="" data-toggle="tab" aria-expanded="true" >แผนงาน (2)</a>
                    </li> -->
                </ul>
                    ...
                    <div class="tab-pane fade  active in" id="tenko1">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <label>&nbsp;</label>
                                <div class="form-group">
                                    <button class="btn btn-default" onclick="select_customertenkoamata();">ค้นหา <li class="fa fa-search"></li></button>
                                </div>
                                        ...
                                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                            <div id="datadef">
                                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $condCustomer = " AND COMPANYCODE IN ('RKL')";
                                                        ...
                                                        while ($result_seCustomer = sqlsrv_fetch_array($query_seCustomer, SQLSRV_FETCH_ASSOC)) {    
                                                            ...
                                                            //CHECK แผนในแต่ละลูกค้าว่ามีแผนงานหรือไม่ 
                                                            // ถ้ามีจะเข้า Function การนับข้อมูลแผนในแต่ละสถานะงาน

                                                            $sql_seCuscheck = "SELECT  COUNT(VEHICLETRANSPORTPLANID) AS 'CHK_CUS'
                                                                FROM [dbo].[VEHICLETRANSPORTPLAN] a
                                                                INNER JOIN dbo.CUSTOMER b ON a.CUSTOMERCODE = b.CUSTOMERCODE
                                                                WHERE b.ACTIVESTATUS = 1
                                                                AND a.COMPANYCODE = 'RKL' AND a.CUSTOMERCODE = '" . $result_seCustomer['CUSTOMERCODE'] . "'
                                                                AND CONVERT(DATE,a.DATEWORKING,103) BETWEEN CONVERT(DATE,GETDATE(),103) AND CONVERT(DATE,GETDATE(),103)";
                                                            $params_seCuscheck = array();
                                                            $query_seCuscheck  = sqlsrv_query($conn, $sql_seCuscheck, $params_seCuscheck);
                                                            $result_seCuscheck = sqlsrv_fetch_array($query_seCuscheck, SQLSRV_FETCH_ASSOC);

                                                            // echo $result_seCuscheck['CHK_CUS'];
                                                            //อันเดิม
                                                            ...
                                                            if ($result_seCuscheck['CHK_CUS'] != '0') {
                                                                ...
                                                                // echo $result_seCntcuspresent['cnt'];
                                                                ...
                                                                // AND VEHICLETRANSPORTPLANID NOT IN (SELECT VEHICLETRANSPORTPLANID FROM TENKOMASTER)
                                                                $condCntcus4 = " AND a.COMPANYCODE = '" . $result_seCustomer['COMPANYCODE'] . "' AND a.CUSTOMERCODE = '" . $result_seCustomer['CUSTOMERCODE'] . "' AND a.STATUSNUMBER = '3'  ";
                                                                ...
                                                                $condCntcus5 = " AND a.COMPANYCODE = '" . $result_seCustomer['COMPANYCODE'] . "' AND a.CUSTOMERCODE = '" . $result_seCustomer['CUSTOMERCODE'] . "' AND a.STATUSNUMBER = 'X' AND VEHICLETRANSPORTPLANID NOT IN (SELECT VEHICLETRANSPORTPLANID FROM TENKOMASTER) ";
                                                                ...
                                                                $condCntcus6 = " AND a.COMPANYCODE = '" . $result_seCustomer['COMPANYCODE'] . "' AND a.CUSTOMERCODE = '" . $result_seCustomer['CUSTOMERCODE'] . "' AND a.STATUSNUMBER = '0' ";
                                                                ...
                                                                $result_seCntcus0['cnt'] = '0';
                                                                $result_seCntcuspresent['cnt'] = '0';
                                                                $result_seCntcus1['cnt'] = '0';
                                                                $result_seCntcus2['cnt'] = '0';
                                                                $result_seCntcus3['cnt'] = '0';
                                                                $result_seCntcus4['cnt'] = '0';
                                                                $result_seCntcus5['cnt'] = '0';
                                                                $result_seCntcus6['cnt'] = '0';
                                                            }
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: left;font-size: 15px;">(<?= $result_seCustomer['COMPANYCODE'] ?>) <?= $result_seCustomer['NAMETH'] ?></td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center"><?php if ($sumcusO != '0') { ?><b><?= $sumcusO ?></b></a><?php } else { ?><b><?= $sumcusO ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcusP != '0') { ?><b><?= $sumcusP ?></b></a><?php } else { ?><b><?= $sumcusP ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcusL != '0') { ?><b><?= $sumcusL ?></b></a><?php } else { ?><b><?= $sumcusL ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcus1 != '0') { ?><b><?= $sumcus1 ?></b></a><?php } else { ?><b><?= $sumcus1 ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcus2 != '0') { ?><b><?= $sumcus2 ?></b></a><?php } else { ?><b><?= $sumcus2 ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcus3 != '0') { ?><b><?= $sumcus3 ?></b></a><?php } else { ?><b><?= $sumcus3 ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcusX != '0') { ?><b><?= $sumcusX ?></b></a><?php } else { ?><b><?= $sumcusX ?><?php } ?></b></td>
                                                            <td style="text-align: center"><?php if ($sumcus0 != '0') { ?><b><?= $sumcus0 ?></b></a><?php } else { ?><b><?= $sumcus0 ?><?php } ?></b></td>
    ...
    <script>
        ...
        function select_customertenkoamata()
        {
            //loadData();
            showLoading();
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    txt_flg: "select_customertenkoamata", companycode: companycode, datestart: datestart, dateend: dateend
                },
                success: function (rs) {
                    // window.setTimeout('alert("โหลดข้อมูลเรียบร้อย");window.close();', 5000);
                    ...
                    save_logprocess('Driver Management', 'Select Driver Management', '<?= $_SESSION["USERNAME"] ?>');
        ...
        // fetch('https://www.mocky.io/v2/5185415ba171ea3a00704eed?mocky-delay=3400ms')
