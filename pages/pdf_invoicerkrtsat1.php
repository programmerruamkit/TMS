...
$table_header3 = '<table style="width: 110%;">
    ...
    <tbody><br><br><br>
        <tr>
            <td colspan="48" style="width: 70%;font-size:18px">บริษัท ร่วมกิจรุ่งเรือง (1993) จำกัด (RUAMKIT RUNGRUENG (1993) CO.,LTD.)</td>
       </tr>
       <tr>
       ...
       <tr>
            <td colspan="48" style="font-size:18px" >เลขประจำตัวผู้เสียภาษี : 0105536076131</td>
       </tr>
       <tr>
            <td colspan="48">&nbsp;</td>
       </tr>
