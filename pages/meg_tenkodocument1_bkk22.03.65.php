...
<html lang="en">
                  ...
                  <h4 class="modal-title"><b>ข้อมูล Simulator และ Accident</b></h4>
                        ...
                        <table style="width:80%;border:1px solid black;">
                            ...
                            <tr>
                                ...
                                <td colspan ="4" style="border:1px solid black;">&nbsp; <?= $result_CalculateWork['RS'] ?></td>
                                <td colspan ="3" style="border:1px solid black;font-size: 16px;background-color: #bfbfbf;">&nbsp;<b>อายุงาน</b></td>
                                <td colspan ="3" style="border:1px solid black;">&nbsp; <?= $result_CalculateAge['RS'] ?></td>
                            ...
                            <div class="row" >
                                ...
                                if ($emp != "") {
                                    ...
                                    <div class="col-lg-10 text-right">
                                        ...
                                        <!--<a href="#"  data-toggle="modal"  data-target="#modal_history" class="btn btn-default">ประวัติสุขภาพ <li class="fa fa-hospital-o"></li></a>-->
                                        <!-- &nbsp;&nbsp;<a href="pdf_reportemployee4_1.php?employeecode=<?= $emp ?>&tenkomasterid=<?= $result_seTenkomaster_temp['TENKOMASTERID'] ?>&vehicletransportplanid=<?= $_GET['vehicletransportplanid'] ?>"  target ="_blank" class="btn btn-default">พิมพ์เอกสารเท็งโกะ 1 <li class="fa fa-print"></li></a>&nbsp;&nbsp; -->
                                        <!--<a href="pdf_reportemployee4_2.php?vehicletransportplanid=<?//= $_GET['vehicletransportplanid'] ?>"  target ="_blank"  class="btn btn-default">พิมพ์เอกสารเท็งโกะ 2 <li class="fa fa-print"></li></a>-->
                                    </div>
                                    <?php
                                }
                                ?>
                            ...
                            <div class="tab-content">
                                ...
                                if ($_GET['employeecode1'] != "") {
                                    ...
                                    <div class="tab-pane fade in active" id="tenko1">
                                        ...
                                        // ข้อมูลใบขับขี่
                                        $sql_seCarData1 = "SELECT a.PersonID,a.CarLicenceID,
                                        ...
                                        $sql_seDateSelfCheck1 = "SELECT CONVERT(VARCHAR(10),DATEWORKING,103) AS 'DATEWORKING',
                                        ...
                                        //SELF CHECKคนที่1
                                        $sql_seSelfCheck1 = "SELECT TOP 1 SELFCHECKID
                                        FROM DRIVERSELFCHECK WHERE EMPLOYEECODE ='".$_GET['employeecode1']."' 
                                        AND (CONVERT(VARCHAR(10),CREATEDATE,103) ='".$result_seDateSelfCheck1['DATEWORKING']."' 
                                        ...
                                        <table style="border: 1px solid black;border-collapse: collapse;">
                                            <tr>
                                                <th colspan = "6" style="border: 1px solid black;background-color: #a3a3a3;border-collapse: collapse;padding: 5px;text-align: center">ตรวจสอบปัญหาสายตา<font style="color:red"> *หากตัวหนังสือมีสีแดง หมายถึงมีปัญหาสายตา เจ้าหน้าที่ต้องเน้นย้ำ และตรวจสอบแว่นสายตาของพนักงาน </font></th>
                                            ...
                                            <tr>
                                                ...
                                                <!-- เอกสาร Tenko -->
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"><button type="button" class="btn btn-primary btn-md" name="myBtn" id ="myBtn" data-toggle="modal" data-target="#myModalinsert"  >ข้อมูล Simulator พขร.1</button></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"><b><?=$year11end?><?=$year12end?></b></td>
                                                <!-- กราฟสุขภาพ -->
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"><b><input type="button" onclick="se_graphdatacheck('<?= $_GET['employeecode1'] ?>');" name="btnSend" id="btnSend" value="ดูกราฟข้อมูลสุขภาพ" class="btn btn-primary"></b></td>
                                                <!-- เอกสารเท็งโกะ -->
                                        ...
                                        <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th  colspan="7" ><input type="button" onclick="commit_1()" class="btn btn-success" value="Commit"> <font style="color: green">พนักงานขับรถ : นาย <?= $result_sePlain['EMPLOYEENAME1'] ?></font></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" readonly="" class="form-control"  id="txt_rs14" name="txt_rs14" value="<?= $result_seTenkobefore['TENKORESTDATA'] ?>" ></td>
                                            ...
                                            <div style="text-align: center;">
                                                ...
                                                <table style="width:500px;border: 1px solid black;border-collapse: collapse;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="text" name="txt_gradesaveemp1" id="txt_gradesaveemp1" value="" style="display:none">
                                                        <input type="text" name="txt_pointsaveemp1" id="txt_pointsaveemp1" value="" style="display:none">
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <div class="tab-pane fade in active" id="tenko1">
                                        ...
                                        $sql_seCarData2 = "SELECT a.PersonID,a.CarLicenceID,
                                        FORMAT (b.ExpireCar_Start, 'dd/MM/yyyy') 'STARTDATE',
                                        FORMAT (b.ExpireCar_End, 'dd/MM/yyyy') AS 'ENDDATE' 
                                        FROM [dbo].[EMPLOYEEEHR2] a
                                        INNER JOIN [dbo].[EMPLOYEEDETAILEHR] b ON a.PersonID = b.PersonID
                                        ...
                                        // ข้อมูลวันที่รายงานตัวและวันที่ทำงานคนที่1 เพื่อเช็ค Self Check
                                        $sql_seDateSelfCheck2 = "SELECT CONVERT(VARCHAR(10),DATEWORKING,103) AS 'DATEWORKING',
                                        CONVERT(VARCHAR(10),DATEPRESENT,103)  AS 'DATEPRESENT'
                                        FROM VEHICLETRANSPORTPLAN
                                        WHERE VEHICLETRANSPORTPLANID ='".$_GET['vehicletransportplanid']."'";
                                        ...
                                        //SELF CHECKคนที่2
                                        $sql_seSelfCheck2 = "SELECT TOP 1 SELFCHECKID
                                        FROM DRIVERSELFCHECK WHERE EMPLOYEECODE ='".$_GET['employeecode2']."' 
                                        AND (CONVERT(VARCHAR(10),CREATEDATE,103) ='".$result_seDateSelfCheck2['DATEWORKING']."' 
                                        ...
                                        <table style="border: 1px solid black;border-collapse: collapse;">
                                            ...
                                            <tr>
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                    ...
                                                    <th colspan = "4" style="width:160px;border: 1px solid black;border-collapse: collapse;padding: 5px;text-align: left"><input type="button" onclick="se_selfcheck('<?=$result_seSelfCheck2['SELFCHECKID']?>','<?= $result_seEmployee2['nameT'] ?>','<?= $_GET['employeecode2'] ?>','<?=$dateself2?>','<?=$result_seDateSelfCheck2['DATEWORKING']?>','<?=$result_seDateSelfCheck2['DATEPRESENT']?>','<?= $result_seEmployee['nameT']?>');" name="btnSend" id="btnSend" value="ดูข้อมูลการ Self Check" class="btn btn-primary"></th>
                                                    <?php
                                                    $emp = ($_GET['employeecode1'] != "") ? $_GET['employeecode1'] : $_GET['employeecode2'];
                                                    if ($emp != "") {
                                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <!-- เอกสารเท็งโกะ -->
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"><button type="button" class="btn btn-primary btn-md" name="myBtn" id ="myBtn" data-toggle="modal" data-target="#myModalinsert"  >ข้อมูล Simulator พขร.2</button></td>
                                            ...
                                            <tr>
                                                ...
                                                <!--ใบขับขี่  -->
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;background-color: #c9c9c9;text-align: left;padding: 5px"><b>วันหมดอายุ</b></td>
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"><b><?=$year21end?><?=$year22end?></b></td>
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"><b><input type="button" onclick="se_graphdatacheck('<?= $_GET['employeecode2'] ?>');" name="btnSend" id="btnSend" value="ดูกราฟข้อมูลสุขภาพ" class="btn btn-primary"></b></td>
                                                <!-- เอกสารเท็งโกะ -->
                                                <td colspan = "4" style="border: 1px solid black;border-collapse: collapse;text-align: left;padding: 5px"></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th  colspan="7" ><input type="button" onclick="commit_1()" class="btn btn-success" value="Commit"> <font style="color: green">พนักงานขับรถ : นาย <?= $result_sePlain['EMPLOYEENAME2'] ?></font></th>
 ...
 <!--<script src="../vendor/jquery/jquery.min.js"></script>-->
        ...
        <script>    
                                               ...
                                               function se_selfcheck(id,employeename,employeecode,datedriverchk,dateworking,datepresent,officername){
                                                    // alert(employeename);
                                                    // alert(employeecode);
                                                    // alert(datedriverchk);
                                                    // alert(dateworking);
                                                    ...
                                                    $type = 'check';
                                                    window.open('meg_selfcheckdetail.php?id=' + id +'&employeecode=' + employeecode+'&employeename='+employeename+'&datedriverchk='+datedriverchk+'&dateworkingchk='+dateworking+'&datepresentchk='+datepresent+'&type='+$type+'&officername='+officername, '_blank');
                                                }
...
?>
                                                    ...
                                                    if (
                                                            ...
                                                            && rs[0] > 7
                                                            && document.getElementById('txt_rs16').value < 37.5
...
if ($result_sePlain['COMPANYCODE'] == 'RKS' || $result_sePlain['COMPANYCODE'] == 'RKR' || $result_sePlain['COMPANYCODE'] == 'RKL') {
    ?>
                    if (document.getElementById("txt_rs16").value >= 37.5)
                    {
...
?>
        ...
        function edit_tenkogps(editableObj, fieldname, ID)
        {
            ...
            // var dataedit = editableObj.innerHTML; //อันเดิมใช้อันนี้
            $.ajax({
                url: 'meg_data.php',
                type: 'POST',
                data: {
