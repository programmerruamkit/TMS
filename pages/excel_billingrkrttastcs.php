...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRTTASTCS_Billing.xls";
} else {
  $strExcelFileName = "RKRTTASTCS_Billing" . $_GET['invoicecode'] . ".xls";
}
...
/////////////////////////////////ZONE CHARGE10////////////////////////////////////////
          ...
          } else if($result_seBilling10['LOCATION'] == 'เวลโกรว์' || $result_seBilling10['LOCATION'] == 'เวลล์โกร์') {
          $zone10 = "Wellgrow";
          ...
          $zone10 = "Poochao";
          }else if($result_seBilling10['LOCATION'] == 'ปทุมธานี') {
          $zone10 = "Pathum Thani";
          }else if($result_seBilling10['LOCATION'] == 'อยุธยา') {
          $zone10 = "Ayutthaya";
          }else if($result_seBilling10['LOCATION'] == 'พนัสนิคม') {
          $zone10 = "Phanat Nikhom";
          }else if($result_seBilling10['LOCATION'] == 'ประชาอุทิศ') {
          $zone10 = "Pracha Uthid";
          }else if($result_seBilling10['LOCATION'] == 'แหลมฉบัง') {
          $zone10 = "Laemchabang";
          }else if($result_seBilling10['LOCATION'] == 'ปิ่นทอง') {
          $zone10 = "Pinthong";
          }else if($result_seBilling10['LOCATION'] == 'อีสเทิร์น ซีบอร์ด') {
          if ($result_seBilling10['JOBEND'] == 'SSSC3 : Easternseaboard' ) {
            $zone10 ="Rayong";
          }else {
            $zone10 = "Eastern Seaboard IE.";
          }
          ...
          $jobend10 = "BTD";
          ////////////TTASTCS(OTHER)(WEIGHT)
          }else if ($result_seBilling10['JOBEND'] == 'TTAST-PT') {
          $jobend10 = "TTAST-PT";
          ...
          $jobend10 = "STE";
          }else if ($result_seBilling10['JOBEND'] == 'SMTL : Sriracha') {
          $jobend10 = "SMTL";
 ...
 ?>
  ...
  <td colspan="" style="border-right:1px solid #000;padding:5px;text-align:center;">CS Wellgrow</td>
...
while($result_seBilling7 = sqlsrv_fetch_array($query_seBilling7, SQLSRV_FETCH_ASSOC)){
    ...
    /////////////////////////////////ZONE CHARGE7////////////////////////////////////////
              ...
              if ($result_seBilling7['JOBEND'] == 'AHT2' || $result_seBilling7['JOBEND'] == 'BHKT' || $result_seBilling10['JOBEND'] == 'TBFST' || $result_seBilling10['JOBEND'] == 'TBFST(BOI)') {
              ...
              if ($result_seBilling7['JOBEND'] == 'SARATHORN' || $result_seBilling7['JOBEND'] == 'SUNSTEEL' || $result_seBilling10['JOBEND'] == 'MONOSTEEL') {
                $zone7 = "Samutsakorn";
              }else {
                $zone7 = "Mueang";
              }

              } else if($result_seBilling7['LOCATION'] == 'เวลโกรว์' || $result_seBilling7['LOCATION'] == 'เวลล์โกร์') {
              $zone7 = "Wellgrow";
              ...
              $zone7 = "Poochao";
              }else if($result_seBilling7['LOCATION'] == 'ปทุมธานี') {
              $zone7 = "Pathum Thani";
              }else if($result_seBilling7['LOCATION'] == 'อยุธยา') {
              $zone7 = "Ayutthaya";
              }else if($result_seBilling7['LOCATION'] == 'พนัสนิคม') {
              $zone7 = "Phanat Nikhom";
              }else if($result_seBilling7['LOCATION'] == 'แหลมฉบัง') {
              $zone7 = "Laemchabang";
              }else if($result_seBilling10['LOCATION'] == 'ปิ่นทอง') {
              $zone7 = "Pinthong";
              }else if($result_seBilling7['LOCATION'] == 'อีสเทิร์น ซีบอร์ด') {
              if ($result_seBilling7['JOBEND'] == 'SSSC3 : Easternseaboard' ) {
                $zone7 ="Rayong";
              }else {
                $zone7 = "Eastern Seaboard IE.";
              }
        ...
        ////////////////////////////////////////JOBEND///////////////////////////////////////////////
          if ($result_seBilling7['JOBEND'] == 'TMB') {
            ...
            $jobend7 = "BTD";
          ////////////TTASTCS(OTHER)(WEIGHT)
          }else if ($result_seBilling7['JOBEND'] == 'TTAST-PT') {
            $jobend7 = "TTAST-PT";
            ...
            $jobend7 = "STE";
          }else if ($result_seBilling7['JOBEND'] == 'SMTL : Sriracha') {
            $jobend7 = "SMTL";
 ...
 <thead>
         ...
         while($result_seBillingnocharge = sqlsrv_fetch_array($query_seBillingnocharge, SQLSRV_FETCH_ASSOC)){
           ...
           /////////////////////////////////ZONE CHARGE NOCHRGE////////////////////////////////////////
             ...
             if ($result_seBillingnocharge['JOBEND'] == 'AHT2' || $result_seBillingnocharge['JOBEND'] == 'BHKT' || $result_seBilling10['JOBEND'] == 'TBFST' || $result_seBilling10['JOBEND'] == 'TBFST(BOI)') {
             ...
             $zonenc = "Poochao";
             }else if($result_seBillingnocharge['LOCATION'] == 'ปทุมธานี') {
             $zonenc = "Pathum Thani";
             }else if($result_seBillingnocharge['LOCATION'] == 'อยุธยา') {
             $zonenc = "Ayutthaya";
             ...
             $zonenc = "Laemchabang";
             }else if($result_seBillingnocharge['LOCATION'] == 'ปิ่นทอง') {
             $zonenc = "Pinthong";
             }else if($result_seBillingnocharge['LOCATION'] == 'อีสเทิร์น ซีบอร์ด') {
              if ($result_seBillingnocharge['JOBEND'] == 'SSSC3 : Easternseaboard' ) {
                $zonenc ="Rayong";
              }else {
                $zonenc = "Eastern Seaboard IE.";
              }
               ...
               $zonenc = $result_seBilling7['LOCATION'];
             }
               ...
               ////////////////////////////////////////JOBEND///////////////////////////////////////////////
                 if ($result_seBillingnocharge['JOBEND'] == 'TMB') {
                   ...
                   $jobendnc = "BTD";
                   ////////////TTASTCS(OTHER)(WEIGHT)
                 }else if ($result_seBillingnocharge['JOBEND'] == 'TTAST-PT') {
                   $jobendnc = "TTAST-PT";
                   ...
                   $jobendnc = "STE";
                 }else if ($result_seBillingnocharge['JOBEND'] == 'SMTL : Sriracha') {
                   $jobendnc = "SMTL";
