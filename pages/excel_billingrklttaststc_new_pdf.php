...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLTTASTSTC_Billing.xls";
} else {
  $strExcelFileName = "RKLTTASTSTC_Billing" . $_GET['invoicecode'] . ".xls";
}
...
////////////////////////////////////////JOBEND///////////////////////////////////////////////
 ...
 ?>
  ...
  <td style="border-right:1px solid #000;padding:5px;text-align:center;">STC <br>Amata City Chonburi</td>
