...
$condTenkomaster = " AND a.TENKOMASTERDIRVERCODE1 = '" . $_GET['employeecode'] . "' AND a.TENKOMASTERID = '".$_GET['tenkomasterid']."'";
...
$sql_seTenkoMasterdata = "SELECT a.TENKOMASTERID, a.VEHICLETRANSPORTPLANID, a.TENKOMASTERCOMPANY, a.TENKOMASTERDIRVERCODE1,
                        ...
                        AND a.TENKOMASTERID='".$_GET['tenkomasterid']."'";
...
{
    $TENKOMASTERVEHICLE = $result_seTenkoMasterdata['VEHICLEREGISNUMBER'];
}
else
{
...
$condTenkotransportDAY12 = " AND CONVERT(DATE,TENKOTRANSPORTDATE) = CONVERT(DATE,'" . $result_seTenkoMasterdata['DATEINPUT_F1'] . "',103)";
...
<thead>
    ...
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">'.$result_seTenkotransportDAY1['TENKOTRANSPORTDATE'].'</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        ...
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seEHR1['nameT'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
...
<thead>
    ...
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">'.$result_seTenkotransportDAY2['TENKOTRANSPORTDATE'].'</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซนเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seEHR2['nameT'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
<thead>
    ...
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">'.$result_seTenkotransportDAY3['TENKOTRANSPORTDATE'].'</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซนเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seEHR3['nameT'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
<thead>
    ...
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">'.$result_seTenkotransportDAY4['TENKOTRANSPORTDATE'].'</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซนเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seEHR4['nameT'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
<thead>
   <tr style="border:1px solid #000;padding:4px;">
    ...
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">'.$result_seTenkotransportDAY5['TENKOTRANSPORTDATE'].'</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซนเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seEHR5['nameT'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
