...
<tr>
    <td colspan="10" style="text-align:left;"><b><font style="font-size: 18px">หมายเลขบัญชี :TXMA Charge 10 </font></b></td>
...
$thead3 = '<thead>
    ...
    <tr style="border:1px solid #000;padding:8px;">
        ...
        <td style="border-right:1px solid #000;padding:8px;text-align:center;width: 20%;font-size: 32px">วันที่</td>
...
<tr style="border:1px solid #000;">
  ...
  <td style="border-right:1px solid #000;padding:8px;text-align:center;font-size: 32px">' . $result_seBilling['DATEVLIN_103'] . '</td>
...
<tr style="border:1px solid #000;">
  ...
  <td style="border-right:1px solid #000;padding:8px;text-align:left;font-size: 32px">' . $result_seBilling['JOBSTART'] . '</td>
  <td style="border-right:1px solid #000;padding:8px;text-align:left;font-size: 32px">' . ($result_seBilling['JOBEND']  == 'TMG' ? 'TMT/GW' : $result_seBilling['JOBEND']) . '</td>
  <td style="border-right:1px solid #000;padding:8px;text-align:left;font-size: 32px">Gateway</td>
