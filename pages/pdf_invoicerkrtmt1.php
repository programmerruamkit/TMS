...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
            <td style="width: 50%;">ลูกค้า บริษัท โตโยต้า มอเตอร์ ประเทศไทย จำกัด (สำนักงานใหญ่)</td>
            <td style="width: 50%;text-align:right">เลขที่ ' . $result_seInvoice['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 50%;">186/1 หมู่ 1  ถนนทางรถไฟเก่า <br>ต.สำโรงใต้ อ.พระประแดง จ.สมุทรปราการ</td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . ' เครดิต 30 วัน</td>
       </tr>
       <tr>
            <td style="width: 50%;">เลขประจำตัวผู้เสียภาษี 0105505001679</td>
