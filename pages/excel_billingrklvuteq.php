...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLVUTEQ_Billing.xls";
} else {
  $strExcelFileName = "RKLVUTEQ_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<body>
 ...
 <table style="width: 110%;">
      ...
      <tbody><br><br><br>
        ...
        <tr>
              <td colspan="5" style="text-align:left;font-size:22px">ลูกค้า บริษัท วูเทคไทย จำกัด (สำนักงานใหญ่)</td>
              <td colspan="6" style="text-align:right;font-size:22px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
        </tr>
        <tr>
              <td colspan="5" style="text-align:left;font-size:22px">ที่อยู่ 700/66 หมู่ที่.6 ต.หนองไม้แดง <br> อ.เมืองชลบุรี  จ.ชลบุรี 20000</td>
