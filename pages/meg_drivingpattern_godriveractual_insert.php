            ...
            <div id="page-wrapper">
                ...
                <div id="datade_edit">
                    <div class="row" id="list-data">
                        ...
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="font-size: 20px;text-align: center;"><b>วิ่งจริงขาไป</b></div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorp1?>;" onclick="select_searchDrivingPattern('GoActual','1','<?=$CHK4HURP1?>','<?=$CHK2HURP1?>')">ลงข้อมูล ช่วงที่1</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorp2?>;" onclick="select_searchDrivingPattern('GoActual','2','<?=$CHK4HURP2?>','<?=$CHK2HURP2?>')">ลงข้อมูล ช่วงที่2</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorp3?>;" onclick="select_searchDrivingPattern('GoActual','3','<?=$CHK4HURP3?>','<?=$CHK2HURP3?>')">ลงข้อมูล ช่วงที่3</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorp4?>;" onclick="select_searchDrivingPattern('GoActual','4','<?=$CHK4HURP4?>','<?=$CHK2HURP4?>')">ลงข้อมูล ช่วงที่4</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorp5?>;" onclick="select_searchDrivingPattern('GoActual','5','<?=$CHK4HURP5?>','<?=$CHK2HURP5?>')">ลงข้อมูล ช่วงที่5</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorp6?>;" onclick="select_searchDrivingPattern('GoActual','6','<?=$CHK4HURP6?>','<?=$CHK2HURP6?>')">ลงข้อมูล ช่วงที่6</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:45%;font-size: 18px;border:solid 2px;color:black;<?=$colorallload?>;" onclick="select_searchDrivingPattern('GoActual','load','YES','YES')">ลงข้อมูล<br>โหลดรถลง</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                    </div>
