...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSTHAITOHKEN_Billing.xls";
} else {
  $strExcelFileName = "RKSTHAITOHKEN_Billing" . $_GET['invoicecode'] . ".xls";
}
...
$condBilling2 = " AND c.COMPANYCODE ='RKS' AND c.CUSTOMERCODE ='THAITOHKEN'";
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
            <td colspan="10" style="font-size:22px">บริษัท ร่วมกิจรุ่งเรือง เซอร์วิส จำกัด (RUAMKIT RUNGRUENG SERVICES CO., LTD.)</td>
       </tr>
       <tr>
       ...
       <tr>
            <td colspan="10" style="font-size:22px">เลขประจำตัวผู้เสียภาษี  0105544064899</td>
       </tr>
       <tr>
            <td colspan="10">&nbsp;</td>
       </tr>
       ...
       <tr>
       <td colspan="5" style="width: 50%;font-size:22px">ลูกค้า บริษัท ไทยโตเคน เทอร์โม จำกัด </td>
       <td colspan="5" style="width: 50%;text-align:right;font-size:22px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="width: 75%;font-size:22px">700/314 หมู่ 6 ถ.บางนา-ตราด กม. 57 ตำบลดอนหัวฬ่อ อำเภอเมือง จังหวัดชลบุรี 20000</td>
            <td colspan="5" style="width: 25%;text-align:right;font-size:22px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
        </tr>
    </tbody>
</table>
...
<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><b>ประเภทรถ</b></font></td>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKS' AND CUSTOMERCODE = 'THAITOHKEN'";
    ...
    // if ($result_seBilling['VEHICLETYPE'] == '10W(Van) (2 Trips/Trailer/Day)') {
    //   $vehicletype = '10 ล้อ';
    // }else if ($result_seBilling['VEHICLETYPE'] == '10W(Van) (1 Trips/Trailer/Day)') {
    //   $vehicletype = '10 ล้อ';
    // }else {
    //   $vehicletype = '6 ล้อ';
    // }
   ...
   ?>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"></font><?= $result_seBilling['DOCUMENTCODE'] ?></td>
            <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?= $result_seBilling['VEHICLETYPE'] ?></font></td>
