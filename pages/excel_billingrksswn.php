...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSSWN_Billing.xls";
} else {
  $strExcelFileName = "RKSSWN_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
       <td colspan="5" style="width: 50%;font-size:22px">ลูกค้า บริษัท สยามวัฒนา เวสต์ แมนเน็จเม้นท์ จำกัด </td>
       <td colspan="5" style="width: 50%;text-align:right;font-size:22px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="width: 75%;font-size:22px">สำนักงานใหญ่ ที่อยู่ 22/1 หมู่ 6 ตำบลหนองบอนแดง อำเภอบ้านบึง จังหวัดชลบุรี 20170</td>
