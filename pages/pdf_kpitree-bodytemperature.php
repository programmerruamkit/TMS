...
if ($_GET['area'] == 'amata') {
    ...
    $params_sePhysical1_1 = array(
        array('select_temperature', SQLSRV_PARAM_IN),
    ...
    $params_sePhysicalng1_1 = array(
        array('select_temperatureng', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : To Check Body temperature driver for Ready to Work on Today.
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : ค่าอุณหภูมิของร่างกาย ต้องต่ำกว่า 37 องศา
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Body temperature and TENKO sheet.
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เครื่องมือตรวจสอบอุณหภูมิร่างกายและใบเท็นโกะ
                </td>
                <td style="width: 10%">
                    เวลาปรับข้อมูล
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Tool Check Body temperature and TENKO sheet.
                </td>
                <td style="width: 10%">
                    Time Adjust data
                </td>
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 80%">
                   : 1.งดมอบหมายงานและให้พนักงานขับรถไปพบแพทย์
                </td>
