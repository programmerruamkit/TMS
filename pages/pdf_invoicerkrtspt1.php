...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td style="width: 50%;">บริษัท ไทยซัมมิท พลาสเทค จำกัด </td>
            <td style="width: 50%;text-align:right">เลขที่ ' . $result_seInvoice['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 50%;">สาขา 00001 ที่อยู่  4/3 ม.1 ถนนบางนา-ตราด ต.บางโฉลง อ.บางพลี  จ.สมุทรปราการ  10540 </td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . '</td>
       </tr>

       <tr>
            <td style="width: 50%;">โทร. 02-3258000</td>
