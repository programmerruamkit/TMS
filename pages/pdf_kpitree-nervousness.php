...
if ($_GET['area'] == 'amata') {
    ...
    $params_sePhysical1_1 = array(
        array('select_nervousness', SQLSRV_PARAM_IN),
    ...
    $params_sePhysicalng1_1 = array(
        array('select_nervousnessng_gw', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
    ...
    $sql_sePhysical1_1 = "{call megKpitree_v2(?,?)}";
    $params_sePhysical1_1 = array(
        array('select_nervousness_gw', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
    $query_sePhysical1_1 = sqlsrv_query($conn, $sql_sePhysical1_1, $params_sePhysical1_1);
    $result_sePhysical1_1 = sqlsrv_fetch_array($query_sePhysical1_1, SQLSRV_FETCH_ASSOC);
...
<figure class="highcharts-figure">
    <table style="width: 100%;font-size: 12px">
        <tbody>
            <tr>
                <td colspan="4">
                    <h3 style="text-align: center">< ความกระวนกระวาย Nervousness > <?= $result_seSystime['MMYYY'] ?></h3>
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เพื่อตรวจสอบสภาพจิตใจ ว่าพร้อมทำงานหรือไม่
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : To Check driver Mental that can Receive job or Not on Today.
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : ใบตรวจสุขภาพด้วยตัวเอง / สอบถามพนักงานโดยตรง
                </td>
                <td style="width: 10%">
                    เวลาปรับข้อมูล
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Self check Sheet & Asking Driver himselt.
                </td>
                <td style="width: 10%">
                    Time Adjust data
                </td>
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    1. ไม่จ่ายงานให้พนักงาน / Don't Give Job to Driver.
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    2. คอยติดตามปัญหาของพนักงานขับรถคนนั้น / Follow Problem of Each Driver.
                </td>
