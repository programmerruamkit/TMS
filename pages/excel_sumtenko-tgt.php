  ...
  <body>
        ...
        <thead>
          <th>
            <tr style="width: 100%;">
              ...
              <td   colspan="11" style="padding:4px;width: 30%;text-align:left"><b>ชื่อผู้รับผิดชอบSummary ข้อมูล <?=$result_seEmployee['nameT']?></b></td>
    ...
    <table id="bg-table"  style="width: 100%;border-collapse: collapse;font-size:9;margin-top:8px;">
      ...
      $i = 1;
          ...
          $sql_seSumTenko = "SELECT FORMAT (CONVERT(DATE,b.CREATEDATE,103),'dd-MM-yyyy') AS 'DATE',FORMAT (CONVERT(DATE,GETDATE(),103),'dd-MM-yyyy') AS 'SYSDATE'
                            ...
                            ,b.TENKOPRESSUREDATA_60110 AS 'HEARTRATE',CONVERT(VARCHAR(10),c.DATEDEALERIN,108) AS 'DEALERTIME',c.VEHICLETRANSPORTPLANID,a.TENKOMASTERID,c.JOBNO
    ...
    while($result_seSumTenko = sqlsrv_fetch_array($query_seSumTenko, SQLSRV_FETCH_ASSOC)){
        ...
        <tr   style="border:1px solid #000;padding:4px;">
          ...
          <td  colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;"><?=$result_seSumTenko['DEALERTIME']?></td>
