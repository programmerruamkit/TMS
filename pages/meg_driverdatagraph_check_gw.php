                                        ...
                                        <script type="text/javascript">
                                                            ...
                                                            function drawChart() {
                                                                ...
                                                                var data = google.visualization.arrayToDataTable([
                                                                    ['Day', 'SYS (ความดันบน)', 'DIA (ความดันล่าง)','MaxStd.บน(160)','MinStd.บน(90)','MaxStd.ล่าง(100)','MinStd.ล่าง(60)'],
                                                                    ['<?= $result_seAdddateweek['D1'] ?>', <?=$SYSDAY1?>, <?=$DIADAY1?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D2'] ?>', <?=$SYSDAY2?>, <?=$DIADAY2?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D3'] ?>', <?=$SYSDAY3?>, <?=$DIADAY3?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D4'] ?>', <?=$SYSDAY4?>, <?=$DIADAY4?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D5'] ?>', <?=$SYSDAY5?>, <?=$DIADAY5?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D6'] ?>', <?=$SYSDAY6?>, <?=$DIADAY6?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D7'] ?>', <?=$SYSDAY7?>, <?=$DIADAY7?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D8'] ?>', <?=$SYSDAY8?>, <?=$DIADAY8?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D9'] ?>', <?=$SYSDAY9?>, <?=$DIADAY9?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D10'] ?>', <?=$SYSDAY10?>, <?=$DIADAY10?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D11'] ?>', <?=$SYSDAY11?>, <?=$DIADAY11?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D12'] ?>', <?=$SYSDAY12?>, <?=$DIADAY12?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D13'] ?>', <?=$SYSDAY13?>, <?=$DIADAY13?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D14'] ?>', <?=$SYSDAY14?>, <?=$DIADAY14?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D15'] ?>', <?=$SYSDAY15?>, <?=$DIADAY15?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D16'] ?>', <?=$SYSDAY16?>, <?=$DIADAY16?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D17'] ?>', <?=$SYSDAY17?>, <?=$DIADAY17?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D18'] ?>', <?=$SYSDAY18?>, <?=$DIADAY18?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D19'] ?>', <?=$SYSDAY19?>, <?=$DIADAY19?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D20'] ?>', <?=$SYSDAY20?>, <?=$DIADAY20?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D21'] ?>', <?=$SYSDAY21?>, <?=$DIADAY21?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D22'] ?>', <?=$SYSDAY22?>, <?=$DIADAY22?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D23'] ?>', <?=$SYSDAY23?>, <?=$DIADAY23?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D24'] ?>', <?=$SYSDAY24?>, <?=$DIADAY24?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D25'] ?>', <?=$SYSDAY25?>, <?=$DIADAY25?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D26'] ?>', <?=$SYSDAY26?>, <?=$DIADAY26?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D27'] ?>', <?=$SYSDAY27?>, <?=$DIADAY27?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D28'] ?>', <?=$SYSDAY28?>, <?=$DIADAY28?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D29'] ?>', <?=$SYSDAY29?>, <?=$DIADAY29?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D30'] ?>', <?=$SYSDAY30?>, <?=$DIADAY30?>,160,90,100,60 ],
                                                                    ['<?= $result_seAdddateweek['D31'] ?>', <?=$SYSDAY31?>, <?=$DIADAY31?>,160,90,100,60 ]
                                                                ]);
