...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLCOPPERCORD_Billing.xls";
} else {
  $strExcelFileName = "RKLCOPPERCORD_Billing" . $_GET['invoicecode'] . ".xls";
}
...
$condBilling2 = " AND c.COMPANYCODE ='RKL' AND c.CUSTOMERCODE ='COPPERCORD'";

// $sql_seBillings = "{call megVehicletransportdocumentdriver_v2(?,?,?)}";
// $params_seBillings = array(
//     array('select_pdfvehicletransportdocumentdrivertgt', SQLSRV_PARAM_IN),
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
            <td colspan="11" style="font-size:20px">บริษัท ร่วมกิจรุ่งเรือง โลจิสติคส์ จำกัด (RUAMKIT RUNGRUENG LOGISTICS CO., LTD.)</td>
       </tr>
       <tr>
            <td colspan="11" style="font-size:20px">สำนักงานใหญ่ เลขที่ 51 หมู่ 4 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160 </td>
       </tr>
       <tr>
            <td colspan="11" style="font-size:20px">โทรศัพท์ : (038)452824-5 โทรสาร : (038)210396</td>
       </tr>
       <tr>
            <td colspan="11" style="font-size:20px">เลขประจำตัวผู้เสียภาษี  0105552003135</td>
       </tr>
       <tr>
            <td colspan="11">&nbsp;</td>
       </tr>
      ...
      <tr>
            <td colspan="5" style="font-size:20px">ลูกค้า  บริษัท คอปเปอร์ คอร์ด อินดัสทรี้ จำกัด (สำนักงานใหญ่)</td>
            <td colspan="6" style="text-align:right;font-size:20px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
       </tr>
       <tr>
            <td colspan="5" style="font-size:20px">ที่อยู่  เลขที่ 700/654  ม.3 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160</td>
            <td colspan="6" style="text-align:right;font-size:20px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
       </tr>
       <tr>
            <td colspan="5" style="font-size:20px">เลขประจำตัวผู้เสียภาษี 0115556023548</td>
            <td colspan="6" style="text-align:right;font-size:20px"></td>
       </tr>
    </tbody>
</table>
...
<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">ลำดับที่</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">วันที่</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">หมายเลข DO</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">ประเภทรถ</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">ทะเบียนรถ</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">พนักงาน</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">จาก</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">ถึง</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">QT.</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">ราคา</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><b><font style="font-size: 24px">จำนวนเงิน(บาท)</font></b></td>
      </tr>
    </thead><tbody>
<?php
$i = 1;
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKL' AND CUSTOMERCODE = 'COPPERCORD'";
   ...
   ?>
      ...
      <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?= $result_seBilling['VEHICLETYPE'] ?></font></td>
...
?>
     ...
     <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">รวมสุทธิ</font></td>
        <td colspan="9" style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?=  convert($sumtotal1+$sumtotal2+$sumtotalholiday) ?></font></td>
