...
$mpdf = new mPDF('', 'Letter', '', '', 6, 20, 75, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
        <tr>
            <td colspan="2" style="font-size:24px">บริษัท ร่วมกิจรุ่งเรือง (1993) จำกัด (RUAMKIT RUNGRUENG (1993) CO., LTD.)</td>
        </tr>
        <tr>
            <td colspan="2" style="font-size:24px">สำนักงานใหญ่ เลขที่ 51 หมู่ 4 ตำบลบ้านเก่า อำเภอพานทอง จังหวัดชลบุรี 20160 </td>
        </tr>
        <tr>
            <td colspan="2" style="font-size:24px">โทรศัพท์ : 038-452824-5 โทรสาร : 038-210396</td>
        </tr>
        <tr>
       ...
       <tr>
            <td style="width: 75%;font-size:24px">ลูกค้า บริษัท โชนัน ยูนิเทค (ประเทศไทย) จำกัด</td>
            <td style="width: 25%;text-align:right;font-size:24px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:24px">สาขาที่ 00001 ที่อยู่ 242 นิคมอุตสาหกรรมเกตเวย์ซิตี้ หมู่7 ต.หัวสำโรง อ.แปลงยาว จ.ฉะเชิงเทรา 24190</td>
            <td style="width: 25%;text-align:right;font-size:24px">วันที่ ' . $result_seInvoicecode['DULYDATE'] . '</td>
        </tr>
        <tr>
            <td style="width: 100%;font-size:24px">เลขประจำตัวผู้เสียภาษี 0115544005922</td>
