...
<html lang="en">
            ...
            <div id="page-wrapper" >
                ...
                <div class="row">
                    <div class="col-md-12" style="background-color: #e7e7e7">
                        <h1>GPS MONITORING &nbsp; Day : <?=date("d/m/Y")?></h1>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-4" style="text-align: center">
                                            <div class="form-group">
                                                ...
                                                <select   id="txt_problem" name="txt_problem" class="selectpicker form-control" data-container="body" data-live-search="true" title="-Don't Select-" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                                    ...
                                                    $sql_seProblem = "SELECT ITEMS FROM [dbo].[GPSMONITORINGMASTER] ORDER BY REMARK ASC";
                                    ...
                                    <div class="col-lg-12" style="text-align: center;">
                                        <br><br>
                                        <input style="width:200px;height:60px;color:#ffffff;font-size: 20px;" type="button" onclick="save_gpsmonitoring();" name="btnSend" id="btnSend" value="บันทึกข้อมูล" class="btn btn-success">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">รายละเอียดข้อมูล GPS Monitoring <font color="red">(ข้อมูลที่แสดงบนตารางคือข้อมูลวันที่ปัจจุบันเท่านั้น)</font></div>
                                        ...
                                        <div class="col-lg-12" >
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control dateen" readonly="" onchange="datetodate();" style="background-color: #f080802e"  id="txt_datestart_monitoring" name="txt_datestart_monitoring" value="<?= $result_getDate['SYSDATE']; ?>" placeholder="วันที่เริ่มต้น">
                                                </div>
                                            ...
                                            <div class="col-lg-2">
                                                <label>&nbsp;</label>
                                                <div class="form-group">
                                                    <input type="text" class="form-control dateen"  readonly=""  style="background-color: #f080802e" id="txt_dateend_monitoring" name="txt_dateend_monitoring" placeholder="วันที่สิ้นสุด" value="<?= $result_getDate['SYSDATE']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-1">
                                                <label>&nbsp;</label>
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-default" onclick="select_gpsmonitoringskp();">ค้นหา <li class="fa fa-search"></li></button>
                                                </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                                            ...
                                                            $i = 1;
                                                            $sql_seData = "SELECT TRAILERNUMBER,PROBLEM,DRIVERNAME,DATETIMEMONITOR,LOCATIONMONITOR,ROOTCAUSE,RESULT,
                                                                        GPSCHECK_START,GPSCHECK_MIDDLE,GPSCHECK_FINISH,PLANID1,DRIVERNAME11,DRIVERNAME12,PLANID2,DRIVERNAME21,DRIVERNAME22
                                                                        FROM [dbo].[GPSMONITORING]
                                                            ...
                                                            while ($result_seData = sqlsrv_fetch_array($query_seData, SQLSRV_FETCH_ASSOC)) {
                                                                ...
                                                                $DATETIMEMONITORING_CHK = str_replace("T"," ",$result_seData['DATETIMEMONITOR']);
                                                                $DATETIMEMONITORING     = str_replace("-","/",$DATETIMEMONITORING_CHK);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center"><?=$DATETIMEMONITORING ?></td>
                                                                    <td style="text-align: center"><?=$result_seData['LOCATIONMONITOR']?></td>
    ...
    <script>
                                        ...
                                        function datetodate()
                                        {
                                            document.getElementById('txt_dateend_monitoring').value = document.getElementById('txt_datestart_monitoring').value;
                                        ...
                                        function save_gpsmonitoring(){
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (rs) {
                                                    ...
                                                    swal.fire({
                                                        title: "Good Job !!!",
                                                        text: "เพิ่มข้อมูล GPS Monitoring เรียบร้อย !!!",
                                                        icon: "success",
                                        ...
                                        function select_gpsmonitoringskp() {

                                        var datestart   = document.getElementById('txt_datestart_monitoring').value;
                                        var dateend     = document.getElementById('txt_dateend_monitoring').value;
                                        ...
                                        if (datestart == '') {
                                            ...
                                            $.ajax({
                                                ...
                                                url: 'meg_data_gpsmonitoring.php',
                                                data: {
                                                    txt_flg: "select_gpsmonitoringskp", datestart: datestart, dateend: dateend,thainame: thainame
                                                },
