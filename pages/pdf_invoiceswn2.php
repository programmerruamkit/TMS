...
$table_header2 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td colspan="2" style="width: 50%;">ลูกค้า ส-001</td>
       </tr>
       <tr>
            <td style="width: 50%;">บริษัท  สยามวัฒนา เวสต์ แมนเน็จเม้นท์  จำกัด</td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . '</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">22/1 หมู่ 6</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">ต.หนองบอนแดง อ.บ้านบึง จ.ชลบุรี</td>
       </tr>
        <tr>
