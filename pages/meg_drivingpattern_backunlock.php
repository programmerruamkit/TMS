            ...
            <div id="page-wrapper">
                ...
                <div id="datade_edit">
                    <div class="row" id="list-data">
                        ...
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="font-size: 20px;text-align: center;"><b>ปลดล็อครูปแบบการวิ่งงาน (วิ่งจริงขากลับ)</b></div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp1?>;" onclick="select_searchDrivingPattern('BackActual','1','<?=$CHK4HURP1?>','<?=$CHK2HURP1?>')">ปลดล็อค ช่วงที่1</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp2?>;" onclick="select_searchDrivingPattern('BackActual','2','<?=$CHK4HURP2?>','<?=$CHK2HURP2?>')">ปลดล็อค ช่วงที่2</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp3?>;" onclick="select_searchDrivingPattern('BackActual','3','<?=$CHK4HURP3?>','<?=$CHK2HURP3?>')">ปลดล็อค ช่วงที่3</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp4?>;" onclick="select_searchDrivingPattern('BackActual','4','<?=$CHK4HURP4?>','<?=$CHK2HURP4?>')">ปลดล็อค ช่วงที่4</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp5?>;" onclick="select_searchDrivingPattern('BackActual','5','<?=$CHK4HURP5?>','<?=$CHK2HURP5?>')">ปลดล็อค ช่วงที่5</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp6?>;" onclick="select_searchDrivingPattern('BackActual','6','<?=$CHK4HURP6?>','<?=$CHK2HURP6?>')">ปลดล็อค ช่วงที่6</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <!-- <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                        ...
                        if (chkstatus4hur == 'YES' || chkstatus2hur == 'YES') {
                            ...
                            if (checksection == '1') {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        txt_flg: "unlockP1", drivingbackplanid: drivingbackplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_officer.php',
                                    data: {
                                        txt_flg: "unlockP2", drivingbackplanid: drivingbackplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_officer.php',
                                    data: {
                                        txt_flg: "unlockP3", drivingbackplanid: drivingbackplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_officer.php',
                                    data: {
                                        txt_flg: "unlockP4", drivingbackplanid: drivingbackplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_officer.php',
                                    data: {
                                        txt_flg: "unlockP5", drivingbackplanid: drivingbackplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_officer.php',
                                    data: {
                                        txt_flg: "unlockP6", drivingbackplanid: drivingbackplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
