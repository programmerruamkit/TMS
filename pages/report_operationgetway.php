...
// echo $result_seLogin['PersonCode'];
// echo "<br>";
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        $sql_sePremissions3 = "{call megRoleaccount_v2(?,?)}";
                        $params_sePremissions3 = array(
                            array('select_permissions', SQLSRV_PARAM_IN),
                            array($condition1, SQLSRV_PARAM_IN)
                        );
                        $query_sePremissions3 = sqlsrv_query($conn, $sql_sePremissions3, $params_sePremissions3);
        ...
        <div class="row">
                                                            ...
                                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                                ...
                                                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example1" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        // $condOps3 = " AND ( CONVERT(DATE,a.DATEVLIN) = CONVERT(DATE,GETDATE()) OR CONVERT(DATE,a.DATEPRESENT) = CONVERT(DATE,GETDATE())) ";
                                                                        ...
                                                                        while ($result_seOps = sqlsrv_fetch_array($query_seOps, SQLSRV_FETCH_ASSOC)) {
                                                                            ...
                                                                            <tr 
                                                                                ...
                                                                                <td ><?= str_replace("(4L)","",$result_seOps['THAINAME']); ?></td>
            ...
            <script type="text/javascript"> 
                                                                                                function select_tenkotransport()
                                                                                                {
                                                                                                        // alert("Tenko2");
                                                                                                        $.ajax({
                                                                                                            url: 'meg_data_reportoperationgateway.php',
                                                                                                            type: 'POST',
                                                                                                            data: {
                                                                                                ...
                                                                                                function select_operationamata()
                                                                                                {
                                                                                                    ...
                                                                                                    $.ajax({
                                                                                                        ...
                                                                                                        success: function (rs) {
                                                                                                            ...
                                                                                                            save_logprocess('Tenko', 'Select Company', '<?= $_SESSION["USERNAME"] ?>');
