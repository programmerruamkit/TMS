                    ...
                    <a href='meg_selfcheck.php'>หน้าแรก</a> / บันทึกใบแจ้งสุขภาพ
                        ...
                        <div class="panel-body col-lg-12"   style="background-color: #e7e7e7;border-color:#ddd;color: #333;" >
                            ...
                            <div class="col-lg-12" style="background-color: #e7e7e7">
                                <p style="font-size: 26px;text-align: center;"><b><u>วิ่งจริงขาไป <?=$sectionchk?></u></b></p>
                            </div>
                                                    ...
                                                    <div class = "row">
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <label ><u>เวลายืนยันข้อมูล</u></label><br>
                                                                    <input  class="form-control" type="text"  style="height:40px;width:240px" id="txt_dateconfirm_p4" name="txt_dateconfirm_p4" value="<?= substr($result_seData['CONFIRMEDDATE_P4'],0,16) ?>" min="" max=""  autocomplete="off">
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
        ...
        function save_actualload_new(checkClient) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    condition3:sumtimeactualdealer1,
                    condition4:parkingtimeactualdealer1,
                    condition5:departuretimeactualdealer1,
                    ...
                    condition10:dealer3actual,
                    condition11:sumtimeactualdealer3,
                    condition12:parkingtimeactualdealer3,
                    condition13:departuretimeactualdealer3,

                    condition14:dealer4actual,
                    condition15:sumtimeactualdealer4,
                    condition16:parkingtimeactualdealer4,
                    condition17:departuretimeactualdealer4,
