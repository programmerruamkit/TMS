...
$i = 1;
   ...
   // $query_seComp = sqlsrv_query($conn, $sql_seComp, $params_seComp);
      ...
      // }
      if ($result_seComp['C2'] != '' || $result_seComp['C2'] > '0') {
         $OILAVG = '3.75';
      } else  {
...
<?php
         ...
         $resmoney = number_format(($result_seComp['C3PLUS'] / $result_seComp['COUNTEMP']) - (($result_seComp['C3MINUS'] / $result_seComp['COUNTEMP']) * -1));
