...
$condTenko0 = " AND VEHICLETRANSPORTPLANID = '".$_GET['vehicletransportplanid']."' AND CONVERT(DATE,CREATEDATE) = CONVERT(DATE,GETDATE())";
...
$condTenko1 = " AND a.TENKOMASTERDIRVERCODE = '".$result_seTenko0['TENKOMASTERDIRVERCODE1']."' AND CONVERT(DATE,CREATEDATE) = CONVERT(DATE,GETDATE())";
