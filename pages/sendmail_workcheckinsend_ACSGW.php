...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_ACSGW.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("Wittawat_it@ruamkit.co.th");//chaimongkol@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณชัยมงคล สมบูรณ์

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Administration แผนก : CorporateStrategy
