...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRTTPRO_Billing.xls";
} else {
  $strExcelFileName = "RKRTTPRO_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td style="width: 50%;">บริษัท ทีที โปรสตีล (ไทยแลนด์) จำกัด </td>
          <td style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td style="width: 50%;">สำนักงานใหญ่ 607 ถ.อโศก-ดินแดง แขวงดินแดง เขตดินแดง กรุงเทพฯ 10400 </td>
          <td style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td style="width: 50%;">โทร. 02-6251441</td>
