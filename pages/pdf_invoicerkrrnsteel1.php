...
$table_header3 = '<table style="width: 110%;">
    ...
    <tbody><br><br><br>
       ...
       <tr>
            <td colspan="45" style="text-align:left;font-size:22px">ลูกค้า บริษัท อาร์ แอนด์ เอ็น สตีล จำกัด</td>
            <td colspan="20" style="text-align:right;font-size:22px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td colspan="45" style="text-align:left;font-size:22px">สำนักงานใหญ่ ที่อยู่ 2341/1 ม.6 ถ.เทพารักษ์ ต.เทพารักษ์  อ.เมืองสมุทรปราการ  จ.สมุทรปราการ 10270</td>
            <td colspan="20" style="text-align:right;font-size:22px">วันที่ ' . $result_seduedate['DUEDATE'] . '</td>
       </tr>
       <tr>
            <td colspan="45" style="font-size:22px">เลขประจำตัวผู้เสียภาษี 0115541004666</td>
       </tr>
    </tbody>
</table>';
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    $holidaysplit = explode(",", $holiday);
      ...
      if (($result_seBilling['DATEVLIN_103'] == $holidaysplit[0]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[1]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[2]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[3]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[4])) {
        ...
        <td style="border-right:1px solid #000;padding:17px;text-align:center;width: 30%;font-size:48px">' . $result_seBilling['PURCHASEORDER'] . '</td>
...
$tfoot3 = '</tbody><tfoot>
     <tr style="border:1px solid #000;">
        ...
        <td  colspan="8" style="border-right:1px solid #000;padding:11px;text-align:center;font-size:46px"><b>' . convert($sumtotal1+$sumtotal2+$sumtotalholiday) . '</td>
