...
$mpdf = new mPDF('', 'Letter', '', '', 6, 20, 65, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      <tr>
            <td colspan="2" style="font-size:24px">บริษัท ร่วมกิจรุ่งเรือง โลจิสติคส์ จำกัด (RUAMKIT RUNGRUENG LOGISTICS CO., LTD.)</td>
       </tr>
       <tr>
            <td colspan="2" style="font-size:24px">สำนักงานใหญ่ เลขที่ 51  ม.4  ต.บ้านเก่า  อ.พานทอง  จ.ชลบุรี 20160 โทรศัพท์: (038) 452824-5 โทรสาร: (038) 210396</td>
       </tr>
       <tr>
            <td colspan="2" style="font-size:24px">เลขประจำตัวผู้เสียภาษี  0105552003135</td>
       </tr>
       <tr>
            <td colspan="2">&nbsp;</td>
       </tr>
       ...
       <tr>
            <td style="width: 75%;font-size:24px">ลูกค้า บริษัท โอกาโมโต ลอจิสติกส์ (ประเทศไทย) จำกัด</td>
            <td style="width: 25%;text-align:right;font-size:24px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:24px">สำนักงานใหญ่ ที่อยู่ 700/655,657 หมู่ที่ 1 ถนนบางนา-ตราด ตำบลพานทอง อำเภอพานทอง จังหวัดชลบุรี 20160</td>
            <td style="width: 25%;text-align:right;font-size:24px">วันที่ ' . $result_seInvoicecode['DULYDATE'] . '</td>
        </tr>
        <tr>
            <td style="width: 100%;font-size:24px">เลขประจำตัวผู้เสียภาษี 0115539008846</td>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    if (($result_seBilling['DATE_VLIN'] == $holidaysplit[0]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[1]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[2]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[3]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[4])) {
      ...
      <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $_GET['invoicecode'] . '</font></td>
        ...
        <tr style="border:1px solid #000;">
          ...
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['DATE_VLIN'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">Holiday</td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['THAINAME'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seEmployeeehr['FnameT'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . ($result_seBilling['JOBSTART'] == 'SWN (Ban Bueng) (Return)' ? 'SWN (Ban Bueng)' :$result_seBilling['JOBSTART']). '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['JOBEND'] . '</font></td>
    ...
    $tbody3 .= '
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><font style="font-size: 24px">' . $_GET['invoicecode'] . '</font></td>
