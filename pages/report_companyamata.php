                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customeramata.php?type=customer&meg=report&companycode=RKL">เลือกลูกค้า</a>
                                                            </li>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customeramata.php?type=customer&meg=report&companycode=RKS">เลือกลูกค้า</a>
                                                            </li>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customeramata.php?type=customer&meg=report&companycode=RKR">เลือกลูกค้า</a>
                                                            </li>
