...
/////////////////////////////////ZONE////////////////////////////////////////////////////////////
    if ($result_seBilling1['LOCATION'] == 'พระประแดง/สำโรง' || $result_seBilling1['LOCATION'] == 'สำโรง') {
      ...
      $zone = "Poochao";
    }else if($result_seBilling1['LOCATION'] == 'ปทุมธานี') {
      $zone = "Pathum Thani";
    }else if($result_seBilling1['LOCATION'] == 'อยุธยา') {
      $zone = "Ayutthaya";
    }else if($result_seBilling1['LOCATION'] == 'พนัสนิคม') {
      $zone = "Phanat Nikhom";
    }else if($result_seBilling1['LOCATION'] == 'แหลมฉบัง') {
      $zone = "Laemchabang";
    }else if($result_seBilling1['LOCATION'] == 'อีสเทิร์น ซีบอร์ด') {
      if ($result_seBilling1['JOBEND'] == 'SSSC3 : Easternseaboard' ) {
        $zone ="Rayong";
      }else {
        $zone = "Eastern Seaboard IE.";
      }
...
////////////////////////////////////////JOBEND///////////////////////////////////////////////
  if ($result_seBilling1['JOBEND'] == 'TMB') {
  ...
  }else if ($result_seBilling1['JOBEND'] == 'TTAST-PT') {
    $jobend = "TTAST-PT";
    ...
    $jobend = "OTC";
  }else if ($result_seBilling1['JOBEND'] == 'SAM : Lamchabang') {
    $jobend = "SAM";
    ...
    $jobend = "SARATHORN";
  }else if ($result_seBilling1['JOBEND'] == 'THAI NIPPON : Lamchabang') {
    $jobend = "THAI NIPPON";
    ...
    $jobend = "STE";
  }else if ($result_seBilling1['JOBEND'] == 'SMTL : Sriracha') {
    $jobend = "SMTL";
  ...
  <td style="border-right:1px solid #000;padding:5px;text-align:center;">CS Wellgrow</td>
  ...
  <td style="border-right:1px solid #000;padding:5px;text-align:right;">' . number_format($result_seBilling1['PRICETON'],3) . '</td>
