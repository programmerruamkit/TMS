...
$strExcelFileName = "Report".$result_getDate['GETDATE']."_TOPS.xls";
...
WHERE 
    RowNum = (SELECT COUNT(*) FROM STRING_SPLIT('" . $result_seWorkcheckin['MAPADDRESS'] . "',' '))-2";
       ...
       AND  b.AREA = 'amata' AND b.DEPARTMENTCODE = '03' AND b.[SECTIONCODE] = '02' AND b.DEPARTMENTCODE !='' AND b.[SECTIONCODE] !=''";
