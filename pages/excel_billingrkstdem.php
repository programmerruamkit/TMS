...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSTDEM_Billing.xls";
} else {
  $strExcelFileName = "RKSTDEM_Billing" . $_GET['invoicecode'] . ".xls";
}
...
if ($result_ChkJobend['JOBEND'] == 'TDEM/SR(RKS)') {
 ...
 <table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td colspan="10" style="font-size:20px">สำนักงานใหญ่ เลขที่ 51 ม.4 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160</td>
       </tr>
       <tr>
