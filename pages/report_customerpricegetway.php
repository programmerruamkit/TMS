                            ...
                            <div class="panel-heading" style="background-color: #e7e7e7">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <?php
                                        $meg = 'ลูกค้า';
                                        echo "<a href='report_companypricegetway.php?type=report'>บริษัท</a> / " . $meg;
                                        $link = "<a href='report_companypricegetway.php?type=report'>บริษัท</a> / <a href='report_customerpricegetway.php?type=report'>ลูกค้า</a>";
                                        $_SESSION["link"] = $link;
                                        ?>
                                    </div>
                                                        ...
                                                        <td style="text-align: center">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu slidedown">
                                                                    ...
                                                                    <li>
                                                                        <a href="meg_transportprice.php?type=transportprice&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&worktype=<?= $result_seCustomer['WORKTYPE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>">กำหนดราคาขนส่ง</a>
                                                                    </li>
