...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSCOPPERCORD_Billing.xls";
} else {
  $strExcelFileName = "RKSCOPPERCORD_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      ...
      <tr>
            ...
            <td style="width: 30%;text-align:right;font-size:20px">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">ที่อยู่ เลขที่ 700/654  ม.3 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160</td>
            <td style="width: 30%;text-align:right;font-size:20px">วันที่ <?= $result_seInvoice['DULYDATE'] ?></td>
       </tr>
       <tr>
...
<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 10%;"><b><font style="font-size: 24px">ลำดับที่</font></b></td>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 15%;"><b><font style="font-size: 24px">ประเภทรถ</font></b></td>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 6%;"><b><font style="font-size: 24px">QT.</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 12%;"><b><font style="font-size: 24px">ราคา</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 12%;"><b><font style="font-size: 24px">จำนวนเงิน(บาท)</font></b></td>
      </tr>
    </thead><tbody>
<?php
$i = 1;
