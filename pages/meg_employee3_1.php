...
<html lang="en">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade in active" id="monday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    ...
                                                    <?php
                                                    $conditiionMonday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    //$conditiionMonday2 = " DATENAME(DW,a.DATEPRESENT) = 'Sunday' AND (a.DATEPRESENT BETWEEN CONVERT(datetime,'" . $result_getDate['STARTWEEK'] . "',103) AND CONVERT(datetime,'" . $result_getDate['ENDWEEK'] . "',103))";
                                                    $conditiionMonday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionMonday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Monday' ";
                                                    ...
                                                    $params_seEmployeeMondaychk = array(
                                                        ...
                                                        array($conditiionMonday3, SQLSRV_PARAM_IN)
                                                    );
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)' >รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeMonday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeMonday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>' >แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#">เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>, 5)'>ปิดงาน</a>
                                                                                    </li>
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeMonday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                            ...
                                            <div class="tab-pane fade" id="tuesday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    <?php
                                                    $conditiionTuesday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    ...
                                                    $conditiionTuesday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionTuesday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Tuesday' ";
                                                    ...
                                                    $params_seEmployeeTuesdaychk = array(
                                                        ...
                                                        array($conditiionTuesday3, SQLSRV_PARAM_IN)
                                                    );
                                                                    ...
                                                                    if ($result_seEmployeeTuesday['STATUSNUMBER'] == '3') {
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeTuesday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeTuesday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeTuesday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeTuesday['VEHICLETRANSPORTPLANID'] ?>'>แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#" >เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeTuesday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeTuesday['VEHICLETRANSPORTPLANID'] ?>, 5)'>ปิดงาน</a>
                                                                                    </li>
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeTuesday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                            ...
                                            <div class="tab-pane fade" id="wednesday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    <?php
                                                    $conditiionWednesday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    ...
                                                    $conditiionWednesday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionWednesday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Wednesday' ";
                                                    ...
                                                    $params_seEmployeeWednesdaychk = array(
                                                        ...
                                                        array($conditiionWednesday3, SQLSRV_PARAM_IN)
                                                    );
                                                                    ...
                                                                    if ($result_seEmployeeWednesday['STATUSNUMBER'] == '3') {
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeWednesday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeWednesday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeWednesday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeWednesday['VEHICLETRANSPORTPLANID'] ?>' >แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#" >เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeWednesday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeWednesday['VEHICLETRANSPORTPLANID'] ?>, 5)'>ปิดงาน</a>
                                                                                    </li>
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeWednesday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                            ...
                                            <div class="tab-pane fade" id="thursday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    <?php
                                                    $conditiionThursday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    ...
                                                    $conditiionThursday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionThursday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Thursday' ";
                                                    ...
                                                    $params_seEmployeeThursdaychk = array(
                                                        ...
                                                        array($conditiionThursday3, SQLSRV_PARAM_IN)
                                                    );
                                                                    ...
                                                                    if ($result_seEmployeeThursday['STATUSNUMBER'] == '3') {
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeThursday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeThursday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeThursday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeThursday['VEHICLETRANSPORTPLANID'] ?>'>แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#" >เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeThursday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li >
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeThursday['VEHICLETRANSPORTPLANID'] ?>, 5)'>ปิดงาน</a>
                                                                                    </li>
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeThursday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                            ...
                                            <div class="tab-pane fade" id="friday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    <?php
                                                    $conditiionFriday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    ...
                                                    $conditiionFriday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionFriday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Friday' ";
                                                    ...
                                                    $params_seEmployeeFridaychk = array(
                                                        ...
                                                        array($conditiionFriday3, SQLSRV_PARAM_IN)
                                                    );
                                                                    ...
                                                                    if ($result_seEmployeeFriday['STATUSNUMBER'] == '3') {
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeFriday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeFriday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeFriday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeFriday['VEHICLETRANSPORTPLANID'] ?>' >แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#" >เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeFriday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeFriday['VEHICLETRANSPORTPLANID'] ?>, 3)'>ปิดงาน</a>
                                                                                    </li>
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeFriday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' class='list-group-item' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeFriday['VEHICLETRANSPORTPLANID'] ?>, 3)'>ปิดงาน</a>
                                                                                    </li>
                                            ...
                                            <div class="tab-pane fade" id="saturday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    <?php
                                                    $conditiionSaturday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    ...
                                                    $conditiionSaturday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionSaturday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Saturday' ";
                                                    ...
                                                    $params_seEmployeeSaturdaychk = array(
                                                        ...
                                                        array($conditiionSaturday3, SQLSRV_PARAM_IN)
                                                    );
                                                                    ...
                                                                    if ($result_seEmployeeSaturday['STATUSNUMBER'] == '3') {
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeSaturday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeSaturday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeSaturday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeSaturday['VEHICLETRANSPORTPLANID'] ?>' >แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#" >เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeSaturday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' class='list-group-item' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeSaturday['VEHICLETRANSPORTPLANID'] ?>, 5)'>ปิดงาน</a>
                                                                                    </li>
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeSaturday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                ...
                <!--<a href='#' class='list-group-item' onclick='edit_vehicletransportplanactualpresent(<?//= $result_seEmployeeMonday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a><br>-->
                                            ...
                                            <div class="tab-pane fade" id="sunday-pills">
                                                ...
                                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                    <?php
                                                    $conditiionSunday1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                    ...
                                                    $conditiionSunday2 = " AND (CONVERT(DATE,a.DATEPRESENT) BETWEEN CONVERT(date,GETDATE()) AND CONVERT(date,GETDATE()))";
                                                    $conditiionSunday3 = " AND DATENAME(DW,a.DATEPRESENT) = 'Sunday' ";
                                                    ...
                                                    $params_seEmployeeSundaychk = array(
                                                        ...
                                                        array($conditiionSunday3, SQLSRV_PARAM_IN)
                                                    );
                                                                    ...
                                                                    if ($result_seEmployeeSunday['STATUSNUMBER'] == '3') {
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <ul class="dropdown-menu slidedown">
                                                                                    <li>
                                                                                        <a href='#' onclick='save_tenkomaster(<?= $result_seEmployeeSunday['VEHICLETRANSPORTPLANID'] ?>)'>รายงานตัวตรวจร่างกาย</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $result_seEmployeeSunday['COMPANYCODE'] ?>&customercode=<?= $result_seEmployeeSunday['CUSTOMERCODE'] ?>&vehicletransportplanid=<?= $result_seEmployeeSunday['VEHICLETRANSPORTPLANID'] ?>' >แก้ไขงาน</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li class="disabled">
                                                                                        <a href="#" >เปิดงาน</a>
                                                                                    ...
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeSunday['VEHICLETRANSPORTPLANID'] ?>, 4)'>รายงานตัวกลับ</a>
                                                                                    </li>
                                                                                    <li class="divider"></li>
                                                                                    <li>
                                                                                        <a href='#' class='list-group-item' onclick='update_vehicletransportplanjob(<?= $result_seEmployeeSunday['VEHICLETRANSPORTPLANID'] ?>, 5)'>ปิดงาน</a>
                                                                                    </li>
                                                                        ...
                                                                        <?php
                                                                    } else if ($result_seEmployeeSunday['STATUSNUMBER'] == '5') {
                                                                        ?> 
                                                                        <td style="text-align: center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
    ...
    <script>
                                                                    ...
                                                                    function btn_submitall()
                                                                    {
                                                                        ...
                                                                        var condition1 = " AND a.STATUSNUMBER IN ('0','1','2','3','4','5')";
                                                                        var condition2 = "";
                                                                        if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        {
                                                                            condition2 = " AND ( CONVERT(DATE,DATEPRESENT) BETWEEN CONVERT(DATE,GETDATE()) AND CONVERT(DATE,GETDATE()))";
                                                                        } else
                                                                        {
                                                                            condition2 = "";
                                                                    ...
                                                                    {
                                                                        var condition1 = "";
                                                                        var condition2 = " AND a.STATUSNUMBER = '0'";
                                                                        //if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        //{
                                                                    ...
                                                                    {
                                                                        var condition1 = "";
                                                                        var condition2 = " AND a.STATUSNUMBER = '1'";
                                                                        //if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        //{
                                                                        //    condition1 = " AND a.STATUSNUMBER = '1' AND ( CONVERT(DATE,DATEPRESENT) BETWEEN CONVERT(DATE,'" + document.getElementById("txt_datestartsr1").value + "',103) AND CONVERT(DATE,'" + document.getElementById("txt_dateendsr1").value + "',103))";
                                                                        //} else
                                                                    ...
                                                                    {
                                                                        var condition1 = "";
                                                                        var condition2 = " AND a.STATUSNUMBER = '2'";
                                                                        //if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        //{
                                                                        //    condition1 = " AND a.STATUSNUMBER = '1' AND ( CONVERT(DATE,DATEPRESENT) BETWEEN CONVERT(DATE,'" + document.getElementById("txt_datestartsr1").value + "',103) AND CONVERT(DATE,'" + document.getElementById("txt_dateendsr1").value + "',103))";
                                                                        //} else
                                                                    ...
                                                                    {
                                                                        var condition1 = "";
                                                                        var condition2 = " AND a.STATUSNUMBER = '3'";
                                                                        //if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        //{
                                                                        //    condition1 = " AND a.STATUSNUMBER = '1' AND ( CONVERT(DATE,DATEPRESENT) BETWEEN CONVERT(DATE,'" + document.getElementById("txt_datestartsr1").value + "',103) AND CONVERT(DATE,'" + document.getElementById("txt_dateendsr1").value + "',103))";
                                                                        //} else
                                                                    ...
                                                                    {
                                                                        var condition1 = "";
                                                                        var condition2 = " AND a.STATUSNUMBER = '4'";
                                                                        //if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        //{
                                                                        //    condition1 = " AND a.STATUSNUMBER = '1' AND ( CONVERT(DATE,DATEPRESENT) BETWEEN CONVERT(DATE,'" + document.getElementById("txt_datestartsr1").value + "',103) AND CONVERT(DATE,'" + document.getElementById("txt_dateendsr1").value + "',103))";
                                                                        //} else
                                                                    ...
                                                                    {
                                                                        var condition1 = "";
                                                                        var condition2 = " AND a.STATUSNUMBER = '5'";
                                                                        //if (document.getElementById("txt_datestartsr1").value != "" && document.getElementById("txt_dateendsr1").value != "")
                                                                        //{
                                                                        //    condition1 = " AND a.STATUSNUMBER = '1' AND ( CONVERT(DATE,DATEPRESENT) BETWEEN CONVERT(DATE,'" + document.getElementById("txt_datestartsr1").value + "',103) AND CONVERT(DATE,'" + document.getElementById("txt_dateendsr1").value + "',103))";
                                                                        //} else
