              ...
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    // $sql_seEmp = "SELECT a.PersonID AS 'EMPID',a.PersonCode AS 'EMPLOYEECODE',a.FnameT,a.LnameT,
                    // (a.FnameT+' '+a.LnameT) AS 'EMPLOYEENAME',c.PositionNameT,a.EndDate,a.CurrentTel
                    ...
                    // AND c.PositionNameT ='พนักงานขับรถ/STM-SR'
                    ...
                    // ";
                    $sql_seEmp = " SELECT a.PersonID AS 'EMPID',a.PersonCode AS 'EMPLOYEECODE',a.FnameT,a.LnameT,
                    (a.FnameT+' '+a.LnameT) AS 'EMPLOYEENAME',a.PositionNameT,a.EndDate,a.CurrentTel  
                   FROM EMPLOYEEEHR2 a WHERE 1=1
                   AND PositionNameT ='พนักงานขับรถ/STM-SR'
                   ORDER BY a.PersonCode ASC";
                    $params_seEmp = array();
                        ...
                        <td style="text-align: center">
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu slidedown">
                              <li>
                                <a target="_bank" href="pdf_basicinfotdem.php?employeecode=<?=$result_seEmp['EMPLOYEECODE']?>">
                                  ประวัติพนักงาน
                                </a>
                              </li>
