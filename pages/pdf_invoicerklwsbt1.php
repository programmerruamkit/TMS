...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td style="width: 50%;">ลูกค้า  บริษัท เวิลด์ ซีโบ-เทค จำกัด  (สำนักงานใหญ่)</td>
            <td style="width: 50%;text-align:right">เลขที่ ' . $result_seInvoice['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 50%;">ที่อยู่ 700/185 หมู่ที่ 1 นิคมอุตสาหกรรมอมตะนคร <br>ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160</td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . ' เครดิต 30 วัน</td>
       </tr>
       <tr>
            <td style="width: 50%;">เเลขประจำตัวผู้เสียภาษี  0115538001449	</td>
