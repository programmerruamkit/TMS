                ...
                <div class="row" style="background-color: #e7e7e7">
                    ...
                    <div class="col-md-4" style="background-color: #e7e7e7">
                        <table style="border:1px solid black;">
                            <thead style="border:1px solid black;">
                                <tr>
                                    <th colspan ="2"  width="550px" style="text-align: center;border:1px solid black;background-color: #bfbfbf">มาตรฐานค่าความดันร่วมกิจ (GW)</th>
                            ...
                            <tbody>
                                <tr>
                                    <!-- &#10004; -->
                                    <td width="100px" style="border:1px solid black;font-size: 28px;text-align: center;"><b><?= $result_seGW['MAXSYS'] ?></b></td>
                                    <td width="100px" style="border:1px solid black;font-size: 28px;text-align: center;"><b><?= $result_seGW['MAXDIA'] ?></b></td>
                                </tr>
                                <!-- <tr>
                                    <td colspan ="6" style="font-size: 16px;">&nbsp;<b></b></td>
                                </tr>   -->
                        ...
                        <div class="slideshow-container" style="">
                            <div class="mySlides slide">
                                <div class="numbertext">1 / 3</div>
                                    <img src="../images/Knowleage1.jpg" style="width:370px;height:210px" data-action="zoom" alt="Pic_Driver1" >
                                <div class="text"><a href="https://www.bangpakok3.com/care_blog/view/241" target="_blank">More Information</a></div>
                            </div>
                            <div class="mySlides slide">
                                <div class="numbertext">2 / 3</div>
                                    <img src="../images/Knowleage2.jpg" style="width:370px;height:210px" data-action="zoom" alt="Pic_Driver1" >
                                <div class="text"><a href="https://allwellhealthcare.com/normal-blood-pressure-range/" target="_blank">More Information</a></div>
                            </div>
                            <div class="mySlides slide">
                                <div class="numbertext">3 / 3</div>
                                    <img src="../images/Knowleage3.jpg" style="width:370px;height:210px" data-action="zoom" alt="Pic_Driver1" >
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label style="font-size:20px;color:red"><b>มาตรฐานการตรวจร่างกาย Ruamkit (GW)</b></label><br>
                                    <label style="font-size:14px">&nbsp;1.อุณหภูมิ ต่ำกว่า <font color="green"><?= $result_seGW['TEMP'] ?> °C (องศาเซลเซียส)</font></label><br>
                                    <label style="font-size:14px">&nbsp;2.ค่าความดันบน&nbsp;: <font color="green"><?= $result_seGW['MINSYS'] ?>-<?= $result_seGW['MAXSYS'] ?> (มิลลิเมตรปรอท)</font></label><br>
                                    <label style="font-size:14px">&nbsp;3.ค่าความดันล่าง&nbsp;: <font color="green"><?= $result_seGW['MINDIA'] ?>-<?= $result_seGW['MAXDIA'] ?> (มิลลิเมตรปรอท)</font></label><br>
                                    <label style="font-size:14px">&nbsp;4.อัตราการเต้นหัวใจ : <font color="green"><?= $result_seGW['MINPULSE'] ?>-<?= $result_seGW['MAXPULSE'] ?> ครั้ง</font></label><br>
                                    <label style="font-size:14px">&nbsp;5.ออกซิเจนในเลือดตั้งแต่ : <font color="green"><?= $result_seGW['OXYGEN'] ?>%</font></label><br>
                                    <label style="font-size:14px">&nbsp;6.แอลกอฮอล์ : <font color="green"><?= $result_seGW['ALCOHOL'] ?> mg% (มิลลิกรัมเปอร์เซนต์) เท่านั้น</font></label><br>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12" >
                            ...
                            <div class="col-lg-1">
                                <label>&nbsp;</label>
                                <div class="form-group">
                                    <button type="button" class="btn btn-default" onclick="select_smarthealthdashboard();">ค้นหา <li class="fa fa-search"></li></button>
                                </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                                            ...
                                                            // เงื่อนไขเดิม AND SUBSTRING(b.PersonCode, 1, 2) IN ('04','05','09','08','06','10')
                                                            ...
                                                            $sql_seData = "SELECT b.PositionNameE,b.PositionNameT,b.nameT,b.TaxID,b.PersonCode,a.LABOTRONDATAID,CARDNUMBER,DRIVER_WEIGHT,DRIVER_HEIGHT,DRIVER_BMI,
                                                                ...
                                                                ,'เจ้าหน้าที่ คปป./RCC 4 LOAD','เจ้าหน้าที่ คปป./RCC 8 LOAD','เจ้าหน้าที่ คปป./RATC 4 LOAD','เจ้าหน้าที่ คปป./RATC 8 LOAD','เจ้าหน้าที่ คปป./GMT'))
                                                                --AND b.PositionNameT IN ('ผู้ฝึกสอน','Dispatcher','Controller')
    ...
    <script>
                                        ...
                                        function select_smarthealthdashboard() {
                                            ...
                                            if (datestart == '') {
                                                ...
                                                $.ajax({
                                                    type: 'post',
                                                    url: 'meg_data_smarthealthdashboard.php',
                                                    data: {
                                                        txt_flg: "select_smarthealthdashboard_gw", datestart: datestart, dateend: dateend,drivercode: drivercode
                                                    },
