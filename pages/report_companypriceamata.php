                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #e7e7e7">
                                ...
                                <?php
                                echo "บริษัท";
                                $link = "<a href='report_companypriceamata.php?type=report'>บริษัท</a>";
                                $_SESSION["link"] = $link;
                                ?>
                            </div>
                            <!-- /.panel-heading -->
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customerpriceamata.php?type=customer&meg=report&companycode=RKL">เลือกลูกค้า</a>
                                                            </li>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customerpriceamata.php?type=customer&meg=report&companycode=RKS">เลือกลูกค้า</a>
                                                            </li>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customerpriceamata.php?type=customer&meg=report&companycode=RKR">เลือกลูกค้า</a>
                                                            </li>
