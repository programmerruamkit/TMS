...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;">
       	  <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า  :  รหัส ฮ-001
								<br>บริษัท ฮีโน่มอเตอร์ส แมนูแฟคเจอริ่ง (ประเทศไทย)  จำกัด)
								<br>(สาขาที่ 00003) ที่อยู่  700/509 หมู่ 2 นิคมอมตะนคร ต.บ้านเก่า 
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        ...
        <tr style="border:1px solid #000;" >
        <td style="border-right:1px solid #000;padding:4px;width:70%" rowspan="4">ลูกค้า : รหัส ฮ-001
								<br>บริษัท ฮีโน่มอเตอร์ส แมนูแฟคเจอริ่ง (ประเทศไทย)  จำกัด)
								<br>(สาขาที่ 00003) ที่อยู่  700/509 หมู่ 2 นิคมอมตะนคร ต.บ้านเก่า 
                                                                <br> อ.พานทอง จ.ชลบุรี 20160
								<br>เลขประจำตัวผู้เสียภาษี  0115546004940
