                            ...
                            <div class="panel-heading" style="background-color: #e7e7e7">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <?php
                                        $meg = 'ลูกค้า';
                                        echo "<a href='report_companyprice.php?type=report'>บริษัท</a> / " . $meg;
                                        $link = "<a href='report_companyprice.php?type=report'>บริษัท</a> / <a href='report_customerprice.php?type=report'>ลูกค้า</a>";
                                        $_SESSION["link"] = $link;
                                        ?>
                                    </div>
