...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLSUTT_Billing.xls";
} else {
  $strExcelFileName = "RKLSUTT_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">ลูกค้า บริษัท โอกาโมโต ลอจิสติกส์ (ประเทศไทย) จำกัด   </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">สำนักงานใหญ่ ที่อยู่ 700/655,657 หมู่ที่ 1 ถนนบางนา-ตราด ตำบลพานทอง อำเภอพานทอง จังหวัดชลบุรี 20160    </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี  0115539008846 </td>
