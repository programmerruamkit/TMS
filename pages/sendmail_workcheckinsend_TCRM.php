...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_TCRM.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("sakchai@ruamkit.co.th");//sakchai@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณศักดิ์ชัย ภักดีอำนาจ

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Transportation แผนก : Customer Relation Managemet
