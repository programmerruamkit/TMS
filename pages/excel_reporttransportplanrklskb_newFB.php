...
if ($_GET['datestart'] == "" || $_GET['dateend'] == "") {
    $strExcelFileName = "เอกสารแนบการวางบิล(ADC-Dealer(FB)).xls";
} else {
    $strExcelFileName = "เอกสารแนบการวางบิล(ADC-Dealer(FB))" . $_GET['datestart'] . ' ถึง ' . $_GET['dateend'] . ".xls";
}
...
<html>                                                                                                              
    ...
    <body>
        ...
        <table style="width: 100%;">
            ...
            <tbody>
                <tr>
                        <td colspan="12"    style="font-size:14px">FLAT BED TRAILER (ADC TO DEALER)</td>
                        <td colspan="5"     style="text-align:right;font-size:14px">No.2</td>
                </tr>
            </tbody>
        </table>
        ...
        <table border="1" id="bg-table" width="100%" style="border-collapse: collapse;margin-top:8px;">
            <thead>
                <tr>
                    ...
                    <th> <label style="width: 200px;text-align: center">ค่าประกอบ<br>หัวเกี่ยวนวดข้าว</label></th>
            ...
            <tbody>
                ...
                $sql_seBilling = "SELECT ROW_NUMBER() OVER (PARTITION BY b.VEHICLETRANSPORTPLANID ORDER BY c.[ZONE],b.VEHICLETRANSPORTPLANID ASC) AS 'RUNNUMBER', 
                    ...
                    AND b.VEHICLETYPE ='ADC-Dealer(FB)'
