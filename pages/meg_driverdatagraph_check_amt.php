...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if ($ChkMonth == '28') { //chk เดือนที่มี 28 วัน
                                            ...
                                            echo 'sdsdsdsds';
                                            echo $result_seDay3['TENKOPRESSUREDATA_90160'];
                                            // SYSDAY3
                                            if($result_seDay3['TENKOPRESSUREDATA_90160'] > '150'){
                                                if ($result_seDay3['TENKOPRESSUREDATA_90160_2'] > '150' ) {
                                                    if ($result_seDay3['TENKOPRESSUREDATA_90160_3'] > '150') {
                                        ...
                                        <script type="text/javascript">
                                                            ...
                                                            function drawChart() {
                                                                ...
                                                                var data = google.visualization.arrayToDataTable([
                                                                    ...
                                                                    ['<?= $result_seAdddateweek['D1'] ?>', <?=$SYSDAY1?>, <?=$DIADAY1?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?>  ],
                                                                    ['<?= $result_seAdddateweek['D2'] ?>', <?=$SYSDAY2?>, <?=$DIADAY2?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D3'] ?>', <?=$SYSDAY3?>, <?=$DIADAY3?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D4'] ?>', <?=$SYSDAY4?>, <?=$DIADAY4?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D5'] ?>', <?=$SYSDAY5?>, <?=$DIADAY5?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D6'] ?>', <?=$SYSDAY6?>, <?=$DIADAY6?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D7'] ?>', <?=$SYSDAY7?>, <?=$DIADAY7?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D8'] ?>', <?=$SYSDAY8?>, <?=$DIADAY8?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D9'] ?>', <?=$SYSDAY9?>, <?=$DIADAY9?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D10'] ?>', <?=$SYSDAY10?>, <?=$DIADAY10?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D11'] ?>', <?=$SYSDAY11?>, <?=$DIADAY11?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D12'] ?>', <?=$SYSDAY12?>, <?=$DIADAY12?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D13'] ?>', <?=$SYSDAY13?>, <?=$DIADAY13?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D14'] ?>', <?=$SYSDAY14?>, <?=$DIADAY14?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D15'] ?>', <?=$SYSDAY15?>, <?=$DIADAY15?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D16'] ?>', <?=$SYSDAY16?>, <?=$DIADAY16?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D17'] ?>', <?=$SYSDAY17?>, <?=$DIADAY17?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D18'] ?>', <?=$SYSDAY18?>, <?=$DIADAY18?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D19'] ?>', <?=$SYSDAY19?>, <?=$DIADAY19?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D20'] ?>', <?=$SYSDAY20?>, <?=$DIADAY20?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D21'] ?>', <?=$SYSDAY21?>, <?=$DIADAY21?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D22'] ?>', <?=$SYSDAY22?>, <?=$DIADAY22?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D23'] ?>', <?=$SYSDAY23?>, <?=$DIADAY23?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D24'] ?>', <?=$SYSDAY24?>, <?=$DIADAY24?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D25'] ?>', <?=$SYSDAY25?>, <?=$DIADAY25?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D26'] ?>', <?=$SYSDAY26?>, <?=$DIADAY26?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D27'] ?>', <?=$SYSDAY27?>, <?=$DIADAY27?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D28'] ?>', <?=$SYSDAY28?>, <?=$DIADAY28?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D29'] ?>', <?=$SYSDAY29?>, <?=$DIADAY29?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D30'] ?>', <?=$SYSDAY30?>, <?=$DIADAY30?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                    ['<?= $result_seAdddateweek['D31'] ?>', <?=$SYSDAY31?>, <?=$DIADAY31?>,140,100,90,60,<?=$SYSAVG?>,<?=$DIAAVG?> ]
                                                                ]);
            ...
            <input type="text" id="txt_month" name="txt_month" value="<?=$_GET['months']?>"> </input>
            <input type="text" id="txt_empcode" name="txt_empcode" value="<?=$_GET['employeecode']?>"> </input>                                              
