...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:75%;">ลูกค้า : รหัส พ-016
...
while ($result_seBillinginvoice2 = sqlsrv_fetch_array($query_seBillinginvoice2, SQLSRV_FETCH_ASSOC)) {
  ...
  AND COMPANYCODE='RKR' AND CUSTOMERCODE = 'PJW' AND JOBEND = 'RKRPJW'";
...
<tbody>
    <tr style="border:1px solid #000;" >
        <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส พ-016
          <br>บริษัท พีเจดับเบิ้ลยู ออโต้อีวี จำกัด (มหาชน)
          <br>สาขาที่ 00002 ที่อยู่ 150/62 หมู่ที่ 9 ต.หนองขาม 
          <br>อ.ศรีราชา จ.ชลบุรี 20230
          <br>โทร. 038-347-187 โทรสาร. 038-347-189
