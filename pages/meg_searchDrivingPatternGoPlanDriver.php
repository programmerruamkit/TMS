...
<html lang="en">
    ...
    <body>
        ...
        <div class="row" id="list-data">
            ...
            <div class="col-lg-12" style="font-size: 30px;text-align: center;">ลงข้อมูลแผนขาไป</div>
                    ...
                    <a href='meg_selfcheck.php'>หน้าแรก</a> / บันทึกใบแจ้งสุขภาพ
                        ...
                        <div class="panel-body col-lg-12"   style="background-color: #e7e7e7;border-color:#ddd;color: #333;" >
                            ...
                            <div class="col-lg-2" style="background-color: #e7e7e7">
                                ...
                                <select   id="txt_thainame" name="txt_thainame" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" value="" >
                                    <option hidden value="<?=$result_seChkDataPlan['THAINAME']?>" ><?=$result_seChkDataPlan['THAINAME']?></option>
                                    <?php
                            ...
                            <div class="col-lg-2" style="background-color: #e7e7e7">
                                ...
                                <input type="text" class="form-control" type="hidden" id="txt_planningroute" name="txt_planningroute" value="<?=$result_seChkDataPlan['JOBSTART']?>-><?=$result_seChkDataPlan['JOBEND']?>" disabled="">
                            </div>
                            <div class="col-lg-2" style="background-color: #e7e7e7">
                                <label style="font-size: 16px;">รูทงานวิ่งจริง:</label>&nbsp;&nbsp;<font style="color: red;font-size: 18px;"><b>*</b></font>
                                <input type="text" class="form-control" type="hidden" id="txt_actualroute" name="txt_actualroute" value="<?=$result_seData['ACTUAL_ROUTE']?>" >
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    ?>
                                        ...
                                        <input type="datetime-local"  style="height:35px; width:315px;" id="txt_drivingdate" name="txt_drivingdate" value="<?= $result_seData['DRIVINGPATTERN_DATE'] ?>" min="" max=""  autocomplete="off">
                                    <?php
                                    ...
                                    ?> 
                                        <label style="font-size: 16px;" ><u>วัน/เดือน/ปี</u></label>&nbsp;&nbsp;<font style="color: red;font-size: 18px;"><b>*</b></font><br>
                                        <input class="form-control dateen"   style=""  id="txt_drivingdate" name="txt_drivingdate"  value="<?= $DRIVINGPATTERNDATE ?>" min="" max="" autocomplete="off">
                                    <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="col-lg-4 panel-body" style="text-align: left;background-color: #e7e7e7;">
                                ...
                                <p> โตโยต้า นครพิงค์     <input style="height:30px; width:30px; vertical-align: middle;background-color: red" type="checkbox" id="chk_tnkp" <?= $tnkpchk ?> name="chk_tnkp" value="" >
                                    &nbsp;&nbsp;&nbsp;
                                    โตโยต้า อุบลราชธานี  <input style="height:30px; width:30px; vertical-align: middle;background-color: red" type="checkbox" id="chk_tubon" <?= $tubonchk ?> name="chk_tubon" value="" >
                                </p>
                                <p> โตโยต้า ไทยเย็น     <input style="height:30px; width:30px; vertical-align: middle;background-color: red" type="checkbox" id="chk_tthaiyen" <?= $tthaiyenchk ?> name="chk_tthaiyen" value="" >
                                    &nbsp;&nbsp;&nbsp;
                                    โตโยต้า กาญจนบุรี &nbsp;&nbsp;&nbsp; <input style="height:30px; width:30px; vertical-align: middle;background-color: red" type="checkbox" id="chk_tkan" <?= $tkanchk ?> name="chk_tkan" value="" >
                                </p>
                            ...
                            <div class="col-lg-4 panel-body" style="text-align: left;background-color: #e7e7e7;">
                                ...
                                <table style="border: 5px solid #dddddd;">
                                    ...
                                    <tr>
                                        ...
                                        <td>รหัสพนักงาน</td>
                                        <td  id ="txt_tlepidemp1"><?=$result_seChkDataPlan['EMPLOYEECODE1']?></td>
                                    </tr>
                                    <tr>
                                        <td>ชื่อ-นามสกุล</td>
                                        <td id ="txt_empname1"><?=$result_seChkDataPlan['EMPLOYEENAME1']?></td>
                                    </tr>
                                    <tr>
                                        <td>อายุงาน</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>รหัสพนักงาน</td>
                                        <td id ="txt_tlepidemp2"><?=$result_seChkDataPlan['EMPLOYEECODE2']?></td>
                                    </tr>
                                    <tr>
                                        <td>ชื่อ-นามสกุล</td>
                                        <td id ="txt_empname2"><?=$result_seChkDataPlan['EMPLOYEENAME2']?></td>
                                    </tr>
                                    <tr>
                                        <td>อายุงาน</td>
                            ...
                            <div class="col-lg-12" style="background-color: #e7e7e7">
                                <p style="font-size: 26px;text-align: center;"><b><u>แผนขาไป หมายเลขไอดี : <?=$_GET['drivinggoplanid']?></u></b></p>
                                <input type="hidden" class="form-control" id="txt_goplanid" name="txt_goplanid" value="<?=$_GET['drivinggoplanid']?>" disabled="">
                            </div> 
                            <div class="col-lg-2" style="background-color: #e7e7e7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    ?>
                                        ...
                                        <input type="datetime-local"  style="height:35px; width:315px;" id="txt_datestartplango" name="txt_datestartplango" value="<?= $result_seData['DATESTARTPLAN'] ?>" min="" max=""  autocomplete="off">
                                    <?php
                                    }else { //สำหรับ PC DESKTOP
                                    ...
                                    ?> 
                                        <label style="font-size: 16px;" ><u>วันที่/เวลาออกเดินทาง</u></label>&nbsp;&nbsp;<font style="color: red;font-size: 18px;"><b>*</b></font><br>
                                        <input class="form-control dateen"   style=""  id="txt_datestartplango" name="txt_datestartplango"  value="<?= $DATESTARTPLAN ?>" min="" max="" autocomplete="off">
                                    <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" >
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class="col-lg-6">
                                                    ...
                                                    <select   id="txt_drivernameplan_p1" name="txt_drivernameplan_p1" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    ?>
                                                        <br>
                                                        <input type="datetime-local"  style="height:40px; width:240px" id="txt_datestartplan_p1" name="txt_datestartplan_p1" value="<?= $result_seData['DATESTART_PLAN_P1'] ?>" min="" max="" onchange ="timestart_p1('MB');" autocomplete="off">
                                                    <?php
                                                    }else { //สำหรับ PC DESKTOP
                                                        ...
                                                        // $date = new DateTimeImmutable($DATESTARTPLANCHK);
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class="col-lg-6">
                                                    <label style="font-size: 16px;">ชื่อผู้ขับ:</label>
                                                    <select   id="txt_drivernameplan_p2" name="txt_drivernameplan_p2" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class="col-lg-6">
                                                    <label style="font-size: 16px;">ชื่อผู้ขับ:</label>
                                                    <select   id="txt_drivernameplan_p3" name="txt_drivernameplan_p3" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class="col-lg-6">
                                                    <label style="font-size: 16px;">ชื่อผู้ขับ:</label>
                                                    <select   id="txt_drivernameplan_p4" name="txt_drivernameplan_p4" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class="col-lg-6">
                                                    <label style="font-size: 16px;">ชื่อผู้ขับ:</label>
                                                    <select   id="txt_drivernameplan_p5" name="txt_drivernameplan_p5" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class="col-lg-6">
                                                    <label style="font-size: 16px;">ชื่อผู้ขับ:</label>
                                                    <select   id="txt_drivernameplan_p6" name="txt_drivernameplan_p6" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input type="datetime-local"  style="height:40px; width:240px" id="txt_parkingtime_plan_4hur_p6" name="txt_parkingtime_plan_4hur_p6" value="<?= $result_seData['PARKINGTIME_PLAN_4HUR_P6'] ?>" min="" max="" onchange ="parkingtime_plan_4hrs_p6('MB');" autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                ...
                                <div class="col-lg-4" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #f0c402;">
                                            <label><font style="font-size: 16px;">โหลดรถลง (ดีลเลอร์1-2)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        <!-- <div class="col-lg-6">
                                                            <label ><u>สถานที่</u></label><br>
                                                            <input class="form-control" type="text"  style="height:40px; width:240px" id="txt_dealer1plan" name="txt_dealer1plan" value="<?= $result_seData['DEALER1_PLAN'] ?>" min="" max=""  autocomplete="off">
                                                        </div> -->
                                                        <!-- <div class="col-lg-6" style="">
                                                            <label style="font-size: 16px;">สถานที่</label>&nbsp;&nbsp;<font style="color: red;font-size: 18px;"><b>*</b></font>
                                                            <select  style="" id="txt_dealer1plan" name="txt_dealer1plan" class="selectpicker form-control" data-container="body" data-live-search="true" title="" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" value="" >
                                                                <option hidden value="<?=$result_seDealer1['DEALER1_PLAN']?>" ><?=$result_seDealer1['DEALER1_PLAN']?></option>
                                                                <?php
                                                                $sql_seDealer1 = "SELECT [NAME] FROM VEHICLETRANSPORTPRICE 
                                                                        WHERE COMPANYCODE ='RCC' AND CUSTOMERCODE ='TTT'
                                                                        AND MONTHST ='3' AND WORKTYPE='nm'
                                                                        ORDER BY [NAME] ASC";
                                                                $params_seDealer1 = array();
                                                                $query_seDealer1 = sqlsrv_query($conn, $sql_seDealer1, $params_seDealer1);
                                                                while ($result_seDealer1 = sqlsrv_fetch_array($query_seDealer1, SQLSRV_FETCH_ASSOC)) {
                                                                    ?>
                                                                    <option value="<?= $result_seDealer1['NAME'] ?>"><?= $result_seDealer1['NAME'] ?></option>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <label>สถานที่</label>
                                                            <input class="form-control" style="height:40px; width:240px" type="text"  name="txt_dealer1plan" id="txt_dealer1plan"  value="<?= $result_seData['DEALER1_PLAN'] ?>" min="" max="" >
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label ><u>รวมเวลา</u></label><br>
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_sumtimedealer1" name="txt_sumtimedealer1" value="<?= $result_seData['SUM_PLAN_DEALER1'] ?>" min="" max=""  autocomplete="off">
                                                        </div>  
                                                    </div>
                                                </div>
                                                <div class = "row">
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input type="datetime-local"  style="height:40px; width:240px" id="txt_parkingtimedealer1" name="txt_parkingtimedealer1" value="<?= $result_seData['PARKINGTIME_PLAN_DEALER1'] ?>" min="" max="" onchange ="sumtimedealer1();" autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtimedealer1" name="txt_parkingtimedealer1"  value="<?= $PARKINGTIME_PLAN_DEALER1 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input type="datetime-local" style="height:40px; width:240px" id="txt_departuretimedealer1" name="txt_departuretimedealer1" value="<?= $result_seData['DEPARTURETIME_PLAN_DEALER1'] ?>" min="" max=""  autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                        // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input class="form-control dateen" style="height:40px; width:240px" id="txt_departuretimedealer1" name="txt_departuretimedealer1" value="<?= $DEPARTURETIME_PLAN_DEALER1 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class = "row">
                                                    <br>
                                                    <div class="col-lg-6">
                                                        <button type="button" style="" class="btn btn-primary btn-lg" onclick ="timedealer1check('<?=$checkClient?>');">กดยืนยันระยะเวลาการจอดรถ</button>
                                                    </div>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        <div class="col-lg-6">
                                                            <label ><u>สถานที่</u></label><br>
                                                            <input class="form-control" type="text"  style="height:40px; width:240px" id="txt_dealer2plan" name="txt_dealer2plan" value="<?= $result_seData['DEALER2_PLAN'] ?>" min="" max=""  autocomplete="off">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label ><u>รวมเวลา</u></label><br>
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_sumtimedealer2" name="txt_sumtimedealer2" value="<?= $result_seData['SUM_PLAN_DEALER2'] ?>" min="" max=""  autocomplete="off">
                                                        </div>  
                                                    </div>
                                                </div>
                                                <div class = "row">
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input type="datetime-local"  style="height:40px; width:240px" id="txt_parkingtimedealer2" name="txt_parkingtimedealer2" value="<?= $result_seData['PARKINGTIME_PLAN_DEALER2'] ?>" min="" max="" 
                                                                         autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtimedealer2" name="txt_parkingtimedealer2"  value="<?= $PARKINGTIME_PLAN_DEALER2 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input type="datetime-local" style="height:40px; width:240px" id="txt_departuretimedealer2" name="txt_departuretimedealer2" value="<?= $result_seData['DEPARTURETIME_PLAN_DEALER2'] ?>" min="" max=""  autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                        // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input class="form-control dateen" style="height:40px; width:240px" id="txt_departuretimedealer2" name="txt_departuretimedealer2" value="<?= $DEPARTURETIME_PLAN_DEALER2 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class = "row">
                                                    <br>
                                                    <div class="col-lg-6">
                                                        <button type="button" style="" class="btn btn-primary btn-lg" onclick ="timedealer2check('<?=$checkClient?>');">กดยืนยันระยะเวลาการจอดรถ</button>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <p style="color:red">*กดปุ่มยืนยันทุกครั้งที่มีการแก้ไขเวลา เพื่อคำนวณชั่วโมงการจอดรถ</p>
                                                    </div>
                                ...
                                <div class="col-lg-4" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #f0c402;">
                                            <label><font style="font-size: 16px;">โหลดรถลง (ดีลเลอร์3-4)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        <div class="col-lg-6">
                                                            <label ><u>สถานที่</u></label><br>
                                                            <input class="form-control" type="text"  style="height:40px; width:240px" id="txt_dealer3plan" name="txt_dealer3plan" value="<?= $result_seData['DEALER3_PLAN'] ?>" min="" max=""  autocomplete="off">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label ><u>รวมเวลา</u></label><br>
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_sumtimedealer3" name="txt_sumtimedealer3" value="<?= $result_seData['SUM_PLAN_DEALER3'] ?>" min="" max=""  autocomplete="off">
                                                        </div>  
                                                    </div>
                                                </div>
                                                <div class = "row">
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input type="datetime-local"  style="height:40px; width:240px" id="txt_parkingtimedealer3" name="txt_parkingtimedealer3" value="<?= $result_seData['PARKINGTIME_PLAN_DEALER3'] ?>" min="" max=""  autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtimedealer3" name="txt_parkingtimedealer3"  value="<?= $PARKINGTIME_PLAN_DEALER3 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input type="datetime-local" style="height:40px; width:240px" id="txt_departuretimedealer3" name="txt_departuretimedealer3" value="<?= $result_seData['DEPARTURETIME_PLAN_DEALER3'] ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                        // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input class="form-control dateen" style="height:40px; width:240px" id="txt_departuretimedealer3" name="txt_departuretimedealer3" value="<?= $DEPARTURETIME_PLAN_DEALER3 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class = "row">
                                                    <br>
                                                    <div class="col-lg-6">
                                                        <button type="button" style="" class="btn btn-primary btn-lg" onclick ="timedealer3check('<?=$checkClient?>');">กดยืนยันระยะเวลาการจอดรถ</button>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <p style="color:red">*กดปุ่มยืนยันทุกครั้งที่มีการแก้ไขเวลา เพื่อคำนวณชั่วโมงการจอดรถ</p>
                                                    </div>
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        <div class="col-lg-6">
                                                            <label ><u>สถานที่</u></label><br>
                                                            <input class="form-control" type="text"  style="height:40px; width:240px" id="txt_dealer4plan" name="txt_dealer4plan" value="<?= $result_seData['DEALER4_PLAN'] ?>" min="" max=""  autocomplete="off">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label ><u>รวมเวลา</u></label><br>
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_sumtimedealer4" name="txt_sumtimedealer4" value="<?= $result_seData['SUM_PLAN_DEALER4'] ?>" min="" max=""  autocomplete="off">
                                                        </div>  
                                                    </div>
                                                </div>
                                                <div class = "row">
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input type="datetime-local"  style="height:40px; width:240px" id="txt_parkingtimedealer4" name="txt_parkingtimedealer4" value="<?= $result_seData['PARKINGTIME_PLAN_DEALER4'] ?>" min="" max=""  autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtimedealer4" name="txt_parkingtimedealer4"  value="<?= $PARKINGTIME_PLAN_DEALER4 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input type="datetime-local" style="height:40px; width:240px" id="txt_departuretimedealer4" name="txt_departuretimedealer4" value="<?= $result_seData['DEPARTURETIME_PLAN_DEALER4'] ?>" min="" max=""  autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                        // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input class="form-control dateen" style="height:40px; width:240px" id="txt_departuretimedealer4" name="txt_departuretimedealer4" value="<?= $DEPARTURETIME_PLAN_DEALER4 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class = "row">
                                                    <br>
                                                    <div class="col-lg-6">
                                                        <button type="button" style="" class="btn btn-primary btn-lg" onclick ="timedealer4check('<?=$checkClient?>');">กดยืนยันระยะเวลาการจอดรถ</button>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <p style="color:red">*กดปุ่มยืนยันทุกครั้งที่มีการแก้ไขเวลา เพื่อคำนวณชั่วโมงการจอดรถ</p>
                                                    </div>
                                ...
                                <div class="col-lg-4" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #f0c402;">
                                            <label><font style="font-size: 16px">บันทึกข้อมูลแผนขาไป(พนักงาน)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                <div class = "row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            &nbsp;
                                                            <input type="text"   style="height:40px; width:200px;<?=$bgcolor?>" class="form-control" id="txt_plangostatus" name="txt_plangostatus" value= "<?=$result_seData['DRIVINGPATTERNGO_STATUS']?>" autocomplete="off" disabled >                    
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label >ยืนยันข้อมูลล่าสุด</label>
                                                            <input type="text" style="height:35px; width:200px" class="form-control" id="txt_datetimeconfirm_plan" name="txt_datetimeconfirm_plan" value= "<?=$result_seSelfCheck['CFDATE']?>:<?=$result_seSelfCheck['CFTIME']?>" autocomplete="off" disabled>                    
                                                        </div>
                                                    </div> -->
                                                </div>
                                                <div class = "row">
                                                ...
                                                <div class = "row">
                                                    <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <input type="button" style="width: 100%;height:80px;font-size: 25px;" onclick="save_DriverPatternPlanGO('save','<?=$checkClient?>');" name="btnSend" id="btnSend" value="บันทึกข้อมูลแผนขาไป" class="btn btn-primary">
                                                            </div>
                                                    </div>
                                                </div>
        ...
        <!-- END --> <script src="../vendor/bootstrap/js/bootstrap.min.js"></script>
        ...
        // END TIMECHECK P6
        // START TIME DEALER1
        function timedealer1check(checkClient){
            ...
            if (checkClient == 'MB') {
                var parkingtimechk   = document.getElementById('txt_parkingtimedealer1').value;
                var departuretimechk = document.getElementById('txt_departuretimedealer1').value;
            }else{
                //START REST
                var parkingtimechk0  = document.getElementById('txt_parkingtimedealer1').value;
                ...
                //END REST
                var departuretimechk0  = document.getElementById('txt_departuretimedealer1').value;
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    // alert(replacetext); 
                    document.getElementById('txt_sumtimedealer1').value = replacetext;
        ...
        // END TIMEDEALER1
        // START TIME DEALER2
        function timedealer2check(checkClient){
        ...
        if (checkClient == 'MB') {
            var parkingtimechk   = document.getElementById('txt_parkingtimedealer2').value;
            var departuretimechk = document.getElementById('txt_departuretimedealer2').value;
        }else{
            //START REST
            var parkingtimechk0  = document.getElementById('txt_parkingtimedealer2').value;
            var parkingtimechk1  = parkingtimechk0.replace(" ","T"); // replave " " เป็น "T"
            var parkingtimechk2  = parkingtimechk1.replace("/","-");
            var parkingtimechk3  = parkingtimechk2.replace("/","-"); // replave "/" เป็น "-"
            var parkingtimechk   = parkingtimechk3;
            ...
            //END REST
            var departuretimechk0  = document.getElementById('txt_departuretimedealer2').value;
            var departuretimechk1  = departuretimechk0.replace(" ","T"); // replave " " เป็น "T"
            var departuretimechk2  = departuretimechk1.replace("/","-");// replave "/" เป็น "-"
            var departuretimechk3  = departuretimechk2.replace("/","-");
            var departuretimechk   = departuretimechk3;
        ...
        $.ajax({
            ...
            success: function (rs) {
                ...
                // alert(replacetext); 
                document.getElementById('txt_sumtimedealer2').value = replacetext;
        ...
        // END TIMEDEALER2
        // START TIME DEALER3
        function timedealer3check(checkClient){
            ...
            if (checkClient == 'MB') {
                var parkingtimechk   = document.getElementById('txt_parkingtimedealer3').value;
                var departuretimechk = document.getElementById('txt_departuretimedealer3').value;
            }else{
                //START REST
                var parkingtimechk0  = document.getElementById('txt_parkingtimedealer3').value;
                var parkingtimechk1  = parkingtimechk0.replace(" ","T"); // replave " " เป็น "T"
                var parkingtimechk2  = parkingtimechk1.replace("/","-");
                var parkingtimechk3  = parkingtimechk2.replace("/","-"); // replave "/" เป็น "-"
                var parkingtimechk   = parkingtimechk3;
                ...
                //END REST
                var departuretimechk0  = document.getElementById('txt_departuretimedealer3').value;
                var departuretimechk1  = departuretimechk0.replace(" ","T"); // replave " " เป็น "T"
                var departuretimechk2  = departuretimechk1.replace("/","-");// replave "/" เป็น "-"
                var departuretimechk3  = departuretimechk2.replace("/","-");
                var departuretimechk   = departuretimechk3;
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    // alert(replacetext); 
                    document.getElementById('txt_sumtimedealer3').value = replacetext;
        ...
        // END TIMEDEALER3
        // START TIME DEALER3
        function timedealer4check(checkClient){
            ...
            if (checkClient == 'MB') {
                var parkingtimechk   = document.getElementById('txt_parkingtimedealer4').value;
                var departuretimechk = document.getElementById('txt_departuretimedealer4').value;
            }else{
                //START REST
                var parkingtimechk0  = document.getElementById('txt_parkingtimedealer4').value;
                var parkingtimechk1  = parkingtimechk0.replace(" ","T"); // replave " " เป็น "T"
                var parkingtimechk2  = parkingtimechk1.replace("/","-");
                var parkingtimechk3  = parkingtimechk2.replace("/","-"); // replave "/" เป็น "-"
                var parkingtimechk   = parkingtimechk3;
                ...
                //END REST
                var departuretimechk0  = document.getElementById('txt_departuretimedealer4').value;
                var departuretimechk1  = departuretimechk0.replace(" ","T"); // replave " " เป็น "T"
                var departuretimechk2  = departuretimechk1.replace("/","-");// replave "/" เป็น "-"
                var departuretimechk3  = departuretimechk2.replace("/","-");
                var departuretimechk   = departuretimechk3;
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    // alert(replacetext); 
                    document.getElementById('txt_sumtimedealer4').value = replacetext;
        ...
        // END TIMEDEALER4
        // END FUNCTION GO PLAN

        
        // FUNCTION SAVE DATA
        function  save_DriverPatternPlanGO(statuschk,checkClient) {

            var drivingplangoid = $("#txt_goplanid").val();
            var employeecode1   = $("#txt_tlepidemp1").text();
            var employeename1   = $("#txt_empname1").text();
            var employeecode2   = $("#txt_tlepidemp2").text();
            var employeename2   = $("#txt_empname2").text();
            ...
            var officercheck    = $("#txt_officerapprovego").text();
            ...
            var sumtimedealer1 = $("#txt_sumtimedealer1").val();

            // Parking Time Dealer1
            if (checkClient == 'MB') {
                var parkingtime_plan_dealer1 = $("#txt_parkingtimedealer1").val();
                
            }else{
                // alert('else');
                //START REST
                var parkingtime_plan_dealer1chk    = $("#txt_parkingtimedealer1").val();
            ...
            // Departure Time Dealer1
            if (checkClient == 'MB') {
                var departuretime_plan_dealer1 = $("#txt_departuretimedealer1").val();
                
            }else{
                // alert('else');
                //START REST
                var departuretime_plan_dealer1chk    = $("#txt_departuretimedealer1").val();
                var departuretime_plan_dealer1chk1   = departuretime_plan_dealer1chk.replace(" ","T"); // replave " " เป็น "T"
                var departuretime_plan_dealer1chk2   = departuretime_plan_dealer1chk1.replaceAll("/","-");
                // var drivingdate3                 = drivingdate2.replace("/","-"); // replave "/" เป็น "-"
                var departuretime_plan_dealer1       = departuretime_plan_dealer1chk2;
            ...
            var sumtimedealer2 = $("#txt_sumtimedealer2").val();

            // Parking Time Dealer1
            if (checkClient == 'MB') {
                var parkingtime_plan_dealer2 = $("#txt_parkingtimedealer2").val();
                
            }else{
                // alert('else');
                //START REST
                var parkingtime_plan_dealer2chk    = $("#txt_parkingtimedealer2").val();
            ...
            // Departure Time Dealer2
            if (checkClient == 'MB') {
                var departuretime_plan_dealer2 = $("#txt_departuretimedealer2").val();
                
            }else{
                // alert('else');
                //START REST
                var departuretime_plan_dealer2chk    = $("#txt_departuretimedealer2").val();
            ...
            var sumtimedealer3 = $("#txt_sumtimedealer3").val();

            // Parking Time Dealer1
            if (checkClient == 'MB') {
                var parkingtime_plan_dealer3 = $("#txt_parkingtimedealer3").val();
                
            }else{
                // alert('else');
                //START REST
                var parkingtime_plan_dealer3chk    = $("#txt_parkingtimedealer3").val();
                var parkingtime_plan_dealer3chk1   = parkingtime_plan_dealer3chk.replace(" ","T"); // replave " " เป็น "T"
                var parkingtime_plan_dealer3chk2   = parkingtime_plan_dealer3chk1.replaceAll("/","-");
                // var drivingdate3                 = drivingdate2.replace("/","-"); // replave "/" เป็น "-"
                var parkingtime_plan_dealer3       = parkingtime_plan_dealer3chk2;
                
            }

            // Departure Time Dealer3
            if (checkClient == 'MB') {
                var departuretime_plan_dealer3 = $("#txt_departuretimedealer3").val();
                
            }else{
                // alert('else');
                //START REST
                var departuretime_plan_dealer3chk    = $("#txt_departuretimedealer3").val();
                var departuretime_plan_dealer3chk1   = departuretime_plan_dealer3chk.replace(" ","T"); // replave " " เป็น "T"
                var departuretime_plan_dealer3chk2   = departuretime_plan_dealer3chk1.replaceAll("/","-");
                // var drivingdate3                 = drivingdate2.replace("/","-"); // replave "/" เป็น "-"
                var departuretime_plan_dealer3       = departuretime_plan_dealer3chk2;
            ...
            var sumtimedealer4 = $("#txt_sumtimedealer4").val();

            // Parking Time Dealer4
            if (checkClient == 'MB') {
                var parkingtime_plan_dealer4 = $("#txt_parkingtimedealer4").val();
                
            }else{
                // alert('else');
                //START REST
                var parkingtime_plan_dealer4chk    = $("#txt_parkingtimedealer4").val();
                var parkingtime_plan_dealer4chk1   = parkingtime_plan_dealer4chk.replace(" ","T"); // replave " " เป็น "T"
                var parkingtime_plan_dealer4chk2   = parkingtime_plan_dealer4chk1.replaceAll("/","-");
                // var drivingdate3                 = drivingdate2.replace("/","-"); // replave "/" เป็น "-"
                var parkingtime_plan_dealer4       = parkingtime_plan_dealer4chk2;
                
            }

            // Departure Time Dealer4
            if (checkClient == 'MB') {
                var departuretime_plan_dealer4 = $("#txt_departuretimedealer4").val();
                
            }else{
                // alert('else');
                //START REST
                var departuretime_plan_dealer4chk    = $("#txt_departuretimedealer4").val();
                var departuretime_plan_dealer4chk1   = departuretime_plan_dealer4chk.replace(" ","T"); // replave " " เป็น "T"
                var departuretime_plan_dealer4chk2   = departuretime_plan_dealer4chk1.replaceAll("/","-");
                // var drivingdate3                 = drivingdate2.replace("/","-"); // replave "/" เป็น "-"
                var departuretime_plan_dealer4       = departuretime_plan_dealer4chk2;
            ...
            if (thainame == '') {
            ...
            }else if((parkingtime_plan_dealer1 != '' && departuretime_plan_dealer1 != '') && (sumtimedealer1 == '')){
                swal.fire({
                    title: "Warning!",
                    text: "ยังไม่ได้กดคำนวณเวลา ดีลเลอร์1",
                    icon: "warning",
                    showConfirmButton: true,
                    allowOutsideClick: false,
                });
                ...
                swal.fire({
                    title: "Warning!",
                    text: "ยังไม่ได้กดคำนวณเวลา ดีลเลอร์2",
                    icon: "warning",
                    showConfirmButton: true,
                    allowOutsideClick: false,
                });
            }else if((parkingtime_plan_dealer3 != '' && departuretime_plan_dealer3 != '') && (sumtimedealer3 == '' || sumtimedealer3 == '0:00' )){
                swal.fire({
                    title: "Warning!",
                    text: "ยังไม่ได้กดคำนวณเวลา ดีลเลอร์3",
                    icon: "warning",
                    showConfirmButton: true,
                    allowOutsideClick: false,
                });
            }else if((parkingtime_plan_dealer4 != '' && departuretime_plan_dealer4 != '') && (sumtimedealer4 == '' || sumtimedealer3 == '0:00' )){
                swal.fire({
                    title: "Warning!",
                    text: "ยังไม่ได้กดคำนวณเวลา ดีลเลอร์4",
                    icon: "warning",
                    showConfirmButton: true,
                    allowOutsideClick: false,
                });
                ...
                if (drivingplangoid != '') {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            // COUNT 10
                            txt_flg: "save_drivingpatternplango",
                            drivingplangoid:drivingplangoid, 
                            ...
                            tnkp_check:tnkp_check,
                            tubon_check: tubon_check,
                            tthaiyen_check: tthaiyen_check,
                            tkan_check: tkan_check, 
