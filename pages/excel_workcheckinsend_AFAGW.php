...
$strExcelFileName = "Report".$result_getDate['GETDATE']."_AFAGW.xls";
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="7" style="border-top:1px solid #000;font-size:14px;border:1px solid #000;padding:6px;text-align:center">
                        <b>สรุปรายงานตัวปฎิบัติงานวันที่ <?= $result_getDate['GETDATE'] ?> - <?= $result_getDate['GETDATE'] ?> (Accounting/Finance)(Accounting)</b> 
...
AND [DEPARTMENTCODE] = '03' AND [SECTIONCODE] = '03' AND AREA = 'gateway' ";
        ...
        <table   style="border-collapse: collapse;margin-top:8px;font-size:10px" width="100%"  >
            <thead>
                <tr>
                    ...
                    <th colspan="14" style="border-top:1px solid #000;font-size:14px;border:1px solid #000;padding:6px;text-align:center">
                        <b>รายงานตัวปฎิบัติงานประจำวันที่ <?= $result_getDate['GETDATE'] ?> ถึงวันที่ <?= $result_getDate['GETDATE'] ?> (Accounting/Finance)(Accounting)</b> 
            ...
            <tbody>
                ...
                $condWorkcheckin2 = " AND c.DEPARTMENTCODE = '02' AND c.[SECTIONCODE] = '02'";
...
WHERE 
    RowNum = (SELECT COUNT(*) FROM STRING_SPLIT('" . $result_seWorkcheckin['MAPADDRESS'] . "',' '))-2";
       ...
       AND  b.AREA = 'gateway' AND b.DEPARTMENTCODE = '02' AND b.[SECTIONCODE] = '02' AND b.DEPARTMENTCODE !='' AND b.[SECTIONCODE] !=''";
