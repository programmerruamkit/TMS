...
$condBilling2 = " AND a.COMPANYCODE = 'RRC' AND a.CUSTOMERCODE = 'BP' AND a.MATERIALTYPE = '" . $_GET['materialtype'] . "'";
...
$condTotal2 = " AND COMPANYCODE = 'RRC' AND CUSTOMERCODE = 'BP' AND MATERIALTYPE = 'ไม่ระบุแผนก'";
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    $tbody = '
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seWeigh['WEIGHOUT'] . '</td>
...
$tfoot = '</tbody><tfoot>
     <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seWeighout['SUMWEIGHOUT'] . '</td>
