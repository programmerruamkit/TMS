...
<style>
   .button {
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"><a href='index2.php'>หน้าแรก</a> / ข้อมูลรถ (สถานะไม่ใช้งาน)</div>
                                            ...
                                            <div class="col-lg-12">
                                                <table  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $condition1 = "";
                                                        $condition2 = "";
                                                        $sql_infolist = "{call megVehicleinfo_statusnotuse_v2(?,?)}";
                                                        ...
                                                        while ($result_infolist = sqlsrv_fetch_array($query_infolist, SQLSRV_FETCH_ASSOC)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select   id="txt_selectyearsinsertsimu" name="txt_selectyearsinsertsimu" onchange="edit_status('<?=$result_infolist['VEHICLEINFOID']?>')" class="form-control" data-container="body" data-live-search="false" title="<?php echo ($result_infolist['ACTIVESTATUS'] == "1") ? "ใช้งาน" : "ไม่ใช้งาน"; ?>" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
                                                                        <option value ="0">ไม่ใช้งาน</option>
                                                                        <option value ="1">ใช้งาน</option>
                                                                    </select>
                                                                </td>
                                                                <!-- <td>
                                                                    <select   id="txt_selectyearsinsertsimu" name="txt_selectyearsinsertsimu" onchange="edit_status('<?=$result_infolist['VEHICLEINFOID']?>')" class="selectpicker form-control" data-container="body" data-live-search="false" title="<?php echo ($result_infolist['ACTIVESTATUS'] == "1") ? "ใช้งาน" : "ไม่ใช้งาน"; ?>" data-hide-disabled="true" data-actions-box="true" data-virtual-scroll="false" tabindex="-98" >
    ...
    <script>
                                        ...
                                        function delete_vehicleinfo(vehicleinfoid)
                                        {
                                            ...
                                            if (confirmation) {
                                                $.ajax({
                                                    ...
                                                    url: 'meg_data2.php',
                                                    data: {
                                                        txt_flg: "delete_vehicleinfo_statusnotuse", vehicleinfoid: vehicleinfoid
                                                    },
                                                    success: function () {
                                        ...
                                        function edit_status(vehicleinfoid)
                                        {
                                            ...
                                            if (confirmation) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    url: 'meg_data2.php',
                                                    data: {
                                                        txt_flg: "update_vehicleinfo_statusnotuse",vehicleinfoid: vehicleinfoid
                                                    },
                                                    success: function () {
                                        ...
                                        //     window.open('meg_vehicleinfocarpoolamata.php?vehicleinfoid=&meg=add', '_blank');
