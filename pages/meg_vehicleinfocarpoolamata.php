...
if ($_GET['vehicleinfoid'] != "") {
    $conditioninfo = ' AND a.VEHICLEINFOCARPOOLID = ' . $_GET['vehicleinfoid'];
    $sql_info = "{call megVehicleinfocarpool_v2(?,?)}";
    $params_info = array(
...
<html lang="en">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  class="form-control" id="cb_cartype" name="cb_cartype" onchange="show_remark(this.value)">
                                                    ...
                                                    while ($result_seCartype = sqlsrv_fetch_array($query_seCartype, SQLSRV_FETCH_ASSOC)) {
                                                        $selected2 = "";
                                                        if ($result_info['VEHICLETYPECODE'] == $result_seCartype['VEHICLETYPECODE'] || $result_info['VEHICLETYPECODE'] == $result_seCartype['VEHICLETYPEDESC']) {
                                                            $selected2 = 'selected';
                                                        }
                                                        ?>

                                                        <option value="<?= $result_seCartype['VEHICLETYPEDESC'] ?>" <?= $selected2 ?>><?= $result_seCartype['VEHICLETYPEDESC'] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                             ...
                             <!-- START ROW2 -->
                                   ...
                                   <!-- START ROW6 -->
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label>แจ้งหยุดรถ</label>
                                                <select  id="cb_truckstatus" name="cb_truckstatus" onchange="update_vehicleinfo('<?= $_GET['vehicleinfoid'] ?>');" class="selectpicker form-control" data-container="body" data-live-search="false" title="เลือก สถานะรถ..." data-hide-disabled="true" data-actions-box="false" data-virtual-scroll="false" tabindex="-98" > 
                                                <?php
                                                    $selected = "SELECTED";

                                                    switch ($result_info['STATUSTRUCK']) {
                                                        case 'หยุดรถ': {
                                                                ?>
                                                                <option value = "พร้อมใช้งาน" >พร้อมใช้งาน</option>
                                                                <option value = "หยุดรถ" <?= $selected ?>>หยุดรถ</option>
                                                                <?php
                                                            }
                                                            break;
                                                        case 'พร้อมใช้งาน' : {
                                                                ...
                                                                <option value = "หยุดรถ" >หยุดรถ</option>
                                                                <?php
                                                            }
                                                            break;
                                                        case 'รถวิ่งงาน' : {
    ...
    <script>
                                                ...
                                                $('.datevehiclestructure').datepicker({
                                                    format: "dd/mm/yyyy",
                                                    language: "th"
                                                    
                                                });   

                                                 $('.datevehicleregister').datepicker({
                                                    format: "dd/mm/yyyy",
                                                    language: "th"
                                                ...
                                                function update_vehicleinfo(){
                                                    alert("update");
                                                    var regisid = <?=$_GET['vehicleinfoid']?>;
                                                    var truckstatus = document.getElementById('cb_truckstatus').value;
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        data: {
                                                            ...
                                                            txt_flg: "update_stopvehicle",
                                                            id:'',
                                                            regisid: regisid,
                                                            regisnumber: '',
                                                            jobno: '',
                                                            keylogstatus: truckstatus,
                                                            datepickup: '',
                                                            datereturn: '' ,
                                                            keypicker: '',
                                                            keyreturnperson: '',
