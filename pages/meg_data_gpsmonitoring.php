...
// SAVE GPS MONITORING 
if ($_POST['txt_flg'] == "save_gpsmonitoring") {


    $sql_savegpsmonitoring    = "{call megGpsMonitoring(?,?,?,?,?,?,?,?,?,?,
                                                        ?,?,?,?,?,?,?,?,?,?)}"; 
    $params_savegpsmonitoring = array(
    array('save_gpsmonitoring', SQLSRV_PARAM_IN),
    ...
    $query_savegpsmonitoring     = sqlsrv_query($conn, $sql_savegpsmonitoring, $params_savegpsmonitoring);
    $result_savegpsmonitoring    = sqlsrv_fetch_array($query_savegpsmonitoring, SQLSRV_FETCH_ASSOC);
    // echo $result_savedealermaster['RS'];
  
}

if ($_POST['txt_flg'] == "save_gpsmonitroingmaster") {


    $sql_savegpsmonitormaster    = "{call megGpsMonitoring(?,?,?,?,?,?,?,?,?,?,?,?,?,?)}"; 
    $params_savegpsmonitormaster = array(
    array('save_gpsmonitroingmaster', SQLSRV_PARAM_IN),
    array($_POST['trailernumber'], SQLSRV_PARAM_IN),
    array($_POST['problem'], SQLSRV_PARAM_IN),
    array($_POST['drivername'], SQLSRV_PARAM_IN),
    array($_POST['datetimedata'], SQLSRV_PARAM_IN),
    ...
    $query_savegpsmonitormaster     = sqlsrv_query($conn, $sql_savegpsmonitormaster, $params_savegpsmonitormaster);
    $result_savegpsmonitormaster    = sqlsrv_fetch_array($query_savegpsmonitormaster, SQLSRV_FETCH_ASSOC);
    echo $result_savegpsmonitormaster['RS'];
  
}
// Driving Pattern แผนขากลับ
if ($_POST['txt_flg'] == "delete_gpsmonitoringmaster") {


    $sql_deletegpsmonitormaster     = "{call megGpsMonitoring(?,?,?,?,?,?,?,?,?,?,?,?,?,?)}"; 
    $params_deletegpsmonitormaster  = array(
    array('delete_gpsmonitoringmaster', SQLSRV_PARAM_IN),
    array($_POST['trailernumber'], SQLSRV_PARAM_IN),
    array($_POST['problem'], SQLSRV_PARAM_IN),
    array($_POST['drivername'], SQLSRV_PARAM_IN),
    array($_POST['datetimedata'], SQLSRV_PARAM_IN),
    ...
    $query_deletegpsmonitormaster = sqlsrv_query($conn, $sql_deletegpsmonitormaster, $params_deletegpsmonitormaster);
    $result_deletegpsmonitormaster = sqlsrv_fetch_array($query_deletegpsmonitormaster, SQLSRV_FETCH_ASSOC);
    // echo $result_deletedealermaster['RS'];
  
}
// Driving Pattern แผนขากลับ
if ($_POST['txt_flg'] == "select_gpsmonitoring") {
?>
...
// Driving Pattern แผนขากลับ
if ($_POST['txt_flg'] == "select_gpsmonitoringskp") {
?>
