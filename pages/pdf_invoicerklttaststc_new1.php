...
////////////////////////////////////////JOBEND///////////////////////////////////////////////
  if ($result_seBilling1['JOBEND'] == 'TMB') {
    ...
    $table_begin1 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:12;margin-top:8px;">';
    $thead1 = '<thead>
  <tr>
    <td colspan="10" style="text-align:left;font-size:18px;"><b>หมายเลขบัญชี :' . $result_seInvoice['BILLING'] . '</b></td>
  </tr>
