...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  ...
  $strExcelFileName = "RKRDAIKI_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<body>
  ...
  <table style="width: 100%;">
      ...
      <tbody>
         ...
         <tr>
              <td colspan="5"style="width: 50%;">บริษัท ไดกิ อลูมิเนียม อินดัสทรี (ประเทศไทย) จำกัด </td>
              <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
         </tr>
         <tr>
              <td colspan="5"style="width: 50%;">สำนักงานใหญ่ ที่อยู่  700/99 ม.1 ต.บ้านเก่า อ.พานทอง  จ.ชลบุรี  20160 </td>
              <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
         </tr>

         <tr>
              <td colspan="5"style="width: 50%;">โทร. 038-468441 , 038-458862-3</td>
