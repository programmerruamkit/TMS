                                                                    ...
                                                                    <table style="background-color: #e7e7e7"  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                            ...
                                                                            <tbody >
                                                                                ...
                                                                                <td style="width: 20%;text-align: left;">มีอาการเหนื่อยล้า </td>
                                                                                    ...
                                                                                    <self1yes>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;background-color: red" type="radio" id="self1yes" <?= $tierdyeschk ?> name="self1" value="self1yes" >
                                                                                        <label for="self1yes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    </self1yes>
                                                                                    <self1no>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self1no" <?= $tierdnochk ?> name="self1" value="self1no">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 20%;text-align: left;"> 
                                                                                    <self2yes>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self2yes" <?= $illnessyeschk ?> name="self2" value="self2yes">
                                                                                        <label for="self2yes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    <self2yes>
                                                                                    <self2no>  
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self2no" <?= $illnessnochk ?> name="self2" value="self2no">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 20%;text-align: left;"> 
                                                                                    <self3yes>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self3yes" <?= $drowseyeschk ?> name="self3" value="self3yes" >
                                                                                        <label for="self3yes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    <self3yes>
                                                                                    <self3no>   
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self3no" <?= $drowsenochk ?> name="self3" value="self3no">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 20%;text-align: left;"> 
                                                                                    <self4yes>    
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle" type="radio" id="self4yes" <?= $injuryyeschk ?> name="self4" value="self4yes">
                                                                                        <label for="self4yes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    <self4yes>
                                                                                    <self4no>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self4no" <?= $injurynochk ?> name="self4" value="self4no">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 20%;text-align: left;"> 
                                                                                    <self4yes>    
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle" type="radio" id="self5yes" <?= $takemedicineyeschk ?> name="self5" value="self5yes">
                                                                                        <label for="self5yes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    <self4yes>
                                                                                    <self4no>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="self5no" <?= $takemedicinenochk ?> name="self5" value="self5no">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <self6yes>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfallyes" <?= $healthyyeschk ?> name="selfall" value="selfallyes">
                                                                                        <label for="selfallyes">ปกติ</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    <self6yes>
                                                                                    <self6no>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfallno" <?= $healthynochk ?> name="selfall" value="selfallno">
                                                            ...
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            if ($checkClient == 'MB') {   
                                                                            ?>  <div class="col-lg-6">
                                                                                    <button disabled="" type="button" style="height:40px; width:245px" class="btn btn-primary btn-lg" onclick ="timesleepselfrestcheck('MB');">กดยืนยันระยะเวลาการพักผ่อน</button>
                                                                                </div>
                                                                                <div class="col-lg-6">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                if ($_GET['type'] == 'check' || $_GET['type'] == 'officercheck' ) {
                                                                                ?>
                                                                                    <button disabled="" type="button" style="height:40px; width:240px" class="btn btn-primary btn-lg" onclick ="timesleepselfrestcheck('DT');">กดยืนยันระยะเวลาการพักผ่อน</button>
                                                                                <?php
                                                                                }else{
                                                                                ?>
                                                                                    <button disabled="" type="button" style="height:40px; width:240px" class="btn btn-primary btn-lg" onclick ="timesleepselfrestcheck('DT');" >กดยืนยันระยะเวลาการพักผ่อน</button>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            if ($TIMESLEEPREST == '0') {
                                                                            ?>
                                                                            <input disabled="" readonly  type="text" class="form-control" id="timesleep_rest" name="timesleep_rest" value= "" autocomplete="off">    
                                                                            <?php
                                                                            }else if ($TIMESLEEPREST >= '8') {
                                                                            ?>
                                                                            <input disabled="" readonly style="background-color: #94FA67;" type="text" class="form-control" id="timesleep_rest" name="timesleep_rest" value= "<?= $result_seSelfCheck['TIMESLEEPREST'] ?>" autocomplete="off">
                                                                            <?php
                                                                            }else {
                                                                            ?>
                                                                            <input disabled="" readonly style="background-color: #FA6767;" type="text" class="form-control" id="timesleep_rest" name="timesleep_rest" value= "<?= $result_seSelfCheck['TIMESLEEPREST'] ?>" autocomplete="off">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                ...
                                                                <div class="">
                                                                    <form class="form-inline">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    <input disabled="" type="datetime-local"  style="height:40px; width:240px" id="daysleep_normalstart" name="daysleep_normalstart" value="<?= $result_seSelfCheck['SLEEPNORMALSTART'] ?>" min="" max="" onchange ="timesleepselfnormalcheck('MB');" autocomplete="off">
                                                                                <?php
                                                                                }else { //สำหรับ PC DESKTOP
                                                                                ...
                                                                                ?> 
                                                                                    <label ><u>เวลาเริ่มนอน</u></label><br>
                                                                                    <input disabled="" class="form-control dateen"   style="height:40px; width:240px;"  id="daysleep_normalstart" name="daysleep_normalstart"  value="<?= $DATESLEEPNORMALSTART ?>" min="" max="" autocomplete="off">
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <input disabled="" type="datetime-local" style="height:40px; width:240px" id="daysleep_normalend" name="daysleep_normalend" value="<?= $result_seSelfCheck['SLEEPNORMALEND'] ?>" min="" max="" onchange ="timesleepselfnormalcheck('MB');" autocomplete="off">
                                                                            <?php
                                                                            }else { //สำหรับ PC DESKTOP
                                                                                // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                                            ...
                                                                            ?> 
                                                                                <label ><u>เวลาตื่นนอน</u></label><br>
                                                                                <input disabled="" class="form-control dateen" style="height:40px; width:240px" id="daysleep_normalend" name="daysleep_normalend" value="<?= $DATESLEEPNORMALEND ?>" min="" max="" autocomplete="off">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            ?>
                                                                            <div class="col-lg-6">
                                                                                <button disabled="" type="button" style="height:40px; width:240px" class="btn btn-primary btn-lg" onclick ="timesleepselfnormalcheck('DT');" >กดยืนยันเวลานอนปกติ</button>
                                                                            </div>
                                                                            <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label>ระยะเวลาที่นอน(ปกติ) 6 ชั่วโมงขึ้นไป</label>
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    ?>  
                                                                                        <input disabled="" readonly style="background-color: #FFFFF;" type="text" class="form-control" id="timeshow_gw" name="timeshow_gw" value= "ยังไม่ได้ลงข้อมูลและกดยืนยันเวลานอนปกติ" autocomplete="off">
                                                                                        <input disabled="" readonly style="background-color: #FFFFF;display: none;" type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "" autocomplete="off">    
                                                                                    <?php
                                                                                    ...
                                                                                    ?>  
                                                                                        ...
                                                                                        if ($_GET['type'] == 'insert') {
                                                                                        ?>  
                                                                                            <input disabled="" readonly style="background-color: #FFFFF;" type="text" class="form-control" id="timeshow_gw" name="timeshow_gw" value= "กดยืนยันเวลานอนปกติเรียบร้อยแล้ว" autocomplete="off">
                                                                                            <input disabled="" readonly style="background-color: #FFFFF;display: none;" type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "<?= $result_seSelfCheck['TIMESLEEPNORMAL'] ?>" autocomplete="off">
                                                                                        <?php
                                                                                        }else{
                                                                                        ?>
                                                                                            <input disabled="" readonly style="background-color: #94FA67;" type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "<?= $result_seSelfCheck['TIMESLEEPNORMAL'] ?>" autocomplete="off">
                                                                                        <?php
                                                                                        }
                                                                                        ?>
                                                                                    ...
                                                                                    ?>
                                                                                        ...
                                                                                        ?>
                                                                                            <input disabled="" readonly style="background-color: #FA6767;" type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "<?= $result_seSelfCheck['TIMESLEEPNORMAL'] ?>" autocomplete="off">
                                                                                        <?php
                                                                                        }
                                                                                        ?>
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    if ($TIMESLEEPNORMAL == '0') {
                                                                                    ?>
                                                                                        <input disabled="" readonly  type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "" autocomplete="off">    
                                                                                    <?php
                                                                                    }else if ($TIMESLEEPNORMAL >= '6') {
                                                                                    ?>  
                                                                                        <?php
                                                                                        if ($_GET['type'] == 'insert') {
                                                                                        ?>
                                                                                            <input disabled="" readonly style="background-color: #FFFFF;" type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "<?= $result_seSelfCheck['TIMESLEEPNORMAL'] ?>" autocomplete="off">
                                                                                        <?php
                                                                                        }else{
                                                                                        ?>
                                                                                            <input disabled="" readonly style="background-color: #94FA67;" type="text" class="form-control" id="timesleep_normal" name="timesleep_normal" value= "<?= $result_seSelfCheck['TIMESLEEPNORMAL'] ?>" autocomplete="off">
                                                        ...
                                                        <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                                ...
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    <input disabled="" type="datetime-local" style="height:40px; width:240px;" id="daysleep_extrastart" name="daysleep_extrastart" value="<?= $result_seSelfCheck['SLEEPEXTRASTART'] ?>" min="" max="" onchange ="timesleepselfextracheck('MB');" autocomplete="off">
                                                                                <?php
                                                                                }else { //สำหรับ PC DESKTOP
                                                                                ...
                                                                                ?> 
                                                                                    <label ><u>เวลาเริ่มพักผ่อน(กะกลางคืน)</u></label><br>
                                                                                    <input disabled="" class="form-control dateen" style="height:40px; width:240px;" id="daysleep_extrastart" name="daysleep_extrastart" value="<?= $DATESLEEPEXTRASTART ?>" min="" max="" autocomplete="off">
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            ...
                                                                            if ($checkClient == 'MB') { //สำหรับมือถือ
                                                                                ?>
                                                                                    ...
                                                                                    <input disabled="" type="datetime-local" style="height:40px; width:240px" id="daysleep_extraend" name="daysleep_extraend" value="<?= $result_seSelfCheck['SLEEPEXTRAEND'] ?>" min="" max="" onchange ="timesleepselfextracheck('MB');" autocomplete="off">
                                                                                <?php
                                                                                }else { //สำหรับ PC DESKTOP
                                                                                    // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                                                ...
                                                                                ?> 
                                                                                    <label ><u>เวลาตื่นพักผ่อน(กะกลางคืน)</u></label><br>
                                                                                    <input disabled="" class="form-control dateen" style="height:40px; width:240px" id="daysleep_extraend" name="daysleep_extraend" value="<?= $DATESLEEPEXTRAEND ?>" min="" max="" autocomplete="off">
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            ...
                                                                            <br><br><br>
                                                                                ...
                                                                                ?>
                                                                                <div class="col-lg-6">
                                                                                    <button disabled="" type="button" style="height:40px; width:240px" class="btn btn-primary btn-lg" onclick ="timesleepselfextracheck('DT');"  >กดยืนยันเวลานอนเพิ่ม</button>
                                                                                </div>
                                                                                <div class="col-lg-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            if ($TIMESLEEPEXTRAHOURCHK == '0') {
                                                                                // echo '1';
                                                                            ?>
                                                                                <input disabled="" readonly  type="text" class="form-control" id="timesleep_extra" name="timesleep_extra" value= "" autocomplete="off">
                                                                            <?php
                                                                               ...
                                                                               ?>
                                                                                <input disabled="" readonly style="background-color: #94FA67;" type="text" class="form-control" id="timesleep_extra" name="timesleep_extra" value= "<?= $result_seSelfCheck['TIMESLEEPEXTRA'] ?>" autocomplete="off">
                                                                               <?php
                                                                                }else {
                                                                                ?>
                                                                                <input disabled="" readonly style="background-color: #FA6767;" type="text" class="form-control" id="timesleep_extra" name="timesleep_extra" value= "<?= $result_seSelfCheck['TIMESLEEPEXTRA'] ?>" autocomplete="off">
                                                                                <?php
                                                                                }
                                                                            ?>
                                                            ...
                                                            <div class = "row">
                                                                ...
                                                                <table style="background-color: #e7e7e7"  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th style="width: 100%;text-align: center;" >ประเมิน(การนอนเพิ่ม) <button disabled="" id="clear" style= "background-color:#FA6767">ล้างข้อมูลประเมิน(การนอนเพิ่ม)</button></th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                        ...
                                                        <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            <label>ชื่อโรค</label>
                                                                            <input disabled="" type="text" class="form-control" id="disease" name="disease" value= "<?= $diseaseinsertchk?>" autocomplete="off">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <div class = "row">
                                                                ...
                                                                <table style="background-color: #e7e7e7"  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width: 100%;text-align: center;">
                                                                            <selfdoctoryes>
                                                                                <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfdoctoryes" <?= $seedoctoryes ?> name="selfdoctor" value="selfdoctoryes">
                                                                                <label for="selfdoctoryes">พบ</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                            </selfdoctoryes>
                                                                            <selfdoctorno>
                                                                                <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfdoctorno" <?= $seedoctorno ?> name="selfdoctor" value="selfdoctorno">
                                                            ...
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            <label >ชื่อยา</label>
                                                                            <input disabled="" type="text" class="form-control" id="drug_name" name="drug_name" value= "<?= $drugnameinsertchk ?>" autocomplete="off">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" type="datetime-local" style="height:40px; width:240px" id="drug_time" name="drug_time" value="<?= $result_seSelfCheck['DRUGTIME']?>" min="" max="">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <div class = "row">
                                                                    ...
                                                                    <table style="background-color: #e7e7e7"  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width: 100%;text-align: center;"> 
                                                                                <selfworryyes>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfworryyes" <?=$worryyes ?> name="selfworry" value="selfworryyes">
                                                                                    <label for="selfworryyes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                </selfworryyes>
                                                                                <selfworryno>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfworryno" <?=$worryno ?> name="selfworry" value="selfworryno">
                                                                    ...
                                                                    <table style="background-color: #e7e7e7"  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width: 100%;text-align: center;">
                                                                                <selfhouseholdyes>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfhouseholdyes" <?=$householdyes ?> name="selfhousehold" value="selfhouseholdyes">
                                                                                    <label for="selfhouseholdyes">บ้าน</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                </selfhouseholdyes> 
                                                                                <selfhouseholdno>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfhouseholdno" <?=$householdno ?> name="selfhousehold" value="selfhouseholdno">
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <selfeyeproblemyes_eyecheck>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfeyeproblemyes" <?=$eyeproblemyes?> name="selfeyeproblem" value="selfeyeproblemyes">
                                                                                        <label for="selfeyeproblemyes">มี</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    </selfeyeproblemyes_eyecheck>
                                                                                    <selfeyeproblemno_eyecheck>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfeyeproblemno" <?=$eyeproblemno?> name="selfeyeproblem" value="selfeyeproblemno">
                                                                            ...
                                                                            ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <selfeyeglassesyes_eyecheck>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfeyeglassesyes" <?=$eyeglassesyes?> name="selfeyeglasses" value="selfeyeglassesyes">
                                                                                        <label for="selfeyeglassesyes">สวม</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                    </selfeyeglassesyes_eyecheck> 
                                                                                    <selfeyeglassesno_eyecheck>
                                                                                        <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfeyeglassesno" <?=$eyeglassesno?>  name="selfeyeglasses" value="selfeyeglassesno">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <selfcarryhearingaidyes>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfcarryhearingaidyes" <?=$carryhearingaidyes?> name="selfcarryhearingaid" value="selfcarryhearingaidyes">
                                                                                    <label for="selfcarryhearingaidyes">สวม</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                </selfcarryhearingaidyes> 
                                                                                <selfcarryhearingaidno>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfcarryhearingaidno" <?=$carryhearingaidno?>  name="selfcarryhearingaid" value="selfcarryhearingaidno">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <selfcarryeyeglassesyes>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfcarryeyeglassesyes" <?=$carryeyeglassesyes?> name="selfcarryeyeglasses" value="selfcarryeyeglassesyes">
                                                                                    <label for="selfcarryeyeglassesyes">พกแว่นสายตา</label> &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                </selfcarryeyeglassesyes> 
                                                                                <selfcarryeyeglassesno>
                                                                                    <input disabled="" style="height:30px; width:30px; vertical-align: middle;" type="radio" id="selfcarryeyeglassesno" <?=$carryeyeglassesno?>  name="selfcarryeyeglasses" value="selfcarryeyeglassesno">
                                                        ...
                                                        <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            <label >ประเภท</label>
                                                                            <input disabled="" type="text" class="form-control" id="alcohol_type" name="alcohol_type" value= "<?= $alcoholtypeinsertchk ?>" autocomplete="off">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input disabled="" type="datetime-local" style="height:35px; width:240px" id="alcohol_time" name="alcohol_time" value="<?= $result_seSelfCheck['ALCOHOLTIME'] ?>" min="" max="">    
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class = "row">
                                                                <div class="">
                                                                        <div class="form-group">
                                                                            <label >ปริมาณ</label>
                                                                            <input disabled="" type="text" class="form-control" id="alcohol_volume" name="alcohol_volume" value= "<?= $alcoholvolumeinsertchk ?>" autocomplete="off">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <div class = "row">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                            <div class = "row">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label >ผู้ยืนยันข้อมูลล่าสุด</label>
                                                            ...
                                                            <div class = "row">
                                                                <div class="col-lg-12">
                                                                        <div class="form-group">
                                                                            <input disabled="" type="button" style="width: 100%;height:80px;font-size: 25px;" onclick="confirm_selfcheck('save','<?=$checkClient?>','<?=$empchkgw?>');" name="btnSend" id="btnSend" value="ยืนยันและบันทึกข้อมูล" class="btn btn-success">
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <!-- <div class = "row">
