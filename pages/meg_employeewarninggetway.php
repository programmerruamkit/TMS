                                        ...
                                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                $params_seEmp = array(
                                                    ...
                                                    array(" AND CONVERT(NVARCHAR(2),a.PersonCode) IN ('04','09','05')", SQLSRV_PARAM_IN)
                                                );
                                                        ...
                                                        <td style="text-align: center">
                                                            <div class="btn-group">
                                                                        ...
                                                                        <ul class="dropdown-menu slidedown">
                                                                            <li>
                                                                                <a href="meg_stopworkgetway.php?employeeid=<?=$result_seEmp['PersonCode']?>">
                                                                                    รับแจ้งหยุดรถ
                                                                                </a>
                                                                            </li>
                                                                            <li class="divider"></li>
                                                                            <li>
                                                                                <a href="meg_tenkogetway.php?employeeid=<?=$result_seEmp['PersonCode']?>">
                                                                                    รับแจ้งเท็งโกะ
                                                                                </a>
                                                                            </li>
                                                                            <li class="divider"></li>
                                                                            <li>
                                                                                <a href="meg_maintenanceagetway.php?employeeid=<?=$result_seEmp['PersonCode']?>">
                                                                                    รับแจ้งซ่อม
                                                                                </a>
                                                                            </li>
