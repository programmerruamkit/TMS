            ...
            <div id="page-wrapper">
                ...
                <div id="datade_edit">
                    <div class="row" id="list-data">
                        ...
                        <div class="col-lg-12" style="font-size: 30px;text-align: center;">เลือกเมนูที่จะลงข้อมูลสำหรับเจ้าหน้าที่</div>
                        ...
                        <div class="col-lg-12" style="text-align: center;">
                            ...
                            &nbsp;<button class="button" style="width:50%;font-size: 25px;background-color: #93f786;border:solid 2px;color:black" onclick="select_searchDrivingPattern('GoActual')">วิ่งจริงขาไป <br>เลขไอดี: <?=$_GET['drivinggoplanid']?></button>
                            <br><br><br>
                            &nbsp;<button class="button" style="width:50%;font-size: 25px;background-color: #93f786;border:solid 2px;color:black" onclick="select_searchDrivingPattern('BackActual')">วิ่งจริงขากลับ <br>เลขไอดี: <?=$_GET['drivingbackplanid']?></button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                    </div>
