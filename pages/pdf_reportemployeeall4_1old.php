...
$sql_seDriverCode = "SELECT TENKOBEFOREID,TENKOMASTERID,TENKOMASTERDIRVERCODE,TENKOMASTERDIRVERNAME
                    FROM TENKOBEFORE
                    WHERE TENKOMASTERDIRVERNAME LIKE '%" . $_GET['employee'] . "%'";
$params_seDriverCode = array();
$query_seDriverCode = sqlsrv_query($conn, $sql_seDriverCode, $params_seDriverCode);
while ($result_seDriverCode = sqlsrv_fetch_array($query_seDriverCode, SQLSRV_FETCH_ASSOC)){



$condTenkomasterall1 = " AND a.TENKOMASTERDIRVERCODE = '" . $result_seDriverCode['TENKOMASTERDIRVERCODE'] . "' ";
$condTenkomasterall2 = " AND a.TENKOBEFOREID = '".$result_seDriverCode['TENKOBEFOREID']."'";
$condTenkomasterall = " AND CONVERT(DATE,a.CREATEDATE) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103) ".$condTenkomasterall1.$condTenkomasterall2;
$sql_seTenkomasterall = "{call megEdittenkobefore_v2(?,?,?,?)}";
$params_seTenkomasterall = array(
    array('select_tenkobefore', SQLSRV_PARAM_IN),
    array($condTenkomasterall, SQLSRV_PARAM_IN),
    array('', SQLSRV_PARAM_IN),
    array('', SQLSRV_PARAM_IN)
);
$query_seTenkomasterall = sqlsrv_query($conn, $sql_seTenkomasterall, $params_seTenkomasterall);
while ($result_seTenkomasterall = sqlsrv_fetch_array($query_seTenkomasterall, SQLSRV_FETCH_ASSOC)) {
    $conditionDir = "  AND a.PersonCode = '".$result_seTenkomasterall['TENKOMASTERDIRVERCODE']."'";
    ...
    $condTenkomaster = " AND a.TENKOMASTERDIRVERCODE1 = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "' AND a.TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
    ...
    $condTenkobefor1 = " AND a.TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "' ";
    $condTenkobefor2 = " AND a.TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
    ...
    $sql_seTenkoMasterdata = "SELECT a.TENKOMASTERID, a.VEHICLETRANSPORTPLANID, a.TENKOMASTERCOMPANY, a.TENKOMASTERDIRVERCODE1,
                            a.TENKOMASTERDIRVERNAME1, a.TENKOMASTERDIRVERCODE2, a.TENKOMASTERDIRVERNAME2, a.TENKOMASTERVEHICLE, a.TENKOMASTERKA,
                            a.TENKOMASTERREMARKBEFORE, a.TENKOMASTERREMARKAFTER, a.REMARK, a.ACTIVESTATUS, a.CREATEBY,
                            CONVERT(VARCHAR(10), a.CREATEDATE, 103) + ' '  + convert(VARCHAR(8), a.CREATEDATE, 14) AS 'CREATEDATE', a.MODIFIEDBY,
                            a.MODIFIEDDATE,
                            CONVERT(VARCHAR(10), a.CREATEDATE, 103) AS 'DATEINPUT_F1',
                            CONVERT(VARCHAR(10), DATEADD(DAY,1, a.CREATEDATE),103) AS 'DATEINPUT_F2',
                            CONVERT(VARCHAR(10), DATEADD(DAY,2, a.CREATEDATE),103) AS 'DATEINPUT_F3',
                            CONVERT(VARCHAR(10), DATEADD(DAY,3, a.CREATEDATE),103) AS 'DATEINPUT_F4',
                            CONVERT(VARCHAR(10), DATEADD(DAY,4, a.CREATEDATE),103) AS 'DATEINPUT_F5',
                            CONVERT(VARCHAR(30), a.CREATEDATE, 106) AS 'DATEINPUT_F1EN',
                            CONVERT(VARCHAR(30), DATEADD(DAY,1, a.CREATEDATE),106) AS 'DATEINPUT_F2EN',
                            CONVERT(VARCHAR(30), DATEADD(DAY,2, a.CREATEDATE),106) AS 'DATEINPUT_F3EN',
                            CONVERT(VARCHAR(30), DATEADD(DAY,3, a.CREATEDATE),106) AS 'DATEINPUT_F4EN',
                            CONVERT(VARCHAR(30), DATEADD(DAY,4, a.CREATEDATE),106) AS 'DATEINPUT_F5EN',
                            a.VEHICLEREGISNUMBER,a.JOBSTART,a.JOBEND1,a.JOBEND2,TENKOTARGET1,TENKOTARGET2,TENKOTARGET3,TENKOTARGET4,TENKOTARGET5,TENKOTARGET6,TENKOTARGET7
                            FROM dbo.TENKOMASTER a
                            WHERE a.ACTIVESTATUS = '1'
                            AND a.TENKOMASTERID='" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
    $params_seTenkoMasterdata = array();
    $query_seTenkoMasterdata = sqlsrv_query($conn, $sql_seTenkoMasterdata, $params_seTenkoMasterdata);
    $result_seTenkoMasterdata = sqlsrv_fetch_array($query_seTenkoMasterdata, SQLSRV_FETCH_ASSOC);
    ...
    $TENKORESTRESULT1 = ($result_seTenkobefor['TENKORESTRESULT'] == "1") ? "<img src='../images/ok.png' width='2%'>" : "";
    ...
    $TENKORESTRESULT0 = ($result_seTenkobefor['TENKORESTRESULT'] == "0") ? "<img src='../images/ok.png' width='2%'>" : "";
    ...
    $TENKOTARGET1 = ($result_seTenkoMasterdata['TENKOTARGET1'] == '1')?"1.ขับเว้นระยะห่าง 3 วิ":"";
    $TENKOTARGET2 = ($result_seTenkoMasterdata['TENKOTARGET2'] == '1')?"2.ควบคุมพวงมาลัยให้คงที่":"";
    $TENKOTARGET3 = ($result_seTenkoMasterdata['TENKOTARGET3'] == '1')?"3.ให้ใช้ความเร็วต่ำขณะผ่านที่ชุมชน":"";
    $TENKOTARGET4 = ($result_seTenkoMasterdata['TENKOTARGET4'] == '1')?"4.ง่วงไม่ฝืนขับ":"";
    $TENKOTARGET5 = ($result_seTenkoMasterdata['TENKOTARGET5'] == '1')?"5.ปฎิบัติงานตามขั้นตอน":"";
    $TENKOTARGET6 = ($result_seTenkoMasterdata['TENKOTARGET6'] == '1')?"6.ขับขี่ตามกฎจราจร":"";
    $TENKOTARGET7 = ($result_seTenkoMasterdata['TENKOTARGET7'] == '1')?"7.พบสิ่งผิดปกติให้ หยุด-เรียก-รอ":"";
...
<style>
    ...
    $TENKOMASTERVEHICLE = $result_seTenkomaster['VEHICLEREGISNUMBER'];

    $table_headerDAY1 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8;margin-top:8px;">
<thead>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkomaster['DATEINPUT_F1'] . '</th>
    ...
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="5" style="border-right:1px solid #000;padding:4px;text-align:left;"></th>
        <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:left;"></th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="5" height="100" style="border-right:1px solid #000;padding:4px;text-align:left;">'.$result_seTenkoMasterdata['JOBSTART'].'->'.$result_seTenkoMasterdata['JOBEND1'].'->'.$result_seTenkoMasterdata['JOBEND2'].'</th>
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
     <th style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
      ...
      <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะก่อนเริ่มงาน</th>
        ...
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkobefor['CREATEBY'] . '</th>
    ...
    <tr style="border:1px solid #000;padding:4px;">
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">ต่ำกว่า 38 องศา</td>
...
';
    ...
    $condTenkotransportDAY11 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "'";
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
      <th colspan="8" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkotransportDAY1['CREATEBY'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
    ...
    <tr style="border:1px solid #000;padding:4px;">
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">มีการรายงานเกี่ยวกับรถใหม่ว่ามีสิ่งผิดปรกติหรือไม่</td>
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">ระหว่างวิ่งงานไม่มีสิ่งผิดปรกติ</td>
...
<thead>
    ...
    <tr style="border:1px solid #000;padding:4px;">
        ...
        <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkomaster['TENKOMASTERREMARKAFTER'] . '</th>
    </tr>
    </thead>
    <tbody>
    </tbody>
...
';
    ...
    $condTenkotransportDAY21 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "'";
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
      <th colspan="8" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkotransportDAY2['CREATEBY'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkomaster['DATEINPUT_F3'] . '</th>
        <th colspan="4" style="border-right:1px solid #000;padding:4px;text-align:center;">เอกสารเท็งโกะ</th>
        <th colspan="4" style="border-right:1px solid #000;padding:4px;text-align:center;">Issue date 23 Jan 2017<br>          Toyota Transport (Thailand) Co.,LTD.</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
...
';
    ...
    $condTenkotransportDAY31 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "'";
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
      <th colspan="8" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkotransportDAY3['CREATEBY'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkomaster['DATEINPUT_F4'] . '</th>
        <th colspan="4" style="border-right:1px solid #000;padding:4px;text-align:center;">เอกสารเท็งโกะ</th>
        <th colspan="4" style="border-right:1px solid #000;padding:4px;text-align:center;">Issue date 23 Jan 2017<br>          Toyota Transport (Thailand) Co.,LTD.</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
...
';
    ...
    $condTenkotransportDAY41 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "'";
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
      <th colspan="8" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkotransportDAY4['CREATEBY'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkomaster['DATEINPUT_F5'] . '</th>
        <th colspan="4" style="border-right:1px solid #000;padding:4px;text-align:center;">เอกสารเท็งโกะ</th>
        <th colspan="4" style="border-right:1px solid #000;padding:4px;text-align:center;">Issue date 23 Jan 2017<br>          Toyota Transport (Thailand) Co.,LTD.</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
...
';
    ...
    $condTenkotransportDAY51 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "'";
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
      <th colspan="8" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นเจ้าหน้าที่เท็งโกะ</th>
        <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkotransportDAY5['CREATEBY'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปรกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปรกติ : 1 | พบสิ่งผิดปรกติ : x</li></th>
    </tr>
...
if ($result_seTenkotransportDAY5['TENKOTIME0'] != '' || $result_seTenkotransportDAY5['TENKOTIME1'] != '' || $result_seTenkotransportDAY5['TENKOTIME2'] != '' || $result_seTenkotransportDAY5['TENKOTIME3'] != '' || $result_seTenkotransportDAY5['TENKOTIME4'] != '' || $result_seTenkotransportDAY5['TENKOTIME5'] != '' || $result_seTenkotransportDAY5['TENKOTIME6'] != '') {
    ...
    $condTenkoafter1 = " AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "' ";
    $condTenkoafter2 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
     <th style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
        <th style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkoafter['CREATEDATE'] . '</th>
    ...
    <tr style="border:1px solid #000;padding:4px;">
     ...
     <tr style="border:1px solid #000;padding:4px;">
      ...
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">5</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">มีความผิดปรกติกับรถใหม่หรือไม่</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOCARNEWCHECK1 . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">รายงานสิ่งผิดปรกติของรถใหม่ว่ามีหรือไม่</td>
      ...
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">6</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">ความผิดปรกติของรถเทรลเลอร์</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOTRAILERCHECK1 . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">รายงานสิ่งผิดปรกติของเทรลเลอร์ว่ามีหรือไม่</td>
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">รายงานว่ามีจุดเปลี่ยนแปลงที่ผิดปรกติหรือไม่</td>
...
';
    $condTenkorisky1 = " AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "' ";
    $condTenkorisky2 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
...
<thead>
    ...
    <tr style="border:1px solid #000;padding:4px;">
     ...
     <tr style="border:1px solid #000;padding:4px;">
        ...
        <th width="25%" style="border-right:1px solid #000;padding:4px;text-align:center;">สิ่งผิดปรกติ</th>
        <th width="25%" style="border-right:1px solid #000;padding:4px;text-align:center;">รายละเอียดสิ่งผิดปรกติ</th>
    </tr>
    </thead>
    <tbody>
    ...
    $condTenkogps1 = " AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE'] . "' ";
    $condTenkogps2 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
