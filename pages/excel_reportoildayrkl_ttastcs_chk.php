...
$strExcelFileName = "รายงานน้ำมัน RKL-CS วันที่ ".$_GET['datestart'] .".xls";
...
<body>
  ...
  <thead>
         <tr>
                <td colspan="74" style="border-right:1px solid #000;padding:3px;text-align:center;">
           ...
           <tr>
             ...
             <tr>
                    <td colspan="74" style="border-right:1px solid #000;padding:3px;text-align:center;">
                        <b>สายงาน TTAST-CS วันที่  <?=date("d")." ".$month_arr[date("n")]." ".(date("Y")+543);?></b>
                    </td>
             </tr>
         ...
         <tr style="border:1px solid #000;background-color: #ccc" >
          ...
          <!-- 10W/OTHER -->
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>ไมล์ต้น</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>ไมล์ปลาย</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>ระยะทาง</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>น้ำมันที่เติม</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>ค่าเฉลี่ยที่กำหนด</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>ค่าเฉลี่ยที่ได้</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>จำนวนน้ำมันที่เกินกำหนด</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>จำนวนบาท/ลิตร</b></td>
          <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b>จำนวนเงินที่ได้(บาท)</b></td>
        ...
        $sql_seBillings = "SELECT a.PersonID AS 'EMPID',a.PersonCode AS 'EMPLOYEECODE',a.FnameT,a.LnameT,
                  ...
                  AND SUBSTRING(a.PersonCode, 1, 2) IN('01')
                  AND a.PositionID IN('26')
        ...
        while ($result_seBillings = sqlsrv_fetch_array($query_seBillings, SQLSRV_FETCH_ASSOC)){
          ...
          $sql_seTrip = "SELECT MAX(a.TRIP) AS 'TRIP' FROM(
                      ...
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] ."' AND CUSTOMERCODE IN ('TTASTCS','TTASTSTC')
          ...
          ////////////////////////////////หา ๋JOB 10 W /OTHER/////TTASTCS 10W//////////////////////////////////
          $sql_seData = "SELECT CUSTOMERCODE,COMPANYCODE,THAINAME,VEHICLETYPE,O4 AS 'OIL',ROW_NUMBER() OVER(ORDER BY VEHICLETRANSPORTPLANID) AS 'TRIP',
                      ...
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] ."' AND CUSTOMERCODE ='TTASTCS'
                      AND CONVERT(DATE,DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] ."',103) AND CONVERT(DATE,'" . $_GET['dateend'] ."',103)
                      AND (EMPLOYEECODE1 ='".$result_seBillings['EMPLOYEECODE']."' OR  EMPLOYEECODE2 ='".$result_seBillings['EMPLOYEECODE']."')
                      AND VEHICLETYPE ='10W'
                      AND O4 IS NOT NULL
          ...
          $sql_seData2 = "SELECT CUSTOMERCODE,COMPANYCODE,THAINAME,VEHICLETYPE,O4 AS 'OIL',ROW_NUMBER() OVER(ORDER BY VEHICLETRANSPORTPLANID) AS 'TRIP',
                      JOBNO,JOBSTART,VEHICLETRANSPORTPLANID FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] ."' AND CUSTOMERCODE ='TTASTSTC'
                      AND CONVERT(DATE,DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] ."',103) AND CONVERT(DATE,'" . $_GET['dateend'] ."',103)
                      AND (EMPLOYEECODE1 ='".$result_seBillings['EMPLOYEECODE']."' OR  EMPLOYEECODE2 ='".$result_seBillings['EMPLOYEECODE']."')
                      AND VEHICLETYPE ='10W'
                      AND O4 IS NOT NULL
          ...
          ////////////////////////////น้ำมันที่กำหนดไว้งาน10 W /OTHER//////////////////////////////////
          ...
          ////////////////////////////ำมันที่กำหนดไว้งาน 10 W /OTHER AMT //////////////////////////////////
          ...
          ///////////////////ดึงข้อมูล ค่าเฉลี่ยน้ำมันที่กำหนดไว้ 10W AMT //////////////////////////////////////
          ...
          ///////////////////ดึงข้อมูล ค่าเฉลี่ยน้ำมันที่กำหนดไว้ 10W OTHER AMT//////////////////////////////////////
          $sql_seOilavg3 = "SELECT OILAVERAGE AS 'OILAVG' FROM [dbo].[OILAVERAGE]
                      WHERE ACTIVESTATUS ='1'
                      AND COMPANYCODE ='RKR'
                      AND CUSTOMERCODE ='DAIKI'
                      AND VEHICLETYPE IN ('10W','10W(AMT)')";
      ...
      <tr style="border:1px solid #000;" >
        ...
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$i?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seBillings['EMPLOYEECODE']?></b></td>
        <td colspan="4" style="border-right:1px solid #000;padding:3px;text-align:left;"><b><?=$result_seBillings['EMPLOYEENAME']?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seVehicledata['THAINAME']?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seVehicledata['VEHICLETYPE']?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seTrip['TRIP']?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:left;"><b><?=$result_seVehicledata['JOBSTART']?></b></td>
        <!-- 10W/OTHER -->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Mileagestart?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Mileageend?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Distance?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seData['OIL']?></b></td> <!-- น้ำมันที่เติม-->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seOilavg['OILAVG']?></b></td> <!-- ค่าเฉลี่ยที่กำหนด-->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($AvgOil,2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($AvgOver,2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$OilPrice?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($MoneyOil)?></b></td>
        <!-- 10W/STC -->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Mileagestart2?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Mileageend2?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Distance2?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seData2['OIL']?></b></td> <!--น้้ำมันที่เติมงานนอก -->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seOilavg2['OILAVG']?></b></td> <!-- ค่าเฉลี่ยที่กำหนด-->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($AvgOil2,2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($AvgOver2,2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$OilPrice2?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($MoneyOil2)?></b></td>
        <!-- 10W/OTHER AMT -->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Mileagestart3?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Mileageend3?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$Distance3?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seData3['OIL']?></b></td> <!--น้้ำมันที่เติมงานนอก -->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$result_seOilavg3['OILAVG']?></b></td> <!-- ค่าเฉลี่ยที่กำหนด-->
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($AvgOil3,2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($AvgOver3,2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=$OilPrice3?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($MoneyOil3)?></b></td>

        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($result_seData['OIL']+$result_seData2['OIL']+$result_seData3['OIL'],2)?></b></td>
        <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?=number_format($MoneyOil)+number_format($MoneyOil2)+number_format($MoneyOil3)?></b></td>
      </tr>
      <?php
      $i++;
      }
       ...
       <tr style="border:1px solid #000;">
          <td colspan="16" style="border:1px solid #000;padding:3px;text-align:center;"><b><u>รวม<u><b></td>
          <td colspan="2" style="border:1px solid #000;padding:3px;text-align:center;"><b><b></td>
          <td colspan="2" style="border:1px solid #000;padding:4px;text-align:center;"><b><b></td>
          <td colspan="2" style="border:1px solid #000;padding:3px;text-align:center;"><b><b></td>
          <td colspan="2" style="border:1px solid #000;padding:3px;text-align:center;"><b><b></td>
          <td colspan="2" style="border:1px solid #000;padding:4px;text-align:center;"><b><b></td>
          <td colspan="2" style="border:1px solid #000;padding:3px;text-align:center;"><b><b></td>
