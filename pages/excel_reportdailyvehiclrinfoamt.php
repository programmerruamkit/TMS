    ...
    <body>
        <table border="1">
            ...
            <tbody>
                <?php
                $i = 1;
                $sql_getCar = "SELECT DISTINCT a.VEHICLEREGISNUMBER,c.VEHICLETYPEDESC, a.THAINAME, a.ENGNAME,CONVERT(NVARCHAR(10),GETDATE(),103) AS 'SYSDATE'
                                                                    FROM VEHICLEINFO a
                                                                    ...
                                                                    OR a.THAINAME NOT LIKE '%เขาชะเมา%' OR a.THAINAME NOT LIKE '%เฉลิมพระเกียรติ%' OR a.THAINAME NOT LIKE '%P35%' ) AND c.VEHICLETYPEDESC != 'เก๋งสองตอน'";
                $params_getCar = array();
