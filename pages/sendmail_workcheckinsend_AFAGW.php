...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_AFAGW.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("supaporn@ruamkit.co.th");//supaporn@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณสุภาภรณ์ นิสัยดี

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : (Accounting/Finance) แผนก : Accounting
