...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
       <td style="width: 50%;font-size:22px">ลูกค้า บริษัท ไทยโตเคน เทอร์โม จำกัด </td>
       <td style="width: 50%;text-align:right;font-size:22px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:22px">700/314 หมู่ 6 ถ.บางนา-ตราด กม. 57 ตำบลดอนหัวฬ่อ อำเภอเมือง จังหวัดชลบุรี 20000</td>
