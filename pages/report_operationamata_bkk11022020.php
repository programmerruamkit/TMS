                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2" >
                                <label>บริษัท</label>
                                <select class="form-control"  id="cb_company" name="cb_company" onchange="select_operationamata()">
            ...
            <script type="text/javascript">
                                                                                                        function select_operationamata()
                                                                                                        {
                                                                                                            ...
                                                                                                            $.ajax({
                                                                                                                ...
                                                                                                                type: 'POST',
                                                                                                                data: {
                                                                                                                    txt_flg: "select_operationamata", company: document.getElementById("cb_company").value
                                                                                                                },
                                                                                                                success: function (rs) {
