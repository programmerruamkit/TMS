...
$table_header2 = '<table width="100%" >
    <tbody >
       ...
       <tr>
        ...
        <tr>
        	<td colspan="7">เลขประจำตัวผู้เสียภาษี 0105552003135  </td>
       </tr>
       <tr>
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;">
       	  <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ส-004
								<br><br>บริษัท สยามคูโบต้า คอร์ปอเรชั่น จำกัด
							  <br><br>ที่อยู่ 700/867 หมู่ 3 นิคมอุตสาหกรรมอมตะซิตี้ชลบุรี (สาขาที่00001)
								<br><br>ต.หนองกะขะ อ.พานทอง จ.ชลบุรี 20160
								<br><br>โทร. 038-185262
...
while ($result_seBillinginvoice2 = sqlsrv_fetch_array($query_seBillinginvoice2, SQLSRV_FETCH_ASSOC)) {
    $tbody2 .= '<tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seBillinginvoice2['INVOICECODE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seBillinginvoice2['BILLINGDATE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seBillinginvoice2['PAYMENTDATE'] . '</td>
...
<tbody>
<tr style="border:1px solid #000;">
        <td style="border-right:1px solid #000;padding:4px;text-align:center;width:35%"><br /><br /><br /><br />วันนัดชำระเงิน / Payment Date<br /><br /><br />_______/_______/_______</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;width:30%"><br /><br /><br /><hr /><br />ผู้วางบิล / Received By<br /><br /><br />_______/_______/_______</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;width:35%"><br /><br /><br /><hr /><br />ผู้วางบิล / Delivery By<br /><br /><br />_______/_______/_______</td>
    </tr>
    </tbody>
    <tfoot>
    </tfoot>
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    ...
    <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ส-004
            ...
            <br><br>ต.หนองกะขะ อ.พานทอง จ.ชลบุรี 20160
            <br><br>โทร. 038-185262
            <br><br>เลขประจำตัวผู้เสียภาษี 01355503009111
    </td>
        ...
        <br><br> 30 วัน
        <br><br> ' . $result_seBillings['DUEDATE'] . '
        </td>
   </tr>
...
while ($result_seBillinginvoice1 = sqlsrv_fetch_array($query_seBillinginvoice1, SQLSRV_FETCH_ASSOC)) {
    $tbody1 .= '<tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;" height="250px" valign="top">ค่าขนส่งสินค้าตามเอกสารแนบ</td>
...
$tfoot1 = '</tbody>
    ...
    <tr style="border:1px solid #000;">
        <td style="border-right:1px solid #000;padding:4px;text-align:center">รวมเงิน</td>
            <td bgcolor="#CCCCCC" style="border-right:1px solid #000;padding:4px;">' . convert($result_seBillinginvoice['SUMTOTAL']) . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:right;">' . number_format($result_seBillinginvoice['SUMTOTAL'], 2) . '</td>
      </tr>
