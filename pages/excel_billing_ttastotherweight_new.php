 ...
 <!-- //////////////////////////////////////Header Charge 10 ////////////////////////////// -->
  ...
  <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:10;margin-top:8px;">
    ...
    <tbody>
      ...
      //QUERY เดิม ที่ยังไม่ได้แก้ไขการเรียงลำดับ
      $sql_seBilling = "SELECT  ROW_NUMBER() OVER (PARTITION BY a.JOBEND,b.VEHICLETRANSPORTPLANID ORDER BY a.JOBEND,b.VEHICLETRANSPORTPLANID,a.DOCUMENTCODE ASC) AS 'ROWNUM',
          ...
          CONVERT(NVARCHAR,CONVERT(DECIMAL(10,3),CONVERT(DECIMAL(10,3),CONVERT(DECIMAL(10,3),a.WEIGHTIN)) / 1000)) AS 'WEIGHT_TON',
          ...
          AND c.CARRYTYPE ='weight' AND c.WORKTYPE ='other'
		  ...
		  ORDER BY b.VEHICLETRANSPORTPLANID,b.JOBNO,a.JOBEND,a.DOCUMENTCODE ASC";
      $query_seBilling = sqlsrv_query($conn, $sql_seBilling, $params_seBilling);
      while($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)){


          $sql_seSumWeighTrip = "SELECT SUM(CONVERT(DECIMAL(10,3),WEIGHTIN)) AS 'WEIGHTIN_TRIP'
      ...
      ?>
            ...
            ?>
              ...
              <td colspan="" style="border-right:1px solid #000;padding:5px;text-align:center;"><?=$_GET['customercode'] == 'TTASTCS' ? 'CS Wellgrow' : $result_seBilling['FROM']?></td>
            <?php
            }else {
            ?>
              <td colspan="" style="border-right:1px solid #000;padding:5px;text-align:center;"><?=$_GET['customercode'] == 'TTASTCS' ? 'CS Wellgrow' : $result_seBilling['FROM']?></td>
