...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRGMT_Billing.xls";
} else {
  $strExcelFileName = "RKRGMT_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">ลูกค้า บริษัท กรีน เมทัลส์ (ประเทศไทย) จำกัด </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">สาขาที่ 00001 เลขที่ 219/18 หมู่ที่ 6  นิคมฯปิ่นทอง ต.บ่อวิน <br>อ.ศรีราชา จ.ชลบุรี 20230</td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี 0245548000991</td>
