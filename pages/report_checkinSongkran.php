        ...
        <script type="text/javascript">
                                                ...
                                                function select_dailytenkoofficer()
                                                {
                                                    ...
                                                    if (department == '02' && (section == '01' || section == '02')) {
                                                        window.open('excel_reportcheckinSongkran_acc.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                    } else if (department == '03' && section == '03') {
                                                        window.open('excel_reportcheckinSongkran_sq.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                    } else {
                                                        window.open('excel_reportcheckinSongkran.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                ...
                                                function select_pdfdailytenkoofficer()
                                                {
                                                    ...
                                                    if (department == '02' && (section == '01' || section == '02')) {
                                                        window.open('pdf_reportcheckinSongkran_acc.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                    } else if (department == '03' && section == '03') {
                                                        window.open('pdf_reportcheckinSongkran_sq.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                    } else {
                                                        window.open('pdf_reportcheckinSongkran.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
