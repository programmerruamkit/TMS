...
$condTenko1 = " AND a.TENKOMASTERDIRVERCODE = '".$_GET['']."' AND CONVERT(DATE,CREATEDATE) = CONVERT(DATE,GETDATE())";
...
$condTenko2 = " AND a.TENKOMASTERDIRVERCODE = '".$result_seTenko0['employeecode']."'";
