...
WHERE 1 = 1
AND a.COMPANYCODE ='RKS' AND a.CUSTOMERCODE ='NITTSUSHOJI'
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส  ท-017
...
while ($result_seBillinginvoice2 = sqlsrv_fetch_array($query_seBillinginvoice2, SQLSRV_FETCH_ASSOC)) {
  ...
  AND COMPANYCODE='RKS' AND CUSTOMERCODE = 'NITTSUSHOJI' ";
