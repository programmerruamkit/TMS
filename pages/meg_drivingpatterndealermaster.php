...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div class="row" >
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            <i class="fa fa-database"></i> ข้อมูลดีลเลอร์ Driving Pattern
                        </h2>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <label>เพิ่มข้อมูลดีลเลอร์</label>
                        <div class="form-group">
                            <input type="text" class="form-control"    style="background-color: #fffff;height:45px;"  id="txt_dealermaster" name="txt_dealermaster" placeholder="เพิ่มข้อมูลดีลเลอร์" value="">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>&nbsp;</label><br>   
                            <input type="button" style="width:128px;height:45px;" onclick="save_dealer()" name="" id="" value="บันทึกข้อมูล" class="btn btn-primary">
                        </div>
                    </div>
                </div>
                <br>
                                ...
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=1;
                                            $sql_seDetails = "SELECT DEALERMASTERID,DEALER FROM [dbo].[DRIVINGPATTERN_DEALERMASTER]
                                            ...
                                            while ($result_seDetails = sqlsrv_fetch_array($query_seDetails, SQLSRV_FETCH_ASSOC)) {
                                                ...
                                                <tr class="odd gradeX">
                                                    <td><?= $i ?></td>
                                                    <td><?= $result_seDetails['DEALER'] ?></td>
                                                    <td style="text-align: center;"><input type="button"    onclick ="confirm_delete('<?=$result_seDetails['DEALERMASTERID']?>');"       name="btnSend" id="btnSend" value="ลบข้อมูล" class="btn btn-danger"></td>
                                                </tr>
    ...
    <script>
        ...
        function save_dealer()
        {
            ...
            // alert(tenkomasterid);
            // alert(companycode);
            var dealermaster = document.getElementById('txt_dealermaster').value;
            ...
            if (dealermaster == '') {
                ...
                swal.fire({
                    title: "Warning!",
                    text: "ยังไม่ได้ลงข้อมูลดีลเลอร์ !!!",
                    icon: "warning",
                ...
                $.ajax({
                    ...
                    data: {
                        txt_flg: "save_dealermaster",
                        employeecode:'',
                        condition1:dealermaster,
                        condition2:username,
                        condition3:'',
                        condition4:'',
                        condition5:'',
        ...
        function delete_dealermaster(id){
