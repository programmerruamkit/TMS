...
$mpdf = new mPDF('', 'Letter', '', '', 6, 20, 70, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
            <td style="width: 75%;font-size:26px">ลูกค้า บริษัท กรีน เมทัลส์ (ประเทศไทย) จำกัด</td>
            <td style="width: 25%;text-align:right;font-size:26px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:26px">สาขาที่ 00001 เลขที่ 219/18 หมู่ที่ 6  นิคมฯปิ่นทอง 3 ต.บ่อวิน อ.ศรีราชา จ.ชลบุรี 20230</td>
            <td style="width: 25%;text-align:right;font-size:26px">วันที่ ' . $result_seInvoicecode['DULYDATE'] . '</td>
        </tr>
        <tr>
            <td style="width: 100%;font-size:26px">เลขประจำตัวผู้เสียภาษี  0245548000991</td>
        </tr>
    </tbody>
</table>';
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    if (($result_seBilling['DATE_VLIN'] == $holidaysplit[0]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[1]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[2]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[3]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[4])) {
      ...
      <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . (substr($result_seBilling['DOCUMENTCODE'],0,3) == 'L17' ? ' ' : $result_seBilling['DOCUMENTCODE'] )  . '</font></td>
        ...
        <tr style="border:1px solid #000;">
          ...
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['DATE_VLIN'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">'. (substr($result_seBilling['DOCUMENTCODE'],0,3) == 'L17' ? ' ' : $result_seBilling['DOCUMENTCODE'] ) . '<br>Holiday</td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['THAINAME'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seEmployeeehr['FnameT'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['JOBSTART'] . '</font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px">' . $result_seBilling['JOBEND'] . '</font></td>
