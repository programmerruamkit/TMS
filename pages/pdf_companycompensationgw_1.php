...
$table_begin = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:12;">';
...
$thead = '<thead>
     <tr style="border:1px solid #000;" >
       ...
       <tr style="border:1px solid #000;background-color: #ccc" >
            ...
            <td rowspan="2" colspan="7" style="border-right:1px solid #000;padding:3px;text-align:center;">
            <b>พนักงานขับรถ</b>
            </td>
       ...
       <tr style="border:1px solid #000;background-color: #ccc" >
        <td style="border-right:1px solid #000;padding:3px;text-align:center;"><b>1-15</b></td>
...
$sql_sePlan = "SELECT *, ROW_NUMBER() OVER(ORDER BY EMPLOYEECODE) AS 'ROWNUM' FROM (
                ...
                WHERE CONVERT(DATE,DATEDEALERIN) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_seGetdate['dateend'] . "',103)
                AND COMPANYCODE = '" . $_GET['companycode'] . "' AND EMPLOYEECODE1 IS NOT NULL AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE != ''
                UNION
                SELECT DISTINCT EMPLOYEECODE2 AS 'EMPLOYEECODE',EMPLOYEENAME2 AS 'EMPLOYEENAME' FROM [dbo].[VEHICLETRANSPORTPLAN]
                WHERE CONVERT(DATE,DATEDEALERIN) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_seGetdate['dateend'] . "',103)
                AND COMPANYCODE = '" . $_GET['companycode'] . "' AND EMPLOYEECODE2 IS NOT NULL AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE != ''
              ) a
...
//////////////////////////////แผนวิ่งงาน/////////////////////////////////////////////////
$sql_sePlan15 = "SELECT COUNT(*) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN]
                WHERE CONVERT(DATE,DATEDEALERIN) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'15/" . $_GET['datestart'] . "',103)
...
$sql_sePlan30 = "SELECT COUNT(*) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN]
      WHERE CONVERT(DATE,DATEDEALERIN) BETWEEN CONVERT(DATE,'16/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_seGetdate['dateend'] . "',103)
      AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "' )
      AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
...
$sql_sePlanpallet15 = "SELECT SUM(CONVERT(INT,a.TRIPAMOUNT_PALLET)) AS 'CNTPALLET' FROM [dbo].[VEHICLETRANSPORTDOCUMENTDIRVERPALLET] a
    ...
    AND CONVERT(DATE,b.DATEDEALERIN) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'15/" . $_GET['datestart'] . "',103)
...
$sql_sePlanpallet30 = "SELECT SUM(CONVERT(INT,a.TRIPAMOUNT_PALLET)) AS 'CNTPALLET' FROM [dbo].[VEHICLETRANSPORTDOCUMENTDIRVERPALLET] a
    INNER JOIN [dbo].[VEHICLETRANSPORTPLAN] b ON a.[VEHICLETRANSPORTPLANID] = b.[VEHICLETRANSPORTPLANID]
    WHERE (a.DOCUMENTCODE_PALLET IS NOT NULL AND a.DOCUMENTCODE_PALLET != '')
    AND CONVERT(DATE,b.DATEDEALERIN) BETWEEN CONVERT(DATE,'16/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_seGetdate['dateend'] . "',103)
    AND (a.EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  a.EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')";
...
//                 INNER JOIN [dbo].[VEHICLETRANSPORTPLAN] b ON a.[VEHICLETRANSPORTPLANID] = b.[VEHICLETRANSPORTPLANID]
//                 WHERE CONVERT(DATE,b.DATEDEALERIN) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'15/" . $_GET['datestart'] . "',103)
...
// FROM [dbo].[VEHICLETRANSPORTDOCUMENTDIRVER] a
// INNER JOIN [dbo].[VEHICLETRANSPORTPLAN] b ON a.[VEHICLETRANSPORTPLANID] = b.[VEHICLETRANSPORTPLANID]
// WHERE CONVERT(DATE,b.DATEDEALERIN) BETWEEN CONVERT(DATE,'16/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_seGetdate['dateend'] . "',103)
// AND b.COMPANYCODE = '" . $_GET['companycode'] . "' AND b.EMPLOYEECODE1 IS NOT NULL
// AND b.EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "'
// AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE !='' ";
...
$result_sePosName = sqlsrv_fetch_array($query_sePosName, SQLSRV_FETCH_ASSOC);
    ...
    <tr style="border:1px solid #000;" >
            ...
            <td colspan = "7" style="border-right:1px solid #000;padding:3px;text-align:left;" >' . $result_sePlan['EMPLOYEENAME'] . '</td>
            ...
            <td colspan="4" style="border-right:1px solid #000;padding:3px;text-align:left;">-</td>
