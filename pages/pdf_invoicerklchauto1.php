...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td style="width: 50%;">บริษัท ซี เอช โอโตพาร์ต จำกัด </td>
            <td style="width: 50%;text-align:right">เลขที่ ' . $result_seInvoice['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 70%;">สำนักงานใหญ่ ที่อยู่  127 หมู่ที่ 2 ซ.วัดสวนส้ม ถ.ปู่เจ้าสมิงพราย ต.สำโรงใต้ <br>อ.พระประแดง จ.สมุทรปราการ 10130</td>
            <td style="width: 30%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . '</td>
       </tr>

       <tr>
            <td style="width: 50%;">โทร. 0-2754-2351-6  โทรสาร. 0-2183-3275</td>
