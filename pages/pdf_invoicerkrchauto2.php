...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส ซ-002
            <br>บริษัท ซี เอช โอโตพาร์ต จำกัด
            <br>สำนักงานใหญ่ ที่อยู่ 127 หมู่ที่ 2 ซ.วัดสวนส้ม ถ.ปู่เจ้าสมิงพราย ต.สำโรงใต้ 
            <br>อ.พระประแดง จ.สมุทรปราการ 10130
            <br>โทร. 0-2754-2351-6 โทรสาร. 0-2183-3275
      </td>
  ...
  if ($holiday !='') {
    ...
    if ($holidaysplit[0] !='') {
      $sql_seCount0 = " SELECT COUNT(VEHICLETRANSPORTPLANID) AS 'COUNT_HOLIDAY0' 
        ...
        WHERE COMPANYCODE ='RKR' AND CUSTOMERCODE ='CH-AUTO'
...
<tbody>
    ...
    <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ซ-002
          ...
          <br>อ.พระประแดง จ.สมุทรปราการ 10130
          <br>โทร.0-2754-2351-6 โทรสาร. 0-2183-3275
          <br>เลขประจำตัวผู้เสียภาษี 0105516007011
    </td>
