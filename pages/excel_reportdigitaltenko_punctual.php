...
if ($_GET['datestart'] == "" || $_GET['dateend'] == "") {
    $strExcelFileName = "รายงาน Punctuality Detail_".$adddate.".xls";
} else {
    $strExcelFileName = "รายงาน Punctuality Detail" . $_GET['datestart'] . ' ถึง ' . $_GET['dateend'] . ".xls";
}
...
<html>
    ...
    <body>
      <table border="0" width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example1" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
        <thead>
          <tr>
            <th colspan ="34" bgcolor="#CCCCCC" style="text-align: left;border:1px solid #000;padding:4px;" ><h3>Punctuality Result for <?=$month;?> <?=$years;?></h3></th>
          </tr>
          <tr>
            <td colspan="34"></td>
          </tr>
          <tr>
            <td colspan="34"><h4><b>1. Departure Time Truck Yard</b></h4></td>
          </tr>
          <tr>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">No.</th>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">HOP</th>
            <th colspan="31"bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">Daily</th>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">Total</th>
          </tr>
          <tr>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">1</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">2</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">3</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">4</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">5</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">6</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">7</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">8</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">9</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">10</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">11</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">12</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">13</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">14</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">15</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">16</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">17</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">18</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">19</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">20</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">21</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">22</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">23</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">24</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">25</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">26</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">27</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">28</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">29</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">30</td>
            <td colspan="1" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">31</td>
          </tr>
        </thead>
        <tbody>
          <!-- Delay -->
          <tr>
              ...
              ?>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><b>1</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #c1e8ff"><b>Delay</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seYARD_DELAY['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMYARD_DELAY;?></b></td>
          </tr>
          <!-- Advance -->
          <tr>
              <!-- QueryData Advance-->
              ...
              ?>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><b>2</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #fff0aa"><b>Advance</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seYARD_ADVANCE['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMYARD_ADVANCE;?></b></td>
          </tr>
          <!-- On time -->
          <tr>
              <!-- QueryData On time -->
              ...
              ?>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><b>3</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #acffaa"><b>On time</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seYARD_ONTIME['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMYARD_ONTIME;?></b></td>
          </tr>
          <!-- Sum Total -->
          <tr>
              <?php 
      ...
      <table border="0" width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example1" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
        <thead>
          <tr>
            <td colspan="34"><h4><b>2. Arrival Time Supplier</b></h4></td>
          </tr>
          <tr>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">No.</th>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">HOP</th>
        ...
        <tbody>
          ...
          <tr>
              ...
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><b>1</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #c1e8ff"><b>Delay</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_seSUPPLIER_DELAY['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMSUPPLIER_DELAY;?></b></td>
          </tr>
          <!-- Advance -->
          <tr>
              <!-- QueryData Advance-->
              ...
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><b>2</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #fff0aa"><b>Advance</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_seSUPPLIER_ADVANCE['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMSUPPLIER_ADVANCE;?></b></td>
          </tr>
          <!-- On time -->
          <tr>
              <!-- QueryData On time -->
              ...
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><b>3</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #acffaa"><b>On time</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_seSUPPLIER_ONTIME['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMSUPPLIER_ONTIME;?></b></td>
          </tr>
          <!-- Sum Total -->
          <tr>
              <?php 
      ...
      <table border="0" width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example1" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
        <thead>
          <tr>
            <td colspan="34"><h4><b>3. Arrival Time Plant</b></h4></td>
          </tr>
          <tr>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">No.</th>
            <th rowspan="2" bgcolor="#CCCCCC" style="text-align: center;border:1px solid black;">HOP</th>
        ...
        <tbody>
          ...
          <tr>
              ...
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><b>1</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #c1e8ff"><b>Delay</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #c1e8ff"><?=$result_sePLANT_DELAY['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMPLANT_DELAY;?></b></td>
          </tr>
          <!-- Advance -->
          <tr>
              <!-- QueryData Advance-->
              ...
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><b>2</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #fff0aa"><b>Advance</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #fff0aa"><?=$result_sePLANT_ADVANCE['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMPLANT_ADVANCE;?></b></td>
          </tr>
          <!-- On time -->
          <tr>
              <!-- QueryData On time -->
              ...
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><b>3</b></td>
              <td style="border:1px solid black;text-align: left;background-color: #acffaa"><b>On time</b></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE1'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE2'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE3'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE4'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE5'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE6'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE7'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE8'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE9'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE10'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE11'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE12'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE13'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE14'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE15'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE16'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE17'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE18'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE19'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE20'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE21'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE22'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE23'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE24'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE25'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE26'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE27'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE28'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE29'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE30'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #acffaa"><?=$result_sePLANT_ONTIME['DATE31'];?></td>
              <td style="border:1px solid black;text-align: center;background-color: #ffbcee"><b><?=$SUMPLANT_ONTIME;?></b></td>
          </tr>
          <!-- Sum Total -->
          <tr>
              <?php 
