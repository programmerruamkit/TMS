    ...
    <body>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <script type="text/javascript">
                                                                ...
                                                                function drawChart() {
                                                                        ...
                                                                        ['Day', 'SYS (ความดันบน)', 'DIA (ความดันล่าง)','MaxStd.บน(<?=$result_seTenkoSTD['MAXSYS']?>)','MinStd.บน(<?=$result_seTenkoSTD['MINSYS']?>)','MaxStd.ล่าง(<?=$result_seTenkoSTD['MAXDIA']?>)','MinStd.ล่าง(<?=$result_seTenkoSTD['MINDIA']?>)','Avg.บน','Avg.ล่าง'],
                                                                        ['<?= $result_seAdddateweek['D1'] ?>', <?=$SYSDAY1?>, <?=$DIADAY1?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?>  ],
                                                                        ['<?= $result_seAdddateweek['D2'] ?>', <?=$SYSDAY2?>, <?=$DIADAY2?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D3'] ?>', <?=$SYSDAY3?>, <?=$DIADAY3?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D4'] ?>', <?=$SYSDAY4?>, <?=$DIADAY4?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D5'] ?>', <?=$SYSDAY5?>, <?=$DIADAY5?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D6'] ?>', <?=$SYSDAY6?>, <?=$DIADAY6?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D7'] ?>', <?=$SYSDAY7?>, <?=$DIADAY7?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D8'] ?>', <?=$SYSDAY8?>, <?=$DIADAY8?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D9'] ?>', <?=$SYSDAY9?>, <?=$DIADAY9?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D10'] ?>', <?=$SYSDAY10?>, <?=$DIADAY10?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D11'] ?>', <?=$SYSDAY11?>, <?=$DIADAY11?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D12'] ?>', <?=$SYSDAY12?>, <?=$DIADAY12?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D13'] ?>', <?=$SYSDAY13?>, <?=$DIADAY13?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D14'] ?>', <?=$SYSDAY14?>, <?=$DIADAY14?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D15'] ?>', <?=$SYSDAY15?>, <?=$DIADAY15?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D16'] ?>', <?=$SYSDAY16?>, <?=$DIADAY16?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D17'] ?>', <?=$SYSDAY17?>, <?=$DIADAY17?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D18'] ?>', <?=$SYSDAY18?>, <?=$DIADAY18?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D19'] ?>', <?=$SYSDAY19?>, <?=$DIADAY19?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D20'] ?>', <?=$SYSDAY20?>, <?=$DIADAY20?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D21'] ?>', <?=$SYSDAY21?>, <?=$DIADAY21?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D22'] ?>', <?=$SYSDAY22?>, <?=$DIADAY22?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D23'] ?>', <?=$SYSDAY23?>, <?=$DIADAY23?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D24'] ?>', <?=$SYSDAY24?>, <?=$DIADAY24?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D25'] ?>', <?=$SYSDAY25?>, <?=$DIADAY25?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D26'] ?>', <?=$SYSDAY26?>, <?=$DIADAY26?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D27'] ?>', <?=$SYSDAY27?>, <?=$DIADAY27?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D28'] ?>', <?=$SYSDAY28?>, <?=$DIADAY28?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D29'] ?>', <?=$SYSDAY29?>, <?=$DIADAY29?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D30'] ?>', <?=$SYSDAY30?>, <?=$DIADAY30?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ],
                                                                        ['<?= $result_seAdddateweek['D31'] ?>', <?=$SYSDAY31?>, <?=$DIADAY31?>,<?=$result_seTenkoSTD['MAXSYS']?>,<?=$result_seTenkoSTD['MINSYS']?>,<?=$result_seTenkoSTD['MAXDIA']?>,<?=$result_seTenkoSTD['MINDIA']?>,<?=$SYSAVG?>,<?=$DIAAVG?> ]
                                                                    ]);
        ...
        <script>
            ...
            function check_graph()
            {
                ...
                // alert(months);
                // alert(employeecode);
                window.open('meg_driverdatagraph_checkprint_amt.php?months=' + months + '&employeecode=' + employeecode, '_blank');
            ...
            function select_graph()
            {
                ...
                if (monthchk == '') {
                    ...
                    window.open('meg_driverdatagraph_check_amt.php?months=' + months + '&employeecode=' + employeecode, '_blank');
                }
