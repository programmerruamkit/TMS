...
$mpdf = new mPDF('', 'Letter', '', '', 6, 15, 85, 5, 5, 10);
$style = '
<style>
	body{
...
$thead3 = '<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 15%;"><b><font style="font-size: 24px">วันที่</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 20%;"><b><font style="font-size: 24px">หมายเลข DO</font></b></td>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 16%;"><b><font style="font-size: 24px">จำนวนเงิน(บาท)</font></b></td>
      </tr>
    </thead><tbody>';
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    if (($result_seBilling['DATE_VLIN'] == $holidaysplit[0]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[1]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[2]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[3]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[4])) {
      ...
      <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:left;"><font style="font-size: 24px">' . $result_seBilling['VEHICLETYPE'] . '</font></td>
