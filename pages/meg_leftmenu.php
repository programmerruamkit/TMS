...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            <?php
            $condition1 = ($_SESSION["EMPLOYEEID"] != "") ? " AND e.EMPLOYEEID = " . $_SESSION["EMPLOYEEID"] . " AND d.ROLENAME = '" . $_SESSION["ROLENAME"] . "'  " : " AND a.EMPLOYEEID = ''";
	
			//อันเดิม 05.10.67
            // $condition1 = ($_SESSION["EMPLOYEEID"] != ผ"") ? " AND e.EMPLOYEEID = " . $_SESSION["EMPLOYEEID"] . " AND d.ROLENAME = '" . $_SESSION["ROLENAME"] . "'  " : " AND a.EMPLOYEEID = 'ไม่มีข้อมูล'";
                        ...
                        <li>
                            ...
                            if ($result_chkSubmenu['SUBMENUNAME'] != "") {
                                while ($result_seSubmenu = sqlsrv_fetch_array($query_seSubmenu, SQLSRV_FETCH_ASSOC)) {
									if($result_seSubmenu['SUBMENUNAME']=='ประวัติซ่อมบำรุง')
									{
										?>
                                    <a href="http://61.91.5.110:81/pages/meg_repairhistory.php" target="_blank"><i class="glyphicon glyphicon-minus"></i>&nbsp;<?= $result_seSubmenu['SUBMENUNAME'] ?></a>
                                    <?php
									}
									else
									{
