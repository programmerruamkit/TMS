...
if ($_GET['area'] == 'amata') {
    ...
    $params_sePhysical1_1 = array(
        array('select_alcohol', SQLSRV_PARAM_IN),
    ...
    $params_sePhysicalng1_1 = array(
        array('select_alcoholng', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
...
<figure class="highcharts-figure">
    <table style="width: 100%;font-size: 12px">
        <tbody>
            <tr>
                <td colspan="4">
                    <h3 style="text-align: center">< แอลกอฮอล์ Alcohol > <?= $result_seSystime['MMYYY'] ?></h3>
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เพื่อตรวจสอบแอลกอฮอล์ของพนักงานขับรถ ให้พร้อมกับการทำงาน
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : To check Alcohol of driver for Ready to Work on today.
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : ค่าของแอลกอฮอล์ต้องเป็น 0 เท่านั้น
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เครื่องมือตรวจสอบแอลกอฮอล์ (แบบเป่า) และใบเท็นโกะ
                </td>
                <td style="width: 10%">
                    เวลาปรับข้อมูล
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Tool Check Alcohol and TENKO sheet.
                </td>
                <td style="width: 10%">
                    Time Adjust data
                </td>
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 80%">
                   : 1.งดมอบหมายงาน,ให้พนักงานขับรถพักแล้วเป่าแอลกอฮอล์จนกระทั่งเป็น 0 และให้กลับ้านไปพักผ่อน
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    Stop work,Rest at company untill Alcohol = 0 and Go home for Rest.
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                   : 2. แนะนำถึงความเสี่ยงหรืออุบัติเหตุที่อาจเกิดขึ้น พร้อมทังผลกระทบ
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    Instruct risk or accident to driver and effect to him,family company.
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    Record data and Found problem again,Make Notice.
                </td>
