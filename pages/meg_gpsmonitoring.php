                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-primary"  onclick="select_gpsmonitoring();">ค้นหา <li class="fa fa-search"></li></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
                                        ...
                                        function select_gpsmonitoring(){
                                            ...
                                            $.ajax({
                                                ...
                                                type: 'POST',
                                                data: {
                                                    txt_flg: "select_gpsmonitoring", companycode: companycode
                                                },
                                                success: function (rs) {
                                                    // hideLoading();
