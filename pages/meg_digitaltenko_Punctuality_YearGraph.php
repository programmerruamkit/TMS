...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="panel-body">                            
                                <div class="col-lg-12" style="text-align: center;">
                                    ...
                                    <div style="align: center;">                                    
                                            <button type="button" name="export_year_graph_punctual_pdf" id="export_year_graph_punctual_pdf" onclick ="export_year_graph_punctual_pdf();" class="btn btn-success btn-lg">Export Graph To PDF</button>
                                    </div>    
                                </div>     
        ...
        <script>
            ...
            function export_year_graph_punctual_pdf()
            {
               ...
               var years = document.getElementById('txt_years').value;
                // alert(months);
                // alert(employeecode);
                window.open('meg_digitaltenko_Punctuality_YearGraphPrint.php?monthnumeric=' + monthnumeric + '&month=' + month+ '&years=' + years, '_blank');
            }
    </script>
