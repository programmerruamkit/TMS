...
$thead = '<thead>
                ...
                <tr style="border:1px solid #000;background-color: #ccc" >
                    <td style="border-right:1px solid #000;padding:3px;text-align:center;" colspan="11"><b>เดือน มิถุนายน วันที่  01/' . $_GET['datestart'] . '  ถึง ' . $result_getDate['ENDMONTH'] . '/' . $_GET['datestart'] . '</b></td>
                </tr>
                <tr style="border:1px solid #000;background-color: #ccc" >
...
while ($result_seEmp = sqlsrv_fetch_array($query_seEmp, SQLSRV_FETCH_ASSOC)) {
    $sql_seCnt1E1 = "SELECT COUNT(EMPLOYEECODE1) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
    ...
    $sql_seCnt1E2 = "SELECT COUNT(EMPLOYEECODE2) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'10/" . $_GET['datestart'] . "',103) 
    ...
    $sql_seCnt2E1 = "SELECT SUM(CONVERT(INT,E1)) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'10/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE1 = '" . $result_seEmp['EMPLOYEECODE1'] . "' )";
    ...
    $sql_seCnt2E2 = "SELECT SUM(CONVERT(INT,E2)) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'10/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE2 = '" . $result_seEmp['EMPLOYEECODE1'] . "')";
    ...
    /////////////////////
    $sql_seCnt3E1 = "SELECT COUNT(EMPLOYEECODE1) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
    ...
    $sql_seCnt3E2 = "SELECT COUNT(EMPLOYEECODE2) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'11/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'20/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE2 = '" . $result_seEmp['EMPLOYEECODE1'] . "')";
    ...
    $sql_seCnt4E1 = "SELECT SUM(CONVERT(INT,E1)) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'11/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'20/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE1 = '" . $result_seEmp['EMPLOYEECODE1'] . "' )";
    ...
    $sql_seCnt4E2 = "SELECT SUM(CONVERT(INT,E2)) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'11/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'20/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE2 = '" . $result_seEmp['EMPLOYEECODE1'] . "')";
    ...
    /////////////////////
    $sql_seCnt5E1 = "SELECT COUNT(EMPLOYEECODE1) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
    ...
    $sql_seCnt5E2 = "SELECT COUNT(EMPLOYEECODE2) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'21/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_getDate['ENDMONTH'] . "/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE2 = '" . $result_seEmp['EMPLOYEECODE1'] . "')";
    ...
    $sql_seCnt6E1 = "SELECT SUM(CONVERT(INT,E1)) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'21/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_getDate['ENDMONTH'] . "/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE1 = '" . $result_seEmp['EMPLOYEECODE1'] . "' )";
    ...
    $sql_seCnt6E2 = "SELECT SUM(CONVERT(INT,E2)) AS 'CNT' FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE ACTIVESTATUS = 1 AND COMPANYCODE = 'RCC'
                    AND CONVERT(DATE,DATERK,103) BETWEEN CONVERT(DATE,'21/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_getDate['ENDMONTH'] . "/" . $_GET['datestart'] . "',103) 
                    AND (EMPLOYEECODE2 = '" . $result_seEmp['EMPLOYEECODE1'] . "')";
...
$table_footer = '<table style="width: 50%;border:1px solid #000">
            <tbody>
                <tr style="border:1px solid #000;">
