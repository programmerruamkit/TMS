...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSNITSUSHOJI_Billing.xls";
} else {
  $strExcelFileName = "RKSNITSUSHOJI_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      ...
      <tr>
       ...
       <tr>
            <td style="width: 70%;font-size:20px">เลขประจำตัวผู้เสียภาษี 0205560011540</td>
