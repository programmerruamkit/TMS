...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;">
       	  <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ก-002
								<br>บริษัท กรีน เมทัลส์ (ประเทศไทย) จำกัด
								<br>สาขาที่ 00001 เลขที่ 219/18 หมู่ที่ 6 นิคมฯปิ่นทอง
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;" >
        <td style="border-right:1px solid #000;padding:4px;width:70%" rowspan="4">ลูกค้า : รหัส ก-002
								<br>บริษัท กรีน เมทัลส์ (ประเทศไทย) จำกัด
								<br>สาขาที่ 00001 เลขที่ 219/18 หมู่ที่ 6 นิคมฯปิ่นทอง
								<br>ต.บ่อวิน อ.ศรีราชา จ.ชลบุรี 20230
								<br>โทร.038-575-557
