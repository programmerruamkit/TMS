...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  ...
  $strExcelFileName = "RKRYNP_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">ลูกค้า บริษัท ยานภัณฑ์ จำกัด (มหาชน) (สาขาที่ 00003)  </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">ที่อยู่ 3 หมู่ที่ 7  ถ.กิ่งแก้ว-ลาดกระบัง ต.ราชาเทวะ อ.บางพลี จ.สมุทรปราการ 10540  </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี  0107547000168</td>
