...
<html lang="en">
    ...
    <body>
            ...
            <div id="page-wrapper" style="color: #666">
                ...
                <div  id="testing" style="text-align: center;">
                    ...
                    <div class="panel-heading" style="text-align: center;">
                        <h2 class="page-header"><i class="fa fa-bar-chart-o fa-fw"></i>  
                             KPI Data Graph&nbsp;&nbsp; (Stop Call Wait)&nbsp;&nbsp; Years:&nbsp;<b><?=$years?></b></b>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="col-lg-12" style="text-align: center;">   
                                    <form method="post" id="make_pdf" action="create_stopcallwaitkpipdf.php?years='<?=$years?>'"  target="_blank">
                                        <input type="hidden" name="hidden_html" id="hidden_html" ></input>
                                        <button type="button" name="create_stopcallwaitkpipdf" id="create_stopcallwaitkpipdf"   class="btn btn-success btn-lg">Export PDF</button>
                                    </form>
                            </div>
        ...
        <script>
            ...
            function autoclick() {
                document.getElementById("create_stopcallwaitkpipdf").click(function(){
            ...
            $(document).ready(function(){
                $('#create_stopcallwaitkpipdf').click(function(){
                $('#hidden_html').val($('#testing').html());
                $('#make_pdf').submit();
                });
            });
