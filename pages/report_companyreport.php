                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #e7e7e7">
                                ...
                                <?php
                                    ...
                                    echo "บริษัท";
                                    $link = "<a href='report_companyreport.php?type=report'>บริษัท</a>";
                                    $_SESSION["link"] = $link;
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                              <?php
                                                ...
                                                {
                                                    $cond = " AND Company_Code IN ('RRC','RATC','RCC')";
                                                }
                                                else
                                                {
                                                    $cond = " AND Company_Code IN ('RKS','RKR','RKL')";
                                                }
                                                ...
                                                while ($result_seCompany = sqlsrv_fetch_array($query_seCompany, SQLSRV_FETCH_ASSOC)) {
                                                    ...
                                                    ?>
                                            <tr>
                                                <td><?=$result_seCompany['Company_NameT']?></td>
                                              ...
                                              <td style="text-align: center">
                                                  <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu slidedown">
                                                                    ...
                                                                    <li>
                                                                        <a href="report_customerreport.php?companycode=<?=$result_seCompany['Company_Code']?>">เลือกลูกค้า</a>
                                                                    </li>
