<?php
    ...
    if($LINEOFWORK!=""){
        if($LINEOFWORK == 'CS'){
            ...
            $QUERYWHERE1="EHR.PositionNameT LIKE '%KUBOTA%' AND NOT (EHR.PositionNameT LIKE 'พนักงานขับรถ/ปลอกเขียว' OR EHR.PositionNameT LIKE 'พนักงานขับรถ/ปลอกเหลือง')";
            $SHOW='KUBOTA';
        }else if($LINEOFWORK == 'TTDK'){
            $QUERYWHERE1="EHR.PositionNameT LIKE '%TGT%' AND NOT (EHR.PositionNameT LIKE 'พนักงานขับรถ/ปลอกเขียว' OR EHR.PositionNameT LIKE 'พนักงานขับรถ/ปลอกเหลือง')";
            $SHOW='TGT';
            ...
            $QUERYWHERE1="NOT ( 
                EHR.PositionNameT LIKE '%CS%' OR 
                EHR.PositionNameT LIKE '%STC%' OR 
                EHR.PositionNameT LIKE '%TTAST%' OR 
        ...
        $QUERYWHERE1="EHR.PositionNameT LIKE '%พนักงานขับรถ%'";
    }   
    ...
    //         $resultArray = array();
    //         while ($RESULTEMP = sqlsrv_fetch_array($QUERYEMP, SQLSRV_FETCH_ASSOC)) {
    //             array_push($resultArray,$RESULTEMP);
    //         }
    //         sqlsrv_close($conn);
    //         return $resultArray;
    //     }else{
                ...
                <tbody>
                    <?php                       
                        ...
                        if($LINEOFWORK == 'OTHER'){ 
                            ...
                            WHERE (VHCTPP.EMPLOYEENAME1 = '$EMPN' OR VHCTPP.EMPLOYEENAME2 ='$EMPN') 
                            AND CONVERT(VARCHAR (10),VHCTPP.DATEWORKING,20) BETWEEN '$start[2]-$start[1]-01' AND '$end[2]-$end[1]-31'";
                            ...
                            WHERE (VHCTPPDTE.EMPLOYEENAME1= '$EMPN' OR VHCTPPDTE.EMPLOYEENAME2= '$EMPN') AND VHCTPPDTE.C3 IS NOT NULL 
                            ...
                            $SQLRDAY="SELECT DISTINCT A.PersonCode, 		
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-01') AS C3DAY01PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-01') AS C3DAY01MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-02') AS C3DAY02PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-02') AS C3DAY02MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-03') AS C3DAY03PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-03') AS C3DAY03MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-04') AS C3DAY04PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-04') AS C3DAY04MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-05') AS C3DAY05PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-05') AS C3DAY05MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-06') AS C3DAY06PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-06') AS C3DAY06MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-07') AS C3DAY07PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-07') AS C3DAY07MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-08') AS C3DAY08PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-08') AS C3DAY08MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-09') AS C3DAY09PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-09') AS C3DAY09MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-10') AS C3DAY10PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-10') AS C3DAY10MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-11') AS C3DAY11PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-11') AS C3DAY11MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-12') AS C3DAY12PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-12') AS C3DAY12MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-13') AS C3DAY13PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-13') AS C3DAY13MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-14') AS C3DAY14PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-14') AS C3DAY14MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-15') AS C3DAY15PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-15') AS C3DAY15MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-16') AS C3DAY16PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-16') AS C3DAY16MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-17') AS C3DAY17PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-17') AS C3DAY17MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-18') AS C3DAY18PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-18') AS C3DAY18MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-19') AS C3DAY19PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-19') AS C3DAY19MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-20') AS C3DAY20PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-20') AS C3DAY20MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-21') AS C3DAY21PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-21') AS C3DAY21MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-22') AS C3DAY22PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-22') AS C3DAY22MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-23') AS C3DAY23PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-23') AS C3DAY23MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-24') AS C3DAY24PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-24') AS C3DAY24MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-25') AS C3DAY25PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-25') AS C3DAY25MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-26') AS C3DAY26PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-26') AS C3DAY26MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-27') AS C3DAY27PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-27') AS C3DAY27MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-28') AS C3DAY28PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-28') AS C3DAY28MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-29') AS C3DAY29PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-29') AS C3DAY29MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-30') AS C3DAY30PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-30') AS C3DAY30MINUS,
                                (SELECT SUM(ISNULL(CAST(C3PLUS AS DECIMAL(6,0)),0)) C3PLUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3PLUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-31') AS C3DAY31PLUS,
                                (SELECT SUM(ISNULL(CAST(C3MINUS AS DECIMAL(6,0)),0)) C3MINUS FROM TEMP_RPAVGDAY WHERE PersonCode = A.PersonCode AND C3MINUS IS NOT NULL AND CONVERT ( VARCHAR ( 10 ), DATEWORKING, 20 ) = '$start[2]-$start[1]-31') AS C3DAY31MINUS
                                FROM TEMP_RPAVGDAY A WHERE A.PersonCode = '$EMPC'";
