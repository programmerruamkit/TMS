...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_AA.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("thitirat@ruamkit.co.th");//thitirat@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณฐิติรัตน์ จิตรานุรักษ์สกุล

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Administration แผนก : Administration
