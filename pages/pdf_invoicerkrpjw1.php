...
$mpdf = new mPDF('', 'Letter', '', '', 5, 10, 80, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 110%;">
    ...
    <tbody><br><br><br>
        <tr>
            <td colspan="48" style="width: 70%;font-size:22px">บริษัท ร่วมกิจรุ่งเรือง (1993) จำกัด (RUAMKIT RUNGRUENG (1993) CO.,LTD.)</td>
       </tr>
       <tr>
       ...
       <tr>
            <td colspan="48" style="font-size:22px" >เลขประจำตัวผู้เสียภาษี : 0105536076131</td>
       </tr>
       <tr>
            <td colspan="48">&nbsp;</td>
       </tr>
       ...
       <tr>
            <td colspan="45" style="text-align:left;font-size:22px">ลูกค้า บริษัท พีเจดับเบิ้ลยู ออโต้อีวี จำกัด (มหาชน)</td>
            <td colspan="20" style="text-align:right;font-size:22px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td colspan="45" style="text-align:left;font-size:22px">สาขาที่ 00002 ที่อยู่ 150/62 หมู่ที่ 9 ต.หนองขาม  <br>อ.ศรีราชา จ.ชลบุรี 20230</td>
            <td colspan="20" style="text-align:right;font-size:22px">วันที่ ' . $result_seduedate['DUEDATE'] . '</td>
       </tr>
       <tr>
            <td colspan="45" style="font-size:22px">เลขประจำตัวผู้เสียภาษี 0107565000603</td>
       </tr>
    </tbody>
</table>';
...
$thead3 = '<thead>
        ...
        <td   style="border-right:1px solid #000;padding:14px;text-align:center;width: 25%;font-size:50px"><b>ประเภทรภ</b></td>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    $holidaysplit = explode(",", $holiday);
      ...
      if (($result_seBilling['DATEVLIN_103'] == $holidaysplit[0]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[1]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[2]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[3]) || ($result_seBilling['DATEVLIN_103'] == $holidaysplit[4])) {
        ...
        <td style="border-right:1px solid #000;padding:17px;text-align:center;width: 25%;font-size:48px">10W</td>
        ...
        <td style="border-right:1px solid #000;padding:17px;text-align:center;width: 15%;font-size:48px">1</td>
