                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background-color: #e7e7e7">
                                ...
                                <?php
                                    ...
                                    echo "บริษัท";
                                    $link = "<a href='report_companybillinggetway.php?type=report'>บริษัท</a>";
                                    $_SESSION["link"] = $link;
                                ...
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>ร่วมกิจรุ่งเรือง คาร์ แคริเออร์</td>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customerbillinggetway.php?type=customer&meg=report&companycode=RCC">เลือกลูกค้า</a>
                                                            </li>
                                            ...
                                            <tr>
                                                ...
                                                <td>ร่วมกิจ ออโตโมทีฟ ทรานสปอร์ต</td>
                                                ...
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customerbillinggetway.php?type=customer&meg=report&companycode=RATC">เลือกลูกค้า</a>
                                                            </li>
                                            ...
                                            <tr>
                                                ...
                                                <td>ร่วมกิจ รีไซเคิล แคริเออร์</td>
                                                <td style="text-align: center">
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                                            <i class="fa fa-chevron-down"></i>
                                                        ...
                                                        <ul class="dropdown-menu slidedown">
                                                            ...
                                                            <li>
                                                                <a href="report_customerbillinggetway.php?type=customer&meg=report&companycode=RRC">เลือกลูกค้า</a>
                                                            </li>
