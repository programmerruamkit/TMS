  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">บริษัท โชนัน ยูนิเทค (ประเทศไทย) จำกัด   </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">สาขาที่ 00001 ที่อยู่ 242 นิคมอุตสาหกรรมเกตเวย์ซิตี้ หมู่ 7 ต.หัวสำโรง อ.แปลงยาว จ.ฉะเชิงเทรา 24190    </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี  0115544005922 </td>
