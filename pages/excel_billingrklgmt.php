...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLGMT_Billing.xls";
} else {
  $strExcelFileName = "RKLGMT_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
            <td colspan="10" style="font-size:24px">บริษัท ร่วมกิจรุ่งเรือง โลจิสติคส์ จำกัด (RUAMKIT RUNGRUENG LOGISTICS CO., LTD.)</td>
       </tr>
       <tr>
            <td colspan="10" style="font-size:24px">สำนักงานใหญ่ เลขที่ 51  ม.4  ต.บ้านเก่า  อ.พานทอง  จ.ชลบุรี 20160 โทรศัพท์: (038) 452824-5 โทรสาร: (038) 210396</td>
       </tr>
       <tr>
            <td colspan="10" style="font-size:24px">เลขประจำตัวผู้เสียภาษี  0105552003135</td>
       </tr>
       <tr>
            <td colspan="10">&nbsp;</td>
       </tr>
