...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
    $strExcelFileName = "RKSSTM_Billing.xls";
} else {
    $strExcelFileName = "RKSSTM_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:10;margin-top:8px;font-size:12;">
    <thead>
        <tr style="border:1px solid #000;padding:4px;">
