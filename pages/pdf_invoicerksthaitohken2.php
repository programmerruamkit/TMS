...
WHERE 1 = 1
AND a.COMPANYCODE ='RKS' AND a.CUSTOMERCODE ='THAITOHKEN'
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส  ท-018
        <br>บริษัท ไทยโตเคน เทอร์โม จำกัด
        <br>700/314 หมู่ 6 ถ.บางนา-ตราด กม. 57 ตำบลดอนหัวฬ่อ
        <br>อำเภอเมือง จังหวัดชลบุรี 20000 ประเทศไทย
        <br>โทร : 038-214-417-420 แฟ็กซ์ : 038-214-421		
      </td>
  ...
  if ($holiday !='') {
    ...
    if ($holidaysplit[0] !='') {
      $sql_seCount0 = " SELECT COUNT(VEHICLETRANSPORTPLANID) AS 'COUNT_HOLIDAY0' 
        ...
        WHERE COMPANYCODE ='RKS' AND CUSTOMERCODE ='THAITOHKEN'
...
<tbody>
    ...
    <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ท-018
        ...
        <br>อำเภอเมือง จังหวัดชลบุรี 20000 ประเทศไทย
        <br>โทร : 038-214-417-420 แฟ็กซ์ : 038-214-421
        <br>เลขประจำตัวผู้เสียภาษี 0105538004987 
    </td>
