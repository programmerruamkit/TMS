...
// 22222
// เช็ค SELFCHECK ข้อมูลเวลาการพักผ่อน และ เวลาการนอนปกติ
// ข้อมูลวันที่รายงานตัวและวันที่ทำงาน ของพนักงาน เพื่อเช็ค Self Check
...
$sql_seSelfCheck = "SELECT TOP 1 SELFCHECKID,SLEEPRESTSTART,SLEEPRESTEND,TIMESLEEPREST,
...
if ($result_seTenkobefor['ACTUALTENKOBY'] == '' || $result_seTenkobefor['ACTUALTENKOBY'] == NULL) {
    $TENKOBEFOREDATE = $result_seTenkobefor['CREATEDATE'].'(CREATE DATE)';
}else{
    $TENKOBEFOREDATE = $result_seTenkobefor['ACTUALDATE'];
}
...
// เช็คถ้าไม่มี selfcheckid จะหมายถึงพนักงานไม่ได้ทำ selfcheck หรือเจ้าหน้าที่ไม่ได้กดยืนยัน
// ช่องแสดงช้อมูลของการพักผ่อนตั้งแต่ 8 ชั่วโมง

if($result_seSelfCheck['SELFCHECKID'] == ''){
    $RS_TENKORESTDATA = "";
}else{
...
//ตรวจสอบปัญหาสายตา แบบใหม่
// eyeproblemcheck
if ($result_seTenkobefor['TENKOSHORTSIGHTCHECK'] == "1"  || $result_seTenkobefor['TENKOLONGSIGHTCHECK'] == "1" 
|| $result_seTenkobefor['TENKOOBLIQUESIGHTCHECK'] == "1" || $result_seTenkobefor['TENKOEYEPROBLEMCHECK'] == "1") {
    $TENKOBEFOREEYEPROBLEMCHECK = "<img src='../images/ok.png' width='2%'>";
}else {
    $TENKOBEFOREEYEPROBLEMCHECK = "<img src='../images/cancel.png' width='2%'>";
}

// eyeproblemresult
if ($result_seTenkobefor['TENKOSHORTSIGHTRESULT'] == "1"  || $result_seTenkobefor['TENKOLONGSIGHTRESULT'] == "1" 
|| $result_seTenkobefor['TENKOOBLIQUESIGHTRESULT'] == "1" || $result_seTenkobefor['TENKOEYEPROBLEMRESULT'] == "1") {
    $TENKOBEFOREEYEPROBLEMRESULT1 = "<img src='../images/ok.png' width='2%'>";
    $TENKOBEFOREEYEPROBLEMRESULT0 = "";
}else {
    $TENKOBEFOREEYEPROBLEMRESULT1 = "";
    $TENKOBEFOREEYEPROBLEMRESULT0 = "<img src='../images/cancel.png' width='2%'>";
}

 // eyeproblemremark
 if ($result_seTenkobefor['TENKOSHORTSIGHTREMARK'] != '') {

      $REMARKEYEPROBLEM = $result_seTenkobefor['TENKOSHORTSIGHTREMARK'];
    
 }else if ($result_seTenkobefor['TENKOLONGSIGHTREMARK'] != '') {

      $REMARKEYEPROBLEM = $result_seTenkobefor['TENKOLONGSIGHTREMARK'];
     
 }else if ($result_seTenkobefor['TENKOOBLIQUESIGHTREMARK'] != '') {
     
      $REMARKEYEPROBLEM = $result_seTenkobefor['TENKOOBLIQUESIGHTREMARK'];
    
 }else {
      $REMARKEYEPROBLEM = $result_seTenkobefor['TENKOEYEPROBLEMREMARK'];
...
// เช็คถ้าไม่มี selfcheckid จะหมายถึงพนักงานไม่ได้ทำ selfcheck หรือเจ้าหน้าที่ไม่ได้กดยืนยัน
// ช่องปกติของการพักผ่อนตั้งแต่ 8 ชั่วโมง
if($result_seSelfCheck['SELFCHECKID'] == ''){
    $TENKORESTRESULT1 = "";
}else{
...
// เช็คถ้าไม่มี selfcheckid จะหมายถึงพนักงานไม่ได้ทำ selfcheck หรือเจ้าหน้าที่ไม่ได้กดยืนยัน
// ช่องปกติของการนอนปกติ
if($result_seSelfCheck['SELFCHECKID'] == ''){
    $TENKOSLEEPTIMERESULT1 = "";
}else{
...
// เช็คถ้าไม่มี selfcheckid จะหมายถึงพนักงานไม่ได้ทำ selfcheck หรือเจ้าหน้าที่ไม่ได้กดยืนยัน
// ช่องผิดปกติของการพักผ่อนตั้งแต่ 8 ชั่วโมง
if($result_seSelfCheck['SELFCHECKID'] == ''){
    $TENKORESTRESULT0 = "<img src='../images/ok.png' width='2%'>";
}else{
    $TENKORESTRESULT0 = ($result_seTenkobefor['TENKORESTDATA'] < 8) ? "<img src='../images/ok.png' width='2%'>" : "";
}

// เช็คถ้าไม่มี selfcheckid จะหมายถึงพนักงานไม่ได้ทำ selfcheck หรือเจ้าหน้าที่ไม่ได้กดยืนยัน
// ช่องผิดปกติของการนอนปกติ
if($result_seSelfCheck['SELFCHECKID'] == ''){
    $TENKOSLEEPTIMERESULT0 = "<img src='../images/ok.png' width='2%'>";
}else{
...
$params_CalculateAge = array(
    array('calculate_age', SQLSRV_PARAM_IN),
...
$cardlivedata = ($result_SeCardliveData['CardAddress'].' '.$result_SeCardliveData['CardBuilding'].' '.$result_SeCardliveData['CardSoi'].' ถ.'.$result_SeCardliveData['CardRoad'].' ต.'.$result_SeCardliveData['DISTRICT_NAME_TH'].'
<br> อ.'.$result_SeCardliveData['AMPHUR_NAME_TH'].' จ.'.$result_SeCardliveData['PROVINCE_NAME_TH'].'
<br>'.$result_SeCardliveData['CardPostID']);
...
|| $result_sehealthhis['OBLIQUESIGHT'] == '1' || $result_sehealthhis['COLORBLIND_NG'] == '1' ) {
    $eyeproblem = 'YES';
    $eyeproblemtextcheck = 'มีปัญหาสายตา';
    ...
    $eyeproblem = 'NO';
    $eyeproblemtextcheck = 'ไม่มีปัญหาสายตา';
    $textshortsight = '';
    $textlongsight  = '';
    $textobliquesight = '';
}
...
$sql_SeCheckArea = "SELECT SUBSTRING(JOBNO, 1, 3) AS 'CheckArea'  
    FROM VEHICLETRANSPORTPLAN 
    WHERE VEHICLETRANSPORTPLANID ='".$_GET['vehicletransportplanid']."'";
$params_SeCheckArea = array();
$query_SeCheckArea  = sqlsrv_query($conn, $sql_SeCheckArea, $params_SeCheckArea);
$result_SeCheckArea = sqlsrv_fetch_array($query_SeCheckArea, SQLSRV_FETCH_ASSOC);

$checkArea = $result_SeCheckArea['CheckArea'];
...
//ความดันค่าบน
$SYS1 = $result_seTenkobefor['TENKOPRESSUREDATA_90160'];
$SYS2 = $result_seTenkobefor['TENKOPRESSUREDATA_90160_2'];
$SYS3 = $result_seTenkobefor['TENKOPRESSUREDATA_90160_3'];

// อันเดิมแสดงแค่ค่าที่ผ่าน
// if ($result_seTenkobefor['TENKOPRESSUREDATA_90160'] >= '90' && $result_seTenkobefor['TENKOPRESSUREDATA_90160'] <=    '150') {
//     $SYS = $result_seTenkobefor['TENKOPRESSUREDATA_90160'];
// }else if ($result_seTenkobefor['TENKOPRESSUREDATA_90160_2'] >= '90' && $result_seTenkobefor['TENKOPRESSUREDATA_90160_2'] <= '150') {
//     $SYS = $result_seTenkobefor['TENKOPRESSUREDATA_90160_2'];
// }else if ($result_seTenkobefor['TENKOPRESSUREDATA_90160_3'] >= '90' && $result_seTenkobefor['TENKOPRESSUREDATA_90160_3'] <= '150'){
...
//ความดันค่าล่าง
$DIA1 = $result_seTenkobefor['TENKOPRESSUREDATA_60100'];
$DIA2 = $result_seTenkobefor['TENKOPRESSUREDATA_60100_2'];
$DIA3 = $result_seTenkobefor['TENKOPRESSUREDATA_60100_3'];

// อันเดิมแสดงแค่ค่าที่ผ่าน
// if ($result_seTenkobefor['TENKOPRESSUREDATA_60100'] >= '60' && $result_seTenkobefor['TENKOPRESSUREDATA_60100'] <= '95') {
//     $DIA = $result_seTenkobefor['TENKOPRESSUREDATA_60100'];
// }else if ($result_seTenkobefor['TENKOPRESSUREDATA_60100_2'] >= '60' && $result_seTenkobefor['TENKOPRESSUREDATA_60100_2'] <= '95') {
//     $DIA = $result_seTenkobefor['TENKOPRESSUREDATA_60100_2'];
// }else if ($result_seTenkobefor['TENKOPRESSUREDATA_60100_3'] >= '60' && $result_seTenkobefor['TENKOPRESSUREDATA_60100_3'] <= '95'){
...
//HEARTRATE
$HEARTRATE1 = $result_seTenkobefor['TENKOPRESSUREDATA_60110'];
$HEARTRATE2 = $result_seTenkobefor['TENKOPRESSUREDATA_60110_2'];
$HEARTRATE3 = $result_seTenkobefor['TENKOPRESSUREDATA_60110_3'];
...
// เวลาในการนอน 8 ชั่วโมง อันเดิมใช้ 
// $result_seTenkobefor['TENKORESTREMARK'] 

// เวลาในการนอน 6 ชั่วโมง อันเดิมใช้
// $result_seTenkobefor['TENKOSLEEPTIMEREMARK']


$tablehistory = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8;margin-top:8px;">
<thead>
<tr style=" padding:4px;">
     <th colspan="6" style=" padding:4px;text-align:center;"><b>' . $result_seEmp['Company_NameT'] . ''.$areashow.'</b></th>
    </tr>
    <tr style=" padding:4px;">
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seTenkobefor['CREATEDATE'] . '</th>
...
$table_1DAY1 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8.5;margin-top:8px;">
<thead>
    <tr style="border:1px solid #000;padding:4px;">
        <th width="25%" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
        <th style="border-right:1px solid #000;padding:4px;text-align:left;">' . $TENKOBEFOREDATE . '</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะก่อนเริ่มงาน</th>
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์<br />เจ้าหน้าที่<br />เท็งโกะ</th>
        <th width="15%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOBEFOREBY1 . '</th>
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์ พขร.</th>
    ...
    <tr style="border:1px solid #000;padding:4px;">
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        // 11111
        <td colspan="2" style="border-right:1px solid #000;padding:4px;text-align:left;"><b>เวลาการพักผ่อน</b><br>' . $result_seSelfCheck['SLEEPRESTSTART']  . ' (จบงาน)<br> ' . $result_seSelfCheck['SLEEPRESTEND'] . ' (เริ่มงาน)</td> //เวลานอน8ชั่วโมง
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">' . ($result_seSelfCheck['SELFCHECKID'] == '' ? '' : $result_seTenkobefor['TENKOSLEEPTIMEDATA_AFTER6H']) . '</td>
        ...
        <td colspan="2" rowspan="3" style="border-right:1px solid #000;padding:4px;text-align:left;">
            <b>เวลานอนปกติ</b><br>' . $result_seSelfCheck['SLEEPNORMALSTART']  . ' (นอนหลับ)<br> ' . $result_seSelfCheck['SLEEPNORMALEND'] . ' (ตื่นนอน)
            <br><br><b>เวลานอนเพิ่ม</b><br>' . $result_seSelfCheck['SLEEPEXTRASTART']  . ' (นอนหลับ)<br> ' . $result_seSelfCheck['SLEEPEXTRAEND'] . ' (ตื่นนอน)
        </td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">(___' . $result_seTenkobefor['TENKOSLEEPTIMEDATA_ADD45H'] . '___ชม.)</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">ต่ำกว่า ' . $result_seTenkoSTD['TEMP'] . ' องศา</td>
      ...
      <tr style="border:1px solid #000;padding:4px;">
        <td rowspan="9" style="border-right:1px solid #000;padding:4px;text-align:center;">7</td>
        <td rowspan="9" style="border-right:1px solid #000;padding:4px;text-align:left;">วัดความดัน</td>
        <td rowspan="9" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOPRESSURECHECK . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">บน : ' . $result_seTenkoSTD['MINSYS'] . ' - ' . $result_seTenkoSTD['MAXSYS'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $SYS1 . '</td>
        <td rowspan="9" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOPRESSURERESULT1 . '</td>
        <td rowspan="9" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOPRESSURERESULT0 . '</td>
        <td colspan="2" rowspan="9" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkobefor['TENKOPRESSUREREMARK'] . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;"></td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $SYS2 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;"></td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $SYS3 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">ล่าง : ' . $result_seTenkoSTD['MINDIA'] . ' - ' . $result_seTenkoSTD['MAXDIA'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $DIA1 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;"></td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $DIA2. '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;"></td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $DIA3 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">อัตราการเต้นหัวใจ : ' . $result_seTenkoSTD['MINPULSE'] . ' - ' . $result_seTenkoSTD['MAXPULSE'] . ' ครั้ง</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $HEARTRATE1 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;"></td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $HEARTRATE2 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:left;"></td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;height:16px">' . $HEARTRATE3 . '</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
      ...
      <tr style="border:1px solid #000;padding:4px;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">ออกซิเจนในเลือดตั้งแต่ 98%</td>
      ...
      <tr style="border:1px solid #000;padding:4px;">
        <td colspan="9" style="border-right:1px solid #000;padding:4px;text-align:center;">ตรวจสอบปัญหาสุขภาพสายตาพนักงาน</td>
      </tr>
      <tr style="border:1px solid #000;padding:4px;">
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">19</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:left;">' . $eyeproblemtextcheck . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOBEFOREEYEPROBLEMCHECK . '</td>
        <td colspan="2" style="border-right:1px solid #000;padding:4px;text-align:left;">พนักงานพกแว่นสายตามาปฏิบัติงาน <br><br>
                                                                                        <b>' .$textshortsight. '</b><br>
                                                                                        <b>' .$textlongsight. '</b><br>
                                                                                        <b>' .$textobliquesight. '</b><br>
        </td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOBEFOREEYEPROBLEMRESULT1 . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOBEFOREEYEPROBLEMRESULT0 . '</td>
        <td colspan="2" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $REMARKEYEPROBLEM . '</td>
      </tr>
    </tbody></table>
';
...
$VAR_ACTUALTENKOBY1 = $result_seTenkotransportDAY1["ACTUALTENKOBY"];

// tenko ระหว่างทางวันที่1
$table_2DAY1 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8;margin-top:8px;">
<thead>
    <tr style="border:1px solid #000;padding:4px;">
    <th width="20%" colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkotransportDAY1['ACTUALTENKODATE'] . '</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง ('.$result_seTenkomaster['DATEINPUT_F1'].')</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์เจ้าหน้าที่เท็งโกะ</th>
        <th width="20%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $VAR_ACTUALTENKOBY1 . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
...
// header tenko ก่อนเริ่มงานวันที่2
...
//       <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะก่อนเริ่มงานวันที่2</th>
...
$VAR_ACTUALTENKOBY2 = $result_seTenkotransportDAY2["ACTUALTENKOBY"];

// tenko ระหว่างทางวันที่2
$table_2DAY2 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8;margin-top:8px;">
<thead>
    <tr style="border:1px solid #000;padding:4px;">
    <th width="20%" colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkotransportDAY2['ACTUALTENKODATE'] . '</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง ('.$result_seTenkomaster['DATEINPUT_F2'].')</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์เจ้าหน้าที่เท็งโกะ</th>
        <th width="20%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $VAR_ACTUALTENKOBY2 . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปกติ : 1 | พบสิ่งผิดปกติ : x</li></th>
    </tr>
...
//  header tenko ก่อนเริมงานวันที่ 3
...
//       <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะก่อนเริ่มงานวันที่3</th>
//         <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็น<br />เจ้าหน้าที่<br />เท็งโกะ</th>
//         <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $TENKOBEFOREBY1 . '</th>
//         <th  width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็น พขร.</th>
//         <th  width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seDir['nameT'] . '</th>
...
$VAR_ACTUALTENKOBY3 =  $result_seTenkotransportDAY3["ACTUALTENKOBY"];

// tenko ระหว่างทางวันที่3
// แบบเดิมลายเซ็นเจ้าหน้าที่ใช้ colspan='1'
$table_2DAY3 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8;margin-top:8px;">
<thead>
    <tr style="border:1px solid #000;padding:4px;">
    <th width="20%" colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkotransportDAY3['ACTUALTENKODATE'] . '</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง ('.$result_seTenkomaster['DATEINPUT_F3'].')</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์เจ้าหน้าที่เท็งโกะ</th>
        <th width="20%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $VAR_ACTUALTENKOBY3 . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปกติ : 1 | พบสิ่งผิดปกติ : x</li></th>
    </tr>
...
// header tenko ก่อนเริ่มงานวันที่4
...
$VAR_ACTUALTENKOBY4 = $result_seTenkotransportDAY4["ACTUALTENKOBY"];
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
    <th width="20%" colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkotransportDAY4['ACTUALTENKODATE'] . '</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง ('.$result_seTenkomaster['DATEINPUT_F4'].')</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์เจ้าหน้าที่เท็งโกะ</th>
        <th width="20%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $VAR_ACTUALTENKOBY4 . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปกติ : 1 | พบสิ่งผิดปกติ : x</li></th>
    </tr>
...
$VAR_ACTUALTENKOBY5 = $result_seTenkotransportDAY5["ACTUALTENKOBY"];
...
<thead>
    <tr style="border:1px solid #000;padding:4px;">
    <th width="20%" colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
    <th colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkotransportDAY5['ACTUALTENKODATE'] . '</th>
      <th colspan="6" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะระหว่างทาง ('.$result_seTenkomaster['DATEINPUT_F5000'].')</th>
        <th colspan="3" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์เจ้าหน้าที่เท็งโกะ</th>
        <th width="20%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $VAR_ACTUALTENKOBY5 . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="12" style="border-right:1px solid #000;padding:4px;text-align:left;">เจ้าหน้าที่โทรไปไม่พบสิ่งผิดปกติ : 0 | พนักงานขับรถโทรมาไม่พบสิ่งผิดปกติ : 1 | พบสิ่งผิดปกติ : x</li></th>
    </tr>
...
$mpdf->AddPage();
if ($result_seTenkotransportDAY1['TENKOLOADRESTCHECK'] == '1') {
        $mpdf->WriteHTML($table_2DAY1);
    }
if ($result_seTenkotransportDAY2['TENKOLOADRESTCHECK'] == '1') {
        $mpdf->WriteHTML($table_2DAY2);
    }
if ($result_seTenkotransportDAY3['TENKOLOADRESTCHECK'] == '1') {
        $mpdf->WriteHTML($table_2DAY3);
    }
if ($result_seTenkotransportDAY4['TENKOLOADRESTCHECK'] == '1') {
        $mpdf->WriteHTML($table_2DAY4);
    }
if ($result_seTenkotransportDAY5['TENKOLOADRESTCHECK'] == '1') {
        $mpdf->WriteHTML($table_2DAY5);
    }
// if ($result_seTenkotransportDAY2['TENKOTIME0'] ) {
...
$VAR_ACTUALTENKOAFTERBY = $result_seTenkoafter["ACTUALTENKOBY"];

$table_3 = '<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:8;margin-top:8px;">
<thead>
    <tr style="border:1px solid #000;padding:4px;">
     <th width="20%" style="border-right:1px solid #000;padding:4px;text-align:center;">เวลา<br />ทำเท็งโกะ</th>
        <th style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_seTenkoafter['ACTUALTENKODATE'] . '</th>
      <th colspan="2" style="border-right:1px solid #000;padding:4px;text-align:center;">เท็งโกะเลิกงาน</th>
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์<br />เจ้าหน้าที่<br />เท็งโกะ</th>
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $VAR_ACTUALTENKOAFTERBY . '</th>
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์ พขร.</th>
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">' . $result_seDir['nameT'] . '</th>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
...
<thead>
    ...
    <tr style="border:1px solid #000;padding:4px;">
        ...
        <th width="10%" style="border-right:1px solid #000;padding:4px;text-align:center;">ลายเซ็นต์พขร.</th>
    </tr>
    </thead>
    <tbody>
