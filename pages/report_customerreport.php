...
<div class="row">
                    <div class="col-lg-6">
                                <?php
                                $meg = 'ลูกค้า';
                                echo "<a href='report_companyreport.php?type=report'>บริษัท</a> / " . $result_seCompany['Company_NameT'] . " / " . $meg;
                                $link = "<a href='report_companyreport.php?type=report'>บริษัท</a> / <a href='report_customerreport.php?type=report'>ลูกค้า</a>";
                                $_SESSION["link"] = $link;
                                ?>
                            ...
                            <div class="panel-body">
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $condCus = " AND b.COMPANYCODE = '" . $_GET['companycode'] . "'";
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu slidedown">
                                                                ...
                                                                <li>
                                                                            ...
                                                                            <a href="report_transportplan.php?companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>">รายงานแผนการขนส่ง</a>
