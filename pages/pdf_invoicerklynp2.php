...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;">
       	  <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส  	ย-004	
								<br>บริษัท ยานภัณฑ์ จำกัด (มหาชน)  
								<br>สาขาที่ 00003  ที่อยู่ 3 หมู่ที่ 7  ถ.กิ่งแก้ว-ลาดกระบัง ต.ราชาเทวะ 
                                                                <br>อ.บางพลี จ.สมุทรปราการ 10540
								<br>โทรศัพท์. 02-175-2100  โทรสาร. 02-175-2115 
								<br>เลขประจำตัวผู้เสียภาษี  0107547000168 
		 </td>
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;" >
        <td style="border-right:1px solid #000;padding:4px;width:70%" rowspan="4">รหัส  	ย-004		
								<br>บริษัท ยานภัณฑ์ จำกัด (มหาชน) 
								<br>สาขาที่ 00003  ที่อยู่ 3 หมู่ที่ 7  ถ.กิ่งแก้ว-ลาดกระบัง  	
                                                                <br>ต.ราชาเทวะ อ.บางพลี จ.สมุทรปราการ 10540 	
								<br> โทรศัพท์. 02-175-2100  โทรสาร. 02-175-2115 
								<br>เลขประจำตัวผู้เสียภาษี  0107547000168 	
		 </td>
