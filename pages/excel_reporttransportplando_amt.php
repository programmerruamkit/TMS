...
if ($_GET['datestart'] == "" || $_GET['dateend'] == "") {
    $strExcelFileName = "รายงานแผนการขนส่ง(DO)ERROR.xls";
} else {
  if ($_GET['companycode'] == "RKR" && $_GET['customercode'] == "TTASTSTC") {
    ...
    $company = "STC";
    // ชื่อไฟล์
    $strExcelFileName = "RKR_".$t1."-".$t2."_".$t3."_".$company."(DO).xls";
    // echo "<br>";
    $strExcelFileName;
    ...
    $company = "STC";
    // ชื่อไฟล์
    $strExcelFileName = "RKL_".$t1."-".$t2."_".$t3."_".$company."(DO).xls";
    // echo "<br>";
    $strExcelFileName;
    ...
    // $strExcelFileName = "รายงานแผนการขนส่งบริษัท(DO)".$_GET['companycode']."ตั้งแต่วันที่" . $_GET['datestart'] . ' ถึง ' . $_GET['dateend'] . ".xls";
}
        ...
        <table border="1">
            <thead>
                <tr>
                    ...
                    <th colspan="3"><label style="width: 200px"></label></th>
                    <th colspan="1"><label style="width: 200px"></label></th>
                ...
                <tr>
                    ...
                    <th><label style="width: 200px">DOCUMENTCODE</label></th>
            ...
            <tbody>
                ...
                ,ROW_NUMBER() OVER (PARTITION BY  CONVERT(VARCHAR(10), b.DATEWORKING, 103) ORDER BY b.DATEWORKING) AS 'ROWNUM2',a.DOCUMENTCODE
                ...
                GROUP BY b.JOBNO,b.THAINAME,b.VEHICLETYPE,a.EMPLOYEENAME1,a.EMPLOYEENAME2,a.JOBSTART, a.JOBEND,b.VEHICLETRANSPORTPRICEID,a.VEHICLETRANSPORTPRICEID,c.[LOCATION],b.CLUSTER,c.PRICE,b.VEHICLETRANSPORTPLANID,a.REMARK,b.DATEWORKING,a.DOCUMENTCODE
