...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
   <tbody>
        <tr style="border:1px solid #000;">
       	  <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ท-031
								<br>บริษัท ไทยอินเตอร์เนชั่นแนลไดเมคกิ้ง จำกัด (สำนักงานใหญ่)
								<br>ที่อยู่ 331 นิคมอุตสาหกรรมบางปู หมู่ 4 
								<br>ถ.สุขุมวิท ต.แพรกษา อ.เมือง จ.สมุทรปราการ 10280
                                                                <br>เลขประจำตัวผู้เสียภาษี  0105530049612
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;" >
<td style="border-right:1px solid #000;padding:4px;width:70%" rowspan="4">ลูกค้า : รหัส ท-031
								<br>บริษัท ไทยอินเตอร์เนชั่นแนลไดเมคกิ้ง จำกัด (สำนักงานใหญ่)
								<br>ที่อยู่ 331 นิคมอุตสาหกรรมบางปู หมู่ 4 
								<br>ถ.สุขุมวิท ต.แพรกษา อ.เมือง จ.สมุทรปราการ 10280
								<br>เลขประจำตัวผู้เสียภาษี  0105530049612
