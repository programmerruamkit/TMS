...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRTGT_Billing.xls";
} else {
  $strExcelFileName = "RKRTGT_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">ลูกค้า บริษัท โตโยด้า โกเซ (ประเทศไทย) จำกัด (สำนักงานใหญ่)  </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">700/489  ม.4  นิคมอุตสาหกรรมอมตะนคร  ต.บ้านเก่า  อ.พานทอง  จ.ชลบุรี  </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี  0105537013231</td>
