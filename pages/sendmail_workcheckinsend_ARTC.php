...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_ARTC.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("narin@ruamkit.co.th");//narin@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณนรินทร์ พิลึก

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Affiliate Business แผนก : Ruamkit Ruamkit Rungrueng Traning Center
