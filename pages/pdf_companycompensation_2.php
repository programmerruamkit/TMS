...
$table_begin = '<table id="bg-table" width="150%" style="border-collapse: collapse;font-size:12;">';
$thead = '<thead>
        <tr style="border:1px solid #000;" >
            ...
            <td colspan="12" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>ประจำเดือน/ปี : ' . $_GET['datestart'] . '</b>
            </td>
        </tr>
        <tr style="border:1px solid #000;background-color: #ccc" >
            ...
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>01/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>02/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>03/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>04/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>05/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>06/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>07/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>08/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>09/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>10/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>11/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>12/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>13/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>14/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>15/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>16/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>17/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>18/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>19/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>20/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>21/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>22/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>23/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>24/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>25/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>26/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>27/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>28/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>29/' . $_GET['datestart'] . '</b>
            </td>
            <td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                <b>30/' . $_GET['datestart'] . '</b>
            </td>';

if ($result_seGetdate['dateend'] == '31') {

    $thead .= '<td colspan="2" style="border-right:1px solid #000;padding:3px;text-align:center;">
                    <b>31/' . $_GET['datestart'] . '</b>
                </td>';
}
...
if ($result_seGetdate['dateend'] == '31') {
    ...
    $thead .= '<td style="border-right:1px solid #000;padding:3px;text-align:center;"><b>Trip</b></td>
                <td style="border-right:1px solid #000;padding:3px;text-align:center;"><b>Incentive</b></td>';
}
...
$sql_sePlan = " SELECT DISTINCT EMPLOYEECODE,EMPLOYEENAME FROM (
                        ...
                        AND CONVERT(DATE,DATEWORKING) BETWEEN CONVERT(DATE,'01/" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $result_seGetdate['dateend'] . "',103)
...
while ($result_sePlan = sqlsrv_fetch_array($query_sePlan, SQLSRV_FETCH_ASSOC)) {
    ...
    $sql_sePlan1 = "SELECT COUNT(JOBNO) AS 'CNT1' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'01/" . $_GET['datestart'] . "',103)
    ...
    $sql_sePlan2 = "SELECT COUNT(JOBNO) AS 'CNT2' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'02/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan3 = "SELECT COUNT(JOBNO) AS 'CNT3' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'03/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan4 = "SELECT COUNT(JOBNO) AS 'CNT4' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'04/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan5 = "SELECT COUNT(JOBNO) AS 'CNT5' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'05/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan6 = "SELECT COUNT(JOBNO) AS 'CNT6' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'06/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan7 = "SELECT COUNT(JOBNO) AS 'CNT7' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'07/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan8 = "SELECT COUNT(JOBNO) AS 'CNT8' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'08/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan9 = "SELECT COUNT(JOBNO) AS 'CNT9' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'09/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan10 = "SELECT COUNT(JOBNO) AS 'CNT10' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'10/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan11 = "SELECT COUNT(JOBNO) AS 'CNT11' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'11/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan12 = "SELECT COUNT(JOBNO) AS 'CNT12' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'12/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan13 = "SELECT COUNT(JOBNO) AS 'CNT13' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'13/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan14 = "SELECT COUNT(JOBNO) AS 'CNT14' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'14/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan15 = "SELECT COUNT(JOBNO) AS 'CNT15' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'15/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan16 = "SELECT COUNT(JOBNO) AS 'CNT16' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'16/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan17 = "SELECT COUNT(JOBNO) AS 'CNT17' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'17/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan18 = "SELECT COUNT(JOBNO) AS 'CNT18' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'18/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan19 = "SELECT COUNT(JOBNO) AS 'CNT19' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'19/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan20 = "SELECT COUNT(JOBNO) AS 'CNT20' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'20/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan21 = "SELECT COUNT(JOBNO) AS 'CNT21' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'21/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan22 = "SELECT COUNT(JOBNO) AS 'CNT22' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'22/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan23 = "SELECT COUNT(JOBNO) AS 'CNT23' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'23/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan24 = "SELECT COUNT(JOBNO) AS 'CNT24' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'24/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan25 = "SELECT COUNT(JOBNO) AS 'CNT25' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'25/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan26 = "SELECT COUNT(JOBNO) AS 'CNT26' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'26/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan27 = "SELECT COUNT(JOBNO) AS 'CNT27' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'27/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan28 = "SELECT COUNT(JOBNO) AS 'CNT28' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'28/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan29 = "SELECT COUNT(JOBNO) AS 'CNT29' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'29/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $sql_sePlan30 = "SELECT COUNT(JOBNO) AS 'CNT30' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'30/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    if ($result_seGetdate['dateend'] == '31') {
        $sql_sePlan31 = "SELECT COUNT(JOBNO) AS 'CNT31' FROM [dbo].[VEHICLETRANSPORTPLAN]
                          WHERE CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'31/" . $_GET['datestart'] . "',103)
                          AND COMPANYCODE  ='" . $_GET['companycode'] . "' 
                          AND (EMPLOYEECODE1 ='" . $result_sePlan['EMPLOYEECODE'] . "' OR  EMPLOYEECODE2 ='" . $result_sePlan['EMPLOYEECODE'] . "')
                          AND DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !=''";
    ...
    $SUMTRIP = $result_sePlan1['CNT1'] + $result_sePlan2['CNT2'] + $result_sePlan3['CNT3'] + $result_sePlan4['CNT4'] + $result_sePlan5['CNT5'] + $result_sePlan6['CNT6'] + $result_sePlan7['CNT7'] + $result_sePlan8['CNT8'] + $result_sePlan9['CNT9'] + $result_sePlan10['CNT10'] + $result_sePlan11['CNT11'] + $result_sePlan12['CNT12'] + $result_sePlan13['CNT13'] + $result_sePlan14['CNT14'] + $result_sePlan15['CNT15'] + $result_sePlan16['CNT16'] + $result_sePlan17['CNT17'] + $result_sePlan18['CNT18'] + $result_sePlan19['CNT19'] + $result_sePlan20['CNT20'] + $result_sePlan21['CNT21'] + $result_sePlan22['CNT22'] + $result_sePlan23['CNT23'] + $result_sePlan24['CNT24'] + $result_sePlan25['CNT25'] + $result_sePlan26['CNT26'] + $result_sePlan27['CNT27'] + $result_sePlan28['CNT28'] + $result_sePlan29['CNT29'] + $result_sePlan30['CNT30'] + $result_sePlan31['CNT31'];
    ...
    //           AND CONVERT(DATE,b.DATEWORKING) = CONVERT(DATE,'01/".$_GET['datestart']."',103)
    ...
    $sql_seIncen1 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'01/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
    ...
    $sql_seIncen2 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'02/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen3 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'03/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen4 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'04/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen5 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'05/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen6 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'06/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen7 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'07/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen8 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'08/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen9 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'09/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen10 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'10/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen11 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'11/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen12 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'12/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen13 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'13/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen14 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'14/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen15 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'15/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen16 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'16/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen17 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'17/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen18 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'18/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen19 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'19/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen20 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'20/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen21 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'21/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen22 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'22/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen23 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'23/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen24 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'24/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen25 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'25/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen26 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'26/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen27 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'27/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen28 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'28/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen29 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'29/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $sql_seIncen30 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'30/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    if ($result_seGetdate['dateend'] == '31') {
        $sql_seIncen31 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='" . $_GET['companycode'] . "' 
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'31/" . $_GET['datestart'] . "',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
    ...
    $SUMINCEN = $result_seIncen1['SUMINCEN1'] + $result_seIncen2['SUMINCEN2'] + $result_seIncen3['SUMINCEN3'] + $result_seIncen4['SUMINCEN4'] + $result_seIncen5['SUMINCEN5'] + $result_seIncen6['SUMINCEN6'] + $result_seIncen7['SUMINCEN7'] + $result_seIncen8['SUMINCEN8'] + $result_seIncen9['SUMINCEN9'] + $result_seIncen10['SUMINCEN10'] + $result_seIncen11['SUMINCEN11'] + $result_seIncen12['SUMINCEN12'] + $result_seIncen13['SUMINCEN13'] + $result_seIncen14['SUMINCEN14'] + $result_seIncen15['SUMINCEN15'] + $result_seIncen16['SUMINCEN16'] + $result_seIncen17['SUMINCEN17'] + $result_seIncen18['SUMINCEN18'] + $result_seIncen19['SUMINCEN19'] + $result_seIncen20['SUMINCEN20'] + $result_seIncen21['SUMINCEN21'] + $result_seIncen22['SUMINCEN22'] + $result_seIncen23['SUMINCEN23'] + $result_seIncen24['SUMINCEN24'] + $result_seIncen25['SUMINCEN25'] + $result_seIncen26['SUMINCEN26'] + $result_seIncen27['SUMINCEN27'] + $result_seIncen28['SUMINCEN28'] + $result_seIncen29['SUMINCEN29'] + $result_seIncen30['SUMINCEN30'] + $result_seIncen31['SUMINCEN31'];
    ...
    if ($result_seGetdate['dateend'] == '31') {
        ...
        $tbody .= '<td style="border-right:1px solid #000;padding:3px;text-align:center;" >' . $result_sePlan31['CNT31'] . '</td>
                    <td style="border-right:1px solid #000;padding:3px;text-align:center;" >' . $result_seIncen31['SUMINCEN31'] . '</td>';
    }

    $tbody .= '<td style="border-right:1px solid #000;padding:3px;text-align:center;" >' . $SUMTRIP . '</td>
    ...
    $i++;
    ///SUM TRIP ในแต่ละวัน
    $SUMTRIP1 = $SUMTRIP1 + $result_sePlan1['CNT1'];
    $SUMTRIP2 = $SUMTRIP2 + $result_sePlan2['CNT2'];
    $SUMTRIP3 = $SUMTRIP3 + $result_sePlan3['CNT3'];
    $SUMTRIP4 = $SUMTRIP4 + $result_sePlan4['CNT4'];
    $SUMTRIP5 = $SUMTRIP5 + $result_sePlan5['CNT5'];
    $SUMTRIP6 = $SUMTRIP6 + $result_sePlan6['CNT6'];
    $SUMTRIP7 = $SUMTRIP7 + $result_sePlan7['CNT7'];
    $SUMTRIP8 = $SUMTRIP8 + $result_sePlan8['CNT8'];
    $SUMTRIP9 = $SUMTRIP9 + $result_sePlan9['CNT9'];
    $SUMTRIP10 = $SUMTRIP10 + $result_sePlan10['CNT10'];
    $SUMTRIP11 = $SUMTRIP11 + $result_sePlan11['CNT11'];
    $SUMTRIP12 = $SUMTRIP12 + $result_sePlan12['CNT12'];
    $SUMTRIP13 = $SUMTRIP13 + $result_sePlan13['CNT13'];
    $SUMTRIP14 = $SUMTRIP14 + $result_sePlan14['CNT14'];
    $SUMTRIP15 = $SUMTRIP15 + $result_sePlan15['CNT15'];
    $SUMTRIP16 = $SUMTRIP16 + $result_sePlan16['CNT16'];
    $SUMTRIP17 = $SUMTRIP17 + $result_sePlan17['CNT17'];
    $SUMTRIP18 = $SUMTRIP18 + $result_sePlan18['CNT18'];
    $SUMTRIP19 = $SUMTRIP19 + $result_sePlan19['CNT19'];
    $SUMTRIP20 = $SUMTRIP20 + $result_sePlan20['CNT20'];
    $SUMTRIP21 = $SUMTRIP21 + $result_sePlan21['CNT21'];
    $SUMTRIP22 = $SUMTRIP22 + $result_sePlan22['CNT22'];
    $SUMTRIP23 = $SUMTRIP23 + $result_sePlan23['CNT23'];
    $SUMTRIP24 = $SUMTRIP24 + $result_sePlan24['CNT24'];
    $SUMTRIP25 = $SUMTRIP25 + $result_sePlan25['CNT25'];
    $SUMTRIP26 = $SUMTRIP26 + $result_sePlan26['CNT26'];
    $SUMTRIP27 = $SUMTRIP27 + $result_sePlan27['CNT27'];
    $SUMTRIP28 = $SUMTRIP28 + $result_sePlan28['CNT28'];
    $SUMTRIP29 = $SUMTRIP29 + $result_sePlan29['CNT29'];
    $SUMTRIP30 = $SUMTRIP30 + $result_sePlan30['CNT30'];
    $SUMTRIP31 = $SUMTRIP31 + $result_sePlan31['CNT31'];
    ///SUM INCEN ในแต่ละวัน
    $SUMINCEN1 = $SUMINCEN1 + $result_seIncen1['SUMINCEN1'];
    $SUMINCEN2 = $SUMINCEN2 + $result_seIncen2['SUMINCEN2'];
    $SUMINCEN3 = $SUMINCEN3 + $result_seIncen3['SUMINCEN3'];
    $SUMINCEN4 = $SUMINCEN4 + $result_seIncen4['SUMINCEN4'];
    $SUMINCEN5 = $SUMINCEN5 + $result_seIncen5['SUMINCEN5'];
    $SUMINCEN6 = $SUMINCEN6 + $result_seIncen6['SUMINCEN6'];
    $SUMINCEN7 = $SUMINCEN7 + $result_seIncen7['SUMINCEN7'];
    $SUMINCEN8 = $SUMINCEN8 + $result_seIncen8['SUMINCEN8'];
    $SUMINCEN9 = $SUMINCEN9 + $result_seIncen9['SUMINCEN9'];
    $SUMINCEN10 = $SUMINCEN10 + $result_seIncen10['SUMINCEN10'];
    $SUMINCEN11 = $SUMINCEN11 + $result_seIncen11['SUMINCEN11'];
    $SUMINCEN12 = $SUMINCEN12 + $result_seIncen12['SUMINCEN12'];
    $SUMINCEN13 = $SUMINCEN13 + $result_seIncen13['SUMINCEN13'];
    $SUMINCEN14 = $SUMINCEN14 + $result_seIncen14['SUMINCEN14'];
    $SUMINCEN15 = $SUMINCEN15 + $result_seIncen15['SUMINCEN15'];
    $SUMINCEN16 = $SUMINCEN16 + $result_seIncen16['SUMINCEN16'];
    $SUMINCEN17 = $SUMINCEN17 + $result_seIncen17['SUMINCEN17'];
    $SUMINCEN18 = $SUMINCEN18 + $result_seIncen18['SUMINCEN18'];
    $SUMINCEN19 = $SUMINCEN19 + $result_seIncen19['SUMINCEN19'];
    $SUMINCEN20 = $SUMINCEN20 + $result_seIncen20['SUMINCEN20'];
    $SUMINCEN21 = $SUMINCEN21 + $result_seIncen21['SUMINCEN21'];
    $SUMINCEN22 = $SUMINCEN22 + $result_seIncen22['SUMINCEN22'];
    $SUMINCEN23 = $SUMINCEN23 + $result_seIncen23['SUMINCEN23'];
    $SUMINCEN24 = $SUMINCEN24 + $result_seIncen24['SUMINCEN24'];
    $SUMINCEN25 = $SUMINCEN25 + $result_seIncen25['SUMINCEN25'];
    $SUMINCEN26 = $SUMINCEN26 + $result_seIncen26['SUMINCEN26'];
    $SUMINCEN27 = $SUMINCEN27 + $result_seIncen27['SUMINCEN27'];
    $SUMINCEN28 = $SUMINCEN28 + $result_seIncen28['SUMINCEN28'];
    $SUMINCEN29 = $SUMINCEN29 + $result_seIncen29['SUMINCEN29'];
    $SUMINCEN30 = $SUMINCEN30 + $result_seIncen30['SUMINCEN30'];
    if ($result_seGetdate['dateend'] == '31') {
        $SUMINCEN31 = $SUMINCEN31 + $result_seIncen31['SUMINCEN31'];
    }
...
if ($result_seGetdate['dateend'] == '31') {
    $tfoot .= '<td style="border:1px solid #000;padding:3px;text-align:center;"><b>' . $SUMTRIP31 . '<b></td>
                                                                                                                                                                                                            <td style="border:1px solid #000;padding:3px;text-align:center;"><b>' . number_format($SUMINCEN31) . '<b></td>';
}

$tfoot .= '<td style = "border:1px solid #000;padding:3px;text-align:center;"><b>' . number_format($ALLSUMTRIP) . '<b></td>
