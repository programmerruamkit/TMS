...
if ($_GET['area'] == 'amata') {
    ...
    $params_sePhysical1_1 = array(
        array('select_bloodpressure', SQLSRV_PARAM_IN),
    ...
    $params_sePhysicalng1_1 = array(
        array('select_bloodpressureng', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
...
<figure class="highcharts-figure">
    <table style="width: 100%;font-size: 12px">
        <tbody>
            <tr>
                <td colspan="4">
                    <h3 style="text-align: center">< อุณหภูมิร่างกาย Body temperature > <?= $result_seSystime['MMYYY'] ?></h3>
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เพื่อตรวจสอบอุณหภูมิร่างกายของพนักงานขับรถ ให้พร้อมกับการทำงาน
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : To Check Body temperature of driver for Ready to Work on Today.
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : ค่าความดันบน 90-140,ค่าความดันล่าง 60-90
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Upper pressure 90-140,Lower pressure 60-90
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เครื่องมือตรวจสอบค่าความดันโลหิต และใบเท็นโกะ
                </td>
                <td style="width: 10%">
                    เวลาปรับข้อมูล
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Tool Check Blood pressure and TENKO sheet.
                </td>
                <td style="width: 10%">
                    Time Adjust data
                </td>
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 80%">
                   1.งดหมอบหมายงาน และให้พนักงานขับรถไปพบแพทย์
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    Stop work and Go to Hospital for check.
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    2. แนะนำถึงความเสี่ยงหรืออุบัติเหตุที่อาจเกิดขึ้น พร้อมทั้งผลกระทบ
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    Instruct risk or accident to drive and effect to him,family,company.
                </td>
