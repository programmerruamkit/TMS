    ...
    <body>
        <div id="wrapper">
            <div id="page-wrapper" >
                <div class="row">
                    <div class="col-md-12" >
                        <h1>TRUCK INFORMATION DETAIL</h1>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    <a href='index2.php'>หน้าแรก</a> / <a href='meg_digitaltenko_truckinfomation.php'>ข้อมูลรถสายงาน STM-SR</a> / <?= $result_info['VEHICLEREGISNUMBER'] ?> 
                                </div>
