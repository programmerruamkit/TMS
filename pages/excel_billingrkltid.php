...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLTID_Billing.xls";
} else {
  $strExcelFileName = "RKLTID_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">ลูกค้า บริษัท ไทยอินเตอร์เนชั่นแนลไดเมคกิ้ง จำกัด (สำนักงานใหญ่)  </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">ที่อยู่ 331 นิคมอุตสาหกรรมบางปู หมู่ 4   ถ.สุขุมวิท ต.แพรกษา อ.เมือง จ.สมุทรปราการ 10280  </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี 0105530049612</td>
