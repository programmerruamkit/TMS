...
<html lang="en">
            ...
            <div id="page-wrapper" >
                <div class="row">
                    <div class="col-md-12" style="background-color: #e7e7e7">
                        <h1>WORKING ISSUE INFORMATION</h1>
                    </div>
                    <div class="col-md-12" style="background-color: #e7e7e7">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6"><a href=''>รายละเอียด</a> / รายละเอียดข้อมูล Working Issue</div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                                            ...
                                                            $sql_seWorkingIssueData = "SELECT WORKINGISSUEID,DRIVERCODE,DRIVERNAME,YEARSWORKINGISSUECHECK,DATEWORKINGISSUECHECK,DATAWORKINGISSUECHECK,CONVERT(VARCHAR(10),DATEWORKINGISSUECHECK,103) AS 'DATE' 
                                                                FROM WORKINGISSUE
                                                                WHERE DRIVERCODE = '".$_GET['employeecode']."'
                                                                AND YEARSWORKINGISSUECHECK BETWEEN '".$_GET['yearstart']."' AND '".$_GET['yearend']."'
                                                                ORDER BY YEARSWORKINGISSUECHECK ASC";
                                                            $params_seWorkingIssueData = array();
                                                            $query_seWorkingIssueData = sqlsrv_query($conn, $sql_seWorkingIssueData, $params_seWorkingIssueData);
                                                            while ($result_seWorkingIssueData = sqlsrv_fetch_array($query_seWorkingIssueData, SQLSRV_FETCH_ASSOC)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?= $result_seWorkingIssueData['DRIVERCODE'] ?></td>
                                                                    <td><?= $result_seWorkingIssueData['DRIVERNAME'] ?></td>
                                                                    <td><?= $result_seWorkingIssueData['YEARSWORKINGISSUECHECK'] ?></td>
                                                                    <td><?= $result_seWorkingIssueData['DATE'] ?></td>
                                                                    <td><?= $result_seWorkingIssueData['DATAWORKINGISSUECHECK'] ?></td>
                                                                </tr>
                                                                <?php
                                                                $i++;
                                                            }
    ...
    <script>
                                        ...
                                        function edit_workingissue(value, fieldname, workingissueid) {

                                            // alert(value);
                                            // alert(fieldname);
                                            // alert(workingissueid);
                                            // alert(IDPLAN);
                                            // alert(IDDRIVER);
                                            ...
                                            $.ajax({
                                                ...
                                                type: 'POST',
                                                data: {
                                                    txt_flg: "update_workingissue", value: value, fieldname: fieldname, workingissueid: workingissueid,modifyby: modifyby
                                                },
                                                success: function (rs) {
                                        ...
                                        function delete_workingissue(id){
