...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_ARTDGW.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("jakkrit@ruamkit.co.th");//jakkrit@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณจักรกฤษณ์ ปัญญาศร

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Affiliate Business แผนก : Ruamkit Rungrueng Truck Details
