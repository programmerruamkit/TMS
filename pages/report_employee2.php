                                                    ...
                                                    <td style="text-align: center">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu slidedown">
                                                                <li>
                                                                    <a target="_bank" href="pdf_reportemployee4_4.php?employeecode=<?=$result_seEmp['PersonCode']?>">
                                                                        ประวัติพนักงาน
                                                                    </a>
                                                                </li>
                                                                <?php
                                                                // เช็ครหัสพนักงานพื้นที่ GW
                                                                $empchk = substr($result_seEmp['PersonCode'],0,2);
                                                                if ($empchk == '04' || $empchk == '05' || $empchk == '09' || $empchk == '10') {
                                                                ?>
                                                                    <li>
                                                                        <a target="_bank" href="meg_driverdatagraph_gw.php?employeecode=<?=$result_seEmp['PersonCode']?>">
                                                                        กราฟข้อมูลสุขภาพ(GW)
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a target="_bank" href="meg_driverdatagraphtel_gw.php?employeecode=<?=$result_seEmp['PersonCode']?>">
                                                                        กราฟข้อมูลโทรศัพท์(GW)
                                                                        </a>
                                                                    </li>
                                                                <?php
                                                                }else{
                                                                ?>  
                                                                    <li>
                                                                        <a target="_bank" href="meg_driverdatagraph_amt.php?employeecode=<?=$result_seEmp['PersonCode']?>">
                                                                        กราฟข้อมูลสุขภาพ(AMT)
                                                                        </a>
                                                                    </li>
                                                                <?php
                                                                }
