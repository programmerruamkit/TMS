...
<div class="row">
                    <div class="col-lg-6">
                                <?php
                                $meg = 'ลูกค้า';
                                echo "<a href='report_companybillinggetway.php?type=report'>บริษัท</a> / " . $meg;
                                $link = "<a href='report_companybillinggetway.php?type=report'>บริษัท</a> / <a href='report_customerbillinggetway.php?type=report'>ลูกค้า</a>";
                                $_SESSION["link"] = $link;
                                ?>
                    </div>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu slidedown">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a href="report_invoice.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>">ใบส่งสินค้า</a>

                                                                </li>
                                                                <li class="divider"></li>
                                                                <li>

                                                                    <a href="report_billing.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>">ใบวางบิลลูกค้า</a>
