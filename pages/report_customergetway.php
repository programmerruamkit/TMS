                            ...
                            <div class="panel-heading" style="background-color: #e7e7e7">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <?php
                                        $meg = 'ลูกค้า';
                                        echo "<a href='report_companygetway.php?type=report'>บริษัท</a> / " . $meg;
                                        $link = "<a href='report_companygetway.php?type=report'>บริษัท</a> / <a href='report_companygetway.php?type=report'>ลูกค้า</a>";
                                        $_SESSION["link"] = $link;
                                        ?>
                                    </div>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu slidedown">
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        ?>
                                                                        <a href="meg_transportplan.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&worktype=<?= $result_seCustomer['WORKTYPE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>">กำหนดแผนขนส่ง</a>
                                                                        <?php
                                                                        }
                                                                        else
                                                                        {
                                                                            ?>
                                                                        <a href="meg_transportplangw.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&worktype=<?= $result_seCustomer['WORKTYPE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>">กำหนดแผนขนส่ง</a>
