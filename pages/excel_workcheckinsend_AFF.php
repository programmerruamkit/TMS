...
$strExcelFileName = "Report".$result_getDate['GETDATE']."_AFF.xls";
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="7" style="border-top:1px solid #000;font-size:14px;border:1px solid #000;padding:6px;text-align:center">
                        <b>สรุปรายงานตัวปฎิบัติงานวันที่ <?= $result_getDate['GETDATE'] ?> - <?= $result_getDate['GETDATE'] ?> (Accounting/Finance)(Finance)</b> 
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="14" style="border-top:1px solid #000;font-size:14px;border:1px solid #000;padding:6px;text-align:center">
                        <b>รายงานตัวปฎิบัติงานประจำวันที่ <?= $result_getDate['GETDATE'] ?> ถึงวันที่ <?= $result_getDate['GETDATE'] ?> (Accounting/Finance)(Finance)</b> 
...
WHERE 
    RowNum = (SELECT COUNT(*) FROM STRING_SPLIT('" . $result_seWorkcheckin['MAPADDRESS'] . "',' '))-2";
       ...
       AND  b.AREA = 'amata' AND b.DEPARTMENTCODE = '02' AND b.[SECTIONCODE] = '02' AND b.DEPARTMENTCODE !='' AND b.[SECTIONCODE] !=''";
