...
<html lang="en">
                ...
                <div class="row" >
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            <i class="fa fa-database"></i>GPS AUDITING
                        </h2>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control"    style="background-color: #fffff;height:45px;"  id="txt_gpsauditmasterdata" name="txt_gpsauditmasterdata" placeholder="เพิ่มข้อมูลการตรวจสอบ" value="">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>&nbsp;</label><br>   
                            <input type="button" style="width:128px;height:45px;" onclick="save_gpsauditmaster()" name="" id="" value="บันทึกข้อมูล" class="btn btn-primary">
                        </div>
                    </div>
                </div>
                <br>
                                ...
                                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                            $i=1;
                                            $sql_seDetails = "SELECT ITEMS,GPSAUDITINGID FROM [dbo].[GPSAUDITINGMASTER] 
                                                              WHERE ACTIVESTATUS ='1'         
                                                              ORDER BY GPSAUDITINGID ASC";
                                            ...
                                            while ($result_seDetails = sqlsrv_fetch_array($query_seDetails, SQLSRV_FETCH_ASSOC)) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td style="text-align: center;"><input type="button"    onclick ="confirm_delete('<?=$result_seDetails['GPSAUDITINGID']?>');"       name="btnSend" id="btnSend" value="ลบข้อมูล" class="btn btn-danger"></td>
                                                </tr>
    ...
    <script>
        ...
        function save_gpsauditmaster()
        {
            ...
            var gpsauditmaster = document.getElementById('txt_gpsauditmasterdata').value;
            ...
            if (gpsauditmaster == '') {
                ...
                $.ajax({
                    ...
                    data: {
                        txt_flg: "save_gpsauditmaster",
                        trailernumber:'',
                        problem:gpsauditmaster,
                        drivername:'',
                        datetimedata:'',
                        location:'',
                        rootcause:'',
