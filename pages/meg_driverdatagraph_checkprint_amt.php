                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <?php
                                ...
                                if ($ChkMonth == '28') { //chk เดือนที่มี 28 วัน
                                ...
                                }else if($ChkMonth == '30') { //chk เดือนที่มี 30 วัน
                                    // echo "30";
                                    /////////////////QUERY ค้นหาข้อมูล///////////////////////////////////////////////////
                                    //DAY1
                                    $sql_seDay1 = "SELECT
                                    ...
                                    if($result_seDay31['TENKOPRESSUREDATA_60110'] > $result_seTenkoSTD['MAXPULSE'] || $result_seDay31['TENKOPRESSUREDATA_60110'] < $result_seTenkoSTD['MINPULSE']){
                                        if ($result_seDay31['TENKOPRESSUREDATA_60110_2'] > $result_seTenkoSTD['MAXPULSE']  || $result_seDay31['TENKOPRESSUREDATA_60110_2'] < $result_seTenkoSTD['MINPULSE'] ) {
                                            if ($result_seDay31['TENKOPRESSUREDATA_60110_3'] > $result_seTenkoSTD['MAXPULSE'] || $result_seDay31['TENKOPRESSUREDATA_60110_3'] < $result_seTenkoSTD['MINPULSE']) {
