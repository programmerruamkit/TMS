...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRTTAT_Billing.xls";
} else {
  $strExcelFileName = "RKRSUTT_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
        <tr>
            <td colspan="10" style="font-size:24px">บริษัท ร่วมกิจรุ่งเรือง (1993) จำกัด (RUAMKIT RUNGRUENG (1993) CO., LTD.)</td>
        </tr>
        <tr>
            <td colspan="10" style="font-size:24px">สำนักงานใหญ่ เลขที่ 51 หมู่ 4 ตำบลบ้านเก่า อำเภอพานทอง จังหวัดชลบุรี 20160 </td>
        </tr>
        <tr>
            <td colspan="10" style="font-size:24px">โทรศัพท์ : 038-452824-5 โทรสาร : 038-210396</td>
        </tr>
        <tr>
       ...
       <tr>
            <td colspan="5" style="font-size:24px">ลูกค้า บริษัท โชนัน ยูนิเทค (ประเทศไทย) จำกัด</td>
            <td colspan="5" style="text-align:right;font-size:24px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="font-size:24px">สาขาที่ 00001 ที่อยู่ 242 นิคมอุตสาหกรรมเกตเวย์ซิตี้ หมู่7 ต.หัวสำโรง อ.แปลงยาว จ.ฉะเชิงเทรา 24190</td>
            <td colspan="5" style="text-align:right;font-size:24px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
        </tr>
        <tr>  
            <td colspan="10" style="font-size:24px">เลขประจำตัวผู้เสียภาษี 0115544005922</td>
...
<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 16%;"><font style="font-size: 24px"><b>วันที่</b></font></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 20%;"><font style="font-size: 24px"><b>หมายเลข DO</b></font></td>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKR' AND CUSTOMERCODE = 'SUTT'";
   ...
   ?>   
      ...
      <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?= $result_seBilling['PURCHASEORDER'] ?></font></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?= $result_seBilling['PERCHASEORDER'] ?></font></td>
        ...
        <tr style="border:1px solid #000;">
          ...
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?= $result_seBilling['DATE_VLIN'] ?></font></td>
          <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><?= $result_seBilling['PURCHASEORDER'] ?><br>Holiday</td>
   ...
   ?>
    ...
    <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;"><font style="font-size: 24px"><font style="font-size: 24px"><?= $result_seBilling['PURCHASEORDER'] ?></font></td>
...
<table style="width: 100%;">
    <tbody>
       ...
       <tr>
        ...
        <td colspan="4" style="text-align:left;font-size:20px">ผู้ตรวจสอบ..........................</td>
