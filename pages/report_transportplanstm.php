    ...
    <body>
        ...
        <div id="wrapper">
                                            ...
                                            <div class="well">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label>&nbsp;</label>
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-default" onclick="select_reporttransportplanstm();">ค้นหา <li class="fa fa-search"></li></button>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6" style="text-align: right">
                                                        <label>&nbsp;</label><br>
                                                        <a href="#" onclick="excel_reporttransportpalnstm();" class="btn btn-default">พิมพ์ <li class="fa fa-print"></li></a>
                                                            ...
                                                            <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                                                ...
                                                                <tbody>
                                                                  ...
                                                                  $sql_seBilling = "SELECT CONVERT(VARCHAR(8),a.DATEPRESENT,108) AS 'TIMEPRESENT',
                                                                                    CONVERT(NVARCHAR(5),a.ROUNDAMOUNT) AS 'ROUNDS',LEFT(a.ROUNDAMOUNT,PATINDEX('%[^0-9]%',a.ROUNDAMOUNT)-1) AS 'Numerics',
                                                                                    ...
                                                                                    AND CONVERT(DATE,a.DATEWORKING,103) BETWEEN CONVERT(DATE,GETDATE(),103) AND CONVERT(DATE,GETDATE(),103)
                                                                                     ORDER BY LEN(LEFT(a.ROUNDAMOUNT,PATINDEX('%[^0-9]%',a.ROUNDAMOUNT)-1)),Numerics ASC";
                                                                  ...
                                                                  while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
                                                                     ...
                                                                     <tr>
                                                                         ...
                                                                         <td><?= $result_seBilling['TIMEPRESENT'] ?></td>
                                                                         <td><?= $result_seBilling['ROUNDS'] ?></td>
                                                                         <td><?= $result_seBilling['TIMERETURN'] ?></td>
                                                                         <td><?= $result_seBilling['VEHICLETYPE'] ?></td>
                                                                         <td><?= $result_seBilling['THAINAME'] ?></td>
                                                                         <td><?= $result_seBilling['EMPNAME'] ?></td>
                                                                         <td><?= $result_seBilling['TEL'] ?></td>
            ...
            <script>
                                                            ...
                                                            function select_reporttransportplanstm()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    url: 'meg_data.php',
                                                                    data: {
                                                                        txt_flg: "select_reporttransportplanstm", datestart: datestart, dateend: dateend
                                                                    },
                                                            ...
                                                            function excel_reporttransportpalnstm()
                                                            {
                                                                var datestart = document.getElementById('txt_datestart').value;
                                                                var dateend = document.getElementById('txt_dateend').value;

                                                                window.open('excel_reporttransportplanstm.php?datestart=' + datestart + '&dateend=' + dateend, '_blank');
