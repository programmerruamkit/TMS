...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLDAIKITON_Billing.xls";
} else {
  $strExcelFileName = "RKLDAIKITON_Billing" . $_GET['invoicecode'] . ".xls";
}
...
WHERE b.COMPANYCODE='".$_GET['companycode']."' AND b.CUSTOMERCODE='".$_GET['companycode']."' AND b.REMARK = 'Charge 12' ";
...
<?php
  ...
  // $result_seInvoicecode = sqlsrv_fetch_array($query_seInvoicecode, SQLSRV_FETCH_ASSOC);
   ...
   AND CONVERT(DATE,c.DATEVLIN) BETWEEN CONVERT(DATE,'".$result_seInvoicecode['BILLINGDATE']."',103) AND CONVERT(DATE,'".$result_seInvoicecode['PAYMENTDATE']."',103) AND b.REMARK='Charge 12' ORDER BY b.JOBEND ASC  ";
