...
<html lang="en">
    ...
    <body>
                ...
                <div class="row" >
                    <div class="col-lg-12">
                        ...
                        <h2 class="page-header"><i class="fa fa-file-text-o"></i>
                            รายงานตัวช่วงเทศกาลวันเข้าพรรษา (วันที่ 21 กรกฎาคม 2567 - 28 กรกฎาคม 2567)
                        </h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
        ...
        <script type="text/javascript">
                                                ...
                                                //     var datestart = document.getElementById('txt_datestart_month').value;
                                                //     if (department == '02' && (section == '01' || section == '02')) {
                                                //         window.open('excel_reportcheckinweekendOCT_acc.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                //     } else if (department == '03' && section == '03') {
                                                //         window.open('excel_reportcheckinweekendOCT_sq.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                //     } else {
                                                //         window.open('excel_reportcheckinweekendOCT.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                ...
                                                //     if (department == '02' && (section == '01' || section == '02')) {
                                                //         window.open('pdf_reportcheckinweekendOCT_acc.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                //     } else if (department == '03' && section == '03') {
                                                //         window.open('pdf_reportcheckinweekendOCT_sq.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
                                                //     } else {
                                                //         window.open('pdf_reportcheckinweekendOCT.php?datestart=' + datestart + '&department=' + department + '&section=' + section + '&area=' + area, '_blank');
