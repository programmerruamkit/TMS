...
WHERE 1 = 1
AND a.COMPANYCODE ='RKS' AND a.CUSTOMERCODE ='SWN'
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส  ส-016  
        <br>บริษัท สยามวัฒนา เวสต์ แมนเนจเม้นท์ จำกัด
        <br>สำนักงานใหญ่ ที่อยู่  22/1  หมู่ที่ 6 ตำบลหนองบอนแดง 
        <br>อำเภอบ้านบึง จังหวัดชลบุรี 20170		
        <br>โทร. 092-2631789							
      </td>
...
<tbody>
    <tr style="border:1px solid #000;" >
    <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ส-016
        <br>บริษัท สยามวัฒนา เวสต์ แมนเน็จเม้นท์ จำกัด
        <br>สำนักงานใหญ่ ที่อยู่  22/1  หมู่ที่ 6  ตำบลหนองบอนแดง
        <br>อำเภอบ้านบึง จังหวัดชลบุรี 20170 
        <br>โทร. 092-2631789 
        <br>เลขประจำตัวผู้เสียภาษี 0205554000353 
    </td>
