    ...
    <body>
        ...
        <?php
            ...
            $sql_seData = "SELECT DRIVINGPATTERNGO_ID,DRIVINGPATTERNRETURN_ID,EMPLOYEECODE1,EMPLOYEENAME1,EMPLOYEECODE2,EMPLOYEENAME2,THAINAME_ID,PLANING_ROUTE,ACTUAL_ROUTE,DRIVINGPATTERN_DATE,OFFICERCHECK_GO,
                ...
                CONFIRMEDBY_P1,CONVERT(VARCHAR,CONFIRMEDDATE_P1,20) AS 'CONFIRMEDDATE_P1',
                ...
                CONFIRMEDBY_P2,CONVERT(VARCHAR,CONFIRMEDDATE_P2,20) AS 'CONFIRMEDDATE_P2',
                ...
                CONFIRMEDBY_P3,CONVERT(VARCHAR,CONFIRMEDDATE_P3,20) AS 'CONFIRMEDDATE_P3',
                ...
                CONFIRMEDBY_P4,CONVERT(VARCHAR,CONFIRMEDDATE_P4,20) AS 'CONFIRMEDDATE_P4',
                ...
                CONFIRMEDBY_P5,CONVERT(VARCHAR,CONFIRMEDDATE_P5,20) AS 'CONFIRMEDDATE_P5',
                ...
                CONFIRMEDBY_P6,CONVERT(VARCHAR,CONFIRMEDDATE_P6,20) AS 'CONFIRMEDDATE_P6',
            ...
            <div id="page-wrapper">
                ...
                <div id="datade_edit">
                    <div class="row" id="list-data">
                        ...
                        <div class="col-lg-12" style="font-size: 18px;text-align: center;">ปลดล็อครูปแบบการวิ่งงาน Actual (Driving Pattern)</div>
                        <div class="col-lg-12">&nbsp;</div>
                        ...
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="font-size: 18px;text-align: center;">หมายเลขไอดี: <?=$_GET['drivinggoplanid']?></div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="font-size: 20px;text-align: center;"><b>ปลดล็อครูปแบบการวิ่งงาน (วิ่งจริงขาไป)</b></div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp1?>;" onclick="select_searchDrivingPattern('GoActual','1','<?=$CHK4HURP1?>','<?=$CHK2HURP1?>')">ปลดล็อค ช่วงที่1</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp2?>;" onclick="select_searchDrivingPattern('GoActual','2','<?=$CHK4HURP2?>','<?=$CHK2HURP2?>')">ปลดล็อค ช่วงที่2</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp3?>;" onclick="select_searchDrivingPattern('GoActual','3','<?=$CHK4HURP3?>','<?=$CHK2HURP3?>')">ปลดล็อค ช่วงที่3</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp4?>;" onclick="select_searchDrivingPattern('GoActual','4','<?=$CHK4HURP4?>','<?=$CHK2HURP4?>')">ปลดล็อค ช่วงที่4</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp5?>;" onclick="select_searchDrivingPattern('GoActual','5','<?=$CHK4HURP5?>','<?=$CHK2HURP5?>')">ปลดล็อค ช่วงที่5</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorp6?>;" onclick="select_searchDrivingPattern('GoActual','6','<?=$CHK4HURP6?>','<?=$CHK2HURP6?>')">ปลดล็อค ช่วงที่6</button>
                        </div>
                        <div class="col-lg-12">&nbsp;</div>
                        <!-- <div class="col-lg-12" style="text-align: center;">
                            <b style="font-size: 16px"></b>
                            &nbsp;<button class="button" style="width:30%;font-size: 18px;border:solid 2px;color:black;<?=$colorallload?>;" onclick="select_searchDrivingPattern('GoActual','load','YES','YES')">ลงข้อมูล<br>โหลดรถลง</button>
                        </div> -->
                        <div class="col-lg-12">&nbsp;</div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            function select_searchDrivingPattern(checkdata,checksection,chkstatus4hur,chkstatus2hur)
            {
                ...
                var unlockby = '<?=$result_seEmp1['PersonCode']?>';
                ...
                if (checkdata == 'GoActual') {
                        ...
                        if (chkstatus4hur == 'YES' || chkstatus2hur == 'YES') {
                            ...
                            swal.fire({
                                title: "Warning!",
                                html: '<div style="text-align: center;"> ไม่สามารถปลดล็อคได้เนื่องจาก<br>ยังไม่เลยเวลาที่วางแผนไว้หรือยังอยู่ในเวลาปกติ</div>',
                        ...
                        }else if (chkstatus4hur == 'NO' || chkstatus2hur == 'NO') {
                            ...
                            if (checksection == '1') {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        txt_flg: "unlockP1", drivinggoplanid: drivinggoplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        ...
                                        swal.fire({
                                            title: "Success!",
                                            html: '<div style="text-align: center;">ปลดล็อครูปแบบวิ่งงาน ช่วงที่ 1 เรียบร้อย !!</div>',
                                            // text: "ไม่สามารถลงเวลาได้เนื่องจากเลยเวลาที่วางแผนไว้ 10 นาที",
                                            icon: "success",
                                            showConfirmButton: true,
                                            allowOutsideClick: false,
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_driver.php',
                                    data: {
                                        txt_flg: "unlockP2", drivinggoplanid: drivinggoplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                        ...
                                        swal.fire({
                                            title: "Success!",
                                            html: '<div style="text-align: center;">ปลดล็อครูปแบบวิ่งงาน ช่วงที่ 2 เรียบร้อย !!</div>',
                                            // text: "ไม่สามารถลงเวลาได้เนื่องจากเลยเวลาที่วางแผนไว้ 10 นาที",
                                            icon: "success",
                                            showConfirmButton: true,
                                            allowOutsideClick: false,
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_driver.php',
                                    data: {
                                        txt_flg: "unlockP3", drivinggoplanid: drivinggoplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                        ...
                                        swal.fire({
                                            title: "Success!",
                                            html: '<div style="text-align: center;">ปลดล็อครูปแบบวิ่งงาน ช่วงที่ 3 เรียบร้อย !!</div>',
                                            // text: "ไม่สามารถลงเวลาได้เนื่องจากเลยเวลาที่วางแผนไว้ 10 นาที",
                                            icon: "success",
                                            showConfirmButton: true,
                                            allowOutsideClick: false,
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_driver.php',
                                    data: {
                                        txt_flg: "unlockP4", drivinggoplanid: drivinggoplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                        ...
                                        swal.fire({
                                            title: "Success!",
                                            html: '<div style="text-align: center;">ปลดล็อครูปแบบวิ่งงาน ช่วงที่ 4 เรียบร้อย !!</div>',
                                            // text: "ไม่สามารถลงเวลาได้เนื่องจากเลยเวลาที่วางแผนไว้ 10 นาที",
                                            icon: "success",
                                            showConfirmButton: true,
                                            allowOutsideClick: false,
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_driver.php',
                                    data: {
                                        txt_flg: "unlockP5", drivinggoplanid: drivinggoplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
                                        ...
                                        swal.fire({
                                            title: "Success!",
                                            html: '<div style="text-align: center;">ปลดล็อครูปแบบวิ่งงาน ช่วงที่ 5 เรียบร้อย !!</div>',
                                            // text: "ไม่สามารถลงเวลาได้เนื่องจากเลยเวลาที่วางแผนไว้ 10 นาที",
                                            icon: "success",
                                            showConfirmButton: true,
                                            allowOutsideClick: false,
                                ...
                                $.ajax({
                                    ...
                                    url: 'meg_data_drivingpattern_driver.php',
                                    data: {
                                        txt_flg: "unlockP6", drivinggoplanid: drivinggoplanid, unlockby: unlockby
                                    },
                                    success: function (rs) {
                                        // alert("ยืนยันข้อมูลเรียบร้อย");
                                        // alert(rs);    
