...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRHINO_Billing.xls";
} else {
  $strExcelFileName = "RKRHINO_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">ลูกค้า บริษัท ฮีโน่มอเตอร์ส แมนูแฟคเจอริ่ง (ประเทศไทย)  จำกัด  </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">สาขาที่ 3 ที่อยู่  700/509 หมู่ 2 นิคมอมตะนคร ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160  </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี  0115546004940</td>
