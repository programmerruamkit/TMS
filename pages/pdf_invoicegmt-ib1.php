...
if ($result_seBillings['JOBSTART'] == 'GMT' || $result_seBillings['JOBEND'] == 'GMT') {
    ...
    <tbody>
       ...
       <tr>
            <td colspan="2" style="width: 50%;font-size:22px">ที่อยู่ 254 หมู่ 7 นิคมอุตสาหกรรมเกตเวย์ชิตี้ ต.หัวสำโรง อ.แปลงยาว จ.ฉะเชิงเทรา 24190</td>
       </tr>
       <tr>
    ...
    <tbody>
       ...
       <tr>
            <td colspan="2" style="width: 50%;font-size:22px">ที่อยู่ 219/18 หมู่ 6 นิคมอุตสาหกรรมปิ่นทอง 3 ต.บ่อวิน อ.ศรีราชา จ.ชลบุรี 20230</td>
       </tr>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    $tbody3 .= '
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px">' . number_format($result_seBilling['WEIGHTIN']) . '</td>
        <td style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px">' . number_format( $result_seBilling['WEIGHTOUT']) . '</td>
