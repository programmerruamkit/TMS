...
<html lang="en">
    ...
    <body>
        ...
        <div class="row" id="list-data">
            ...
            <div class="col-lg-12" style="font-size: 30px;text-align: center;"><b>ลงข้อมูลวิ่งจริงขากลับสำหรับเจ้าหน้าที่</b></div>
                    ...
                    <a href='meg_selfcheck.php'>หน้าแรก</a> / บันทึกใบแจ้งสุขภาพ
                        ...
                        <div class="panel-body col-lg-12"   style="background-color: #e7e7e7;border-color:#ddd;color: #333;" >
                            ...
                            <div class="col-lg-4 panel-body" style="text-align: left;background-color: #e7e7e7;">
                                ...
                                <!-- <label style="font-size: 20px;">แผนวิ่งงาน ขาไป:</label> -->
                                <p><u>Driving Pattern :</u> แผนขากลับ/วิ่งจริงขากลับ</p>
                            ...
                            <div class="col-lg-6" style="background-color: #e7e7e7">
                                <p style="font-size: 26px;text-align: center;"><b><u>แผนขากลับ</u></b></p>
                            </div> 
                            <div class="col-lg-6" style="background-color: #e7e7e7">
                                <p style="font-size: 26px;text-align: center;"><b><u>วิ่งจริงขากลับ</u></b></p>
                            </div> 
                            <div class="col-lg-3" style="background-color: #e7e7e7">
                                ...
                                <input type="text" class="form-control" type="hidden" id="txt_jobstartplango" name="txt_jobstartplango" value="<?= $result_seData['JOBSTARTPLAN'] ?>" >
                            </div>            
                            <div class="form-group">
                                <!-- <label >ช่วงเวลาของการนอน(ปกติ)</label><br><br> -->
                                <!-- <input type="text" class="form-control" data-toggle="modal"  data-target="#modal_tenkosleepnormal" id="daysleep_normal" name="daysleep_normal" value= "" autocomplete="off"> -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" >
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input class="form-control dateen" style="height:40px; width:240px" id="txt_departuretime_actual_4hur_p1" name="dtxt_departuretime_actual_4hur_p1aysleep_normalend" value="<?= $DEPARTURETIME_ACTUAL_4HUR_P1 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtime_actual_2hur_p1" name="txt_parkingtime_actual_2hur_p1"  value="<?= $PARKINGTIME_ACTUAL_2HUR_P1 ?>" min="" max="" onchange ="parkingtime_actual_2hrs_p1('DT');" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input type="datetime-local" style="height:40px; width:240px" id="txt_departuretime_actual_2hur_p1" name="txt_departuretime_actual_2hur_p1" value="<?= $result_seData['DEPARTURETIME_ACTUAL_2HUR_P1'] ?>" min="" max=""   autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                        // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                ...
                                <div class="col-lg-6" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #02c719;">
                                            <label><font style="font-size: 16px;">วิ่งจริงขากลับ (ช่วงที่2)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                ...
                                <div class="col-lg-6" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #02c719;">
                                            <label><font style="font-size: 16px;">วิ่งจริงขากลับ (ช่วงที่3)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input type="datetime-local" style="height:40px; width:240px" id="txt_departuretime_actual_4hur_p3" name="txt_departuretime_actual_4hur_p3" value="<?= $result_seData['DEPARTURETIME_ACTUAL_4HUR_P3'] ?>" min="" max=""   autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                        // echo str_replace("T"," ",$result_seSelfCheck['SLEEPRESTEND']);
                                                        ...
                                                        <form class="form-inline">
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtime_plan_2hur_p4" name="txt_parkingtime_plan_2hur_p4"  value="<?= $PARKINGTIME_PLAN_2HUR_P4 ?>" min="" max="" onchange ="parkingtime_plan_2hrs_p4('MB');" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                ...
                                <div class="col-lg-6" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #02c719;">
                                            <label><font style="font-size: 16px;">วิ่งจริงขากลับ (ช่วงที่4)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                ...
                                <div class="col-lg-6" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #02c719;">
                                            <label><font style="font-size: 16px;">วิ่งจริงขากลับ (ช่วงที่5)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                ...
                                <div class="col-lg-6" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #02c719;">
                                            <label><font style="font-size: 16px;">วิ่งจริงขากลับ (ช่วงที่6)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                ...
                                <div class="col-lg-6" >
                                    <div class="panel panel-default">
                                        <div class="panel-heading" style="background-color: #f0c402;">
                                            <label><font style="font-size: 16px;">ปลายทาง/โหลดรถลง (แผนขากลับ)</font></label>
                                        </div>
                                        <!-- /.panel-heading -->
                                        <div class="panel-body">
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        <div class="col-lg-6">
                                                            <label ><u>สถานที่</u></label><br>
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_dealer1plan" name="txt_dealer1plan" value="RRR" min="" max=""   autocomplete="off">
                                                        </div> 
                                                        <div class="">
                                                            <div class="form-group">
                                                                <!-- <label >ระยะเวลาการขับรถ 4 ชั่วโมง</label><br> -->
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtimedealer1plan" name="txt_parkingtimedealer1plan"  value="<?= $PARKINGTIME_PLAN_DEALER1 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_sumtimedealer2plan" name="txt_sumtimedealer2plan" value="<?= $result_seData['SUM_PLAN_DEALER2'] ?>" min="" max=""   autocomplete="off">
                                                        </div>  
                                                    </div>
                                                </div>
                                                <div class = "row">
                                                        ...
                                                        <!-- <form class="form-inline"> -->
                                                            <div class="form-group">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?>
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input type="datetime-local"  style="height:40px; width:260px" id="txt_parkingtimedealer2plan" name="txt_parkingtimedealer2plan" value="<?= $result_seData['PARKINGTIME_PLAN_DEALER2'] ?>" min="" max=""   autocomplete="off">
                                                                    <?php
                                                                    }else { //สำหรับ PC DESKTOP
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:260px;"  id="txt_parkingtimedealer2plan" name="txt_parkingtimedealer2plan"  value="<?= $PARKINGTIME_PLAN_DEALER2 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาออก</u></label><br>
                                                                        <input class="form-control dateen" style="height:40px; width:240px;" id="txt_departuretimedealer2plan" name="txt_departuretimedealer2plan" value="<?= $DEPARTURETIME_PLAN_DEALER2 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class = "row">
                                                    <br>
                                                    <div class="col-lg-4">
                                                        <button type="button" style="" class="btn btn-primary btn-lg" onclick ="timedealervlplancheck('<?=$checkClient?>');">กดคำนวณระยะเวลาการจอดรถ</button>
                                                    </div>
                                                    <div class="col-lg-8">
                                            ...
                                            <div class="alert alert-info"  style="background-color: #ffffff;border-color:#ddd;color: #333;border: 0px solid transparent;">
                                                ...
                                                <div class = "row">
                                                    <div class="form-group">
                                                        <div class="col-lg-6">
                                                            <label ><u>สถานที่</u></label><br>
                                                            <input disabled="" class="form-control" type="text"  style="height:40px; width:240px" id="txt_dealer1actual" name="txt_dealer1actual" value="RRR" min="" max=""   autocomplete="off">
                                                        </div> 
                                                        <div class="">
                                                            <div class="form-group">
                                                                <!-- <label >ระยะเวลาการขับรถ 4 ชั่วโมง</label><br> -->
                                                                ...
                                                                <?php
                                                                    ...
                                                                    ?> 
                                                                        <label ><u>เวลาจอด</u></label><br>
                                                                        <input class="form-control dateen"   style="height:40px; width:240px;"  id="txt_parkingtimedealer1actual" name="txt_parkingtimedealer1actual"  value="<?= $PARKINGTIME_ACTUAL_DEALER1 ?>" min="" max="" autocomplete="off">
                                                                    <?php
                                                                    }
                                                                    ?>
        ...
        function confirmdatap1(checkClient,chkp1){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualp1(drivingpatternreturnid,checkClient,chkp1);

                }
            }); 
        }
        function save_actualp1(checkBackId,checkClient,chkp1) {
        ...
        function confirmdatap2(checkClient,chkp2){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualp2(drivingpatternreturnid,checkClient,chkp2);
                }
            }); 
        }
        function save_actualp2(checkBackId,checkClient,chkp2) {
        ...
        function confirmdatap3(checkClient,chkp3){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualp3(drivingpatternreturnid,checkClient,chkp3);
                }
            }); 
        }
        function save_actualp3(checkBackId,checkClient,chkp3) {
        ...
        function confirmdatap4(checkClient,chkp4){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualp4(drivingpatternreturnid,checkClient,chkp4);
                }
            }); 
        }
        ...
        function confirmdatap5(checkClient,chkp5){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualp5(drivingpatternreturnid,checkClient,chkp5);
                }
            }); 
        }
        ...
        function confirmdatap6(checkClient,chkp6){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualp6(drivingpatternreturnid,checkClient,chkp6);
                }
            }); 
        }
        function save_actualp6(checkBackId,checkClient,chkp6) {
        ...
        function confirmdataactualload(checkClient,chkallload){
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    save_actualload(drivingpatternreturnid,checkClient,chkallload);
                }
            }); 
        }
        function save_actualload(checkBackId,checkClient,chkallload) {
            ...
            $.ajax({
                ...
                success: function (rs) {
                    ...
                    if (chkallload == 'CONALL') {
                        ...
                        swal.fire({
                            title: "Success!",
                            text: "ยืนยันข้อมูลขากลับทั้งหมด เรียบร้อย !!!",
                            icon: "success",
                            showConfirmButton: true,
                            allowOutsideClick: false,
                        }); 
        ...
        function confirm_actual_back(checkClient){
            ...
            // }else{
                    ...
                    // ALL LOAD
                    if (($("#txt_parkingtimedealer1plan").val() != '') && ($("#txt_parkingtimedealer1actual").val() != '')) {
                        // alert('p6');

                        confirmdataactualload('<?=$checkClient?>','CONALL');
                    }else if (($("#txt_parkingtimedealer1plan").val() != '') && ($("#txt_parkingtimedealer1actual").val() == '')){
                        swal.fire({
                            title: "Warning!",
                            text: "กรุณาตรวจสอบข้อมูลโหลดรถลง(วิ่งจริงขากลับ)",
                            icon: "warning",
                            showConfirmButton: true,
                            allowOutsideClick: false,
                        });
