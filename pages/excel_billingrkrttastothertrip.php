...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
    $strExcelFileName = "RKRTTAST(TRIP)_Billing.xls";
} else {
    $strExcelFileName = "RKRTTAST(TRIP)_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    <thead>
        <tr>
            <td colspan="11" style="text-align:center;font-size:28px"><b>ใบส่งสินค้า</b></td>
    </thead>
    <tbody>
        <tr>
            <td colspan="11" style="width: 100%;font-size:24px">บริษัท ร่วมกิจรุ่งเรือง (1993) จำกัด (RUAMKIT RUNGRUENG (1993) CO., LTD.)</td>
       </tr>
       <tr>
            <td colspan="11" style="width: 100%;font-size:22px">สำนักงานใหญ่ เลขที่ 51 หมู่ 4 ตำบลบ้านเก่า อำเภอพานทอง จังหวัดชลบุรี 20160  โทรศัพท์ : 038-452824-5 โทรสาร : 038-210396</td>
       </tr>
       <tr>
            <td colspan="11" style="width: 50%;font-size:22px">เลขประจำตัวผู้เสียภาษี  0105536076131</td>
       </tr>
       ...
       <tr>
            <td colspan="5" style="font-size:22px">บริษัท ทีที ออโตโมทีฟ สตีล (ไทยแลนด์) จำกัด </td>
            <td colspan="6" style="text-align:right;font-size:22px">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
       </tr>
       <tr>
            <td colspan="5" style="font-size:22px">สำนักงานใหญ่ นิคมอุตสาหกรรมเกตเวย์ซิตี้ เลขที่ 256 หมู่ที่ 7 ต.หัวสำโรง อ.แปลงยาว จ.ฉะเชิงเทรา 24190</td>
            <td colspan="6" style="text-align:right;font-size:22px">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
       </tr>

       <tr>
            <td colspan="5" style="font-size:22px">เลขประจำตัวผู้เสียภาษี  0105548107746</td>
...
<thead>
        ...
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>ลำดับที่</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>วันที่</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>หมายเลข DO</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>ทะเบียนรถ</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>พนักงาน</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>จาก</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>ถึง</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>พื้นที่</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>QT.</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>ราคา</b></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><b>จำนวนเงิน(บาท)</b></td>
      </tr>
    </thead><tbody>
<?php
$i = 1;
...
?>
      ...
      <tr style="border:1px solid #000;">
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:center;font-size:18px"><?= $i ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $result_seBilling['DATEVLIN_103'] ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $result_seBilling['DOCUMENTCODE'] ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $result_seBilling['THAINAME'] ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $result_seBilling['EMPLOYEENAME1'] ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $jobstart ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $jobend ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:left;font-size:18px"><?= $location ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:right;font-size:18px"><?=$QT?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:right;font-size:18px"><?= number_format($PRICE, 2) ?></td>
        <td colspan="1" style="border-right:1px solid #000;padding:4px;text-align:right;font-size:18px"><?= number_format($PRICE, 2) ?></td>
      </tr>
    <?php
    $i++;
