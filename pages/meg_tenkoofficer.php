                                                        ...
                                                        <td style="text-align: center">
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu slidedown">
                                                                    <li>
                                                                        <a href="#"  onclick="save_tenkomasterofficer('<?= $result_seEmp['PersonCode'] ?>', '','<?= $result_seEmp['Company_Code'] ?>')">
                                                                  ...
                                                                  // alert(companycode);
                                                                    $.ajax({
                                                                        ...
                                                                        success: function (rs) {
                                                                            ...
                                                                            window.open('meg_tenkodocumentofficer1.php?employeecode1=' + employeecode1+ '&companycode=' + companycode + '&tenkomasterid=' + tenkomasterid, '_blank');
