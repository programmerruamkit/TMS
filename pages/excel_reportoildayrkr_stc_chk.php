...
$strExcelFileName = "รายงานน้ำมัน STC-10W วันที่ ".$_GET['datestart'] .".xls";
  ...
  <thead>
         <tr>
           ...
           <tr>
             ...
             <tr>
                    <td colspan="27" style="border-right:1px solid #000;padding:3px;text-align:center;">
                        <b>สายงาน TTAST-STC วันที่  <?=date("d")." ".$month_arr[date("n")]." ".(date("Y")+543);?></b>
                    </td>
             </tr>
