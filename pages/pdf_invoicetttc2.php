...
$table_header2 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td colspan="2" style="width: 50%;">ลูกค้า : รหัส ต-001</td>
       </tr>
       <tr>
            <td style="width: 50%;">บริษัท โตโยต้า ทูโช (ไทยแลนด์) จำกัด</td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . '</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">สำนักงานใหญ่ 607 ถ.อโศก-ดินแดง</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">แขวงดินแดง เขตดินแดง กรุงเทพฯ 10400</td>
       </tr>
        <tr>
...
$tfoot2 = '</tbody><tfoot><tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;">' . $SUMTOTAL . '</td>
      </tr>
    </tfoot>';
...
$table_header1 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td style="width: 50%;">&nbsp;</td>
            <td style="width: 50%;text-align:right">เลขที่วางบิล RE' . $_GET['billingcode'] . '</td>
       </tr>
        <tr>
            <td colspan="2" style="width: 50%;">ลูกค้า บ-001</td>
       </tr>
       <tr>
            <td style="width: 50%;">บจก.บายโปรดักส์สตีล</td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . '</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">ที่อยู่ 88 หมู่ 6 ถนนสัตตพงษ์ ตำบลดอนหัวฬ่อ</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">อำเภอเมืองชลบุรี จังหวัดชุลบุรี 20000</td>
       </tr>
        <tr>
            <td style="width: 50%;text-align:center">หมายเหตุ</td>
          <td style="width: 50%;text-align:center">เงื่อนไขการชำระเงิน</td>
...
while ($result_seBilling2 = sqlsrv_fetch_array($query_seBilling2, SQLSRV_FETCH_ASSOC)) {
    $tbody1 = '<tr style="border:1px solid #000;">
        <td style="border-right:1px solid #000;padding:4px;">' . $i2 . '</td>
