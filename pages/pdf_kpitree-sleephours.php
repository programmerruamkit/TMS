...
if ($_GET['area'] == 'amata') {
    ...
    $params_sePhysical1_1 = array(
        array('select_sleephours', SQLSRV_PARAM_IN),
    ...
    $params_sePhysicalng1_1 = array(
        array('select_sleephoursng', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
...
<figure class="highcharts-figure">
    <table style="width: 100%;font-size: 12px">
        <tbody>
            <tr>
                <td colspan="4">
                    <h3 style="text-align: center">< เวลานอน Sleep hours > <?= $result_seSystime['MMYYY'] ?></h3>
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เพื่อให้ร่างกายพนักงานขับรถใด้พักพ่อนและฟื้นฟูร่างกายให้พร้อมทำงาน
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : To let driver and recover his fatigue for Ready to Work on Today
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : ช่วงเวลานอนไม่น้อยกว่า 6 ชั่วโมง
                </td>
                <td style="width: 10%">
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : ใบตรวจสุขภาพตนเอง (การนอนปรกติ) พนักงานขับรถลงข้อมูลด้วยตัวเอง
                </td>
                <td style="width: 10%">
                    เวลาปรับข้อมูล
                </td>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : Health Check and Driver declared by themselves.
                </td>
                <td style="width: 10%">
                    Time Adjust data
                </td>
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 80%">
                   : 1.งดมอบหมายงานและให้พนักงานขับรถกลับบ้านไปพักผ่อน
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    Stop work and Go home for Rest.
                </td>
