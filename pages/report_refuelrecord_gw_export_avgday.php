<?php
    ...
    if($LINEOFWORK == 'RRC1'){
        ...
        $QUERYWHERE2="VHCTPP.CUSTOMERCODE IN('GMT') AND NOT EHR.PersonCode = '090285'";
        ...
        $QUERYWHERE2="VHCTPP.CUSTOMERCODE IN('TTAST') AND NOT EHR.PersonCode = '090285'";
        ...
        $QUERYWHERE2="VHCTPP.CUSTOMERCODE IN('TTT') AND NOT VHCTPP.VEHICLETYPE = '4L' AND NOT EHR.PersonCode = '090285'";
        $FINECUSTOMER="1=1";
        ...
        $QUERYWHERE2="VHCTPP.CUSTOMERCODE IN('TTT') AND NOT VHCTPP.VEHICLETYPE = '8L' AND NOT EHR.PersonCode = '090285'";
        $FINECUSTOMER="1=1";
                ...
                <tbody>
                    <?php             
                        ...
                        while($RESULTEMP = sqlsrv_fetch_array($QUERYEMP)) {    
                            ...
                            WHERE (VHCTPPDTE.EMPLOYEENAME1= '$EMPN' OR VHCTPPDTE.EMPLOYEENAME2= '$EMPN') 
