...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "TOYOTOMI_Billing.xls";
} else {
  $strExcelFileName = "TOYOTOMI_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="9">สำนักงานใหญ่ เลขที่ 51  ม.4  ต.บ้านเก่า  อ.พานทอง  จ.ชลบุรี 20160 </td>
        </tr>
        <tr>
          <td colspan="9">โทรศัพท์: (038) 452824-5 โทรสาร: (038) 210396</td>
        </tr>
        <tr>
            <td colspan="2" >เลขประจำตัวผู้เสียภาษี  0105552003135</td>
       </tr>
       <tr>
            <td colspan="2">&nbsp;</td>
       </tr>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">บริษัท  โตโยโตมิ ออโต้ พาร์ท (ประเทศไทย)  จำกัด  </td>
          <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
        </tr>
        <tr>
          <td colspan="5"style="width: 50%;">สำนักงานใหญ่ ที่อยู่  1/28  หมู่ที่ 5   <br>ต.ท่าสะอ้าน อ.บางปะกง จ.ฉะเชิงเทรา 24130  </td>
          <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
        </tr>

        <tr>
          <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี  0245554001961</td>
    ...
    <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:10;margin-top:8px;">
      <thead>
        ...
        <tr style="border:1px solid #000;padding:4px;">
          ...
          <td style="border-right:1px solid #000;padding:4px;text-align:center;width: 25%;"><b>จาก</b></td>
          <td style="border-right:1px solid #000;padding:4px;text-align:center;width: 25%;"><b>ถึง</b></td>
        ...
        <tr style="border:1px solid #000;">
          <td colspan="8" style="border-right:1px solid #000;padding:4px;text-align:center;"><?= convert($sumtotal) ?></td>
