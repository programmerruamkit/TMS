...
$table_header2 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td colspan="2" style="width: 50%;">ลูกค้า ก-001</td>
       </tr>
       <tr>
            <td style="width: 50%;">บจก.กรีน เมทัลส์(ประเทศไทย)</td>
...
$condBilling12 = "";
$sql_seBilling1 = "SELECT DISTINCT a.DUEDATE,a.LOGBILLINGINVOICEID,a.COMPANYCODE,a.CUSTOMERCODE, a.BILLINGCODE, a.INVOICECODE, a.BILLINGDATE, a.PAYMENTDATE,a.PRPO1,a.TRIP1,a.PRPO2,a.TRIP2, a.SUMTOTAL, a.EXPRESSWAYAMT15, a.EXPRESSWAYAMT45, a.EXPRESSWAYAMT55, a.EXPRESSWAYAMT65, a.EXPRESSWAYAMT75, a.EXPRESSWAYAMT100, a.EXPRESSWAYAMT195, a.EXPRESSWAYAMT65RETURN, a.EXPRESSWAYAMT105RETURN, a.EXPRESSWAYPRICE15, a.EXPRESSWAYPRICE45, a.EXPRESSWAYPRICE55, a.EXPRESSWAYPRICE65, a.EXPRESSWAYPRICE75, a.EXPRESSWAYPRICE100, a.EXPRESSWAYPRICE195, a.EXPRESSWAYPRICE65RETURN, a.EXPRESSWAYPRICE105RETURN, a.ACTIVESTATUS, a.REMARK,b.EXPRESSWAYCODE FROM [dbo].[LOGBILLINGINVOICE] a
			INNER JOIN [dbo].[LOGINVOICE] b ON a.INVOICECODE = b.INVOICECODE
			WHERE a.ACTIVESTATUS = '1'".$condBilling11.$condBilling12;
...
while ($result_seBilling1 = sqlsrv_fetch_array($query_seBilling1, SQLSRV_FETCH_ASSOC)) {
    $tbody2 .= '<tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling1['INVOICECODE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling1['BILLINGDATE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling1['PAYMENTDATE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling1['SUMTOTAL'] . '</td>
...
$tfoot2 = '</tbody><tfoot><tr style="border:1px solid #000;">
        <td colspan="5" style="border-right:1px solid #000;padding:4px;">' . convert($sumtotal) . '</td>
            <td style="border-right:1px solid #000;padding:4px;">รวมเงินทั้งสิ้น</td>
        <td style="border-right:1px solid #000;padding:4px;">' . number_format($sumtotal,2) . '</td>
      </tr>
    </tfoot>';
...
$table_header1 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td style="width: 50%;">&nbsp;</td>
            <td style="width: 50%;text-align:right">เลขที่วางบิล RE' . substr($_GET['billingcode'],2) . '</td>
       </tr>
       <tr>
            <td colspan="2" style="width: 50%;">ลูกค้า ก-001</td>
       </tr>
...
$condBilling22 = "";
$sql_seBilling2 = "SELECT DISTINCT a.DUEDATE,a.LOGBILLINGINVOICEID,a.COMPANYCODE,a.CUSTOMERCODE, a.BILLINGCODE, a.INVOICECODE, a.BILLINGDATE, a.PAYMENTDATE,a.PRPO1,a.TRIP1,a.PRPO2,a.TRIP2, a.SUMTOTAL, a.EXPRESSWAYAMT15, a.EXPRESSWAYAMT45, a.EXPRESSWAYAMT55, a.EXPRESSWAYAMT65, a.EXPRESSWAYAMT75, a.EXPRESSWAYAMT100, a.EXPRESSWAYAMT195, a.EXPRESSWAYAMT65RETURN, a.EXPRESSWAYAMT105RETURN, a.EXPRESSWAYPRICE15, a.EXPRESSWAYPRICE45, a.EXPRESSWAYPRICE55, a.EXPRESSWAYPRICE65, a.EXPRESSWAYPRICE75, a.EXPRESSWAYPRICE100, a.EXPRESSWAYPRICE195, a.EXPRESSWAYPRICE65RETURN, a.EXPRESSWAYPRICE105RETURN, a.ACTIVESTATUS, a.REMARK,b.EXPRESSWAYCODE FROM [dbo].[LOGBILLINGINVOICE] a
			INNER JOIN [dbo].[LOGINVOICE] b ON a.INVOICECODE = b.INVOICECODE
			WHERE a.ACTIVESTATUS = '1'".$condBilling21.$condBilling22;
...
while ($result_seBilling2 = sqlsrv_fetch_array($query_seBilling2, SQLSRV_FETCH_ASSOC)) {
    $tbody1 = '<tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling2['BILLINGCODE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling2['BILLINGDATE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling2['PAYMENTDATE'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling2['SUMTOTAL'] . '</td>
        <td style="border-right:1px solid #000;padding:4px;"></td>
        <td style="border-right:1px solid #000;padding:4px;">' . $result_seBilling2['SUMTOTAL'] . '</td>
      </tr>';
          $i2++;
          $sumtotal2 = $sumtotal2 + $result_seBilling2['SUMTOTAL'];
}

$tfoot1 = '</tbody><tfoot><tr style="border:1px solid #000;">
        <td colspan="5" style="border-right:1px solid #000;padding:4px;">' . convert($sumtotal2) . '</td>
            <td style="border-right:1px solid #000;padding:4px;">รวมเงินทั้งสิ้น</td>
        <td style="border-right:1px solid #000;padding:4px;">' . number_format($sumtotal2,2) . '</td>
      </tr>
    </tfoot>';
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            ...
            <td style="width: 50%;text-align:right">เลขที่ -</td>
       </tr>
       <tr>
