...
$mpdf = new mPDF('', 'Letter', '', '', 6, 25, 85, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      ...
      <tr>
            <td style="width: 70%;font-size:20px">ลูกค้า  บริษัท คอปเปอร์ คอร์ด อินดัสทรี้ จำกัด (สำนักงานใหญ่)</td>
            <td style="width: 30%;text-align:right;font-size:20px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">ที่อยู่  เลขที่ 700/654  ม.3 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160</td>
            <td style="width: 30%;text-align:right;font-size:20px">วันที่ ' . $result_seInvoicecode['DULYDATE'] . '</td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">เลขประจำตัวผู้เสียภาษี 0115556023548</td>
...
$thead3 = '<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 13%;"><b><font style="font-size: 24px">ลำดับที่</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 13%;"><b><font style="font-size: 24px">วันที่</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 30%;"><b><font style="font-size: 24px">หมายเลข DO</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 20%;"><b><font style="font-size: 24px">ประเภทรถ</font></b></td>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 25%;"><b><font style="font-size: 24px">ถึง</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 7%;"><b><font style="font-size: 24px">QT.</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 15%;"><b><font style="font-size: 24px">ราคา</font></b></td>
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 17%;"><b><font style="font-size: 24px">จำนวนเงิน(บาท)</font></b></td>
      </tr>
    </thead><tbody>';
