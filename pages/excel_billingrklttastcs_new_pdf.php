...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLTTASTCS_Billing.xls";
} else {
  $strExcelFileName = "RKLTTASTCS_Billing" . $_GET['invoicecode'] . ".xls";
}
...
/////////////////////////////////ZONE////////////////////////////////////////////////////////////
    if ($result_seBilling1['LOCATION'] == 'พระประแดง/สำโรง' || $result_seBilling1['LOCATION'] == 'สำโรง') {
    ...
    } else if($result_seBilling1['LOCATION'] == 'เวลโกรว์' || $result_seBilling['LOCATION'] == 'เวลล์โกร์') {
      $zone = "Wellgrow";
      ...
      $zone = "Pracha Uthid";
    }else if($result_seBilling1['LOCATION'] == 'อีสเทิร์นซีบอร์ด' || $result_seBilling['LOCATION'] == 'อีสเทิร์น ซีบอร์ด') {
      $zone = "Eastern Seaboard IE";
