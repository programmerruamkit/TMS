...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        <tr style="border:1px solid #000;">
       	  <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส ว-002	
								<br>บริษัท เวิลด์ ซีโบ-เทค จำกัด
								<br>สำนักงานใหญ่ ที่อยู่  700/185 หมู่ที่ 1 นิคมอุตสาหกรรมอมตะนคร
...
<table id="bg-table" width="100%"  style="border-collapse: collapse;margin-top:8px;">
    <tbody>
        ...
        <tr style="border:1px solid #000;" >
        <td style="border-right:1px solid #000;padding:4px;width:70%" rowspan="4">ลูกค้า : รหัส  	ว-002	
								<br>บริษัท เวิลด์ ซีโบ-เทค จำกัด 	
								<br>สำนักงานใหญ่ ที่อยู่  700/185 หมู่ที่ 1 นิคมอุตสาหกรรมอมตะนคร 	
								<br>ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160 
                                                                <br>โทร. 038-457051 	
								<br>เลขประจำตัวผู้เสียภาษี  0115538001449 		
		 </td>
