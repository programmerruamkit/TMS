...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
       ...
       <tr>
            <td style="width: 50%;">ลูกค้า บริษัท ไทยซัมมิท พลาสเทค จำกัด</td>
            <td style="width: 50%;text-align:right">เลขที่ ' . $result_seInvoice['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 50%;">สาขาที่ 00001 ที่อยู่  4/3 หมู่ที่ 1 ถ.บางนา-ตราด กม.16  ต.บางโฉลง อ.บางพลี จ.สมุทรปราการ 10540</td>
            <td style="width: 50%;text-align:right">วันที่ ' . $result_getDate['SYSDATE'] . ' เครดิต 30 วัน</td>
       </tr>
       <tr>
            <td style="width: 50%;">เลขประจำตัวผู้เสียภาษี 0115556007119</td>
