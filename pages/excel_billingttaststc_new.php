  ...
  <table style="width: 100%;">
      <thead>
          <tr>
              ...
              <td colspan="13" style="text-align:center;font-size:18px;"><b>เอกสารข้อมูลรายละเอียดการวางบิล</b></td>

      </thead>
      <tbody>
          <tr>
              <td colspan="13" style="text-align:center;font-size:14px;"><b> <?= $_GET['startdate']?> - <?= $_GET['enddate']?></b></td>
        </tr>
  ...
  <table id="bg-table" width="100%" style="border-collapse: collapse;font-size:10;margin-top:8px;">
    ...
    <tbody>
      ...
      $sql_seBilling = "SELECT  ROW_NUMBER() OVER (PARTITION BY a.JOBEND,b.VEHICLETRANSPORTPLANID ORDER BY a.JOBEND,b.VEHICLETRANSPORTPLANID,a.DOCUMENTCODE ASC) AS 'ROWNUM',
          ...
          b.VEHICLETYPE AS 'TYPE',b.EMPLOYEENAME1 AS 'DRIVER',a.JOBSTART AS 'FROM',a.JOBEND AS 'TO',c.[LOCATION] AS 'ZONE',
          ...
          CASE WHEN a.DESTINATION = 'C' THEN '100'
          ELSE ''
          END AS 'DROP',
      ...
      while($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)){
          ...
          $sql_seSumWeighTrip = "SELECT SUM(CONVERT(INT,WEIGHTIN)) AS 'WEIGHTIN_TRIP'
                                ...
                                AND JOBEND ='".$result_seBilling['TO']."'";
      ...
      /////////////////////////////////ZONE////////////////////////////////////////////////////////////
          ...
          }else if ($result_seBilling['LOCATION'] == 'บางบ่อ') {
          ...
          ////////////////////////////////////////JOBEND///////////////////////////////////////////////
            if ($result_seBilling['JOBEND'] == 'TMB') {
              ...
              $jobend = "OTC";
            }else if ($result_seBilling['JOBEND'] == 'SAM : Lamchabang') {
              $jobend = "SAM";
              ...
              $jobend = "SARATHORN";
            }else if ($result_seBilling['JOBEND'] == 'THAI NIPPON : Lamchabang') {
              $jobend = "THAI NIPPON";
      ...
      ?>
            ...
            <td colspan="" style="border-right:1px solid #000;padding:5px;text-align:center;"><?=$result_seBilling['TO']?></td>
            <td colspan="" style="border-right:1px solid #000;padding:5px;text-align:center;"><?=$result_seBilling['ZONE']?></td>
            ...
            <td colspan="" style="border-right:1px solid #000;padding:5px;text-align:center;"><?=$DIF_THB == '0' ? '' : $DIF_THB?></td>
