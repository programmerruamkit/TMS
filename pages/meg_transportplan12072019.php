                                            ...
                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <table  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example22" role="grid" aria-describedby="dataTables-example22" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $i2 = 1;
                                                        if ($_GET['vehicletransportplanid'] != "") {
                                                            $conditiontuesday = " AND DATENAME(DW,a.DATEPRESENT) = 'Tuesday' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "' AND a.VEHICLETRANSPORTPLANID = '" . $_GET['vehicletransportplanid'] . "' AND a.STATUSNUMBER = 'O' ";
                                                        } else {
                                                            $conditiontuesday = " AND DATENAME(DW,a.DATEPRESENT) = 'Tuesday' AND (CONVERT(DATE,a.DATEPRESENT,103) BETWEEN CONVERT(DATE,'" . $result_seSystime['STARTWEEK'] . "',103) AND CONVERT(DATE,'" . $result_seSystime['ENDWEEK'] . "',103)) AND a.STATUSNUMBER = 'O' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "'";
                                                        }
                                                        ...
                                                        while ($result_sePlantuesday = sqlsrv_fetch_array($query_sePlantuesday, SQLSRV_FETCH_ASSOC)) {
                                                            if ($result_sePlanmonday['COMPANYCODE'] == 'RRC') {
                                                                ...
                                                                $jobstu2 = select_jobautocomplate('megVehicletransportprice_v2', 'select_vehicletransportprice', '');
                                                            }
                                                            ?>
                                                            <tr 
                                                            <?php
                                                            if ($result_sePlantuesday['ACTUALPRICE'] == '' || $result_sePlantuesday['ACTUALPRICE'] == '0.00') {
                                                                ?>
                                                                    style="color: red"
                                                                    <?php
                                                                }
                                                                ...
                                                                <?php
                                                                if ($result_sePlantuesday['COMPANYCODE'] == 'RCC' || $result_sePlantuesday['COMPANYCODE'] == 'RATC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrcc('<?= $result_sePlantuesday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupd"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlantuesday['COMPANYCODE'] == 'RRC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrrc('<?= $result_sePlantuesday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrrc"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlantuesday['COMPANYCODE'] == 'RKS') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrks('<?= $result_sePlantuesday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrks"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button title="COPY JOB" type="button" onclick="select_copyjob('<?= $result_sePlantuesday['JOBNO'] ?>', '<?= $result_sePlantuesday['JOBSTART'] ?>', '<?= $result_sePlantuesday['JOBEND'] ?>', '<?= $result_sePlantuesday['DATEVLIN'] ?>');" class="btn btn-default btn-circle" data-toggle="modal"  data-target="#modal_copyjob"><span class="fa fa-copy"></span></button>
                                                                </td>
                                                                <td><?= $result_sePlantuesday['EMPLOYEENAME1'] ?></td>
                                                                <td><?= $result_sePlantuesday['EMPLOYEENAME2'] ?></td>
                                                                <td><?= $result_sePlantuesday['THAINAME'] ?></td>
                                                                <td><?= $result_sePlantuesday['JOBSTART'] ?></td>
                                                                <td><?= $result_sePlantuesday['CLUSTER'] ?></td>
                                                                <td><?= $result_sePlantuesday['JOBEND'] ?></td>
                                                                <td ><?= $result_sePlantuesday['JOBNO'] ?></td>
                                                                <td ><?= $result_sePlantuesday['TRIPNO'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEINPUT'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEWORKING'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEWORKSUS'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEPRESENT'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEVLIN'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEVLOUT'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATEDEALERIN'] ?></td>
                                                                <td><?= $result_sePlantuesday['DATERETURN'] ?></td>
                                                                <td>
                                                                    <?php
                                            ...
                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example33" role="grid" aria-describedby="dataTables-example33" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $i3 = 1;
                                                        if ($_GET['vehicletransportplanid'] != "") {
                                                            $conditionwednesday = " AND DATENAME(DW,a.DATEPRESENT) = 'Wednesday' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "' AND a.VEHICLETRANSPORTPLANID = '" . $_GET['vehicletransportplanid'] . "' AND a.STATUSNUMBER = 'O' ";
                                                        } else {
                                                            $conditionwednesday = " AND DATENAME(DW,a.DATEPRESENT) = 'Wednesday' AND (CONVERT(DATE,a.DATEPRESENT,103) BETWEEN CONVERT(DATE,'" . $result_seSystime['STARTWEEK'] . "',103) AND CONVERT(DATE,'" . $result_seSystime['ENDWEEK'] . "',103)) AND a.STATUSNUMBER = 'O' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "'";
                                                        }
//echo $condition1;
                                                        ...
                                                        while ($result_sePlanwednesday = sqlsrv_fetch_array($query_sePlanwednesday, SQLSRV_FETCH_ASSOC)) {
                                                            if ($result_sePlanmonday['COMPANYCODE'] == 'RRC') {
                                                                ...
                                                                $jobsw2 = select_jobautocomplate('megVehicletransportprice_v2', 'select_vehicletransportprice', '');
                                                            }
                                                            ?>
                                                            <tr 
                                                            <?php
                                                            if ($result_sePlanwednesday['ACTUALPRICE'] == '' || $result_sePlanwednesday['ACTUALPRICE'] == '0.00') {
                                                                ?>
                                                                    style="color: red"
                                                                    <?php
                                                                }
                                                                ...
                                                                <?php
                                                                if ($result_sePlanwednesday['COMPANYCODE'] == 'RCC' || $result_sePlanwednesday['COMPANYCODE'] == 'RATC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrcc('<?= $result_sePlanwednesday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupd"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlanwednesday['COMPANYCODE'] == 'RRC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrrc('<?= $result_sePlanwednesday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrrc"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlanwednesday['COMPANYCODE'] == 'RKS') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrks('<?= $result_sePlanwednesday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrks"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button title="COPY JOB" type="button" onclick="select_copyjob('<?= $result_sePlanwednesday['JOBNO'] ?>', '<?= $result_sePlanwednesday['JOBSTART'] ?>', '<?= $result_sePlanwednesday['JOBEND'] ?>', '<?= $result_sePlanwednesday['DATEVLIN'] ?>');" class="btn btn-default btn-circle" data-toggle="modal"  data-target="#modal_copyjob"><span class="fa fa-copy"></span></button>
                                                                </td>
                                                                <td><?= $result_sePlanwednesday['EMPLOYEENAME1'] ?></td>
                                                                <td><?= $result_sePlanwednesday['EMPLOYEENAME2'] ?></td>
                                                                <td><?= $result_sePlanwednesday['THAINAME'] ?></td>
                                                                <td><?= $result_sePlanwednesday['JOBSTART'] ?></td>
                                                                <td><?= $result_sePlanwednesday['CLUSTER'] ?></td>
                                                                <td><?= $result_sePlanwednesday['JOBEND'] ?></td>
                                                                <td ><?= $result_sePlanwednesday['JOBNO'] ?></td>
                                                                <td ><?= $result_sePlanwednesday['TRIPNO'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEINPUT'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEWORKING'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEWORKSUS'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEPRESENT'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEVLIN'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEVLOUT'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATEDEALERIN'] ?></td>
                                                                <td><?= $result_sePlanwednesday['DATERETURN'] ?></td>
                                                                <td>
                                                                    <?php
                                            ...
                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example44" role="grid" aria-describedby="dataTables-example44" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $i4 = 1;
                                                        if ($_GET['vehicletransportplanid'] != "") {
                                                            $conditionthursday = " AND DATENAME(DW,a.DATEPRESENT) = 'Thursday' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "' AND a.VEHICLETRANSPORTPLANID = '" . $_GET['vehicletransportplanid'] . "' AND a.STATUSNUMBER = 'O'";
                                                        } else {

                                                            $conditionthursday = " AND DATENAME(DW,a.DATEPRESENT) = 'Thursday' AND (CONVERT(DATE,a.DATEPRESENT,103) BETWEEN CONVERT(DATE,'" . $result_seSystime['STARTWEEK'] . "',103) AND CONVERT(DATE,'" . $result_seSystime['ENDWEEK'] . "',103)) AND a.STATUSNUMBER = 'O' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "'";
                                                        }
                                                        ...
                                                        while ($result_sePlanthursday = sqlsrv_fetch_array($query_sePlanthursday, SQLSRV_FETCH_ASSOC)) {
                                                            if ($result_sePlanmonday['COMPANYCODE'] == 'RRC') {
                                                                ...
                                                                $jobsth2 = select_jobautocomplate('megVehicletransportprice_v2', 'select_vehicletransportprice', '');
                                                            }
                                                            ?>
                                                            <tr 
                                                            <?php
                                                            if ($result_sePlanthursday['ACTUALPRICE'] == '' || $result_sePlanthursday['ACTUALPRICE'] == '0.00') {
                                                                ?>
                                                                    style="color: red"
                                                                    <?php
                                                                }
                                                                ...
                                                                <?php
                                                                if ($result_sePlanthursday['COMPANYCODE'] == 'RCC' || $result_sePlanthursday['COMPANYCODE'] == 'RATC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrcc('<?= $result_sePlanthursday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupd"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlanthursday['COMPANYCODE'] == 'RRC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrrc('<?= $result_sePlanthursday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrrc"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlanthursday['COMPANYCODE'] == 'RKS') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrks('<?= $result_sePlanthursday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrks"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button title="COPY JOB" type="button" onclick="select_copyjob('<?= $result_sePlanthursday['JOBNO'] ?>', '<?= $result_sePlanthursday['JOBSTART'] ?>', '<?= $result_sePlanthursday['JOBEND'] ?>', '<?= $result_sePlanthursday['DATEVLIN'] ?>');" class="btn btn-default btn-circle" data-toggle="modal"  data-target="#modal_copyjob"><span class="fa fa-copy"></span></button>
                                                                </td>
                                                                <td><?= $result_sePlanthursday['EMPLOYEENAME1'] ?></td>
                                                                <td><?= $result_sePlanthursday['EMPLOYEENAME2'] ?></td>
                                                                <td><?= $result_sePlanthursday['THAINAME'] ?></td>
                                                                <td><?= $result_sePlanthursday['JOBSTART'] ?></td>
                                                                <td><?= $result_sePlanthursday['CLUSTER'] ?></td>
                                                                <td><?= $result_sePlanthursday['JOBEND'] ?></td>
                                                                <td ><?= $result_sePlanthursday['JOBNO'] ?></td>
                                                                <td ><?= $result_sePlanthursday['TRIPNO'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEINPUT'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEWORKING'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEWORKSUS'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEPRESENT'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEVLIN'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEVLOUT'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATEDEALERIN'] ?></td>
                                                                <td><?= $result_sePlanthursday['DATERETURN'] ?></td>
                                                                <td>
                                                                    <?php
                                            ...
                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example55" role="grid" aria-describedby="dataTables-example55" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $i5 = 1;
                                                        if ($_GET['vehicletransportplanid'] != "") {
                                                            $conditionfriday = " AND DATENAME(DW,a.DATEPRESENT) = 'Friday' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "' AND a.VEHICLETRANSPORTPLANID = '" . $_GET['vehicletransportplanid'] . "' AND a.STATUSNUMBER = 'O'";
                                                        } else {
                                                            $conditionfriday = " AND DATENAME(DW,a.DATEPRESENT) = 'Friday' AND (CONVERT(DATE,a.DATEPRESENT,103) BETWEEN CONVERT(DATE,'" . $result_seSystime['STARTWEEK'] . "',103) AND CONVERT(DATE,'" . $result_seSystime['ENDWEEK'] . "',103)) AND a.STATUSNUMBER = 'O' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "'";
                                                        }
                                                        ...
                                                        while ($result_sePlanfriday = sqlsrv_fetch_array($query_sePlanfriday, SQLSRV_FETCH_ASSOC)) {
                                                            if ($result_sePlanmonday['COMPANYCODE'] == 'RRC') {
                                                                ...
                                                                $jobsf2 = select_jobautocomplate('megVehicletransportprice_v2', 'select_vehicletransportprice', '');
                                                            }
                                                            ?>
                                                            <tr 
                                                            <?php
                                                            if ($result_sePlanfriday['ACTUALPRICE'] == '' || $result_sePlanfriday['ACTUALPRICE'] == '0.00') {
                                                                ?>
                                                                    style="color: red"
                                                                    <?php
                                                                }
                                                                ...
                                                                <?php
                                                                if ($result_sePlanfriday['COMPANYCODE'] == 'RCC' || $result_sePlanfriday['COMPANYCODE'] == 'RATC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrcc('<?= $result_sePlanfriday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupd"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlanfriday['COMPANYCODE'] == 'RRC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrrc('<?= $result_sePlanfriday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrrc"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlanfriday['COMPANYCODE'] == 'RKS') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrks('<?= $result_sePlanfriday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrks"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button title="COPY JOB" type="button" onclick="select_copyjob('<?= $result_sePlanfriday['JOBNO'] ?>', '<?= $result_sePlanfriday['JOBSTART'] ?>', '<?= $result_sePlanfriday['JOBEND'] ?>', '<?= $result_sePlanfriday['DATEVLIN'] ?>');" class="btn btn-default btn-circle" data-toggle="modal"  data-target="#modal_copyjob"><span class="fa fa-copy"></span></button>
                                                                </td>
                                                                <td><?= $result_sePlanfriday['EMPLOYEENAME1'] ?></td>
                                                                <td><?= $result_sePlanfriday['EMPLOYEENAME2'] ?></td>
                                                                <td><?= $result_sePlanfriday['THAINAME'] ?></td>
                                                                <td><?= $result_sePlanfriday['JOBSTART'] ?></td>
                                                                <td><?= $result_sePlanfriday['CLUSTER'] ?></td>
                                                                <td><?= $result_sePlanfriday['JOBEND'] ?></td>
                                                                <td ><?= $result_sePlanfriday['JOBNO'] ?></td>
                                                                <td ><?= $result_sePlanfriday['TRIPNO'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEINPUT'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEWORKING'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEWORKSUS'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEPRESENT'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEVLIN'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEVLOUT'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATEDEALERIN'] ?></td>
                                                                <td><?= $result_sePlanfriday['DATERETURN'] ?></td>
                                                                <td>
                                                                    <?php
                                            ...
                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example66" role="grid" aria-describedby="dataTables-example66" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $i6 = 1;
                                                        if ($_GET['vehicletransportplanid'] != "") {
                                                            $conditionsaturday = " AND DATENAME(DW,a.DATEPRESENT) = 'Saturday' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "' AND a.VEHICLETRANSPORTPLANID = '" . $_GET['vehicletransportplanid'] . "' AND a.STATUSNUMBER = 'O'";
                                                        } else {
                                                            $conditionsaturday = " AND DATENAME(DW,a.DATEPRESENT) = 'Saturday' AND (CONVERT(DATE,a.DATEPRESENT,103) BETWEEN CONVERT(DATE,'" . $result_seSystime['STARTWEEK'] . "',103) AND CONVERT(DATE,'" . $result_seSystime['ENDWEEK'] . "',103)) AND a.STATUSNUMBER = 'O' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "'";
                                                        }
//echo $conditionsaturday;
                                                        ...
                                                        while ($result_sePlansaturday = sqlsrv_fetch_array($query_sePlansaturday, SQLSRV_FETCH_ASSOC)) {
                                                            if ($result_sePlanmonday['COMPANYCODE'] == 'RRC') {
                                                                ...
                                                                $jobssat2 = select_jobautocomplate('megVehicletransportprice_v2', 'select_vehicletransportprice', '');
                                                            }
                                                            ?>
                                                            <tr 
                                                            <?php
                                                            if ($result_sePlansaturday['ACTUALPRICE'] == '' || $result_sePlansaturday['ACTUALPRICE'] == '0.00') {
                                                                ?>
                                                                    style="color: red"
                                                                    <?php
                                                                }
                                                                ...
                                                                <?php
                                                                if ($result_sePlansaturday['COMPANYCODE'] == 'RCC' || $result_sePlansaturday['COMPANYCODE'] == 'RATC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrcc('<?= $result_sePlansaturday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupd"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlansaturday['COMPANYCODE'] == 'RRC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrrc('<?= $result_sePlansaturday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrrc"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlansaturday['COMPANYCODE'] == 'RKS') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrks('<?= $result_sePlansaturday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrks"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                <td style="text-align: center;">
                                                                    <button title="COPY JOB" type="button" onclick="select_copyjob('<?= $result_sePlansaturday['JOBNO'] ?>', '<?= $result_sePlansaturday['JOBSTART'] ?>', '<?= $result_sePlansaturday['JOBEND'] ?>', '<?= $result_sePlansaturday['DATEVLIN'] ?>');" class="btn btn-default btn-circle" data-toggle="modal"  data-target="#modal_copyjob"><span class="fa fa-copy"></span></button>
                                                                </td>
                                                                <td><?= $result_sePlansaturday['EMPLOYEENAME1'] ?></td>
                                                                <td><?= $result_sePlansaturday['EMPLOYEENAME2'] ?></td>
                                                                <td><?= $result_sePlansaturday['THAINAME'] ?></td>
                                                                <td><?= $result_sePlansaturday['JOBSTART'] ?></td>
                                                                <td><?= $result_sePlansaturday['CLUSTER'] ?></td>
                                                                <td><?= $result_sePlansaturday['JOBEND'] ?></td>
                                                                <td ><?= $result_sePlansaturday['JOBNO'] ?></td>
                                                                <td ><?= $result_sePlansaturday['TRIPNO'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEINPUT'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEWORKING'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEWORKSUS'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEPRESENT'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEVLIN'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEVLOUT'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATEDEALERIN'] ?></td>
                                                                <td><?= $result_sePlansaturday['DATERETURN'] ?></td>
                                                                <td>
                                                                    <?php
                                            ...
                                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <table  width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example77" role="grid" aria-describedby="dataTables-example77" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $i7 = 1;
                                                        if ($_GET['vehicletransportplanid'] != "") {
                                                            $conditionsunday = " AND DATENAME(DW,a.DATEPRESENT) = 'Sunday' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "' AND a.VEHICLETRANSPORTPLANID = '" . $_GET['vehicletransportplanid'] . "' AND a.STATUSNUMBER = 'O'";
                                                        } else {
                                                            $conditionsunday = " AND DATENAME(DW,a.DATEPRESENT) = 'Sunday' AND (CONVERT(DATE,a.DATEPRESENT,103) BETWEEN CONVERT(DATE,'" . $result_seSystime['STARTWEEK'] . "',103) AND CONVERT(DATE,'" . $result_seSystime['ENDWEEK'] . "',103)) AND a.STATUSNUMBER = 'O' AND a.COMPANYCODE ='" . $_GET['companycode'] . "' AND a.CUSTOMERCODE ='" . $_GET['customercode'] . "'";
                                                        }
                                                        ...
                                                        while ($result_sePlansunday = sqlsrv_fetch_array($query_sePlansunday, SQLSRV_FETCH_ASSOC)) {
                                                            if ($result_sePlanmonday['COMPANYCODE'] == 'RRC') {
                                                                ...
                                                                $jobssun2 = select_jobautocomplate('megVehicletransportprice_v2', 'select_vehicletransportprice', '');
                                                            }
                                                            ?>
                                                            <tr 
                                                            <?php
                                                            if ($result_sePlansunday['ACTUALPRICE'] == '' || $result_sePlansunday['ACTUALPRICE'] == '0.00') {
                                                                ?>
                                                                    style="color: red"
                                                                    <?php
                                                                }
                                                                ...
                                                                <?php
                                                                if ($result_sePlansunday['COMPANYCODE'] == 'RCC' || $result_sePlansunday['COMPANYCODE'] == 'RATC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrcc('<?= $result_sePlansunday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupd"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlansunday['COMPANYCODE'] == 'RRC') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrrc('<?= $result_sePlansunday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrrc"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                } else if ($result_sePlansunday['COMPANYCODE'] == 'RKS') {
                                                                    ?>
                                                                    <td style="text-align: center;">
                                                                        <button onclick="update_modalrks('<?= $result_sePlansunday['VEHICLETRANSPORTPLANID'] ?>')"  data-toggle="modal"  data-target="#modal_copydiagramupdrks"  title="แก้ไขแผนการขนส่ง" type="button" class="btn btn-default btn-circle"><span class="glyphicon glyphicon-wrench"></span></button> 
                                                                    </td>
                                                                    <?php
                                                                }
                                                                ?>
                                                                <td style="text-align: center;">
                                                                    <button title="COPY JOB" type="button" onclick="select_copyjob('<?= $result_sePlansunday['JOBNO'] ?>', '<?= $result_sePlansunday['JOBSTART'] ?>', '<?= $result_sePlansunday['JOBEND'] ?>', '<?= $result_sePlansunday['DATEVLIN'] ?>');" class="btn btn-default btn-circle" data-toggle="modal"  data-target="#modal_copyjob"><span class="fa fa-copy"></span></button>
                                                                </td>
                                                                <td><?= $result_sePlansunday['EMPLOYEENAME1'] ?></td>
                                                                <td><?= $result_sePlansunday['EMPLOYEENAME2'] ?></td>
                                                                <td><?= $result_sePlansunday['THAINAME'] ?></td>
                                                                <td><?= $result_sePlansunday['JOBSTART'] ?></td>
                                                                <td><?= $result_sePlansunday['CLUSTER'] ?></td>
                                                                <td><?= $result_sePlansunday['JOBEND'] ?></td>
                                                                <td ><?= $result_sePlansunday['JOBNO'] ?></td>
                                                                <td ><?= $result_sePlansunday['TRIPNO'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEINPUT'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEWORKING'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEWORKSUS'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEPRESENT'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEVLIN'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEVLOUT'] ?></td>
                                                                <td><?= $result_sePlansunday['DATEDEALERIN'] ?></td>
                                                                <td><?= $result_sePlansunday['DATERETURN'] ?></td>
                                                                <td>
                                                                    <?php
