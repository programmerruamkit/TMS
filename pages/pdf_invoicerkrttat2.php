...
WHERE 1 = 1
AND a.COMPANYCODE ='RKR' AND a.CUSTOMERCODE ='TTAT'
AND a.DOCUMENTCODE != ''
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">บริษัท  โตโยโตมิ ออโต้ พาร์ท (ประเทศไทย)  จำกัด
								<br>สำนักงานใหญ่ ที่อยู่  1/28  หมู่ที่ 5 ต.ท่าสะอ้าน อ.บางปะกง จ.ฉะเชิงเทรา 24130
								<br>โทร.  038-989808-19
								<br> เลขประจำตัวผู้เสียภาษี  0245554001961
      </td>
...
<tbody>
    <tr style="border:1px solid #000;" >
    <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส  	T-003
								<br>บริษัท  โตโยโตมิ ออโต้ พาร์ท (ประเทศไทย)  จำกัด
								<br>สำนักงานใหญ่ ที่อยู่  1/28  หมู่ที่ 5 ต.ท่าสะอ้าน
                                                                <br>อ.บางปะกง จ.ฉะเชิงเทรา 24130
								<br> โทร.  038-989808-19
								<br>เลขประจำตัวผู้เสียภาษี 0245554001961
    </td>
...
while ($result_seBillinginvoice1 = sqlsrv_fetch_array($query_seBillinginvoice1, SQLSRV_FETCH_ASSOC)) {
    $tbody1 .= '<tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;font-size:20px;"  valign="top">ค่าขนส่งสินค้าตามเอกสารแนบ <br> '.$result_seBillings['DOCUMENTCODE'].'</td>
