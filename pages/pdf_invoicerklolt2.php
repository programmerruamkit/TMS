...
WHERE 1 = 1
AND a.COMPANYCODE ='RKL' AND a.CUSTOMERCODE ='OLT'
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส  
        <br>ลูกค้า บริษัท โอกาโมโต ลอจิสติกส์ (ประเทศไทย) จำกัด
        <br>สำนักงานใหญ่ ที่อยู่ 700/655,657 หมู่ที่ 1 ถนนบางนา-ตราด 
        <br>ตำบลพานทอง  อำเภอพานทอง จังหวัดชลบุรี 20160		
        <br>โทร. 038-210278-83						
      </td>
...
while ($result_seBillinginvoice2 = sqlsrv_fetch_array($query_seBillinginvoice2, SQLSRV_FETCH_ASSOC)) {
  ...
  AND COMPANYCODE ='RKL' AND CUSTOMERCODE = 'OLT' ";
  ...
  if ($holiday !='') {
    ...
    if ($holidaysplit[0] !='') {
      $sql_seCount0 = " SELECT COUNT(VEHICLETRANSPORTPLANID) AS 'COUNT_HOLIDAY0' 
        ...
        WHERE COMPANYCODE ='RKL' AND CUSTOMERCODE ='OLT'
...
<tbody>
<tr style="border:1px solid #000;" >
    <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส  ช-001  
         <br>ลูกค้า บริษัท โอกาโมโต ลอจิสติกส์ (ประเทศไทย) จำกัด
        <br>สำนักงานใหญ่ ที่อยู่ 700/655,657 หมู่ที่ 1 ถนนบางนา-ตราด 
        <br>ตำบลพานทอง  อำเภอพานทอง จังหวัดชลบุรี 20160		
        <br>โทร. 038-210278-83									
