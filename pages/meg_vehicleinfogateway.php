                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4" style="background-color: #fffff;font-size:20px;text-align: center">
                                        <h3><b>ประเภทการขนส่ง : ขนส่งทุกประเภท</b></h3>
                                    </div>
                                </div>
                                <div class="panel-body">
                                        <div class="row" >
                                            <div  class="col-sm-4 col-md-4 col-lg-4" id="pic1" style="border-style: solid; background:#fffff;text-align: center">
                                            <!-- <div class="form-group">
                                                <p><img style="height:200px; width:200px;" src="../images/hinoT.png" data-action="zoom" alt="Pic_Truck1"/></p>
                                            </div> -->
                                            <div class="form-group">
                                                <p><img id="myImg" src="../images/truck/<?=$result_info['VEHICLEREGISNUMBER']?>.webp" alt="ทะเบียน : <b>(<?=$result_info['VEHICLEREGISNUMBER'] ?>)</b> <br> ชื่อรถ: <b>(<?=$result_info['THAINAME'] ?>)</b>" width="400" height="280">
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label>*สายงาน</label>
                                                <input class="form-control"  id="txt_truckline" name="txt_truckline" value="<?= $result_info['TRUCKLINE'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <label>อายุรถ</label>
                                                <input disabled="" class="form-control"  id="txt_truckold" name="txt_truckold" value="<?= $result_info['TRUCKYEAR'] ?> ปี <?= $result_info['TRUCKMONTH'] ?> เดือน">
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="form-group">
