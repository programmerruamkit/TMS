...
$mpdf = new mPDF('', 'Letter', '', '', 6, 22, 85, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
            <td colspan="2" style="font-size:20px">สำนักงานใหญ่ เลขที่ 51  ม.4  ต.บ้านเก่า  อ.พานทอง  จ.ชลบุรี 20160  </td>
       </tr>
       <tr>
      ...
      <tr>
            <td style="width: 70%;font-size:20px">บริษัท  โตโยโตมิ ออโต้ พาร์ท (ประเทศไทย)  จำกัด</td>
            <td style="width: 30%;text-align:right;font-size:20px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">สำนักงานใหญ่ ที่อยู่  1/28  หมู่ที่ 5 ต.ท่าสะอ้าน อ.บางปะกง จ.ฉะเชิงเทรา 24130</td>
            <td style="width: 30%;text-align:right;font-size:20px">วันที่ ' . $result_seInvoicecode['DULYDATE'] . '</td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">เลขประจำตัวผู้เสียภาษี 0245554001961</td>
...
$thead3 = '<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 20%;"><b><font style="font-size: 24px">จำนวนเงิน(บาท)</font></b></td>
      </tr>
    </thead><tbody>';
