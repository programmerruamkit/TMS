...
//new 23/01/19
$top1 = ($result_seTenko1['TENKOPRESSUREDATA_90160']<=160)?"Y":"N";
$bottom1 = ($result_seTenko1['TENKOPRESSUREDATA_60100']>=90)?"Y":"N";
$TENKOPRESSURERESULT1 = ($top1 == "Y" && $bottom1 == "Y")?"Y":"N";
$summary1 = ($TENKOTEMPERATURERESULT1 == "Y" && $TENKOALCOHOLRESULT_BEFORE1 == "Y" && $TENKORESTRESULT1 == "Y" && $TENKOOXYGENRESULT1 == "Y" && $TENKOPRESSURERESULT1 == "Y")?"Y":"N";
...
$top2 = ($result_seTenko2['TENKOPRESSUREDATA_90160']<=160)?"Y":"N";
$bottom2 = ($result_seTenko2['TENKOPRESSUREDATA_60100']>=90)?"Y":"N";
$TENKOPRESSURERESULT2 = ($top2 == "Y" && $bottom2 == "Y")?"Y":"N";
$summary2 = ($TENKOTEMPERATURERESULT2 == "Y" && $TENKOALCOHOLRESULT_BEFORE2 == "Y" && $TENKORESTRESULT2 == "Y" && $TENKOOXYGENRESULT2 == "Y" && $TENKOPRESSURERESULT2 == "Y")?"Y":"N";

$checkT = ($summary1 == "Y" && ($summary2 == "" || $summary2 = "Y"))?"/":"";
$checkF = ($summary1 == "N" && ($summary2 == "" || $summary2 = "N"))?"/":"";
...
<thead>
    ...
    <tr style="border:1px solid #000;padding:4px;">
     ...
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">'.$result_seTenko1['TENKOPRESSUREDATA_90160'].'</td>
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">'.$summary1.'</td>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">&nbsp;</td>
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">&nbsp;</td>
    ...
    <tr style="border:1px solid #000;padding:4px;">
     ...
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">'.$result_seTenko2['TENKOPRESSUREDATA_90160'].'</td>
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;">'.$summary2.'</td>
    </tr>
    <tr style="border:1px solid #000;padding:4px;">
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">&nbsp;</td>
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">&nbsp;</td>
...
<thead>
    ...
    <tr style="border:1px solid #000;padding:4px;">
     ...
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">'.$checkT.'</td>
     <td style="border-right:1px solid #000;padding:4px;text-align:center;">'.$checkF.'</td>
     </tr>
    </tbody></table>
