...
$strExcelFileName = "Report".$result_getDate['GETDATE']."_AAGW.xls";
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="7" style="border-top:1px solid #000;font-size:14px;border:1px solid #000;padding:6px;text-align:center">
                        <b>สรุปรายงานตัวปฎิบัติงานวันที่ <?= $result_getDate['GETDATE'] ?> - <?= $result_getDate['GETDATE'] ?> (Administration)(Administration)</b> 
...
AND b.[DEPARTMENTCODE] = '01' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '01' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '04' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '02' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '02' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '04' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '04' AND b.[SECTIONCODE] = '03' AND b.AREA = 'gateway'
) AS A";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '03' AND b.AREA = 'gateway'
) AS A";
...
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '01' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '01' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '04' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '02' AND b.[SECTIONCODE] = '01' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '02' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '04' AND b.[SECTIONCODE] = '02' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '04' AND b.[SECTIONCODE] = '03' AND b.AREA = 'gateway' ) AS A";
...
WHERE  a.REMARK = '0'
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '03' AND b.AREA = 'gateway' ) AS A";
...
AND [DEPARTMENTCODE] = '01' AND [SECTIONCODE] = '02' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '01' AND [SECTIONCODE] = '01' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '03' AND [SECTIONCODE] = '01' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '04' AND [SECTIONCODE] = '01' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '02' AND [SECTIONCODE] = '01' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '02' AND [SECTIONCODE] = '02' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '03' AND [SECTIONCODE] = '02' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '04' AND [SECTIONCODE] = '02' AND AREA = 'gateway' ";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '04' AND [SECTIONCODE] = '03' AND AREA = 'gateway'";
...
(SELECT EMPLOYEECODE FROM [dbo].[WORKCHECKIN] WHERE CONVERT(DATE,CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103))
AND [DEPARTMENTCODE] = '03' AND [SECTIONCODE] = '03' AND AREA = 'gateway' ";
...
WHERE 1=1
AND CONVERT(DATE,a.CREATEDATE,103) BETWEEN CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) AND CONVERT(DATE,'" . $result_getDate['GETDATE'] . "',103) 
AND b.[DEPARTMENTCODE] = '03' AND b.[SECTIONCODE] = '03' AND b.AREA = 'gateway' AND d.PositionGroup = 'เจ้าหน้าที่'
";
                    $query_seSumary10 = sqlsrv_query($conn, $sql_seSumary10, $params_seSumary10);
        ...
        <table   style="border-collapse: collapse;margin-top:8px;font-size:10px" width="100%"  >
            <thead>
                <tr>
                    ...
                    <th colspan="14" style="border-top:1px solid #000;font-size:14px;border:1px solid #000;padding:6px;text-align:center">
                        <b>รายงานตัวปฎิบัติงานประจำวันที่ <?= $result_getDate['GETDATE'] ?> ถึงวันที่ <?= $result_getDate['GETDATE'] ?> (Administration)(Administration)</b> 
            ...
            <tbody>
                <?php
                    ...
                    $condWorkcheckin2 = " AND c.DEPARTMENTCODE = '01' AND c.[SECTIONCODE] = '01'";
                    ...
                    $params_seWorkcheckin = array(
                        ...
                        array(" AND c.AREA = 'gateway'", SQLSRV_PARAM_IN)
                    );
...
WHERE 
    RowNum = (SELECT COUNT(*) FROM STRING_SPLIT('" . $result_seWorkcheckin['MAPADDRESS'] . "',' '))-2";
       ...
       AND  b.AREA = 'gateway' AND b.DEPARTMENTCODE = '01' AND b.[SECTIONCODE] = '01' AND b.DEPARTMENTCODE !='' AND b.[SECTIONCODE] !=''";
