        ...
        <div id="wrapper">
                ...
                <div class="row" >
                    <div class="col-lg-12">
                        ...
                        <h2 class="page-header"><i class="fa fa-file-text-o"></i>
                            รายงานข้อมูลการ CHECK IN ช่วงปีใหม่ 2564
                        </h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                        ...
                                        <div class="row" >
                                            <div class="col-lg-12">
                                                <div class="well">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" style="background-color: #e7e7e7">
                                                            <h4><b>รายงาน CHECK IN ช่วงปีใหม่ </b></h4>
                                                        </div>
                                                    </div>
                                                        <div class="col-lg-2">
                                                        ...
                                                        <div class="col-lg-2" style="text-align: right">
                                                            <label>&nbsp;</label><br>
                                                            <a href="#" onclick="select_dailytenkoofficer();" class="btn btn-default">รานงานการรายงานตัวปีใหม่<li class="fa fa-file-excel-o" ></li></a>
            ...
            <script type="text/javascript">
                                                                ...
                                                                function select_dailytenkoofficer()
                                                                {
                                                                    ...
                                                                    if (department =='02' && (section =='01' || section =='02') ) { // แผนกบัญชีและวางบิล
                                                                         window.open('excel_reportcheckinNewYear_acc.php?datestart=' + datestart +  '&department=' + department+ '&section=' + section+ '&area=' + area, '_blank');    
                                                                    }else if (department =='03' && section == '03') {// แผนก SQ
                                                                         window.open('excel_reportcheckinNewYear_sq.php?datestart=' + datestart + '&department=' + department+ '&section=' + section+ '&area=' + area, '_blank');   
                                                                    }else{
                                                                        window.open('excel_reportcheckinNewYear.php?datestart=' + datestart +  '&department=' + department+ '&section=' + section+ '&area=' + area, '_blank');   
