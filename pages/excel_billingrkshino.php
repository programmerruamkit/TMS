...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSHINO_Billing.xls";
} else {
  $strExcelFileName = "RKSHINO_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
            <td colspan="10" style="font-size:20px">บริษัท ร่วมกิจรุ่งเรือง เซอร์วิส จำกัด (RUAMKIT RUNGRUENG SERVICES CO., LTD.)</td>
       </tr>
       <tr>
            <td colspan="10" style="font-size:20px">สำนักงานใหญ่ เลขที่ 51 หมู่ 4 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160 โทรศัพท์ : (038)-452824-5 โทรสาร : (038)-210396</td>
       </tr>
       <tr>
            <td colspan="10" style="font-size:20px">เลขประจำตัวผู้เสียภาษี  0105544064899</td>
       </tr>
       <tr>
            <td colspan="10">&nbsp;</td>
       </tr>
      ...
      <tr>
       ...
       <tr>
            <td colspan="5" style="font-size:20px">สาขาที่ 3 ที่อยู่  700/509  หมู่ 2 ต.บ้านเก่า อ.พานทอง จ.ชลบุรี 20160 </td>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKR' AND CUSTOMERCODE = 'RKSHINO'";
