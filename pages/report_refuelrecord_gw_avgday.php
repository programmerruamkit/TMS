<?php
                    ...
                    /* Table_1 */
                        /* SQL QUERY */ 
                            // Query ใหม่ ดึงจาก Table TEMP_OILAVERAGE_GW และ นำมาคำนวณ และ แสดงผล ใช้เวลาไม่ถึง 1 วินาที
                                ${"s_1".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RCC' AND TYPE='4L' AND ROUTE='TTT' AND WOTY='NM' AND DWK='$start_ymd_new'"; 
                                ${"s_2".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RCC' AND TYPE='8L' AND ROUTE='TTT' AND WOTY='SH' AND DWK='$start_ymd_new'";
                                ${"s_3".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RCC' AND TYPE='8L' AND ROUTE='TTT' AND WOTY='NM' AND DWK='$start_ymd_new'";
                                ${"s_4".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RCC' AND TYPE='8L' AND ROUTE='TTT' AND WOTY='LR' AND DWK='$start_ymd_new'";
                                ${"s_5".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RATC' AND TYPE='8L' AND ROUTE='TTT' AND WOTY='SH' AND DWK='$start_ymd_new'";
                                ${"s_6".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RATC' AND TYPE='8L' AND ROUTE='TTT' AND WOTY='NM' AND DWK='$start_ymd_new'";
                                ${"s_7".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RATC' AND TYPE='8L' AND ROUTE='TTT' AND WOTY='LR' AND DWK='$start_ymd_new'";
                                ${"s_8".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='10W(Van)' AND ROUTE='' AND WOTY='' AND DWK='$start_ymd_new'";
                                ${"s_9".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='10W(Dump)' AND ROUTE='' AND WOTY='' AND DWK='$start_ymd_new'";
                                ${"s_10".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='10W(กระบะสไลด์)' AND ROUTE='' AND WOTY='' AND DWK='$start_ymd_new'";
                                ${"s_11".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='22W(Dump)' AND ROUTE='' AND WOTY='' AND DWK='$start_ymd_new'";
                                ${"s_12".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='Semitrailer' AND ROUTE='' AND WOTY='' AND DWK='$start_ymd_new'";
                                ${"s_13".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='10W (Van)' AND ROUTE='T-001-T-004' AND WOTY='' AND DWK='$start_ymd_new'";
                                ${"s_14".$work_sheet} = "SELECT DISTINCT * FROM TEMP_OILAVERAGE_GW WHERE CPNC='RRC' AND TYPE='10W (Van)' AND ROUTE='T-005-T-009' AND WOTY='' AND DWK='$start_ymd_new'";
    ...
    // OPEN SECTION
        ...
        $sheet->getDefaultStyle()->applyFromArray($styleText);
        /* SQL QUERY */ 
            $s2_1 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RCC' AND TYPE = '4L' AND ROUTE = 'TTT' AND WOTY = 'NM' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_2 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RCC' AND TYPE = '8L' AND ROUTE = 'TTT' AND WOTY = 'SH' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_3 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RCC' AND TYPE = '8L' AND ROUTE = 'TTT' AND WOTY = 'NM' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_4 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RCC' AND TYPE = '8L' AND ROUTE = 'TTT' AND WOTY = 'LR' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_5 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RATC' AND TYPE = '8L' AND ROUTE = 'TTT' AND WOTY = 'SH' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_6 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RATC' AND TYPE = '8L' AND ROUTE = 'TTT' AND WOTY = 'NM' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_7 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RATC' AND TYPE = '8L' AND ROUTE = 'TTT' AND WOTY = 'LR' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_8 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = '10W(Van)' AND ROUTE = '' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_9 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = '10W(Dump)' AND ROUTE = '' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_10 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = '10W(กระบะสไลด์)' AND ROUTE = '' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_11 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = '22W(Dump)' AND ROUTE = '' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_12 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = 'Semitrailer' AND ROUTE = '' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_13 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = '10W (Van)' AND ROUTE = 'T-001-T-004' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
            $s2_14 = "SELECT DISTINCT CPNC,TYPE,TARGET,ROUTE,WOTY,SUM(CAST(TRIPS AS INT)) AS TOTAL_TRIPS,FORMAT(SUM(CAST(REPLACE(MILEAGE,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_MILEAGE,FORMAT(SUM(CAST(REPLACE(LITER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_LITER,FORMAT(ROUND(AVG(CAST(REPLACE(ACTUAL,',','') AS DECIMAL(18,2))), 2),'N2') AS TOTAL_ACTUAL,ROUND(AVG(CASE WHEN [MIN] = '9,999,999,999.00' THEN NULL ELSE CAST([MIN] AS FLOAT) END), 2) AS TOTAL_MIN,ROUND(AVG(CASE WHEN [MAX] = '-9,999,999,999.00' THEN NULL ELSE CAST([MAX] AS FLOAT) END), 2) AS TOTAL_MAX,FORMAT(SUM(CAST(REPLACE(OK,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_OK,FORMAT(SUM(CAST(REPLACE(NG,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_NG,CONCAT(CAST(ROUND(AVG(CAST(REPLACE(REPLACE(PERCENTAGE,',',''),'%','') AS DECIMAL(18,2))),0) AS INT),'%') AS TOTAL_PERCENTAGE,FORMAT(SUM(CAST(REPLACE(DRIVER,',','') AS DECIMAL(18,2))),'N2') AS TOTAL_DRIVER FROM dbo.TEMP_OILAVERAGE_GW WHERE CPNC = 'RRC' AND TYPE = '10W (Van)' AND ROUTE = 'T-005-T-009' AND WOTY = '' AND DWK BETWEEN '$startsumSQL' AND '$endsumSQL' GROUP BY CPNC,TYPE,TARGET,ROUTE,WOTY"; 
    ...
    $RENAME= "สรุปค่าเฉลี่ยน้ำมันรายวัน";
