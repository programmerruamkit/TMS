                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6"><a href='index2.php'>หน้าแรก</a> / ข้อมูลรถพื้นที่เกตุเวย์</div>
                                        <div class="col-sm-6 text-right"><a target="_bank" href='meg_vehiclrinfogateway.php?vehicleinfoid=&meg=add'>เพิ่มข้อมูลรถ</a></div>
                                    </div>
