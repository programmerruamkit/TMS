...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLTDEM_Billing.xls";
} else {
  $strExcelFileName = "RKLTDEM_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
            <td colspan="10" style="font-size:20px">สำนักงานสาขาที่ 1  เลขที่ 51 หมู่ 4 ตำบลบ้านเก่า อำเภอพานทอง จังหวัดชลบุรี 20160</td>
       </tr>
       <tr>
...
<table style="width: 100%;">
    <thead>
        <tr>
            <td colspan="10" style="text-align:center;font-size:28px"><b>ใบส่งสินค้าSR</b></td>
    </thead>
    <tbody>
      <tr>
            <td colspan="10" style="font-size:20px">บริษัท ร่วมกิจรุ่งเรือง โลจิสติคส์ จำกัด (RUAMKIT RUNGRUENG LOGISTICS CO., LTD.)</td>
      ...
      <tr>
       ...
       <tr>
            <td colspan="6" style="font-size:20px">สาขาที่ 00019 ที่อยู่  99 หมู่ 2 ต.ลาดขวาง อ.บ้านโพธิ์ จ.ฉะเชิงเทรา 24140</td>
            <td colspan="4" style="text-align:right;font-size:20px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?> เครดิต 30 วัน</td>
       </tr>
       <tr>
            <td colspan="6" style="font-size:20px">เลขประจำตัวผู้เสียภาษี 0105505001679</td>
       </tr>
...
<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:10;margin-top:8px;">
  <thead>
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;width: 15%;font-size:18px"><b>จาก</b></td>
