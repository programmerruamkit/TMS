                                        ...
                                        <div class="col-lg-12">
                                            <div class="well">
                                                <div class="row">
                                                    ...
                                                    <!-- สำหรับทดสอบการดึงข้อมูลให้ บัญชีวางบิล -->
                                                    <div class="col-lg-2">
                                                      <label>&nbsp;</label>
                                                      <select id="txt_customercode" name="txt_customercode" class="form-control" >
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-2" style="text-align: left">
                                                        <label>&nbsp;</label><br>
                                                        <a href="#" onclick="excel_reporttransportpalndo_amt();" class="btn btn-default">พิมพ์(DO) <li class="fa fa-print"></li></a>

                                                    </div>
                                                    <div class="col-lg-2" style="text-align: left">
                                                        <label>&nbsp;</label><br>
                                                        <a href="#" onclick="excel_reporttransportpalnamt();" class="btn btn-default">พิมพ์ <li class="fa fa-print"></li></a>
            ...
            <script>
                                                            ...
                                                            function select_reporttransportplanamt()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    url: 'meg_data.php',
                                                                    data: {
                                                                        txt_flg: "select_reporttransportplanamt", datestart: datestart, dateend: dateend,companycode: companycode
                                                                    },
                                                            ...
                                                            function excel_reporttransportpalnamt()
                                                            {
                                                                var datestart       = document.getElementById('txt_datestart').value;
                                                                var dateend         = document.getElementById('txt_dateend').value;
                                                                var companycode     = document.getElementById('txt_companycode').value;
                                                                ...
                                                                if (companycode == '') {
                                                                    ...
                                                                    window.open('excel_reporttransportplanamt.php?datestart=' + datestart + '&dateend=' + dateend+ '&companycode=' + companycode + '&customercode=' + customercode, '_blank');
                                                                }
                                                                

                                                            }
                                                            
                                                            function excel_reporttransportpalndo_amt()
                                                            {
                                                                var datestart       = document.getElementById('txt_datestart').value;
                                                                var dateend         = document.getElementById('txt_dateend').value;
                                                                var companycode     = document.getElementById('txt_companycode').value;
                                                                ...
                                                                if (companycode == '') {
                                                                    ...
                                                                    window.open('excel_reporttransportplando_amt.php?datestart=' + datestart + '&dateend=' + dateend+ '&companycode=' + companycode + '&customercode=' + customercode, '_blank');
                                                                }
