                ...
                <div  id="testing">
                    ...
                    <div class="col-lg-12" style="text-align:center;">
                        <h2 class="page-header"><i class="fa fa-bar-chart-o fa-fw"></i>  
                            Data Graph Punctuality Monthly:&nbsp;<b><?=$month?> <?=$years;?></b>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">                          
                                <div class="col-lg-12" style="text-align: center;">   
                                        <form method="post" id="make_pdf" action="meg_digitaltenko_Punctuality_MonthGraphPrintCreatePDF.php?month='<?=$month?>'"  target="_blank">
                                ...
                                <div class="row question-template">
                                    <div class="col-lg-12" style="text-align:center;">
                                        <!-- <h2 class="page-header"><i class="fa fa-bar-chart-o fa-fw"></i>  
                                            Data Graph Punctuality Monthly:&nbsp;<b><?=DateThai($strDate)?></b>
                                            Data Graph Punctuality Monthly:&nbsp;<b><?=$years+543?></b>
                                            <input type="hidden" id="txt_empcode" name="txt_empcode" value="<?=$_GET['employeecode']?>" ></imput>
                                        </h2> -->
                                    </div>                           
                                    <div class="col-lg-12">
                                            ...
                                            function drawChart1() {
                                                ...
                                                var options1 = 
                                                    {  
                                                        ...
                                                        hAxis: {title: 'Data Graph Punctuality Truck Yard Monthly: <?=$month?> <?=$years?>'},
                                                        legend: {position: 'top'},
                                                        series: {
                                                ...
                                                var options2 = 
                                                    {
                                                        ...
                                                        title : '',
                                                        annotations: {alwaysOutside: true,textStyle: {fontSize: 14,color: '#000',auraColor: 'none'}},
                                                        hAxis: {title: 'Data Graph Punctuality Supplier Monthly: <?=$month?> <?=$years?>'},
                                                        legend: {position: 'top'},
                                                        series: {
                                                ...
                                                var options3 = 
                                                    {
                                                        ...
                                                        title : '',
                                                        annotations: {alwaysOutside: true,textStyle: {fontSize: 14,color: '#000',auraColor: 'none'}},
                                                        hAxis: {title: 'Data Graph Punctuality Plant Monthly: <?=$month?> <?=$years?>'},
                                                        legend: {position: 'top'},
                                                        series: {
