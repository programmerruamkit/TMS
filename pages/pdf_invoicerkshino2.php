...
WHERE 1 = 1
AND a.COMPANYCODE ='RKS' AND a.CUSTOMERCODE ='HINO'
AND CONVERT(DATE,a.DATEVLIN) BETWEEN CONVERT(DATE,'".$result_seBillinginvoice['BILLINGDATE']."',103) AND CONVERT(DATE,'".$result_seBillinginvoice['PAYMENTDATE']."',103)
) a";
...
<tbody>
    <tr>
      <td colspan="1" rowspan="4" style="text-align:center"><img src="../images/logonew.png"></td>
        <td colspan="7" style="font-size:20px" ><b>บริษัท ร่วมกิจรุ่งเรือง เซอร์วิส จำกัด (RUAMKIT RUNGRUENG SERVICES CO., LTD.)<b></td>
   </tr>
   <tr>
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส  ฮ-007
