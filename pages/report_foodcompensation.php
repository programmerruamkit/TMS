            ...
            <script>
                                                                ...
                                                                function select_foodcompensation()
                                                                {
                                                                    ...
                                                                    $.ajax({
                                                                        ...
                                                                        url: 'meg_data.php',
                                                                        data: {
                                                                            txt_flg: "select_foodcompensation", datestart: datestart, dateend: dateend, companycode: companycode
                                                                        },
                                                                ...
                                                                function excel_foodcompensation2()
                                                                {
                                                                    ...
                                                                    window.open('excel_foodcompensation2.php?datestart=' + datestart + '&dateend=' + dateend + '&employeecode=' + employeecode, '_blank');
                                                                ...
                                                                function excel_foodcompensation()
                                                                {
                                                                    ...
                                                                    window.open('excel_foodcompensation.php?datestart=' + datestart + '&dateend=' + dateend + '&companycode=' + companycode, '_blank');

                                                                }
                                                                function excel_foodcompensation3()
                                                                {
                                                                    var datestart = document.getElementById('txt_datestart').value;
                                                                    var dateend = document.getElementById('txt_dateend').value;
                                                                    var companycode = document.getElementById('select_com').value;
                                                                    ...
                                                                    window.open('excel_foodcompensation3.php?datestart=' + datestart + '&dateend=' + dateend + '&companycode=' + companycode, '_blank');
