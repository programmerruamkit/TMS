...
if ($EXCEL != ""){ ?>
    <?php
        $RENAME= "ข้อมูลเติมน้ำมันปั๊มนอก (GW) $startm $starty";
    ...
    <div class="wrapper">
        <section class="invoice">
                <table class="table table-bordered " style="font-size: 20px;" border="0" width="100%">
                    <thead><tr><th colspan="9" style="background-color: #FFFFFF"><div align="center">รายงานข้อมูลเติมน้ำมันปั๊มนอก (GW)</div></th></tr></thead>
                </table>  
                <table class="table table-bordered " style="font-size: 13px;" border="0" width="100%">
                    <thead><tr><th colspan="9" align="center" style="background-color: #FFFFFF">รายงาน ตั้งแต่วันที่ <b><?=$startd.' '.$selectmonth.' '.$start_yen;?></b> ถึงวันที่ <b><?=$endd.' '.$selectmonth.' '.$end_yen;?></b></th></tr></thead>
                </table>            
                <p></p>    
                <p></p>
                <table class="table table-bordered " style="font-size: 13px;" border="1" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="1" colspan="5" style="background-color: #C6E0B4"><div align="center">รายละเอียดการเติมน้ำมัน</div></th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <?php 
                            $i = 1;
                            $SQL_CENTER = "SELECT OSGS_ID,OSGS_PLID,OSGS_TY,CONVERT (VARCHAR (10),OSGS_DRF,20) OSGS_DRF,OSGS_BL,OSGS_AM,OSGS_PAY,OSGS_RM,OSGS_VHCRG,EMPLOYEECODE1,EMPLOYEENAME1,COMPANYCODE,DATEWORKING,PositionNameT,
                            ROW_NUMBER() OVER (PARTITION BY OSGS_PLID ORDER BY OSGS_ID ASC) AS 'ROWNUM'
                                ...
                                AND COMPANYCODE != 'RKR' AND COMPANYCODE != 'RKS' AND COMPANYCODE != 'RKL'
                ...
                <table class="table table-bordered " style="font-size: 18px;" border="0" width="100%">
                    <thead><tr><th colspan="6" style="background-color: #FFFFFF"><div align="center">สรุปประจำวัน แยกตามหมายเลขทะเบียน</div></th></tr></thead>
                </table>   
                <table class="table table-bordered " style="font-size: 13px;" border="1" width="100%">
                    <thead>
                        <tr>
