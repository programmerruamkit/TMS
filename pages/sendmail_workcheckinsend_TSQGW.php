...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_TSQGW.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("bancha@ruamkit.co.th");//bancha@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณบัญชา คงแก้ว

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Transportation แผนก : Safety & Quality
