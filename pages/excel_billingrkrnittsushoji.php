...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRNITTSUSHOJI_Billing.xls";
} else {
  $strExcelFileName = "RKRNITTSUSHOJI_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
            <td colspan="2" style="font-size:20px">เลขประจำตัวผู้เสียภาษี  0105536076131</td>
       </tr>
       <tr>
            <td colspan="2">&nbsp;</td>
       </tr>
      ...
      <tr>
            <td style="width: 70%;font-size:20px">ลูกค้า  บริษัท ที.เอช.เอ็ม.เอ็นเตอร์ไพรส์ (ประเทศไทย) จำกัด</td>
            <td style="width: 30%;text-align:right;font-size:20px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">สำนักงานใหญ่ ที่อยู่  166/58  หมู่ที่ 3 ตำบลบึง อำเภอศรีราชา จังหวัดชลบุรี 20230 </td>
            <td style="width: 30%;text-align:right;font-size:20px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
       </tr>
       <tr>
            <td style="width: 70%;font-size:20px">เลขประจำตัวผู้เสียภาษี 0105552003135</td>
...
<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 12%;"><b><font style="font-size: 24px">ทะเบียนรถ</font></b></td>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKR' AND CUSTOMERCODE = 'NITTSUSHOJI'";
    ...
    if (($result_seBilling['DATE_VLIN'] == $holidaysplit[0]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[1]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[2]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[3]) || ($result_seBilling['DATE_VLIN'] == $holidaysplit[4])) {
      ...
      <tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:left;"><font style="font-size: 24px"></font></td>
