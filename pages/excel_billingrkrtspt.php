...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRDAIKI_Billing.xls";
} else {
  $strExcelFileName = "RKRTSPT_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<body>
  ...
  <table style="width: 100%;">
      ...
      <tbody>
         ...
         <tr>
              <td colspan="5"style="width: 50%;">ลูกค้า บริษัท ไทยซัมมิท พลาสเทค จำกัด </td>
              <td colspan="4"style="width: 50%;text-align:right">เลขที่ <?= $result_seInvoice['INVOICECODE'] ?></td>
         </tr>
         <tr>
              <td colspan="5"style="width: 50%;">สาขา 00001 ที่อยู่  4/3 ม.1 ถนนบางนา-ตราด ต.บางโฉลง อ.บางพลี  จ.สมุทรปราการ  10540 </td>
              <td colspan="4"style="width: 50%;text-align:right">วันที่ <?= $result_getDate['SYSDATE'] ?></td>
         </tr>

         <tr>
              <td colspan="5"style="width: 50%;">เลขประจำตัวผู้เสียภาษี 0115556007119</td>
