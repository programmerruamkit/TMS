...
if ($_GET['area'] == 'amata') {
    ...
    $params_sePhysical1_1 = array(
        array('select_physical2', SQLSRV_PARAM_IN),
    ...
    $params_sePhysicalng1_1 = array(
        array('select_physicalng2', SQLSRV_PARAM_IN),
        array('01 ' . $result_seSystime['MMYYY'], SQLSRV_PARAM_IN)
    );
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    : เพื่อตรวจสอบความพร้อมของร่างกาย หลังจากกลับมา
                </td>
                <td style="width: 10%">
    ...
    <table style="width: 100%;font-size: 12px">
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    1. ถ้าดวงตาหรือใบหน้า ถ้าไม่ปรกติ สอบถามถึงความผิดปรกติ
                </td>
            ...
            <tr>
                ...
                <td style="width: 80%">
                    If Eye or Face is not bright,Must ask to have problem or not.
                </td>
