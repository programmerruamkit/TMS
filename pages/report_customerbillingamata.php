...
<div class="row">
                    <div class="col-lg-6">
                                <?php
                                $meg = 'ลูกค้า';
                                echo "<a href='report_companybillingamata.php?type=report'>บริษัท</a> / " . $meg;
                                $link = "<a href='report_companybillingamata.php?type=report'>บริษัท</a> / <a href='report_customerbillingamata.php?type=report'>ลูกค้า</a>";
                                $_SESSION["link"] = $link;
                                ?>
                    </div>
    <div class="col-lg-6 text-right"><?=$result_seCompany['Company_NameT']?></div>
</div>
                            </div>
                            <!-- /.panel-heading -->
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center">เลือกสายงาน</th>

                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $condCus = " AND a.COMPANYCODE = '" . $_GET['companycode'] . "'";
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu slidedown">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <a href="report_invoice.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>&worktype=<?= $result_seCustomer['WORKTYPE'] ?>">ใบส่งสินค้า</a>

                                                                </li>
                                                                 <li class="divider"></li>
                                                                <li>

                                                                    <a href="report_invoicepallet.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>&worktype=<?= $result_seCustomer['WORKTYPE'] ?>">ใบส่งสินค้า(พาเลท)</a>

                                                                </li>
                                                                <li class="divider"></li>
                                                                <li>

                                                                    <a href="report_billing.php?type=transportplan&meg=add&companycode=<?= $_GET['companycode'] ?>&customercode=<?= $result_seCustomer['CUSTOMERCODE'] ?>&carrytype=<?= $result_seCustomer['CARRYTYPE'] ?>&worktype=<?= $result_seCustomer['WORKTYPE'] ?>">ใบวางบิลลูกค้า</a>
