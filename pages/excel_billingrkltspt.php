...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLTSPT_Billing.xls";
} else {
  $strExcelFileName = "RKLTSPT_Billing" . $_GET['invoicecode'] . ".xls";
}
  ...
  <table style="width: 100%;">
    <thead>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="5"style="width: 50%;">สาขาที่ 00001 ที่อยู่  4/3 หมู่ที่ 1 ถ.บางนา-ตราด กม.16  ต.บางโฉลง อ.บางพลี จ.สมุทรปราการ 10540  </td>
