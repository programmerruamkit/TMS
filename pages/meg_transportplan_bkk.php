                    ...
                    <div class="modal-body">
                                    ...
                                    if ($_GET['customercode'] == 'SKB') {
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select id="cb_copydiagramcartype" name="cb_copydiagramcartype" class="form-control"  title="เลือกประเภทรถ..." >
                                                ...
                                                <option value="ADC-AGLT(FB)">ADC-AGLT(FB)</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="text" class="form-control datetimeen" id="txt_copydiagramdaterk2" name="txt_copydiagramdaterk" onchange="show_timepresent(this.value)" style="display: none" autocomplete="off">
                            </div>
                            <div class="col-lg-2">
