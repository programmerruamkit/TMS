...
$employee = ($_GET['employee'] != "") ? " AND a.TENKOMASTERDIRVERNAME1 = '".$_GET['employee']."'":"";
$area  = ($_GET['area'] == 'amata') ? " AND a.TENKOMASTERCOMPANY IN ('RKS','RKR','RKL')":" AND a.TENKOMASTERCOMPANY IN ('RATC','RCC','RRC')";
$condTenkomasterall = " AND CONVERT(DATE,a.CREATEDATE) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103) ".$employee.$area;
$sql_seTenkomasterall = "{call megEdittenkomaster_v2(?,?)}";
...
while ($result_seTenkomasterall = sqlsrv_fetch_array($query_seTenkomasterall, SQLSRV_FETCH_ASSOC)) {
    $conditionDir = "  AND a.PersonCode = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "'";
    ...
    $condTenkomaster = " AND a.TENKOMASTERDIRVERCODE1 = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "' AND a.TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "'";
    ...
    $condTenkobefor1 = " AND a.TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "' ";
...
<thead>
    ...
    <tr style="border:1px solid #000;padding:4px;">
        <th colspan="5" style="border-right:1px solid #000;padding:4px;text-align:left;">' . $result_sePlain['JOBSTART'] . '</th>
...
';
    ...
    $condTenkotransportDAY11 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "'";
...
';
    ...
    $condTenkotransportDAY21 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "'";
...
';
    ...
    $condTenkotransportDAY31 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "'";
...
';
    ...
    $condTenkotransportDAY41 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "'";
...
';
    ...
    $condTenkotransportDAY51 = " AND TENKOMASTERID = '" . $result_seTenkomasterall['TENKOMASTERID'] . "' AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "'";
...
';
    ...
    $condTenkoafter1 = " AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "' ";
...
';
    $condTenkorisky1 = " AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "' ";
...
<thead>
    ...
    $condTenkogps1 = " AND TENKOMASTERDIRVERCODE = '" . $result_seTenkomasterall['TENKOMASTERDIRVERCODE1'] . "' ";
