        ...
        <div id="wrapper">
                                                    ...
                                                    <div class="col-lg-1">
                                                        ...
                                                        <div id="sec_def">
                                                            <select id="select_status" name="select_status" class="form-control">
                                                                ...
                                                                <option value="success">สมบูรณ์</option>
                                                                <option value="provinceno">จังหวัดไม่ตรง</option>
                                                                <option value="timeno">เวลาไม่ตรง</option>
                                                                <option value="employeeno">ยังไม่รายงายตัว</option>
            ...
            <script>
                                                            ...
                                                            function select_workcheckin()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    url: 'meg_data.php',
                                                                    data: {
                                                                        txt_flg: "select_workcheckin", datestart: datestart, dateend: dateend, department: department, section: section, category: category, time: time,area:'<?=$_GET['area']?>',status:status
                                                                    },
                                                                    success: function (response) {
                                                                        if (response)
                                                                        {
                                                            ...
                                                            function excel_workcheckin()
                                                            {
                                                                ...
                                                                window.open('excel_workcheckin.php?datestart=' + datestart + '&dateend=' + dateend + '&department=' + department + '&section=' + section + '&category=' + category + '&time=' + time+'&area='+'<?=$_GET['area']?>'+'&status='+status, '_blank');
            ...
            <script>
                ...
                function initMap(latitude, longitude, data_uri, latitudemaster, longitudemaster, addressmaster) {
                    ...
                    //        '<img style="width: 100%;" id="img_showemployee" src="' + data_uri + '"/>';
                    document.getElementById('emp_image').innerHTML =
                            '<img style="width: 100%;" id="img_showemployee" src="images/person.png"/>';
