...
$strExcelFileName = "รายงานค่าเที่ยวประจำเดือน" . $_GET['datestart'] . " พนักงาน " . $result_seEHR['nameT'] . ".xls";
...
$i = 1;
      ...
      // ELSE '1'
      // END AS 'COUNTEMP',b.OILAVERAGE AS 'OILAVERAGE',c.MILEAGESTART,c.MILEAGEEND
      ...
      // AND (VEHICLETRANSPORTPRICEID IS NOT NULL AND VEHICLETRANSPORTPRICEID != '')
      // AND (JOBSTART IS NOT NULL AND JOBSTART != '')
      // AND (DOCUMENTCODE IS NOT NULL AND DOCUMENTCODE !='')ORDER BY DATEWORKING ASC";
...
?>
   ...
   <tfoot>
      <tr style="border:1px solid #000;" >
         ...
         <td style="border-right:1px solid #000;padding:3px;text-align:left;"><b>-</b></td>
         <td style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?= number_format($rsc3plus, 2) ?></b></td>
         <td style="border-right:1px solid #000;padding:3px;text-align:center;"><b><?= number_format($rsc3minus, 2) ?></b></td>
         ...
         <td style="border-right:1px solid #000;padding:3px;text-align:left;"><b><?= number_format($rscompensation, 0) ?></b></td>
         <td style="border-right:1px solid #000;padding:3px;text-align:left;"><b>-</b></td>
         <td style="border-right:1px solid #000;padding:3px;text-align:left;"><b>-</b></td>
         <td style="border-right:1px solid #000;padding:3px;text-align:left;"><b>-</b></td>
      </tr>
