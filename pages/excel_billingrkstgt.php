...
<table style="width: 110%;">
    ...
    <tbody><br><br><br>
        <tr>
            <td colspan="10" style="width: 70%;font-size:22px">บริษัท ร่วมกิจรุ่งเรือง เซอร์วิส จำกัด (RUAMKIT RUNGRUENG SERVICES CO.,LTD.)</td>
       </tr>
       <tr>
       ...
       <tr>
            <td colspan="5" style="font-size:22px">ลูกค้า บริษัท โตโยด้า โกเซ (ประเทศไทย) จำกัด  (สำนักงานใหญ่)</td>
            <td colspan="5" style="text-align:right;font-size:22px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
       </tr>
       <tr>
            <td colspan="5" style="font-size:22px">700/489 ม.4  นิคมอุตสาหกรรมอมตะซิตี้ ต.บ้านเก่า  อ.พานทอง  จ.ชลบุรี 20160</td>
            <td colspan="5" style="text-align:right;font-size:22px">วันที่ 28/<?= $date ?> เครดิต 30 วัน</td>
       </tr>
       <tr>
            <td colspan="5" style="font-size:22px">เลขประจำตัวผู้เสียภาษี 0105537013231</td>
            <td colspan="5" style="text-align:right;font-size:22px">วันที่ครบกำหนด <?= $result_seduedate['DUEDATE'] ?></td>
       </tr>
    </tbody>
</table>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    $holidaysplit = explode(",", $holiday);
      ...
      ?>
        ...
        <td style="border-right:1px solid #000;padding:17px;text-align:center;font-size:24px"><?= ($result_seBilling['JOBEND']  == 'INGY' ? 'INGY (Rayong)' : $result_seBilling['JOBEND']) ?></td>
...
?>
     ...
     <tr style="border:1px solid #000;">
        <td  colspan="9" style="border-right:1px solid #000;padding:11px;text-align:center;font-size:24px"><b><?= convert($sumtotal1+$sumtotal2+$sumtotalholiday) ?></td>
