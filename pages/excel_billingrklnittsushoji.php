...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLNITTSUSHOJI_Billing.xls";
} else {
  $strExcelFileName = "RKLNITTSUSHOJI_Billing" . $_GET['invoicecode'] . ".xls";
}
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKL' AND CUSTOMERCODE = 'NITTSUSHOJI' ";
