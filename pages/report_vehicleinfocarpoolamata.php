                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"><a href='index2.php'>หน้าแรก</a> / ข้อมูลรถส่วนกลางพื้นที่อมตะ</div>
                                            ...
                                            <div class="col-lg-12">
                                                <table  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql_infolist = "{call megVehicleinfocarpool_v2(?,?,?,?,?)}";
                                                        ...
                                                        while ($result_infolist = sqlsrv_fetch_array($query_infolist, SQLSRV_FETCH_ASSOC)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center">
                                                                    <button style="text-align: center" onclick="delete_vehicleinfo(<?= $result_infolist['VEHICLEINFOCARPOOLID'] ?>);" title="ลบข้อมูล" type="button" class="list-group-item"><span class="glyphicon glyphicon-remove"></span></button>
                                                                </td>
                                                                <td style="text-align: center">
                                                                    <a href='meg_vehicleinfocarpoolamata.php?vehicleinfoid=<?= $result_infolist['VEHICLEINFOCARPOOLID'] ?>&meg=edit' target="_bank" class='list-group-item'><span class="glyphicon glyphicon-wrench"></span></a>
                                                                </td>
