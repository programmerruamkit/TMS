...
$strExcelFileName = "รายงานปิดงบประมาณรายวัน(Summary)วันที่" . $_GET['datestart'] . ".xls";
...
<body>
  <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-examplesummary2" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
    ...
    <tbody>
      ...
      <?php
      $company = ($_GET['companycode'] != "") ? " AND a.COMPANYCODE = '" . $_GET['companycode'] . "'" : "";
      $condiReporttransport1 = $sql_seCus = "SELECT DISTINCT CUSTOMERCODE FROM [dbo].[VEHICLETRANSPORTPLAN] WHERE COMPANYCODE = '" . $_GET['companycode'] . "'";

      $query_seCus = sqlsrv_query($conn, $sql_seCus, $params_seCus);
      while ($result_seCus = sqlsrv_fetch_array($query_seCus, SQLSRV_FETCH_ASSOC)) {


        $condiReporttransport1sum = " AND CONVERT(DATE,a.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)";
        $condiReporttransport2sum = " AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = '" . $result_seCus['CUSTOMERCODE'] . "'";
        ...
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = '" . $result_seCus['CUSTOMERCODE'] . "' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != '' ";
        ...
        AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''";
        ...
        WHERE CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = '" . $result_seCus['CUSTOMERCODE'] . "' ";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'TGT'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a ";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'TTAT'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a ";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'TKT'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'DAIKI'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'NITTSUSHOJI'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'TDEM'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'GMT'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'HINO'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'TSAT'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        WHERE 1 = 1
        AND CONVERT(DATE,b.DATEWORKING) BETWEEN CONVERT(DATE,'" . $_GET['datestart'] . "',103) AND CONVERT(DATE,'" . $_GET['dateend'] . "',103)
        AND a.COMPANYCODE = '" . $_GET['companycode'] . "' AND a.CUSTOMERCODE = 'TTTC'
        AND b.STATUSNUMBER != '0' AND a.EMPLOYEENAME1 != 'ทดสอบ ทดสอบ' AND a.DOCUMENTCODE IS NOT NULL AND a.DOCUMENTCODE != ''
        GROUP BY a.VEHICLETRANSPORTPLANID,b.ACTUALPRICE) a";
        ...
        if ($result_seReporttransportsum['COMPANYCODE'] == 'RKL' && $result_seCus['CUSTOMERCODE'] == 'SKB') {
          ...
          AND COMPANYCODE = '" . $_GET['companycode'] . "' AND CUSTOMERCODE = '" . $result_seCus['CUSTOMERCODE'] . "' ";
        ...
        $sql_seCartype = "SELECT DISTINCT CARRYTYPE FROM [dbo].[VEHICLETRANSPORTPRICE] WHERE COMPANYCODE = '" . $_GET['companycode'] . "' AND CUSTOMERCODE = '" . $result_seCus['CUSTOMERCODE'] . "' AND CARRYTYPE IS NOT NULL";
        ...
        if ($result_seReporttransportsum['COMPANYCODE'] == 'RKS') {
          ...
          if ($result_seCus['CUSTOMERCODE'] == 'SKB') {
            ...
            $EVASUM = ($TOTALSUM < $result_sumActualpricerkrtsat['SUMACTUALPRICE']) ? OK : NG;
        ...
        if ($result_seReporttransportsum['COMPANYCODE'] == 'RKS') {
          ...
          if ($result_seCus['CUSTOMERCODE'] == 'SKB') {
            ...
            $PROFITSUM = (($result_sumActualpricerkrtsat['SUMACTUALPRICE'] - $TOTALSUM) * 100) / ($result_sumActualpricerkrtsat['SUMACTUALPRICE']);
          }else if ($result_seCus['CUSTOMERCODE'] == 'TTTC') {
        ...
        ?>
        <tr>
          <td style="text-align: center"><label  style="width: 100px"><?= $_GET['companycode'] ?><label></td>
                                                    ...
                                                    <td ><label  style="width: 100px"><?= number_format($result_sumActualpricerkrtdem['SUMACTUALPRICE'], 2) ?><label></td>
                                                      ...
                                                      <td ><label  style="width: 100px"><?= number_format($result_sumActualpricerkrgmt['SUMACTUALPRICE'], 2) ?><label></td>
                                                        ...
                                                        <td ><label  style="width: 100px"><?= number_format($result_sumActualpricerkrhino['SUMACTUALPRICE'], 2) ?><label></td>
                                                          ...
                                                          ?>
                                                          <td ><label  style="width: 100px"><?= number_format($result_sumActualpricerkrtsat['SUMACTUALPRICE'], 2) ?><label></td>
                                                            <?php
                                                          ...
                                                          <td ><label  style="width: 100px"><?= number_format($result_sumActualpricerkrtttc['SUMACTUALPRICE'], 2) ?><label></td>
                                                            ...
                                                            <td ><label  style="width: 100px"><?= number_format($result_sumActualpricerkr['SUMACTUALPRICE'], 2) ?><label></td>
                                                              ...
                                                              +$result_sumActualpricerkrtgt['SUMACTUALPRICE']+$result_sumActualpricerkrttat['SUMACTUALPRICE']+$result_sumActualpricerkrdaiki['SUMACTUALPRICE']
                                                              +$result_sumActualpricerkrtkt['SUMACTUALPRICE']+$result_sumActualpricerkrnitsu['SUMACTUALPRICE']+$result_sumActualpricerkrtdem['SUMACTUALPRICE']
                                                              +$result_sumActualpricerkrgmt['SUMACTUALPRICE']+$result_sumActualpricerkrhino['SUMACTUALPRICE']+$result_sumActualpricerkrtttc['SUMACTUALPRICE']
                                                              +$result_sumActualpricerkrtsat['SUMACTUALPRICE'];
