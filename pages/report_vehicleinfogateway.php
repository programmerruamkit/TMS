                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"><a href='index2.php'>หน้าแรก</a> / ข้อมูลรถพื้นที่เกตเวย์</div>
                                                ...
                                                <table  class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example" style="width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><label style="width: 100px">ประเภททะเบียน</label></th>
                                                            ...
                                                            <th><label style="width: 100px">GPS</label></th>
                                                            <th><label style="width: 100px">บริษัทประกันภัย</label></th>
                                                            <th><label style="width: 100px">วันที่หมดอายุตามป้ายภาษี</label></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $condition1 = "AND a.VEHICLEGROUPCODE !='VG-1403-0755' AND a.AFFCOMPANY IN ('RRC','RCC','RATC') ORDER BY a.VEHICLEINFOID,a.VEHICLEREGISNUMBER ASC";
                                                        $condition2 = "";
                                                        $condition3 = "";
                                                        $condition4 = "";
                                                        ...
                                                        while ($result_infolist = sqlsrv_fetch_array($query_infolist, SQLSRV_FETCH_ASSOC)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $result_infolist['VEHICLETYPEDESC'] ?></td>
                                                                ...
                                                                <td><?= $result_infolist['GPS'] ?></td>
                                                                <td><?= $result_infolist['INSURANCE'] ?></td>
                                                                <td><?= $result_infolist['TAXEXPIREDDATE'] ?></td>
                                                                <td><?= $result_infolist['AFFCOMPANY'] ?></td>
