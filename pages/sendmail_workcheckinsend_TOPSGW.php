...
try {
    $my_path = "D:\Downloads\Report".$result_getDate['GETDATE']."_TOPSGW.xls";
    $mail = new PHPMailer();
    $mail->IsSMTP();
    ...
    $mail->AddAddress("prattana@ruamkit.co.th");//prattana@ruamkit.co.th
    ...
    $mail->Body = "
    เรียนคุณปรารถนา สุขพราย

            รายงานตัวปฎิบัติงานนอกสถานที่ ฝ่าย : Transportation แผนก : Operation
