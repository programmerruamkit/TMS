...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKSTTTC_Billing.xls";
} else {
  $strExcelFileName = "RKSTTTC_Billing" . $_GET['invoicecode'] . ".xls";
}
...
$condBilling2 = " AND c.COMPANYCODE ='RKS' AND c.CUSTOMERCODE ='TTTC'";
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
       <td colspan="5" style="width: 50%;font-size:22px">ลูกค้า บริษัท โตโยต้า ทูโช (ไทยแลนด์) จำกัด</td>
       <td colspan="5" style="width: 50%;text-align:right;font-size:22px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="width: 75%;font-size:22px">สำนักงานใหญ่ 607 ถ.อโศก-ดินแดง แขวงดินแดง เขตดินแดง กรุงเทพ 10400</td>
            <td colspan="5" style="width: 25%;text-align:right;font-size:22px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="width: 75%;font-size:22px">โทร. 02-6255555</td>
            <td colspan="5" style="width: 25%;text-align:right;font-size:22px"></td>
        </tr>
        <tr>
            <td colspan="5" style="width: 75%;font-size:22px">เลขประจำตัวผู้เสียภาษี 0105500000011</td>
            <td colspan="5" style="width: 25%;text-align:right;font-size:22px"></td>
        </tr>
    </tbody>
</table>
...
while ($result_seBilling = sqlsrv_fetch_array($query_seBilling, SQLSRV_FETCH_ASSOC)) {
    ...
    AND COMPANYCODE='RKS' AND CUSTOMERCODE = 'TTTC'";
