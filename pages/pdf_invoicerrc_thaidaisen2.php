...
<tbody>
    <tr>
      <td colspan="1" rowspan="4" style="text-align:center"><img src="../images/logonew.png"></td>
        <td colspan="7" style="font-size:24px" ><b>บริษัท ร่วมกิจ รีไซเคิล แคริเออร์ จำกัด<b></td>
   </tr>
   <tr>
      <td colspan="7" style="font-size:20px">109/1 หมู่ที่ 9 ตำบลหัวสำโรง อำเภอแปลงยาว จังหวัดฉะเชิงเทรา 24190</td>
   </tr>
    <tr>
      <td colspan="7" style="font-size:20px"></td>
   </tr>
    <tr>
      <td colspan="7" style="font-size:20px"></td>
   </tr>
...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:70%;">ลูกค้า : รหัส ท-003
            <br>บจก. ไทย ไดเซ็น เทรดดิ้ง
            <br>1 อาคารวสุ 1 ชั้นที่ 15 ห้องเลขที่ 1501/4
            <br>ซอยสุขุมวิท 25 แขวงคลองเตยเหนือ เขตวัฒนา
...
while ($result_seBillinginvoice2 = sqlsrv_fetch_array($query_seBillinginvoice2, SQLSRV_FETCH_ASSOC)) {
  ...
  AND COMPANYCODE='".$result_seInvoice['COMPANYCODE']."' AND CUSTOMERCODE = '".$result_seInvoice['CUSTOMERCODE']."'";
  ...
  $countall = $countall+$count0+$count1+$count2+$count3+$count4;
  $holidayprice = ($countall*1000);
...
<tr style="border:1px solid #000;">
        ...
        <td style="border-right:1px solid #000;padding:4px;text-align:center;width:35%">ในนาม บริษัท ร่วมกิจ รีไซเคิล แคริเออร์ จำกัด<br><br><br><br><br><br>.....................................................................<br>ลงวันที่............./............/.............<br>ผู้มีอำนาจลงนาม / Authorized Signature</td>
    </tr>
    </tbody>
    <tfoot>
    </tfoot>
