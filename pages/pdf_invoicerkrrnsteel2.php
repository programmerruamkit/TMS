...
<tbody>
    <tr style="border:1px solid #000;font-size:24px">
      <td style="border-right:1px solid #000;padding:4px;width:75%;">ลูกค้า : รหัส อ-034
...
while ($result_seBillinginvoice2 = sqlsrv_fetch_array($query_seBillinginvoice2, SQLSRV_FETCH_ASSOC)) {
  ...
  $sql_seHoliday = " SELECT HOLIDAY AS 'DATE' FROM [dbo].[BILLING_HOLIDAY] 
...
<tbody>
    <tr style="border:1px solid #000;" >
    <td style="border-right:1px solid #000;padding:4px;width:70%">ลูกค้า : รหัส อ-034
          <br>บริษัท อาร์ แอนด์ เอ็น สตีล จำกัด (สำนักงานใหญ่)
          <br>ที่อยู่ 2341/1 ม.6 ถ.เทพารักษ์ ต.เทพารักษ์ 
