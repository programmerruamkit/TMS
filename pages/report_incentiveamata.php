        ...
        <div id="wrapper">
                                            ...
                                            <div class="well">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label>&nbsp;</label>
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-default" onclick="select_reportincentiveamata();">ค้นหา <li class="fa fa-search"></li></button>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-2" style="text-align: right">
                                                        <label>&nbsp;</label><br>
                                                        <a href="#" onclick="excel_reportincentiveamata();" class="btn btn-default">พิมพ์ <li class="fa fa-print"></li></a>
            ...
            <script>
                                                          ...
                                                          function select_customer(companycode)
                                                          {
                                                            ...
                                                            function select_reportincentiveamata()
                                                            {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    url: 'meg_data.php',
                                                                    data: {
                                                                        txt_flg: "select_reportincentiveamata", datestart: datestart, dateend: dateend ,companycode: companycode,customercode: customercodechk
                                                                    },
                                                                    success: function (response) {
                                                                        if (response)
                                                                        {
                                                            ...
                                                            function excel_reportincentiveamata()
                                                            {
                                                                var datestart = document.getElementById('txt_datestart').value;
                                                                var dateend = document.getElementById('txt_dateend').value;
                                                                var companycode = document.getElementById('select_com').value;
                                                                ...
                                                                window.open('excel_reportincentiveamata.php?datestart=' + datestart + '&dateend=' + dateend + '&companycode=' + companycode + '&customercode=' + customercodechk, '_blank');
