...
$mpdf = new mPDF('', 'Letter', '', '', 6, 30, 75, 5, 5, 10);
$style = '
<style>
	body{
...
$table_header3 = '<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
       <td style="width: 50%;font-size:22px">ลูกค้า บริษัท โตโยต้า ทูโช (ไทยแลนด์) จำกัด </td>
       <td style="width: 50%;text-align:right;font-size:22px">เลขที่ ' . $result_seInvoicecode['INVOICECODE'] . '</td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:22px">สำนักงานใหญ่ 607 ถ.อโศก-ดินแดง แขวงดินแดง เขตดินแดง กรุงเทพ 10400</td>
            <td style="width: 25%;text-align:right;font-size:22px">วันที่ ' . $result_seInvoicecode['DULYDATE'] . '</td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:22px">โทร. 02-6255555</td>
            <td style="width: 25%;text-align:right;font-size:22px"></td>
        </tr>
        <tr>
            <td style="width: 75%;font-size:22px">เลขประจำตัวผู้เสียภาษี 0105500000011</td>
            <td style="width: 25%;text-align:right;font-size:22px"></td>
        </tr>
    </tbody>
</table>';
...
$thead3 = '<thead>
        ...
        <td style="border-right:1px solid #000;padding:6px;text-align:center;width: 15%;"><font style="font-size: 24px"><b>ประเภทรถ</b></font></td>
