                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label style="font-size:20px;color:red"><b>มาตรฐานการตรวจร่างกาย Ruamkit (AMT)</b></label><br>
                                                    ...
                                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                                            ...
                                                            $sql_seData = "SELECT b.PositionNameE,b.PositionNameT,b.nameT,b.TaxID,b.PersonCode,a.LABOTRONDATAID,CARDNUMBER,DRIVER_WEIGHT,DRIVER_HEIGHT,DRIVER_BMI,
                                                                ...
                                                                AND (b.PositionNameE ='Driver' OR b.PositionNameT IN ('ผู้ฝึกสอน','Dispatcher','Controller'))
                                        ...
                                        function select_smarthealthdashboard() {
                                            ...
                                            if (datestart == '') {
                                                ...
                                                $.ajax({
                                                    ...
                                                    data: {
                                                        txt_flg: "select_smarthealthdashboard_amt", datestart: datestart, dateend: dateend,drivercode: drivercode
                                                    },
