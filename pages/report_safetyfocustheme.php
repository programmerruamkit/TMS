...
<html lang="en">
            ...
            <div id="page-wrapper" >
                <div class="row">
                    <div class="col-md-12" style="background-color: #e7e7e7">
                        ...
                        if ($_GET['area'] == 'amt') {
                        ?>
                            <h1> SAFETY FOCUS THEME (AMT)</h1>
                        <?php
                        }else{
                        ?>
                            <h1> SAFETY FOCUS THEME (GW)</h1>
                        <?php
                        }
                        ?>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color: #e7e7e7">
                                    ...
                                    <div class="row">
                                        ...
                                        if ($_GET['area'] == 'amt') {
                                        ?>
                                            <div class="col-sm-6"> รายละเอียดข้อมูล safetyfocustheme(amt)</div>
                                        <?php
                                        }else{
                                        ?>
                                            <div class="col-sm-6"> รายละเอียดข้อมูล safetyfocustheme(gw)</div>
                                        <?php
                                        }
                                        ?>
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" >
                                                            <thead>
                                                                <tr>
                                                                    <th>ลำดับ</th>
                                                                    <th>เดือนภาษาไทย</th>
                                                                    <th>เดือนภาษาอังกฤษ</th>
                                                                    <th>พื้นที่</th>
                                                                    <th style="height:40px; width:550px" >SafetyFocusTheme</th>
                                                                    <th>จัดการ</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                            ...
                                                            if ($_GET['area'] == 'amt') {
                                                                $sql_seSafetyfocusthemeData = "SELECT SAFETYID,MONTHTH,MONTHENG,YEARTHEME,YEARCHECK,SAFETYDATA,AREA
                                                                FROM SAFETYFOCUSTHEME
                                                                WHERE YEARTHEME BETWEEN '".$_GET['yearstart']."' AND '".$_GET['yearend']."'
                                                                AND AREA ='amt'
                                                                ORDER BY YEARCHECK,YEARTHEME ASC";
                                                                $params_seSafetyfocusthemeData = array();
                                                                $query_seSafetyfocusthemeData = sqlsrv_query($conn, $sql_seSafetyfocusthemeData, $params_seSafetyfocusthemeData);
                                                            }else {
                                                                $sql_seSafetyfocusthemeData = "SELECT SAFETYID,MONTHTH,MONTHENG,YEARTHEME,YEARCHECK,SAFETYDATA,AREA
                                                                FROM SAFETYFOCUSTHEME
                                                                WHERE YEARTHEME BETWEEN '".$_GET['yearstart']."' AND '".$_GET['yearend']."'
                                                            ...
                                                            while ($result_seSafetyfocusthemeData = sqlsrv_fetch_array($query_seSafetyfocusthemeData, SQLSRV_FETCH_ASSOC)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?= $result_seSafetyfocusthemeData['MONTHTH'] ?> : <?= $result_seSafetyfocusthemeData['YEARTHEME'] ?></td>
                                                                    <td><?= $result_seSafetyfocusthemeData['MONTHENG'] ?>: <?= $result_seSafetyfocusthemeData['YEARTHEME'] ?></td>
                                                                    <td style="text-align: center"><?= $result_seSafetyfocusthemeData['AREA'] ?></td>
                                                                    <td><input class="form-control" placeholder="SafetyFocusTheme"    title="SafetyFocusTheme"  onchange="edit_safetydata(this.value, 'SAFETYDATA', '<?=$result_seSafetyfocusthemeData['SAFETYID']?>')"  style="height:40px; width:550px" id="txt_dayaccident" name="txt_dayaccident" value="<?= $result_seSafetyfocusthemeData['SAFETYDATA'] ?>"  min="" max=""  autocomplete="off"></td>
                                                                    <td style="text-align: center"><input type="button"   data-confirm ="กรุณากด 'ตกลง' เพื่อยืนยันการลบข้อมูล!!!" onclick ="confirm_delete('<?=$result_seSafetyfocusthemeData['SAFETYID']?>');" name="btnSend" id="btnSend" value="ลบข้อมูล" class="btn btn-danger"></td>
                                                                </tr>
                                                                <?php
                                                                $i++;
                                                            }
    ...
    <script>
                                        ...
                                        function edit_safetydata(value, fieldname, safetyid) {
                                        ...
                                        function delete_safetyfocustheme(id){
                                            ...
                                            $.ajax({
                                                    ...
                                                    txt_flg: "delete_safetyfocustheme",
                                                    id:id, 
                                                    monthth: '',
                                                    montheng: '', 
                                                    yeasafety: '',
