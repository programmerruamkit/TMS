...
$strExcelFileName = "Report".$result_getDate['GETDATE']."_AFA.xls";
...
AND [DEPARTMENTCODE] = '03' AND [SECTIONCODE] = '03' AND AREA = 'amata' ";
        ...
        <table   style="border-collapse: collapse;margin-top:8px;font-size:10px" width="100%"  >
            ...
            <tbody>
                ...
                $condWorkcheckin2 = " AND c.DEPARTMENTCODE = '02' AND c.[SECTIONCODE] = '01'";
...
WHERE 
    RowNum = (SELECT COUNT(*) FROM STRING_SPLIT('" . $result_seWorkcheckin['MAPADDRESS'] . "',' '))-2";
       ...
       AND  b.AREA = 'amata' AND b.DEPARTMENTCODE = '02' AND b.[SECTIONCODE] = '01' AND b.DEPARTMENTCODE !='' AND b.[SECTIONCODE] !=''";
