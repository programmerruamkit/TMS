...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKLTSAT_Billing.xls";
} else {
  $strExcelFileName = "RKLTSAT_Billing" . $_GET['invoicecode'] . ".xls";
}
...
<table style="width: 100%;">
    ...
    <tbody>
      <tr>
       ...
       <tr>
            <td colspan="11" style="font-size:22px">สำนักงานสาขาที่ 1 เลขที่ 51 หมู่ 4 ตำบลบ้านเก่า อำเภอพานทอง จังหวัดชลบุรี 20160 โทรศัพท์ : 038-452824-5 โทรสาร : 038-210396</td>
       </tr>
       <tr>
       ...
       <tr>
        ...
        <tr>
            <td colspan="5" style="font-size:22px">ลูกค้า บริษัท ไทยซัมมิท โอโตโมทีฟ จำกัด (สำนักงานใหญ่) </td>
            <td colspan="6" style="text-align:right;font-size:22px">เลขที่ <?= $result_seInvoicecode['INVOICECODE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="font-size:22px">ที่อยู่  4/3, 4/29 หมู่ที่ 1 ถ.บางนา-ตราด กม.16  ต.บางโฉลง อ.บางพลี จ.สมุทรปราการ 10540</td>
            <td colspan="6" style="text-align:right;font-size:22px">วันที่ <?= $result_seInvoicecode['DULYDATE'] ?></td>
        </tr>
        <tr>
            <td colspan="5" style="font-size:22px">เลขประจำตัวผู้เสียภาษี 0115556007101</td>
            <td colspan="6" style="text-align:right;font-size:22px"></td>
        </tr>
    </tbody>
</table>
