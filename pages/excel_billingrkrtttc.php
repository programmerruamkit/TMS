...
if ($_GET['invoicecode'] == "" || $_GET['invoicecode'] == "") {
  $strExcelFileName = "RKRTTTC_OTHER_Billing.xls";
} else {
  $strExcelFileName = "RKRTTTC_OTHER_Billing" . $_GET['invoicecode'] . ".xls";
}
...
$condBilling2 = " AND c.COMPANYCODE ='RKR' AND c.CUSTOMERCODE ='TTTC'";
