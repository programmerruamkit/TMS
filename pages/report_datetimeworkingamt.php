    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                                            ...
                                            <div class="well">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <label>&nbsp;</label>
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-default" onclick="select_datetimeworkingamt();">ค้นหา <li class="fa fa-search"></li></button>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4" style="text-align: left">
                                                        ...
                                                        <a href="#" onclick="excel_datetimeworkingamt();" class="btn btn-default">พิมพ์รายงานข้อมูลปฎิบัติงาน <li class="fa fa-print"></li></a>
               ...
               <!-- ////////////////////////////////////////////////////////////////// -->
                <!-- รายงานเวลาปฏิบัติงานเกิน 14 ชั่วโมง -->
                <div class="row" >
                    <div class="col-lg-12">

                        <h2 class="page-header"><i class="fa fa-file-text-o"></i>
                            รายงานเวลาปฏิบัติงานเกิน 14 ชั่วโมง (AMT)
                                            ...
                                            <div class="well">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4" style="text-align: left">
                                                        ...
                                                        <a href="#" onclick="pdf_workinggrater14hour();" class="btn btn-default">พิมพ์รายงานข้อมูลปฎิบัติงานเกิน 14 ชั่วโมง <li class="fa fa-print"></li></a>
            ...
            <script>
                                                            ...
                                                            function select_datetimeworkingamt()
                                                            {
                                                            ...
                                                            function excel_datetimeworkingamt()
                                                            {
                                                                var startdate = document.getElementById('txt_datestart').value;
                                                                var enddate = document.getElementById('txt_dateend').value;
                                                                var companycode = document.getElementById('txt_companycode').value;
                                                                ...
                                                                window.open('excel_reportdatetimeworkingamt.php?startdate=' + startdate +  '&enddate=' + enddate + '&companycode=' + companycode, '_blank');
                                                            ...
                                                            function pdf_workinggrater14hour()
                                                            {
                                                                var startdate = document.getElementById('txt_datestartgrater14').value;
                                                                var drivercode = document.getElementById('txt_drivernamegrater14').value;
