  ...
  <thead>
       <tr style="border:1px solid #000;" >
              <td colspan="60" style="border-right:1px solid #000;padding:3px;text-align:center;">
                  <b>สรุปค่าเที่ยวบริษัท <?= $result_seComp['Company_NameT'] ?> สายงาน <?= $_GET['customercode'] ?></b>
              </td>
        ...
        while ($result_sePlan = sqlsrv_fetch_array($query_sePlan, SQLSRV_FETCH_ASSOC)) {
          ...
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan1 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT1' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่2
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan2 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT2' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที3
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan3 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT3' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที4
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan4 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT4' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่5
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan5 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT5' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่6
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan6 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT6' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่7
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan7 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT7' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่8
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan8 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT8' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่9
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan9 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT9' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่10
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan10 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT10' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่11
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan11 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2)AS INT) AS 'CNT11' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่10
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan12 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT12' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่13
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan13 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT14' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่14
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan14 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT14' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่15
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan15 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT15' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่16
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan16 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT16' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่17
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan17 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT17' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่18
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan18 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT18' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่19
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan19 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT19' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่20
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan20 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT20' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่21
          if ($_GET['customercode'] == 'STM') {
             $sql_sePlan21 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT21' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่22
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan22 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT22' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่23
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan23 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT23' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่24
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan24 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT24' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่25
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan25 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT25' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่26
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan26 = "SELECT  CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT26' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่27
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan27 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT27' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่28
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan28 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT28' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่29
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan29 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT29' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่30
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan30 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT30' FROM [dbo].[VEHICLETRANSPORTPLAN]
          ...
          //วันที่31
          if ($_GET['customercode'] == 'STM') {
            $sql_sePlan31 = "SELECT CAST(SUBSTRING(ROUNDAMOUNT, 1, 2) AS INT) AS 'CNT31' FROM [dbo].[VEHICLETRANSPORTPLAN]
        ...
        //           AND CONVERT(DATE,b.DATEWORKING) = CONVERT(DATE,'01/".$date."',103)
        ...
        $sql_seIncen1 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'01/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      ...
                      +
                      (SELECT   COALESCE(SUM(CONVERT(INT,C4)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'01/".$date."',103)
                      AND C4 IS NOT NULL
                      AND C4 !=''
                      ...
                      AND EMPLOYEECODE1 ='".$result_sePlan['EMPLOYEECODE']."')
                      +
                      (SELECT   COALESCE(SUM(CONVERT(INT,C5)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'01/".$date."',103)
                      AND C5 IS NOT NULL
                      AND C5 !=''
        ...
        $sql_seIncen2 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'02/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen3 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'03/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen4 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'04/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen5 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'05/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen6 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'06/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen7 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'07/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen8 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'08/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen9 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'09/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen10 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'10/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen11 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'11/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen12 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'12/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen13 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'13/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen14 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'14/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen15 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'15/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen16 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'16/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen17 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'17/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen18 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'18/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen19 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'19/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen20 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'20/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen21 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'21/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen22 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'22/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen23 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'23/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen24 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'24/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen25 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'25/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen26 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'26/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen27 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'27/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen28 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'28/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen29 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'29/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen30 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'30/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_seIncen31 = "SELECT (SELECT   COALESCE(SUM(CONVERT(INT,E1)),0)   FROM [dbo].[VEHICLETRANSPORTPLAN]
                      WHERE COMPANYCODE  ='".$_GET['companycode']."' AND CUSTOMERCODE = '".$_GET['customercode']."'
                      AND CONVERT(DATE,DATEWORKING) = CONVERT(DATE,'31/".$date."',103)
                      AND E1 IS NOT NULL
                      AND E1 !=''
                      AND DOCUMENTCODE IS NOT NULL
                      AND DOCUMENTCODE !=''
        ...
        $sql_sePosId = "SELECT PositionID AS 'POSID'  FROM [dbo].[EMPLOYEEEHR2] WHERE PersonCode = '" . $result_sePlan['EMPLOYEECODE'] . "'";
        $query_sePosId = sqlsrv_query($conn, $sql_sePosId, $params_sePosId);
        $result_sePosId = sqlsrv_fetch_array($query_sePosId, SQLSRV_FETCH_ASSOC);

        $sql_sePosName = "SELECT PositionNameT AS 'POSNAME'  FROM [dbo].[POSITIONEHR] WHERE PositionID ='" . $result_sePosId ['POSID']. "'";
        $query_sePosName = sqlsrv_query($conn, $sql_sePosName, $params_sePosName);
        $result_sePosName = sqlsrv_fetch_array($query_sePosName, SQLSRV_FETCH_ASSOC);
